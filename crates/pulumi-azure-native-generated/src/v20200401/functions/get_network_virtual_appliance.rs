...
pub struct GetNetworkVirtualApplianceResult {
    ...
    pub sku: Option<network::v20200401::VirtualApplianceSkuPropertiesResponse>,
    /// Resource tags.
    ...
    pub virtual_appliance_nics: Vec<network::v20200401::VirtualApplianceNicPropertiesResponse>,
...
pub async fn get_network_virtual_appliance(
    ...
    let result = ctx.invoke("azure-native:network/v20200401:getNetworkVirtualAppliance", invoke_args, &opts).await?;
