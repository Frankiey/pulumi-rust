...
pub struct GetNetworkInterfaceResult {
    ...
    pub dns_settings: Option<network::v20200401::NetworkInterfaceDnsSettingsResponse>,
    ...
    pub ip_configurations: Option<Vec<network::v20200401::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint: network::v20200401::PrivateEndpointResponse,
    ...
    pub tap_configurations: Vec<network::v20200401::NetworkInterfaceTapConfigurationResponse>,
    /// Resource type.
    pub type_: String,
    /// The reference to a virtual machine.
    pub virtual_machine: network::v20200401::SubResourceResponse,
}
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network/v20200401:getNetworkInterface", invoke_args, &opts).await?;
