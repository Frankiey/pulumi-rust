...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20200401::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20200401::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200401:NetworkInterface";
