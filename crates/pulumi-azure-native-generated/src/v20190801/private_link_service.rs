...
pub struct PrivateLinkServiceArgs {
    ...
    pub auto_approval: Option<Input<network::v20190801::PrivateLinkServicePropertiesAutoApprovalArgs>>,
    /// The list of Fqdn.
    pub fqdns: Option<Vec<Input<String>>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// An array of private link service IP configurations.
    pub ip_configurations: Option<Vec<Input<network::v20190801::PrivateLinkServiceIpConfigurationArgs>>>,
    /// An array of references to the load balancer IP configurations.
    pub load_balancer_frontend_ip_configurations: Option<Vec<Input<network::v20190801::FrontendIPConfigurationArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// An array of list about connections to the private endpoint.
    pub private_endpoint_connections: Option<Vec<Input<network::v20190801::PrivateEndpointConnectionArgs>>>,
    ...
    pub visibility: Option<Input<network::v20190801::PrivateLinkServicePropertiesVisibilityArgs>>,
}
...
impl PrivateLinkService {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190801:PrivateLinkService";
