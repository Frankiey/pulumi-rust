...
pub struct GetVirtualHubResult {
    ...
    pub azure_firewall: Option<network::v20190801::SubResourceResponse>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The expressRouteGateway associated with this VirtualHub.
    pub express_route_gateway: Option<network::v20190801::SubResourceResponse>,
    /// Resource ID.
    ...
    pub p2s_vpn_gateway: Option<network::v20190801::SubResourceResponse>,
    /// The provisioning state of the virtual hub resource.
    pub provisioning_state: String,
    /// The routeTable associated with this virtual hub.
    pub route_table: Option<network::v20190801::VirtualHubRouteTableResponse>,
    ...
    pub virtual_network_connections: Option<Vec<network::v20190801::HubVirtualNetworkConnectionResponse>>,
    /// The VirtualWAN to which the VirtualHub belongs.
    pub virtual_wan: Option<network::v20190801::SubResourceResponse>,
    /// The VpnGateway associated with this VirtualHub.
    pub vpn_gateway: Option<network::v20190801::SubResourceResponse>,
}
...
pub async fn get_virtual_hub(
    ...
    let result = ctx.invoke("azure-native:network/v20190801:getVirtualHub", invoke_args, &opts).await?;
