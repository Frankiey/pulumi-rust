...
pub struct GetLocalNetworkGatewayResult {
    ...
    pub local_network_address_space: Option<network::v20190801::AddressSpaceResponse>,
    /// Resource location.
...
pub async fn get_local_network_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20190801:getLocalNetworkGateway", invoke_args, &opts).await?;
