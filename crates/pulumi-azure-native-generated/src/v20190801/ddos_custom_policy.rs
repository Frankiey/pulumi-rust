...
pub struct DdosCustomPolicyArgs {
    ...
    pub protocol_custom_settings: Option<Vec<Input<network::v20190801::ProtocolCustomSettingsFormatArgs>>>,
...
impl DdosCustomPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190801:DdosCustomPolicy";
