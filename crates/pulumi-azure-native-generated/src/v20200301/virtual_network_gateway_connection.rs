...
pub struct VirtualNetworkGatewayConnectionArgs {
    ...
    pub ipsec_policies: Option<Vec<Input<network::v20200301::IpsecPolicyArgs>>>,
    /// The reference to local network gateway resource.
    pub local_network_gateway2: Option<Input<network::v20200301::LocalNetworkGatewayArgs>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The reference to peerings resource.
    pub peer: Option<Input<network::v20200301::SubResourceArgs>>,
    ...
    pub traffic_selector_policies: Option<Vec<Input<network::v20200301::TrafficSelectorPolicyArgs>>>,
    ...
    pub virtual_network_gateway1: Input<network::v20200301::VirtualNetworkGatewayArgs>,
    /// The reference to virtual network gateway resource.
    pub virtual_network_gateway2: Option<Input<network::v20200301::VirtualNetworkGatewayArgs>>,
...
impl VirtualNetworkGatewayConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200301:VirtualNetworkGatewayConnection";
