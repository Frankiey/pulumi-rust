...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20200301::BgpSettingsResponse>,
    /// The device properties.
    pub device_properties: Option<network::v20200301::DevicePropertiesResponse>,
    ...
    pub vpn_site_links: Option<Vec<network::v20200301::VpnSiteLinkResponse>>,
}
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20200301:getVpnSite", invoke_args, &opts).await?;
