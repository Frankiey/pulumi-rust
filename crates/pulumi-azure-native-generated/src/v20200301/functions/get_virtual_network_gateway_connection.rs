...
pub struct GetVirtualNetworkGatewayConnectionResult {
    ...
    pub ipsec_policies: Option<Vec<network::v20200301::IpsecPolicyResponse>>,
    /// The reference to local network gateway resource.
    pub local_network_gateway2: Option<network::v20200301::LocalNetworkGatewayResponse>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// The reference to peerings resource.
    pub peer: Option<network::v20200301::SubResourceResponse>,
    ...
    pub traffic_selector_policies: Option<Vec<network::v20200301::TrafficSelectorPolicyResponse>>,
    /// Collection of all tunnels' connection health status.
    pub tunnel_connection_status: Vec<network::v20200301::TunnelConnectionHealthResponse>,
    /// Resource type.
    pub type_: String,
    ...
    pub virtual_network_gateway1: network::v20200301::VirtualNetworkGatewayResponse,
    /// The reference to virtual network gateway resource.
    pub virtual_network_gateway2: Option<network::v20200301::VirtualNetworkGatewayResponse>,
}
...
pub async fn get_virtual_network_gateway_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20200301:getVirtualNetworkGatewayConnection", invoke_args, &opts).await?;
