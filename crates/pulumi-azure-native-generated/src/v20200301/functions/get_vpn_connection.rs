...
pub struct GetVpnConnectionResult {
    ...
    pub remote_vpn_site: Option<network::v20200301::SubResourceResponse>,
    ...
    pub vpn_link_connections: Option<Vec<network::v20200301::VpnSiteLinkConnectionResponse>>,
}
...
pub async fn get_vpn_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20200301:getVpnConnection", invoke_args, &opts).await?;
