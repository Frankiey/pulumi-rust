...
pub struct GetInboundNatRuleResult {
    ...
    pub backend_ip_configuration: network::v20200301::NetworkInterfaceIPConfigurationResponse,
    ...
    pub frontend_ip_configuration: Option<network::v20200301::SubResourceResponse>,
...
pub async fn get_inbound_nat_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20200301:getInboundNatRule", invoke_args, &opts).await?;
