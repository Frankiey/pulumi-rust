...
pub struct ExpressRouteCircuitPeeringArgs {
    ...
    pub connections: Option<Vec<Input<network::v20200301::ExpressRouteCircuitConnectionArgs>>>,
    ...
    pub route_filter: Option<Input<network::v20200301::SubResourceArgs>>,
    /// The secondary port.
    ...
    pub stats: Option<Input<network::v20200301::ExpressRouteCircuitStatsArgs>>,
    /// The VLAN ID.
...
impl ExpressRouteCircuitPeering {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200301:ExpressRouteCircuitPeering";
