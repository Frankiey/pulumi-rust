...
pub struct PrivateLinkServiceArgs {
    ...
    pub auto_approval: Option<Input<network::PrivateLinkServicePropertiesAutoApprovalArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::PrivateLinkServiceIpConfigurationArgs>>>,
    /// An array of references to the load balancer IP configurations.
    pub load_balancer_frontend_ip_configurations: Option<Vec<Input<network::FrontendIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub visibility: Option<Input<network::PrivateLinkServicePropertiesVisibilityArgs>>,
}
...
impl PrivateLinkService {
    const TYPE_TOKEN: &'static str = "azure-native:network:PrivateLinkService";
