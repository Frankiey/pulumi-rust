...
pub struct NspAccessRuleArgs {
    ...
    pub subscriptions: Option<Vec<Input<network::v20210201preview::SubscriptionIdArgs>>>,
    /// Resource tags.
...
impl NspAccessRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210201preview:NspAccessRule";

    /// Create a new NspAccessRule resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
