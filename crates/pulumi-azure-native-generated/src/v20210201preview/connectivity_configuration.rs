...
pub struct ConnectivityConfigurationArgs {
    ...
    pub applies_to_groups: Option<Vec<Input<network::v20210201preview::ConnectivityGroupItemArgs>>>,
    ...
    /// List of hubItems
    pub hubs: Option<Vec<Input<network::v20210201preview::HubArgs>>>,
...
impl ConnectivityConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210201preview:ConnectivityConfiguration";
