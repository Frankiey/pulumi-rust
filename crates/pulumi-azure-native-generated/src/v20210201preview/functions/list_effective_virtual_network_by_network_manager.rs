...
pub struct ListEffectiveVirtualNetworkByNetworkManagerResult {
    ...
    pub value: Option<Vec<network::v20210201preview::EffectiveVirtualNetworkResponse>>,
}
...
pub async fn list_effective_virtual_network_by_network_manager(
    ...
    let result = ctx.invoke("azure-native:network/v20210201preview:listEffectiveVirtualNetworkByNetworkManager", invoke_args, &opts).await?;
