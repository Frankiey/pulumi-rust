...
pub struct GetNspProfileResult {
...
/// Gets the specified NSP profile.
pub async fn get_nsp_profile(
    ctx: &Context,
    args: GetNspProfileArgs,
    opts: Option<InvokeOptions>,
) -> Result<GetNspProfileResult> {
    ...
    let result = ctx.invoke("azure-native:network/v20210201preview:getNspProfile", invoke_args, &opts).await?;

    Ok(GetNspProfileResult {
