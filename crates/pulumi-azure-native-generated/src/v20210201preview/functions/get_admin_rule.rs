...
pub struct GetAdminRuleResult {
    ...
    pub destinations: Option<Vec<network::v20210201preview::AddressPrefixItemResponse>>,
    ...
    pub sources: Option<Vec<network::v20210201preview::AddressPrefixItemResponse>>,
...
pub async fn get_admin_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20210201preview:getAdminRule", invoke_args, &opts).await?;
