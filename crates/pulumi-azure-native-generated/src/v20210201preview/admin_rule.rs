...
pub struct AdminRuleArgs {
    ...
    pub destinations: Option<Vec<Input<network::v20210201preview::AddressPrefixItemArgs>>>,
    ...
    pub sources: Option<Vec<Input<network::v20210201preview::AddressPrefixItemArgs>>>,
}
...
impl AdminRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210201preview:AdminRule";
