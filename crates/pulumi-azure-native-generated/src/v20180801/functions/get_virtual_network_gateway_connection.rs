...
pub struct GetVirtualNetworkGatewayConnectionResult {
    ...
    pub ipsec_policies: Option<Vec<network::v20180801::IpsecPolicyResponse>>,
    /// The reference to local network gateway resource.
    pub local_network_gateway2: Option<network::v20180801::LocalNetworkGatewayResponse>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// The reference to peerings resource.
    pub peer: Option<network::v20180801::SubResourceResponse>,
    ...
    pub tunnel_connection_status: Vec<network::v20180801::TunnelConnectionHealthResponse>,
    /// Resource type.
    pub type_: String,
    /// Enable policy-based traffic selectors.
    pub use_policy_based_traffic_selectors: Option<bool>,
    /// The reference to virtual network gateway resource.
    pub virtual_network_gateway1: network::v20180801::VirtualNetworkGatewayResponse,
    /// The reference to virtual network gateway resource.
    pub virtual_network_gateway2: Option<network::v20180801::VirtualNetworkGatewayResponse>,
}
...
pub async fn get_virtual_network_gateway_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20180801:getVirtualNetworkGatewayConnection", invoke_args, &opts).await?;
