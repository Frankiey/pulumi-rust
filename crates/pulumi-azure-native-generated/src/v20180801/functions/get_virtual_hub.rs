...
pub struct GetVirtualHubResult {
    ...
    pub express_route_gateway: Option<network::v20180801::SubResourceResponse>,
    /// Resource ID.
    ...
    pub p2s_vpn_gateway: Option<network::v20180801::SubResourceResponse>,
    /// The provisioning state of the resource.
    pub provisioning_state: String,
    /// The routeTable associated with this virtual hub.
    pub route_table: Option<network::v20180801::VirtualHubRouteTableResponse>,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// Resource type.
    pub type_: String,
    /// list of all vnet connections with this VirtualHub.
    pub virtual_network_connections: Option<Vec<network::v20180801::HubVirtualNetworkConnectionResponse>>,
    /// The VirtualWAN to which the VirtualHub belongs
    pub virtual_wan: Option<network::v20180801::SubResourceResponse>,
    /// The VpnGateway associated with this VirtualHub
    pub vpn_gateway: Option<network::v20180801::SubResourceResponse>,
}
...
pub async fn get_virtual_hub(
    ...
    let result = ctx.invoke("azure-native:network/v20180801:getVirtualHub", invoke_args, &opts).await?;
