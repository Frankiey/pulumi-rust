...
pub struct GetConnectionMonitorResult {
    ...
    pub destination: network::v20180801::ConnectionMonitorDestinationResponse,
    ...
    pub source: network::v20180801::ConnectionMonitorSourceResponse,
...
pub async fn get_connection_monitor(
    ...
    let result = ctx.invoke("azure-native:network/v20180801:getConnectionMonitor", invoke_args, &opts).await?;
