...
pub struct GetP2sVpnGatewayResult {
    ...
    pub p2s_vpn_server_configuration: Option<network::v20180801::SubResourceResponse>,
    ...
    pub vpn_client_address_pool: Option<network::v20180801::AddressSpaceResponse>,
    /// All P2S VPN clients' connection health status.
    pub vpn_client_connection_health: network::v20180801::VpnClientConnectionHealthResponse,
...
pub async fn get_p2s_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20180801:getP2sVpnGateway", invoke_args, &opts).await?;
