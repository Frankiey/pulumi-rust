...
pub struct GetNetworkInterfaceResult {
    ...
    pub dns_settings: Option<network::v20180801::NetworkInterfaceDnsSettingsResponse>,
    ...
    pub interface_endpoint: network::v20180801::InterfaceEndpointResponse,
    /// A list of IPConfigurations of the network interface.
    pub ip_configurations: Option<Vec<network::v20180801::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub tap_configurations: Option<Vec<network::v20180801::NetworkInterfaceTapConfigurationResponse>>,
    /// Resource type.
    pub type_: String,
    /// The reference of a virtual machine.
    pub virtual_machine: network::v20180801::SubResourceResponse,
}
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network/v20180801:getNetworkInterface", invoke_args, &opts).await?;
    ...
    Ok(GetNetworkInterfaceResult {
        ...
        interface_endpoint: serde_json::from_value(result.fields.get("interfaceEndpoint").cloned().unwrap_or_default())?
            ,
