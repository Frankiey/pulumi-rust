...
pub struct VpnSiteArgs {
    ...
    pub bgp_properties: Option<Input<network::v20180801::BgpSettingsArgs>>,
    /// The device properties
    pub device_properties: Option<Input<network::v20180801::DevicePropertiesArgs>>,
    /// Resource ID.
...
impl VpnSite {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180801:VpnSite";
