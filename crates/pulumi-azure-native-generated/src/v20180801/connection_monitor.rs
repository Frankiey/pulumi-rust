...
pub struct ConnectionMonitorArgs {
    ...
    pub destination: Input<network::v20180801::ConnectionMonitorDestinationArgs>,
    ...
    pub source: Input<network::v20180801::ConnectionMonitorSourceArgs>,
...
impl ConnectionMonitor {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180801:ConnectionMonitor";
