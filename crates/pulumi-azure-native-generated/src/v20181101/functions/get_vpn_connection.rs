...
pub struct GetVpnConnectionResult {
    ...
    pub remote_vpn_site: Option<network::v20181101::SubResourceResponse>,
...
pub async fn get_vpn_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20181101:getVpnConnection", invoke_args, &opts).await?;
