...
pub struct GetNetworkInterfaceResult {
    ...
    pub dns_settings: Option<network::v20181101::NetworkInterfaceDnsSettingsResponse>,
    ...
    pub interface_endpoint: network::v20181101::InterfaceEndpointResponse,
    /// A list of IPConfigurations of the network interface.
    pub ip_configurations: Option<Vec<network::v20181101::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub tap_configurations: Option<Vec<network::v20181101::NetworkInterfaceTapConfigurationResponse>>,
    /// Resource type.
    pub type_: String,
    /// The reference of a virtual machine.
    pub virtual_machine: network::v20181101::SubResourceResponse,
}
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network/v20181101:getNetworkInterface", invoke_args, &opts).await?;
