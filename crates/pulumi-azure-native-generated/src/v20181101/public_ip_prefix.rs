...
pub struct PublicIPPrefixArgs {
    ...
    pub public_ip_addresses: Option<Vec<Input<network::v20181101::ReferencedPublicIpAddressArgs>>>,
    ...
    pub sku: Option<Input<network::v20181101::PublicIPPrefixSkuArgs>>,
    /// Resource tags.
...
impl PublicIPPrefix {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181101:PublicIPPrefix";
