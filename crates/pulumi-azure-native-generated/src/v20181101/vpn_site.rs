...
pub struct VpnSiteArgs {
    ...
    pub bgp_properties: Option<Input<network::v20181101::BgpSettingsArgs>>,
    /// The device properties
    pub device_properties: Option<Input<network::v20181101::DevicePropertiesArgs>>,
    /// Resource ID.
...
impl VpnSite {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181101:VpnSite";
