...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20181101::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20181101::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub network_security_group: Option<Input<network::v20181101::NetworkSecurityGroupArgs>>,
    ...
    pub tap_configurations: Option<Vec<Input<network::v20181101::NetworkInterfaceTapConfigurationArgs>>>,
}
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181101:NetworkInterface";
