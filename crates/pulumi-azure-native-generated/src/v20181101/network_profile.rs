...
pub struct NetworkProfileArgs {
    ...
    pub container_network_interface_configurations: Option<Vec<Input<network::v20181101::ContainerNetworkInterfaceConfigurationArgs>>>,
    /// List of child container network interfaces.
    pub container_network_interfaces: Option<Vec<Input<network::v20181101::ContainerNetworkInterfaceArgs>>>,
    /// Resource ID.
...
impl NetworkProfile {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181101:NetworkProfile";
