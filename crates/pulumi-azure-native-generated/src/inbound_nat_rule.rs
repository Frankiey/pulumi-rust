...
pub struct InboundNatRuleArgs {
    ...
    pub backend_address_pool: Option<Input<network::SubResourceArgs>>,
    ...
    pub frontend_ip_configuration: Option<Input<network::SubResourceArgs>>,
...
impl InboundNatRule {
    const TYPE_TOKEN: &'static str = "azure-native:network:InboundNatRule";
