...
pub struct WebApplicationFirewallPolicyArgs {
    ...
    pub custom_rules: Option<Vec<Input<network::v20190601::WebApplicationFirewallCustomRuleArgs>>>,
    /// Resource ID.
    ...
    pub policy_settings: Option<Input<network::v20190601::PolicySettingsArgs>>,
...
impl WebApplicationFirewallPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190601:WebApplicationFirewallPolicy";
