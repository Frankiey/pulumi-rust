...
pub struct GetNetworkProfileResult {
    ...
    pub container_network_interface_configurations: Option<Vec<network::v20190601::ContainerNetworkInterfaceConfigurationResponse>>,
    /// List of child container network interfaces.
    pub container_network_interfaces: Option<Vec<network::v20190601::ContainerNetworkInterfaceResponse>>,
...
pub async fn get_network_profile(
    ...
    let result = ctx.invoke("azure-native:network/v20190601:getNetworkProfile", invoke_args, &opts).await?;
    ...
    Ok(GetNetworkProfileResult {
        ...
        container_network_interfaces: result.fields.get("containerNetworkInterfaces").cloned().map(serde_json::from_value).transpose()?,
