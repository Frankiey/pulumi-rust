...
pub struct GetPrivateEndpointResult {
    ...
    pub manual_private_link_service_connections: Option<Vec<network::v20190601::PrivateLinkServiceConnectionResponse>>,
    /// Resource name.
    pub name: String,
    ...
    pub private_link_service_connections: Option<Vec<network::v20190601::PrivateLinkServiceConnectionResponse>>,
    /// The provisioning state of the private endpoint.
    pub provisioning_state: String,
    /// The ID of the subnet from which the private IP will be allocated.
    pub subnet: Option<network::v20190601::SubnetResponse>,
    /// Resource tags.
...
pub async fn get_private_endpoint(
    ...
    let result = ctx.invoke("azure-native:network/v20190601:getPrivateEndpoint", invoke_args, &opts).await?;
