...
pub struct GetFirewallPolicyResult {
    ...
    pub base_policy: Option<network::v20190601::SubResourceResponse>,
    /// List of references to Child Firewall Policies
    pub child_policies: Vec<network::v20190601::SubResourceResponse>,
    /// Gets a unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// List of references to Azure Firewalls that this Firewall Policy is associated with
    pub firewalls: Vec<network::v20190601::SubResourceResponse>,
    /// Resource ID.
    ...
    pub rule_groups: Vec<network::v20190601::SubResourceResponse>,
    /// Resource tags.
...
pub async fn get_firewall_policy(
    ...
    let result = ctx.invoke("azure-native:network/v20190601:getFirewallPolicy", invoke_args, &opts).await?;
