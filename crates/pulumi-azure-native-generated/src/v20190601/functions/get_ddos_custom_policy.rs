...
pub struct GetDdosCustomPolicyResult {
    ...
    pub protocol_custom_settings: Option<Vec<network::v20190601::ProtocolCustomSettingsFormatResponse>>,
    ...
    pub public_ip_addresses: Vec<network::v20190601::SubResourceResponse>,
...
pub async fn get_ddos_custom_policy(
    ...
    let result = ctx.invoke("azure-native:network/v20190601:getDdosCustomPolicy", invoke_args, &opts).await?;
