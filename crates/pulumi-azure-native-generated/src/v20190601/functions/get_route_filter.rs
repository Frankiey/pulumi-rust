...
pub struct GetRouteFilterResult {
    ...
    pub ipv6peerings: Option<Vec<network::v20190601::ExpressRouteCircuitPeeringResponse>>,
    /// Resource location.
    pub location: String,
    /// Resource name.
    pub name: String,
    ...
    pub rules: Option<Vec<network::v20190601::RouteFilterRuleResponse>>,
    /// Resource tags.
...
pub async fn get_route_filter(
    ...
    let result = ctx.invoke("azure-native:network/v20190601:getRouteFilter", invoke_args, &opts).await?;
