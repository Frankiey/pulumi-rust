...
pub struct GetPrivateLinkServiceResult {
    ...
    pub auto_approval: Option<network::v20190601::PrivateLinkServicePropertiesResponseAutoApproval>,
    ...
    pub ip_configurations: Option<Vec<network::v20190601::PrivateLinkServiceIpConfigurationResponse>>,
    /// An array of references to the load balancer IP configurations.
    pub load_balancer_frontend_ip_configurations: Option<Vec<network::v20190601::FrontendIPConfigurationResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// Gets an array of references to the network interfaces created for this private link service.
    pub network_interfaces: Vec<network::v20190601::NetworkInterfaceResponse>,
    /// An array of list about connections to the private endpoint.
    pub private_endpoint_connections: Option<Vec<network::v20190601::PrivateEndpointConnectionResponse>>,
    ...
    pub visibility: Option<network::v20190601::PrivateLinkServicePropertiesResponseVisibility>,
}
...
pub async fn get_private_link_service(
    ...
    let result = ctx.invoke("azure-native:network/v20190601:getPrivateLinkService", invoke_args, &opts).await?;
    ...
    Ok(GetPrivateLinkServiceResult {
        ...
        network_interfaces: serde_json::from_value(result.fields.get("networkInterfaces").cloned().unwrap_or_default())?
            ,
        private_endpoint_connections: result.fields.get("privateEndpointConnections").cloned().map(serde_json::from_value).transpose()?,
