...
pub struct GetP2sVpnGatewayP2sVpnConnectionHealthResult {
    ...
    pub p2s_vpn_server_configuration: Option<network::v20190601::SubResourceResponse>,
    ...
    pub virtual_hub: Option<network::v20190601::SubResourceResponse>,
    /// The reference of the address space resource which represents Address space for P2S VpnClient.
    pub vpn_client_address_pool: Option<network::v20190601::AddressSpaceResponse>,
    /// All P2S VPN clients' connection health status.
    pub vpn_client_connection_health: network::v20190601::VpnClientConnectionHealthResponse,
...
pub async fn get_p2s_vpn_gateway_p2s_vpn_connection_health(
    ...
    let result = ctx.invoke("azure-native:network/v20190601:getP2sVpnGatewayP2sVpnConnectionHealth", invoke_args, &opts).await?;
