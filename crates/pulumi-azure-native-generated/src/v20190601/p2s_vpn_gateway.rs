...
pub struct P2sVpnGatewayArgs {
    ...
    pub p2s_vpn_server_configuration: Option<Input<network::v20190601::SubResourceArgs>>,
    ...
    pub vpn_client_address_pool: Option<Input<network::v20190601::AddressSpaceArgs>>,
...
impl P2sVpnGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190601:P2sVpnGateway";
