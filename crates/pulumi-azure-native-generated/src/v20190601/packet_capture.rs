...
pub struct PacketCaptureArgs {
    ...
    pub filters: Option<Vec<Input<network::v20190601::PacketCaptureFilterArgs>>>,
    ...
    pub storage_location: Input<network::v20190601::PacketCaptureStorageLocationArgs>,
...
impl PacketCapture {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190601:PacketCapture";
