...
pub struct PublicIPPrefixArgs {
    ...
    pub custom_ip_prefix: Option<Input<network::v20200601::SubResourceArgs>>,
    /// Resource ID.
    ...
    pub sku: Option<Input<network::v20200601::PublicIPPrefixSkuArgs>>,
    /// Resource tags.
...
impl PublicIPPrefix {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200601:PublicIPPrefix";
