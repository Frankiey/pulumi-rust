...
pub struct FirewallPolicyArgs {
    ...
    pub base_policy: Option<Input<network::v20200601::SubResourceArgs>>,
    /// DNS Proxy Settings definition.
    pub dns_settings: Option<Input<network::v20200601::DnsSettingsArgs>>,
    ...
    pub threat_intel_whitelist: Option<Input<network::v20200601::FirewallPolicyThreatIntelWhitelistArgs>>,
}
...
impl FirewallPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200601:FirewallPolicy";
