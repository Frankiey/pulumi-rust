...
pub struct GetPacketCaptureResult {
    ...
    pub filters: Option<Vec<network::v20200601::PacketCaptureFilterResponse>>,
    ...
    pub storage_location: network::v20200601::PacketCaptureStorageLocationResponse,
...
pub async fn get_packet_capture(
    ...
    let result = ctx.invoke("azure-native:network/v20200601:getPacketCapture", invoke_args, &opts).await?;
