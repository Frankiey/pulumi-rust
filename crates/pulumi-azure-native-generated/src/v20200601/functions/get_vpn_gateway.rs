...
pub struct GetVpnGatewayResult {
    ...
    pub connections: Option<Vec<network::v20200601::VpnConnectionResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// Resource ID.
    pub id: Option<String>,
    /// List of all IPs configured on the gateway.
    pub ip_configurations: Vec<network::v20200601::VpnGatewayIpConfigurationResponse>,
    /// Resource location.
    pub location: String,
    /// Resource name.
    pub name: String,
...
pub async fn get_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20200601:getVpnGateway", invoke_args, &opts).await?;
