...
pub struct GetDdosProtectionPlanResult {
    ...
    pub virtual_networks: Vec<network::v20200601::SubResourceResponse>,
}
...
pub async fn get_ddos_protection_plan(
    ...
    let result = ctx.invoke("azure-native:network/v20200601:getDdosProtectionPlan", invoke_args, &opts).await?;
