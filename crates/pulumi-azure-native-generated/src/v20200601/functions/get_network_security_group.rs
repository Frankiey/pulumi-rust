...
pub struct GetNetworkSecurityGroupResult {
    ...
    pub default_security_rules: Vec<network::v20200601::SecurityRuleResponse>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// A collection of references to flow log resources.
    pub flow_logs: Vec<network::v20200601::FlowLogResponse>,
    /// Resource ID.
    ...
    pub security_rules: Option<Vec<network::v20200601::SecurityRuleResponse>>,
    /// A collection of references to subnets.
    pub subnets: Vec<network::v20200601::SubnetResponse>,
    /// Resource tags.
...
pub async fn get_network_security_group(
    ...
    let result = ctx.invoke("azure-native:network/v20200601:getNetworkSecurityGroup", invoke_args, &opts).await?;
