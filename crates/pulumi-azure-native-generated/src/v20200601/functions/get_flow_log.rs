...
pub struct GetFlowLogResult {
    ...
    pub flow_analytics_configuration: Option<network::v20200601::TrafficAnalyticsPropertiesResponse>,
    /// Parameters that define the flow log format.
    pub format: Option<network::v20200601::FlowLogFormatParametersResponse>,
    /// Resource ID.
    ...
    pub retention_policy: Option<network::v20200601::RetentionPolicyParametersResponse>,
...
pub async fn get_flow_log(
    ...
    let result = ctx.invoke("azure-native:network/v20200601:getFlowLog", invoke_args, &opts).await?;
