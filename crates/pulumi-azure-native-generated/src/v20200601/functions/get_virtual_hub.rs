...
pub struct GetVirtualHubResult {
    ...
    pub azure_firewall: Option<network::v20200601::SubResourceResponse>,
    /// List of references to Bgp Connections.
    pub bgp_connections: Vec<network::v20200601::SubResourceResponse>,
    ...
    pub express_route_gateway: Option<network::v20200601::SubResourceResponse>,
    /// Resource ID.
    pub id: Option<String>,
    /// List of references to IpConfigurations.
    pub ip_configurations: Vec<network::v20200601::SubResourceResponse>,
    /// Resource location.
    pub location: String,
    /// Resource name.
    pub name: String,
    /// The P2SVpnGateway associated with this VirtualHub.
    pub p2s_vpn_gateway: Option<network::v20200601::SubResourceResponse>,
    /// The provisioning state of the virtual hub resource.
    pub provisioning_state: String,
    /// The routeTable associated with this virtual hub.
    pub route_table: Option<network::v20200601::VirtualHubRouteTableResponse>,
    /// The routing state.
    pub routing_state: String,
    /// The securityPartnerProvider associated with this VirtualHub.
    pub security_partner_provider: Option<network::v20200601::SubResourceResponse>,
    ...
    pub virtual_hub_route_table_v2s: Option<Vec<network::v20200601::VirtualHubRouteTableV2Response>>,
    /// VirtualRouter ASN.
    pub virtual_router_asn: Option<f64>,
    /// VirtualRouter IPs.
    pub virtual_router_ips: Option<Vec<String>>,
    /// The VirtualWAN to which the VirtualHub belongs.
    pub virtual_wan: Option<network::v20200601::SubResourceResponse>,
    /// The VpnGateway associated with this VirtualHub.
    pub vpn_gateway: Option<network::v20200601::SubResourceResponse>,
}
...
pub async fn get_virtual_hub(
    ...
    let result = ctx.invoke("azure-native:network/v20200601:getVirtualHub", invoke_args, &opts).await?;
    ...
    Ok(GetVirtualHubResult {
        ...
        bgp_connections: serde_json::from_value(result.fields.get("bgpConnections").cloned().unwrap_or_default())?
            ,
        enable_virtual_router_route_propogation: result.fields.get("enableVirtualRouterRoutePropogation").cloned().map(serde_json::from_value).transpose()?,
