...
pub struct DeploymentAtSubscriptionScopeArgs {
    /// The name of the deployment.
    pub deployment_name: Option<Input<String>>,
    /// The Managed Identity configuration for a deployment.
    pub identity: Option<Input<resources::v20250401::DeploymentIdentityArgs>>,
...
/// Deployment information.
pub struct DeploymentAtSubscriptionScope {
...
impl DeploymentAtSubscriptionScope {
    const TYPE_TOKEN: &'static str = "azure-native:resources/v20250401:DeploymentAtSubscriptionScope";

    /// Create a new DeploymentAtSubscriptionScope resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
