...
pub struct DeploymentAtScopeArgs {
...
impl DeploymentAtScope {
    const TYPE_TOKEN: &'static str = "azure-native:resources/v20250401:DeploymentAtScope";

    /// Create a new DeploymentAtScope resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
