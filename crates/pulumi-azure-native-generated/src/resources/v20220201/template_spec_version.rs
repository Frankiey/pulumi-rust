...
pub struct TemplateSpecVersionArgs {
    ...
    pub linked_templates: Option<Vec<Input<resources::v20220201::LinkedTemplateArtifactArgs>>>,
...
impl TemplateSpecVersion {
    const TYPE_TOKEN: &'static str = "azure-native:resources/v20220201:TemplateSpecVersion";
