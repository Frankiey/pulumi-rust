...
pub struct GetTemplateSpecVersionResult {
    ...
    pub linked_templates: Option<Vec<resources::v20220201::LinkedTemplateArtifactResponse>>,
    ...
    pub system_data: resources::v20220201::SystemDataResponse,
    /// Resource tags.
...
pub async fn get_template_spec_version(
    ...
    let result = ctx.invoke("azure-native:resources/v20220201:getTemplateSpecVersion", invoke_args, &opts).await?;
