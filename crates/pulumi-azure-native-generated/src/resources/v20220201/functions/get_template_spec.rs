...
pub struct GetTemplateSpecResult {
    ...
    pub versions: HashMap<String, resources::v20220201::TemplateSpecVersionInfoResponse>,
}
...
pub async fn get_template_spec(
    ...
    let result = ctx.invoke("azure-native:resources/v20220201:getTemplateSpec", invoke_args, &opts).await?;
