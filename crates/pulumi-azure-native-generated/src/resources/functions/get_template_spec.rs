...
pub struct GetTemplateSpecResult {
    ...
    pub versions: HashMap<String, resources::TemplateSpecVersionInfoResponse>,
}
...
pub async fn get_template_spec(
    ...
    let result = ctx.invoke("azure-native:resources:getTemplateSpec", invoke_args, &opts).await?;
