...
pub struct GetResourceResult {
    ...
    pub identity: Option<resources::v20201001::IdentityResponse>,
    ...
    pub plan: Option<resources::v20201001::PlanResponse>,
    /// The resource properties.
    pub properties: serde_json::Value,
    /// The SKU of the resource.
    pub sku: Option<resources::v20201001::SkuResponse>,
    /// Resource tags
...
pub async fn get_resource(
    ...
    let result = ctx.invoke("azure-native:resources/v20201001:getResource", invoke_args, &opts).await?;
