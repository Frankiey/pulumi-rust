...
pub struct AzurePowerShellScriptArgs {
    /// Command line arguments to pass to the script. Arguments are separated by spaces. ex: -Name blue* -Location 'West US 2' 
    pub arguments: Option<Input<String>>,
    /// Azure PowerShell module version to be used.
    pub az_power_shell_version: Input<String>,
    /// The clean up preference when the script execution gets in a terminal state. Default setting is 'Always'.
    pub cleanup_preference: Option<Input<serde_json::Value>>,
    /// Container settings.
    pub container_settings: Option<Input<resources::v20201001::ContainerConfigurationArgs>>,
    /// The environment variables to pass over to the script.
    pub environment_variables: Option<Vec<Input<resources::v20201001::EnvironmentVariableArgs>>>,
    /// Gets or sets how the deployment script should be forced to execute even if the script resource has not changed. Can be current time stamp or a GUID.
    pub force_update_tag: Option<Input<String>>,
    /// Optional property. Managed identity to be used for this deployment script. Currently, only user-assigned MSI is supported.
    pub identity: Option<Input<resources::v20201001::ManagedServiceIdentityArgs>>,
    /// Type of the script.
    ...
    pub storage_account_settings: Option<Input<resources::v20201001::StorageAccountConfigurationArgs>>,
...
pub struct AzurePowerShellScript {
    ...
    /// Azure PowerShell module version to be used.
    pub az_power_shell_version: Output<serde_json::Value>,
...
impl AzurePowerShellScript {
    const TYPE_TOKEN: &'static str = "azure-native:resources/v20201001:AzurePowerShellScript";

    /// Create a new AzurePowerShellScript resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
        ...
        pulumi_sdk::resolve_input("azPowerShellVersion", args.az_power_shell_version, &mut inputs, &mut deps, &mut prop_deps).await;
        ...
        Ok(Self {
            ...
            arguments: registered.outputs.get("arguments")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            az_power_shell_version: registered.outputs.get("azPowerShellVersion")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
