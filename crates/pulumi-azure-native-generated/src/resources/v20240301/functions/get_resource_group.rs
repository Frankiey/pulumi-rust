...
pub struct GetResourceGroupResult {
    ...
    pub properties: resources::v20240301::ResourceGroupPropertiesResponse,
...
pub async fn get_resource_group(
    ...
    let result = ctx.invoke("azure-native:resources/v20240301:getResourceGroup", invoke_args, &opts).await?;
