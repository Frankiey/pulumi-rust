...
pub struct GetDeploymentStackAtManagementGroupResult {
    ...
    pub action_on_unmanage: resources::v20240301::ActionOnUnmanageResponse,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// The correlation id of the last Deployment stack upsert or delete operation. It is in GUID format and is used for tracing.
    pub correlation_id: String,
    /// The debug setting of the deployment.
    pub debug_setting: Option<resources::v20240301::DeploymentStacksDebugSettingResponse>,
    ...
    pub deleted_resources: Vec<resources::v20240301::ResourceReferenceResponse>,
    /// Defines how resources deployed by the stack are locked.
    pub deny_settings: resources::v20240301::DenySettingsResponse,
    ...
    pub detached_resources: Vec<resources::v20240301::ResourceReferenceResponse>,
    /// The duration of the last successful Deployment stack update.
    pub duration: String,
    /// The error detail.
    pub error: resources::v20240301::ErrorDetailResponse,
    /// An array of resources that failed to reach goal state during the most recent update. Each resourceId is accompanied by an error message.
    pub failed_resources: Vec<resources::v20240301::ResourceReferenceExtendedResponse>,
    ...
    pub parameters: Option<HashMap<String, resources::v20240301::DeploymentParameterResponse>>,
    /// The URI of parameters file. Use this element to link to an existing parameters file. Use either the parametersLink property or the parameters property, but not both.
    pub parameters_link: Option<resources::v20240301::DeploymentStacksParametersLinkResponse>,
    /// State of the deployment stack.
    pub provisioning_state: String,
    /// An array of resources currently managed by the deployment stack.
    pub resources: Vec<resources::v20240301::ManagedResourceReferenceResponse>,
    /// Azure Resource Manager metadata containing createdBy and modifiedBy information.
    pub system_data: resources::v20240301::SystemDataResponse,
    /// Resource tags.
...
pub async fn get_deployment_stack_at_management_group(
    ...
    let result = ctx.invoke("azure-native:resources/v20240301:getDeploymentStackAtManagementGroup", invoke_args, &opts).await?;
