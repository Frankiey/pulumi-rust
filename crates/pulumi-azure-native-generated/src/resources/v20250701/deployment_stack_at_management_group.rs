...
pub struct DeploymentStackAtManagementGroupArgs {
    /// Defines the behavior of resources that are no longer managed after the Deployment stack is updated or deleted.
    pub action_on_unmanage: Input<resources::v20250701::ActionOnUnmanageArgs>,
    /// Flag to bypass service errors that indicate the stack resource list is not correctly synchronized.
    pub bypass_stack_out_of_sync_error: Option<Input<bool>>,
    /// The debug setting of the deployment.
    pub debug_setting: Option<Input<resources::v20250701::DeploymentStacksDebugSettingArgs>>,
    /// Defines how resources deployed by the stack are locked.
    pub deny_settings: Input<resources::v20250701::DenySettingsArgs>,
    ...
    pub extension_configs: Option<HashMap<String, Input<HashMap<String, Input<resources::v20250701::DeploymentExtensionConfigItemArgs>>>>>,
    /// External input definitions, used by external tooling to define expected external input values.
    pub external_input_definitions: Option<HashMap<String, Input<resources::v20250701::DeploymentExternalInputDefinitionArgs>>>,
    /// External input values, used by external tooling for parameter evaluation.
    pub external_inputs: Option<HashMap<String, Input<resources::v20250701::DeploymentExternalInputArgs>>>,
    /// The geo-location where the resource lives. Required for subscription and management group scoped stacks. The location is inherited from the resource group for resource group scoped stacks.
    pub location: Option<Input<String>>,
    /// The management group ID.
    pub management_group_id: Input<String>,
    /// Name and value pairs that define the deployment parameters for the template. Use this element when providing the parameter values directly in the request, rather than linking to an existing parameter file. Use either the parametersLink property or the parameters property, but not both.
    pub parameters: Option<HashMap<String, Input<resources::v20250701::DeploymentParameterArgs>>>,
    /// The URI of parameters file. Use this element to link to an existing parameters file. Use either the parametersLink property or the parameters property, but not both.
    pub parameters_link: Option<Input<resources::v20250701::DeploymentStacksParametersLinkArgs>>,
    /// Resource tags.
    ...
    pub template_link: Option<Input<resources::v20250701::DeploymentStacksTemplateLinkArgs>>,
    /// The validation level of the deployment stack
    pub validation_level: Option<Input<serde_json::Value>>,
}

/// Deployment stack object.
pub struct DeploymentStackAtManagementGroup {
    ...
    pub correlation_id: Output<serde_json::Value>,
    /// The debug setting of the deployment.
    ...
    pub deployment_extensions: Output<serde_json::Value>,
    ...
    /// The validation level of the deployment stack
    pub validation_level: Output<serde_json::Value>,
}

impl DeploymentStackAtManagementGroup {
    const TYPE_TOKEN: &'static str = "azure-native:resources/v20250701:DeploymentStackAtManagementGroup";

    /// Create a new DeploymentStackAtManagementGroup resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
        ...
        if let Some(v) = args.bypass_stack_out_of_sync_error {
            pulumi_sdk::resolve_input("bypassStackOutOfSyncError", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        if let Some(v) = args.extension_configs {
            pulumi_sdk::resolve_input_map("extensionConfigs", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        if let Some(v) = args.external_input_definitions {
            pulumi_sdk::resolve_input_map("externalInputDefinitions", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        if let Some(v) = args.external_inputs {
            pulumi_sdk::resolve_input_map("externalInputs", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        if let Some(v) = args.location {
            pulumi_sdk::resolve_input("location", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        pulumi_sdk::resolve_input("managementGroupId", args.management_group_id, &mut inputs, &mut deps, &mut prop_deps).await;
        ...
        if let Some(v) = args.validation_level {
            pulumi_sdk::resolve_input("validationLevel", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            azure_api_version: registered.outputs.get("azureApiVersion")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            correlation_id: registered.outputs.get("correlationId")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            deny_settings: registered.outputs.get("denySettings")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            deployment_extensions: registered.outputs.get("deploymentExtensions")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            type_: registered.outputs.get("type")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            validation_level: registered.outputs.get("validationLevel")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
        })
    }
