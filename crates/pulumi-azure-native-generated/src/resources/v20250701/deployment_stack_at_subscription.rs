...
pub struct DeploymentStackAtSubscriptionArgs {
...
/// Deployment stack object.
pub struct DeploymentStackAtSubscription {
...
impl DeploymentStackAtSubscription {
    const TYPE_TOKEN: &'static str = "azure-native:resources/v20250701:DeploymentStackAtSubscription";

    /// Create a new DeploymentStackAtSubscription resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
