...
#[derive(Default)]
pub struct GetDeploymentStackAtManagementGroupArgs {
...
pub struct GetDeploymentStackAtManagementGroupResult {
    /// Defines the behavior of resources that are no longer managed after the Deployment stack is updated or deleted.
    pub action_on_unmanage: resources::v20250701::ActionOnUnmanageResponse,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// The correlation id of the last Deployment stack upsert or delete operation. It is in GUID format and is used for tracing.
    pub correlation_id: String,
    /// The debug setting of the deployment.
    pub debug_setting: Option<resources::v20250701::DeploymentStacksDebugSettingResponse>,
    ...
    pub deleted_resources: Vec<resources::v20250701::ResourceReferenceResponse>,
    /// Defines how resources deployed by the stack are locked.
    pub deny_settings: resources::v20250701::DenySettingsResponse,
    /// The extensions used during deployment. Contains extension data for all extensible resources managed by the stack.
    pub deployment_extensions: Vec<resources::v20250701::DeploymentExtensionResponse>,
    ...
    pub detached_resources: Vec<resources::v20250701::ResourceReferenceResponse>,
    /// The duration of the last successful Deployment stack update.
    pub duration: String,
    /// The error detail.
    pub error: resources::v20250701::ErrorDetailResponse,
    /// An array of resources that failed to reach goal state during the most recent update. Each resourceId is accompanied by an error message.
    pub failed_resources: Vec<resources::v20250701::ResourceReferenceExtendedResponse>,
    ...
    pub parameters: Option<HashMap<String, resources::v20250701::DeploymentParameterResponse>>,
    /// The URI of parameters file. Use this element to link to an existing parameters file. Use either the parametersLink property or the parameters property, but not both.
    pub parameters_link: Option<resources::v20250701::DeploymentStacksParametersLinkResponse>,
    /// State of the deployment stack.
    pub provisioning_state: String,
    /// An array of resources currently managed by the deployment stack.
    pub resources: Vec<resources::v20250701::ManagedResourceReferenceResponse>,
    /// Azure Resource Manager metadata containing createdBy and modifiedBy information.
    pub system_data: resources::v20250701::SystemDataResponse,
    /// Resource tags.
...
/// Gets the Deployment stack with the given name.
pub async fn get_deployment_stack_at_management_group(
    ctx: &Context,
    args: GetDeploymentStackAtManagementGroupArgs,
    opts: Option<InvokeOptions>,
) -> Result<GetDeploymentStackAtManagementGroupResult> {
    ...
    let result = ctx.invoke("azure-native:resources/v20250701:getDeploymentStackAtManagementGroup", invoke_args, &opts).await?;

    Ok(GetDeploymentStackAtManagementGroupResult {
        ...
        deny_settings: serde_json::from_value(result.fields.get("denySettings").cloned().unwrap_or_default())?
            ,
        deployment_extensions: serde_json::from_value(result.fields.get("deploymentExtensions").cloned().unwrap_or_default())?
            ,
        ...
        type_: serde_json::from_value(result.fields.get("type").cloned().unwrap_or_default())?
            ,
        validation_level: result.fields.get("validationLevel").cloned().map(serde_json::from_value).transpose()?,
    })
}
