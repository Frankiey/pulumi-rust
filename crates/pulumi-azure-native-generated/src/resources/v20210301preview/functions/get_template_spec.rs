...
pub struct GetTemplateSpecResult {
    ...
    pub versions: HashMap<String, resources::v20210301preview::TemplateSpecVersionInfoResponse>,
}
...
pub async fn get_template_spec(
    ...
    let result = ctx.invoke("azure-native:resources/v20210301preview:getTemplateSpec", invoke_args, &opts).await?;
