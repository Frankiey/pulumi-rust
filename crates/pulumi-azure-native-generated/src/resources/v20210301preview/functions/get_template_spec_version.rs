...
pub struct GetTemplateSpecVersionResult {
    ...
    pub linked_templates: Option<Vec<resources::v20210301preview::LinkedTemplateArtifactResponse>>,
    ...
    pub system_data: resources::v20210301preview::SystemDataResponse,
    /// Resource tags.
...
pub async fn get_template_spec_version(
    ...
    let result = ctx.invoke("azure-native:resources/v20210301preview:getTemplateSpecVersion", invoke_args, &opts).await?;
