...
pub struct GetTemplateSpecVersionResult {
    ...
    pub linked_templates: Option<Vec<resources::v20210501::LinkedTemplateArtifactResponse>>,
...
pub async fn get_template_spec_version(
    ...
    let result = ctx.invoke("azure-native:resources/v20210501:getTemplateSpecVersion", invoke_args, &opts).await?;
