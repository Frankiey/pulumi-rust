...
pub struct GetResourceResult {
    ...
    pub extended_location: Option<resources::v20250301::ExtendedLocationResponse>,
    /// Resource ID
    pub id: String,
    /// The identity of the resource.
    pub identity: Option<resources::v20250301::IdentityResponse>,
    ...
    pub plan: Option<resources::v20250301::PlanResponse>,
    /// The resource properties.
    pub properties: serde_json::Value,
    /// The SKU of the resource.
    pub sku: Option<resources::v20250301::SkuResponse>,
    /// Resource tags
...
pub async fn get_resource(
    ...
    let result = ctx.invoke("azure-native:resources/v20250301:getResource", invoke_args, &opts).await?;
