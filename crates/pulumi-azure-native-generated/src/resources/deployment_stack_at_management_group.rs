...
pub struct DeploymentStackAtManagementGroupArgs {
    ...
    pub action_on_unmanage: Input<resources::ActionOnUnmanageArgs>,
    /// Flag to bypass service errors that indicate the stack resource list is not correctly synchronized.
    pub bypass_stack_out_of_sync_error: Option<Input<bool>>,
    /// The debug setting of the deployment.
    pub debug_setting: Option<Input<resources::DeploymentStacksDebugSettingArgs>>,
    /// Defines how resources deployed by the stack are locked.
    pub deny_settings: Input<resources::DenySettingsArgs>,
    ...
    pub parameters: Option<HashMap<String, Input<resources::DeploymentParameterArgs>>>,
    /// The URI of parameters file. Use this element to link to an existing parameters file. Use either the parametersLink property or the parameters property, but not both.
    pub parameters_link: Option<Input<resources::DeploymentStacksParametersLinkArgs>>,
    /// Resource tags.
    ...
    pub template_link: Option<Input<resources::DeploymentStacksTemplateLinkArgs>>,
}
...
impl DeploymentStackAtManagementGroup {
    const TYPE_TOKEN: &'static str = "azure-native:resources:DeploymentStackAtManagementGroup";
