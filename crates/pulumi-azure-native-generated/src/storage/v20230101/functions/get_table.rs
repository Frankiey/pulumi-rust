...
pub struct GetTableResult {
    ...
    pub signed_identifiers: Option<Vec<storage::v20230101::TableSignedIdentifierResponse>>,
...
pub async fn get_table(
    ...
    let result = ctx.invoke("azure-native:storage/v20230101:getTable", invoke_args, &opts).await?;
