...
pub struct GetObjectReplicationPolicyResult {
    ...
    pub rules: Option<Vec<storage::v20230101::ObjectReplicationPolicyRuleResponse>>,
...
pub async fn get_object_replication_policy(
    ...
    let result = ctx.invoke("azure-native:storage/v20230101:getObjectReplicationPolicy", invoke_args, &opts).await?;
