...
pub struct GetBlobContainerResult {
    ...
    pub immutability_policy: storage::v20230101::ImmutabilityPolicyPropertiesResponse,
    /// The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
    pub immutable_storage_with_versioning: Option<storage::v20230101::ImmutableStorageWithVersioningResponse>,
    ...
    pub legal_hold: storage::v20230101::LegalHoldPropertiesResponse,
...
pub async fn get_blob_container(
    ...
    let result = ctx.invoke("azure-native:storage/v20230101:getBlobContainer", invoke_args, &opts).await?;
