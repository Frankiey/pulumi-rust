...
pub struct GetFileServicePropertiesResult {
    ...
    pub protocol_settings: Option<storage::v20230101::ProtocolSettingsResponse>,
    /// The file service properties for share soft delete.
    pub share_delete_retention_policy: Option<storage::v20230101::DeleteRetentionPolicyResponse>,
    /// Sku name and tier.
...
pub async fn get_file_service_properties(
    ...
    let result = ctx.invoke("azure-native:storage/v20230101:getFileServiceProperties", invoke_args, &opts).await?;
