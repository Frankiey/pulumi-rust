...
pub struct GetObjectReplicationPolicyResult {
    ...
    pub metrics: Option<storage::ObjectReplicationPolicyPropertiesResponseMetrics>,
    /// The name of the resource
    pub name: String,
    /// A unique id for object replication policy.
    pub policy_id: String,
    /// The storage account object replication rules.
    pub rules: Option<Vec<storage::ObjectReplicationPolicyRuleResponse>>,
...
pub async fn get_object_replication_policy(
    ...
    let result = ctx.invoke("azure-native:storage:getObjectReplicationPolicy", invoke_args, &opts).await?;
