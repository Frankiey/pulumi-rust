...
pub struct GetPrivateEndpointConnectionResult {
    ...
    pub private_endpoint: Option<storage::PrivateEndpointResponse>,
    /// A collection of information about the state of the connection between service consumer and provider.
    pub private_link_service_connection_state: storage::PrivateLinkServiceConnectionStateResponse,
...
pub async fn get_private_endpoint_connection(
    ...
    let result = ctx.invoke("azure-native:storage:getPrivateEndpointConnection", invoke_args, &opts).await?;
