...
pub struct PrivateEndpointConnectionArgs {
    ...
    pub private_link_service_connection_state: Input<storage::v20250601::PrivateLinkServiceConnectionStateArgs>,
...
impl PrivateEndpointConnection {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20250601:PrivateEndpointConnection";
