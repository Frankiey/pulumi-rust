...
pub struct StorageTaskAssignmentArgs {
    ...
    pub properties: Input<storage::v20250601::StorageTaskAssignmentPropertiesArgs>,
...
impl StorageTaskAssignment {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20250601:StorageTaskAssignment";
