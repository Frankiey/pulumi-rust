...
pub struct EncryptionScopeArgs {
    ...
    pub key_vault_properties: Option<Input<storage::v20250601::EncryptionScopeKeyVaultPropertiesArgs>>,
...
impl EncryptionScope {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20250601:EncryptionScope";
