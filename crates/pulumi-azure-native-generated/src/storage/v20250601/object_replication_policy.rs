...
pub struct ObjectReplicationPolicyArgs {
    ...
    pub metrics: Option<Input<storage::v20250601::ObjectReplicationPolicyPropertiesMetricsArgs>>,
    ...
    pub priority_replication: Option<Input<storage::v20250601::ObjectReplicationPolicyPropertiesPriorityReplicationArgs>>,
    /// The name of the resource group. The name is case insensitive.
    pub resource_group_name: Input<String>,
    /// The storage account object replication rules.
    pub rules: Option<Vec<Input<storage::v20250601::ObjectReplicationPolicyRuleArgs>>>,
...
pub struct ObjectReplicationPolicy {
    ...
    /// Optional. The object replication policy metrics feature options.
    pub metrics: Output<serde_json::Value>,
    /// The name of the resource
    pub name: Output<serde_json::Value>,
    /// A unique id for object replication policy.
    pub policy_id: Output<serde_json::Value>,
    /// Optional. The object replication policy priority replication feature options.
    pub priority_replication: Output<serde_json::Value>,
    /// The storage account object replication rules.
...
impl ObjectReplicationPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20250601:ObjectReplicationPolicy";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.metrics {
            pulumi_sdk::resolve_input("metrics", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        if let Some(v) = args.priority_replication {
            pulumi_sdk::resolve_input("priorityReplication", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            enabled_time: registered.outputs.get("enabledTime")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            metrics: registered.outputs.get("metrics")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            policy_id: registered.outputs.get("policyId")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            priority_replication: registered.outputs.get("priorityReplication")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
