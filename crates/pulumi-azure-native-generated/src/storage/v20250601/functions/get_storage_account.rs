...
pub struct GetStorageAccountResult {
    ...
    pub azure_files_identity_based_authentication: Option<storage::v20250601::AzureFilesIdentityBasedAuthenticationResponse>,
    /// Blob restore status
    pub blob_restore_status: storage::v20250601::BlobRestoreStatusResponse,
    /// Gets the creation date and time of the storage account in UTC.
    pub creation_time: String,
    /// Gets the custom domain the user assigned to this storage account.
    pub custom_domain: storage::v20250601::CustomDomainResponse,
    ...
    pub dual_stack_endpoint_preference: Option<storage::v20250601::DualStackEndpointPreferenceResponse>,
    ...
    pub encryption: storage::v20250601::EncryptionResponse,
    /// The extendedLocation of the resource.
    pub extended_location: Option<storage::v20250601::ExtendedLocationResponse>,
    ...
    pub geo_priority_replication_status: Option<storage::v20250601::GeoPriorityReplicationStatusResponse>,
    /// Geo Replication Stats
    pub geo_replication_stats: storage::v20250601::GeoReplicationStatsResponse,
    /// Fully qualified resource ID for the resource. E.g. "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}"
    pub id: String,
    /// The identity of the resource.
    pub identity: Option<storage::v20250601::IdentityResponse>,
    /// The property is immutable and can only be set to true at the account creation time. When set to true, it enables object level immutability for all the containers in the account by default.
    pub immutable_storage_with_versioning: Option<storage::v20250601::ImmutableStorageAccountResponse>,
    ...
    pub key_creation_time: storage::v20250601::KeyCreationTimeResponse,
    /// KeyPolicy assigned to the storage account.
    pub key_policy: storage::v20250601::KeyPolicyResponse,
    /// Gets the Kind.
    pub kind: String,
    ...
    pub name: String,
    /// Network rule set
    pub network_rule_set: storage::v20250601::NetworkRuleSetResponse,
    /// Optional. Gets or sets the zonal placement details for the storage account.
    pub placement: Option<storage::v20250601::PlacementResponse>,
    /// Gets the URLs that are used to perform a retrieval of a public blob, queue, or table object. Note that Standard_ZRS and Premium_LRS accounts only return the blob endpoint.
    pub primary_endpoints: storage::v20250601::EndpointsResponse,
    /// Gets the location of the primary data center for the storage account.
    pub primary_location: String,
    /// List of private endpoint connection associated with the specified storage account
    pub private_endpoint_connections: Vec<storage::v20250601::PrivateEndpointConnectionResponse>,
    ...
    pub routing_preference: Option<storage::v20250601::RoutingPreferenceResponse>,
    /// SasPolicy assigned to the storage account.
    pub sas_policy: storage::v20250601::SasPolicyResponse,
    /// Gets the URLs that are used to perform a retrieval of a public blob, queue, or table object from the secondary location of the storage account. Only available if the SKU name is Standard_RAGRS.
    pub secondary_endpoints: storage::v20250601::EndpointsResponse,
    /// Gets the location of the geo-replicated secondary for the storage account. Only available if the accountType is Standard_GRS or Standard_RAGRS.
    pub secondary_location: String,
    /// Gets the SKU.
    pub sku: storage::v20250601::SkuResponse,
    ...
    pub storage_account_sku_conversion_status: Option<storage::v20250601::StorageAccountSkuConversionStatusResponse>,
...
pub async fn get_storage_account(
    ...
    let result = ctx.invoke("azure-native:storage/v20250601:getStorageAccount", invoke_args, &opts).await?;
    ...
    Ok(GetStorageAccountResult {
        ...
        failover_in_progress: serde_json::from_value(result.fields.get("failoverInProgress").cloned().unwrap_or_default())?
            ,
        geo_priority_replication_status: result.fields.get("geoPriorityReplicationStatus").cloned().map(serde_json::from_value).transpose()?,
