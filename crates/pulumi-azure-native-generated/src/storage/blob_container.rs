...
pub struct BlobContainerArgs {
    ...
    pub immutable_storage_with_versioning: Option<Input<storage::ImmutableStorageWithVersioningArgs>>,
    /// A name-value pair to associate with the container as metadata.
    pub metadata: Option<HashMap<String, Input<String>>>,
    /// Specifies whether data in the container may be accessed publicly and the level of access.
    pub public_access: Option<Input<storage::PublicAccessArgs>>,
...
impl BlobContainer {
    const TYPE_TOKEN: &'static str = "azure-native:storage:BlobContainer";
