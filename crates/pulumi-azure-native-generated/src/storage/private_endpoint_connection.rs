...
pub struct PrivateEndpointConnectionArgs {
    ...
    pub private_link_service_connection_state: Input<storage::PrivateLinkServiceConnectionStateArgs>,
...
impl PrivateEndpointConnection {
    const TYPE_TOKEN: &'static str = "azure-native:storage:PrivateEndpointConnection";
