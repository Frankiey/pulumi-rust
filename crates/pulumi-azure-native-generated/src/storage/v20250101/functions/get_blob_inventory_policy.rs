...
pub struct GetBlobInventoryPolicyResult {
    ...
    pub policy: storage::v20250101::BlobInventoryPolicySchemaResponse,
...
pub async fn get_blob_inventory_policy(
    ...
    let result = ctx.invoke("azure-native:storage/v20250101:getBlobInventoryPolicy", invoke_args, &opts).await?;
