...
pub struct ListStorageAccountServiceSASArgs {
    ...
    pub protocols: Option<storage::v20250101::HttpProtocol>,
...
pub async fn list_storage_account_service_sas(
    ...
    let result = ctx.invoke("azure-native:storage/v20250101:listStorageAccountServiceSAS", invoke_args, &opts).await?;
