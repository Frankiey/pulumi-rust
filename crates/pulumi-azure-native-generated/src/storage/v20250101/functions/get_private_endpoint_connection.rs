...
pub struct GetPrivateEndpointConnectionResult {
    ...
    pub private_endpoint: Option<storage::v20250101::PrivateEndpointResponse>,
    /// A collection of information about the state of the connection between service consumer and provider.
    pub private_link_service_connection_state: storage::v20250101::PrivateLinkServiceConnectionStateResponse,
...
pub async fn get_private_endpoint_connection(
    ...
    let result = ctx.invoke("azure-native:storage/v20250101:getPrivateEndpointConnection", invoke_args, &opts).await?;
