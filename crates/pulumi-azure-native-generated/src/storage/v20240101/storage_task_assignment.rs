...
pub struct StorageTaskAssignmentArgs {
    ...
    pub properties: Input<storage::v20240101::StorageTaskAssignmentPropertiesArgs>,
...
impl StorageTaskAssignment {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20240101:StorageTaskAssignment";
