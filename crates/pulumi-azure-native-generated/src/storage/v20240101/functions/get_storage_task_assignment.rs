...
pub struct GetStorageTaskAssignmentResult {
    ...
    pub properties: storage::v20240101::StorageTaskAssignmentPropertiesResponse,
...
pub async fn get_storage_task_assignment(
    ...
    let result = ctx.invoke("azure-native:storage/v20240101:getStorageTaskAssignment", invoke_args, &opts).await?;
