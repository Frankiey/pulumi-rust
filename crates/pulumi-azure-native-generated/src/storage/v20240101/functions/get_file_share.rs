...
pub struct GetFileShareResult {
    ...
    pub file_share_paid_bursting: Option<storage::v20240101::FileSharePropertiesResponseFileSharePaidBursting>,
    ...
    pub signed_identifiers: Option<Vec<storage::v20240101::SignedIdentifierResponse>>,
...
pub async fn get_file_share(
    ...
    let result = ctx.invoke("azure-native:storage/v20240101:getFileShare", invoke_args, &opts).await?;
