...
pub struct GetObjectReplicationPolicyResult {
    ...
    pub metrics: Option<storage::v20240101::ObjectReplicationPolicyPropertiesResponseMetrics>,
    /// The name of the resource
    pub name: String,
    /// A unique id for object replication policy.
    pub policy_id: String,
    /// The storage account object replication rules.
    pub rules: Option<Vec<storage::v20240101::ObjectReplicationPolicyRuleResponse>>,
...
pub async fn get_object_replication_policy(
    ...
    let result = ctx.invoke("azure-native:storage/v20240101:getObjectReplicationPolicy", invoke_args, &opts).await?;
