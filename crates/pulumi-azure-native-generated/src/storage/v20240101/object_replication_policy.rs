...
pub struct ObjectReplicationPolicyArgs {
    ...
    pub metrics: Option<Input<storage::v20240101::ObjectReplicationPolicyPropertiesMetricsArgs>>,
    ...
    pub rules: Option<Vec<Input<storage::v20240101::ObjectReplicationPolicyRuleArgs>>>,
...
impl ObjectReplicationPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20240101:ObjectReplicationPolicy";
