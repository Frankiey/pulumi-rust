...
pub struct FileShareArgs {
    ...
    pub file_share_paid_bursting: Option<Input<storage::v20240101::FileSharePropertiesFileSharePaidBurstingArgs>>,
    ...
    pub signed_identifiers: Option<Vec<Input<storage::v20240101::SignedIdentifierArgs>>>,
}
...
impl FileShare {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20240101:FileShare";
