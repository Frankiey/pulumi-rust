...
pub struct ObjectReplicationPolicyArgs {
    ...
    pub rules: Option<Vec<Input<storage::v20220901::ObjectReplicationPolicyRuleArgs>>>,
...
impl ObjectReplicationPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20220901:ObjectReplicationPolicy";
