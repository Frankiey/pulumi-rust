...
pub struct GetManagementPolicyResult {
    ...
    pub policy: storage::v20220901::ManagementPolicySchemaResponse,
...
pub async fn get_management_policy(
    ...
    let result = ctx.invoke("azure-native:storage/v20220901:getManagementPolicy", invoke_args, &opts).await?;
