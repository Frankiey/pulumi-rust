...
pub struct GetBlobInventoryPolicyResult {
    ...
    pub policy: storage::v20220901::BlobInventoryPolicySchemaResponse,
    /// Metadata pertaining to creation and last modification of the resource.
    pub system_data: storage::v20220901::SystemDataResponse,
...
pub async fn get_blob_inventory_policy(
    ...
    let result = ctx.invoke("azure-native:storage/v20220901:getBlobInventoryPolicy", invoke_args, &opts).await?;
