...
pub struct ListStorageAccountKeysResult {
    ...
    pub keys: Vec<storage::v20220901::StorageAccountKeyResponse>,
}
...
pub async fn list_storage_account_keys(
    ...
    let result = ctx.invoke("azure-native:storage/v20220901:listStorageAccountKeys", invoke_args, &opts).await?;
