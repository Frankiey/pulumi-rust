...
pub struct ListStorageAccountServiceSASArgs {
    ...
    pub protocols: Option<storage::v20220901::HttpProtocol>,
...
pub async fn list_storage_account_service_sas(
    ...
    let result = ctx.invoke("azure-native:storage/v20220901:listStorageAccountServiceSAS", invoke_args, &opts).await?;
