...
pub struct GetEncryptionScopeResult {
    ...
    pub key_vault_properties: Option<storage::v20230501::EncryptionScopeKeyVaultPropertiesResponse>,
...
pub async fn get_encryption_scope(
    ...
    let result = ctx.invoke("azure-native:storage/v20230501:getEncryptionScope", invoke_args, &opts).await?;
