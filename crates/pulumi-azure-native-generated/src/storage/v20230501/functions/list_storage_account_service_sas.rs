...
pub struct ListStorageAccountServiceSASArgs {
    ...
    pub protocols: Option<storage::v20230501::HttpProtocol>,
...
pub async fn list_storage_account_service_sas(
    ...
    let result = ctx.invoke("azure-native:storage/v20230501:listStorageAccountServiceSAS", invoke_args, &opts).await?;
