...
pub struct ListStorageAccountKeysResult {
    ...
    pub keys: Vec<storage::v20230501::StorageAccountKeyResponse>,
}
...
pub async fn list_storage_account_keys(
    ...
    let result = ctx.invoke("azure-native:storage/v20230501:listStorageAccountKeys", invoke_args, &opts).await?;
