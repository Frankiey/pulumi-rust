...
pub struct GetStorageTaskAssignmentResult {
    ...
    pub properties: storage::v20230501::StorageTaskAssignmentPropertiesResponse,
...
pub async fn get_storage_task_assignment(
    ...
    let result = ctx.invoke("azure-native:storage/v20230501:getStorageTaskAssignment", invoke_args, &opts).await?;
