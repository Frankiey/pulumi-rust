...
pub struct GetBlobInventoryPolicyResult {
    ...
    pub policy: storage::v20230501::BlobInventoryPolicySchemaResponse,
    /// Metadata pertaining to creation and last modification of the resource.
    pub system_data: storage::v20230501::SystemDataResponse,
...
pub async fn get_blob_inventory_policy(
    ...
    let result = ctx.invoke("azure-native:storage/v20230501:getBlobInventoryPolicy", invoke_args, &opts).await?;
