...
pub struct ObjectReplicationPolicyArgs {
    ...
    pub rules: Option<Vec<Input<storage::v20230501::ObjectReplicationPolicyRuleArgs>>>,
...
impl ObjectReplicationPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20230501:ObjectReplicationPolicy";
