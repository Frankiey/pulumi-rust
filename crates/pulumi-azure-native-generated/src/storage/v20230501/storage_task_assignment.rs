...
pub struct StorageTaskAssignmentArgs {
    ...
    pub properties: Input<storage::v20230501::StorageTaskAssignmentPropertiesArgs>,
...
impl StorageTaskAssignment {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20230501:StorageTaskAssignment";
