...
pub struct BlobContainerArgs {
    ...
    pub immutable_storage_with_versioning: Option<Input<storage::v20230401::ImmutableStorageWithVersioningArgs>>,
    /// A name-value pair to associate with the container as metadata.
    pub metadata: Option<HashMap<String, Input<String>>>,
    /// Specifies whether data in the container may be accessed publicly and the level of access.
    pub public_access: Option<Input<storage::v20230401::PublicAccessArgs>>,
...
impl BlobContainer {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20230401:BlobContainer";
