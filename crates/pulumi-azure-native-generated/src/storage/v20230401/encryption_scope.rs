...
pub struct EncryptionScopeArgs {
    ...
    pub key_vault_properties: Option<Input<storage::v20230401::EncryptionScopeKeyVaultPropertiesArgs>>,
...
impl EncryptionScope {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20230401:EncryptionScope";
