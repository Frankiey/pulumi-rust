...
pub struct BlobServicePropertiesArgs {
    ...
    pub change_feed: Option<Input<storage::v20230401::ChangeFeedArgs>>,
    /// The blob service properties for container soft delete.
    pub container_delete_retention_policy: Option<Input<storage::v20230401::DeleteRetentionPolicyArgs>>,
    ...
    pub delete_retention_policy: Option<Input<storage::v20230401::DeleteRetentionPolicyArgs>>,
    /// Versioning is enabled if set to true.
    pub is_versioning_enabled: Option<Input<bool>>,
    /// The blob service property to configure last access time based tracking policy.
    pub last_access_time_tracking_policy: Option<Input<storage::v20230401::LastAccessTimeTrackingPolicyArgs>>,
    /// The name of the resource group within the user's subscription. The name is case insensitive.
    pub resource_group_name: Input<String>,
    /// The blob service properties for blob restore policy.
    pub restore_policy: Option<Input<storage::v20230401::RestorePolicyPropertiesArgs>>,
}
...
impl BlobServiceProperties {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20230401:BlobServiceProperties";
