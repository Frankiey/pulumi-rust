...
pub struct GetFileShareResult {
    ...
    pub signed_identifiers: Option<Vec<storage::v20230401::SignedIdentifierResponse>>,
...
pub async fn get_file_share(
    ...
    let result = ctx.invoke("azure-native:storage/v20230401:getFileShare", invoke_args, &opts).await?;
