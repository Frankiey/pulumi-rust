...
pub struct GetManagementPolicyResult {
    ...
    pub policy: storage::v20230401::ManagementPolicySchemaResponse,
...
pub async fn get_management_policy(
    ...
    let result = ctx.invoke("azure-native:storage/v20230401:getManagementPolicy", invoke_args, &opts).await?;
