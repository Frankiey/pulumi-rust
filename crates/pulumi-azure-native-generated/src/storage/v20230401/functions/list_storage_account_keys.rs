...
pub struct ListStorageAccountKeysResult {
    ...
    pub keys: Vec<storage::v20230401::StorageAccountKeyResponse>,
}
...
pub async fn list_storage_account_keys(
    ...
    let result = ctx.invoke("azure-native:storage/v20230401:listStorageAccountKeys", invoke_args, &opts).await?;
