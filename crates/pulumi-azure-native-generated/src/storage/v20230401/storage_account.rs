...
pub struct StorageAccountArgs {
    ...
    pub access_tier: Option<Input<storage::v20230401::AccessTierArgs>>,
    ...
    pub azure_files_identity_based_authentication: Option<Input<storage::v20230401::AzureFilesIdentityBasedAuthenticationArgs>>,
    /// User domain assigned to the storage account. Name is the CNAME source. Only one custom domain is supported per storage account at this time. To clear the existing custom domain, use an empty string for the custom domain name property.
    pub custom_domain: Option<Input<storage::v20230401::CustomDomainArgs>>,
    ...
    pub encryption: Option<Input<storage::v20230401::EncryptionArgs>>,
    /// Optional. Set the extended location of the resource. If not set, the storage account will be created in Azure main region. Otherwise it will be created in the specified extended location
    pub extended_location: Option<Input<storage::v20230401::ExtendedLocationArgs>>,
    /// The identity of the resource.
    pub identity: Option<Input<storage::v20230401::IdentityArgs>>,
    ...
    pub immutable_storage_with_versioning: Option<Input<storage::v20230401::ImmutableStorageAccountArgs>>,
    ...
    pub key_policy: Option<Input<storage::v20230401::KeyPolicyArgs>>,
    ...
    /// Network rule set
    pub network_rule_set: Option<Input<storage::v20230401::NetworkRuleSetArgs>>,
    ...
    pub routing_preference: Option<Input<storage::v20230401::RoutingPreferenceArgs>>,
    /// SasPolicy assigned to the storage account.
    pub sas_policy: Option<Input<storage::v20230401::SasPolicyArgs>>,
    /// Required. Gets or sets the SKU name.
    pub sku: Input<storage::v20230401::SkuArgs>,
...
impl StorageAccount {
    const TYPE_TOKEN: &'static str = "azure-native:storage/v20230401:StorageAccount";
