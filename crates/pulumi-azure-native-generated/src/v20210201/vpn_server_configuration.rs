...
pub struct VpnServerConfigurationArgs {
    ...
    pub properties: Option<Input<network::v20210201::VpnServerConfigurationPropertiesArgs>>,
...
impl VpnServerConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210201:VpnServerConfiguration";
