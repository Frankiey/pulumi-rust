...
pub struct GetApplicationGatewayPrivateEndpointConnectionResult {
    ...
    pub private_link_service_connection_state: Option<network::v20210201::PrivateLinkServiceConnectionStateResponse>,
...
pub async fn get_application_gateway_private_endpoint_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20210201:getApplicationGatewayPrivateEndpointConnection", invoke_args, &opts).await?;
