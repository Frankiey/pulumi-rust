...
pub struct GetPrivateLinkServiceResult {
    ...
    pub auto_approval: Option<network::v20210201::PrivateLinkServicePropertiesResponseAutoApproval>,
    ...
    pub ip_configurations: Option<Vec<network::v20210201::PrivateLinkServiceIpConfigurationResponse>>,
    /// An array of references to the load balancer IP configurations.
    pub load_balancer_frontend_ip_configurations: Option<Vec<network::v20210201::FrontendIPConfigurationResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// An array of references to the network interfaces created for this private link service.
    pub network_interfaces: Vec<network::v20210201::NetworkInterfaceResponse>,
    /// An array of list about connections to the private endpoint.
    pub private_endpoint_connections: Vec<network::v20210201::PrivateEndpointConnectionResponse>,
    ...
    pub visibility: Option<network::v20210201::PrivateLinkServicePropertiesResponseVisibility>,
}
...
pub async fn get_private_link_service(
    ...
    let result = ctx.invoke("azure-native:network/v20210201:getPrivateLinkService", invoke_args, &opts).await?;
