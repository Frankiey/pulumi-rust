...
pub struct GetPacketCaptureResult {
    ...
    pub filters: Option<Vec<network::v20210201::PacketCaptureFilterResponse>>,
    ...
    pub storage_location: network::v20210201::PacketCaptureStorageLocationResponse,
...
pub async fn get_packet_capture(
    ...
    let result = ctx.invoke("azure-native:network/v20210201:getPacketCapture", invoke_args, &opts).await?;
