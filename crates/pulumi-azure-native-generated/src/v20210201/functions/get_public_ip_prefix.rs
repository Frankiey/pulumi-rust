...
pub struct GetPublicIPPrefixResult {
    ...
    pub custom_ip_prefix: Option<network::v20210201::SubResourceResponse>,
    ...
    pub load_balancer_frontend_ip_configuration: network::v20210201::SubResourceResponse,
    /// Resource location.
    ...
    pub public_ip_addresses: Vec<network::v20210201::ReferencedPublicIpAddressResponse>,
    /// The resource GUID property of the public IP prefix resource.
    pub resource_guid: String,
    /// The public IP prefix SKU.
    pub sku: Option<network::v20210201::PublicIPPrefixSkuResponse>,
    /// Resource tags.
...
pub async fn get_public_ip_prefix(
    ...
    let result = ctx.invoke("azure-native:network/v20210201:getPublicIPPrefix", invoke_args, &opts).await?;
