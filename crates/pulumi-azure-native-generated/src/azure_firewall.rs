...
pub struct AzureFirewallArgs {
    ...
    pub application_rule_collections: Option<Vec<Input<network::AzureFirewallApplicationRuleCollectionArgs>>>,
    /// Properties to provide a custom autoscale configuration to this azure firewall.
    pub autoscale_configuration: Option<Input<network::AzureFirewallAutoscaleConfigurationArgs>>,
    ...
    pub hub_ip_addresses: Option<Input<network::HubIPAddressesArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// IP configuration of the Azure Firewall resource.
    pub ip_configurations: Option<Vec<Input<network::AzureFirewallIPConfigurationArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// IP configuration of the Azure Firewall used for management traffic.
    pub management_ip_configuration: Option<Input<network::AzureFirewallIPConfigurationArgs>>,
    /// Collection of NAT rule collections used by Azure Firewall.
    pub nat_rule_collections: Option<Vec<Input<network::AzureFirewallNatRuleCollectionArgs>>>,
    /// Collection of network rule collections used by Azure Firewall.
    pub network_rule_collections: Option<Vec<Input<network::AzureFirewallNetworkRuleCollectionArgs>>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The Azure Firewall Resource SKU.
    pub sku: Option<Input<network::AzureFirewallSkuArgs>>,
    /// Resource tags.
...
impl AzureFirewall {
    const TYPE_TOKEN: &'static str = "azure-native:network:AzureFirewall";
