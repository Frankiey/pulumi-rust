...
pub struct GetNetworkInterfaceResult {
    ...
    pub dns_settings: Option<network::v20180701::NetworkInterfaceDnsSettingsResponse>,
    ...
    pub ip_configurations: Option<Vec<network::v20180701::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub virtual_machine: Option<network::v20180701::SubResourceResponse>,
}
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network/v20180701:getNetworkInterface", invoke_args, &opts).await?;
    ...
    Ok(GetNetworkInterfaceResult {
        ...
        type_: serde_json::from_value(result.fields.get("type").cloned().unwrap_or_default())?
            ,
        virtual_machine: result.fields.get("virtualMachine").cloned().map(serde_json::from_value).transpose()?,
    })
}
