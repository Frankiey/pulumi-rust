...
pub struct GetVpnGatewayResult {
    ...
    pub connections: Option<Vec<network::v20180701::VpnConnectionResponse>>,
    ...
    pub policies: Option<network::v20180701::PoliciesResponse>,
    ...
    pub virtual_hub: Option<network::v20180701::SubResourceResponse>,
}
...
pub async fn get_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20180701:getVpnGateway", invoke_args, &opts).await?;
    ...
    Ok(GetVpnGatewayResult {
        ...
        name: serde_json::from_value(result.fields.get("name").cloned().unwrap_or_default())?
            ,
        policies: result.fields.get("policies").cloned().map(serde_json::from_value).transpose()?,
