...
pub struct VirtualHubArgs {
    ...
    pub hub_virtual_network_connections: Option<Vec<Input<network::v20180701::HubVirtualNetworkConnectionArgs>>>,
    /// Resource ID.
...
impl VirtualHub {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180701:VirtualHub";
