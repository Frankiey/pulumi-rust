...
pub struct VirtualNetworkPeeringArgs {
    ...
    pub remote_address_space: Option<Input<network::v20180701::AddressSpaceArgs>>,
    ...
    pub remote_virtual_network: Option<Input<network::v20180701::SubResourceArgs>>,
...
impl VirtualNetworkPeering {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180701:VirtualNetworkPeering";
