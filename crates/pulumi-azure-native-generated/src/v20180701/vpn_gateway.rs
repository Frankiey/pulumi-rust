...
pub struct VpnGatewayArgs {
    ...
    pub bgp_settings: Option<Input<network::v20180701::BgpSettingsArgs>>,
    /// list of all vpn connections to the gateway.
    pub connections: Option<Vec<Input<network::v20180701::VpnConnectionArgs>>>,
    ...
    pub policies: Option<Input<network::v20180701::PoliciesArgs>>,
    /// The resource group name of the VpnGateway.
    pub resource_group_name: Input<String>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The VirtualHub to which the gateway belongs
    pub virtual_hub: Option<Input<network::v20180701::SubResourceArgs>>,
}
...
pub struct VpnGateway {
    ...
    /// The policies applied to this vpn gateway.
    pub policies: Output<serde_json::Value>,
...
impl VpnGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180701:VpnGateway";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.policies {
            pulumi_sdk::resolve_input("policies", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            name: registered.outputs.get("name")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            policies: registered.outputs.get("policies")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
