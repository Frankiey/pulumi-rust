...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20180701::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20180701::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub virtual_machine: Option<Input<network::v20180701::SubResourceArgs>>,
}
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180701:NetworkInterface";
