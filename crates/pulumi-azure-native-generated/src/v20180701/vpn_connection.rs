...
pub struct VpnConnectionArgs {
    ...
    pub remote_vpn_site: Option<Input<network::v20180701::SubResourceArgs>>,
...
pub struct VpnConnection {
    ...
    pub connection_bandwidth_in_mbps: Output<serde_json::Value>,
...
impl VpnConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180701:VpnConnection";
    ...
    pub async fn new(
        ...
        Ok(Self {
            ...
            azure_api_version: registered.outputs.get("azureApiVersion")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            connection_bandwidth_in_mbps: registered.outputs.get("connectionBandwidthInMbps")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
