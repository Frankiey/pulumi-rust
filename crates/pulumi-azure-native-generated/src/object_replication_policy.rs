...
pub struct ObjectReplicationPolicyArgs {
    ...
    pub metrics: Option<Input<storage::ObjectReplicationPolicyPropertiesMetricsArgs>>,
    ...
    pub rules: Option<Vec<Input<storage::ObjectReplicationPolicyRuleArgs>>>,
...
impl ObjectReplicationPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:storage:ObjectReplicationPolicy";
