...
pub struct NetworkSecurityGroupArgs {
    ...
    pub default_security_rules: Option<Vec<Input<network::v20181001::SecurityRuleArgs>>>,
    /// Resource ID.
    ...
    pub security_rules: Option<Vec<Input<network::v20181001::SecurityRuleArgs>>>,
    /// Resource tags.
...
impl NetworkSecurityGroup {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181001:NetworkSecurityGroup";
