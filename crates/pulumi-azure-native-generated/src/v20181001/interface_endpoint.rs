...
pub struct InterfaceEndpointArgs {
    ...
    pub endpoint_service: Option<Input<network::v20181001::EndpointServiceArgs>>,
    ...
    pub subnet: Option<Input<network::v20181001::SubnetArgs>>,
    /// Resource tags.
...
impl InterfaceEndpoint {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181001:InterfaceEndpoint";
