...
pub struct ApplicationGatewayArgs {
    ...
    pub authentication_certificates: Option<Vec<Input<network::v20181001::ApplicationGatewayAuthenticationCertificateArgs>>>,
    /// Autoscale Configuration.
    pub autoscale_configuration: Option<Input<network::v20181001::ApplicationGatewayAutoscaleConfigurationArgs>>,
    /// Backend address pool of the application gateway resource.
    pub backend_address_pools: Option<Vec<Input<network::v20181001::ApplicationGatewayBackendAddressPoolArgs>>>,
    /// Backend http settings of the application gateway resource.
    pub backend_http_settings_collection: Option<Vec<Input<network::v20181001::ApplicationGatewayBackendHttpSettingsArgs>>>,
    /// Custom error configurations of the application gateway resource.
    pub custom_error_configurations: Option<Vec<Input<network::v20181001::ApplicationGatewayCustomErrorArgs>>>,
    /// Whether FIPS is enabled on the application gateway resource.
    pub enable_fips: Option<Input<bool>>,
    /// Whether HTTP2 is enabled on the application gateway resource.
    pub enable_http2: Option<Input<bool>>,
    /// Frontend IP addresses of the application gateway resource.
    pub frontend_ip_configurations: Option<Vec<Input<network::v20181001::ApplicationGatewayFrontendIPConfigurationArgs>>>,
    /// Frontend ports of the application gateway resource.
    pub frontend_ports: Option<Vec<Input<network::v20181001::ApplicationGatewayFrontendPortArgs>>>,
    /// Subnets of application the gateway resource.
    pub gateway_ip_configurations: Option<Vec<Input<network::v20181001::ApplicationGatewayIPConfigurationArgs>>>,
    /// Http listeners of the application gateway resource.
    pub http_listeners: Option<Vec<Input<network::v20181001::ApplicationGatewayHttpListenerArgs>>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// The identity of the application gateway, if configured.
    pub identity: Option<Input<network::v20181001::ManagedServiceIdentityArgs>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// Probes of the application gateway resource.
    pub probes: Option<Vec<Input<network::v20181001::ApplicationGatewayProbeArgs>>>,
    /// Provisioning state of the application gateway resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
    pub provisioning_state: Option<Input<String>>,
    /// Redirect configurations of the application gateway resource.
    pub redirect_configurations: Option<Vec<Input<network::v20181001::ApplicationGatewayRedirectConfigurationArgs>>>,
    /// Request routing rules of the application gateway resource.
    pub request_routing_rules: Option<Vec<Input<network::v20181001::ApplicationGatewayRequestRoutingRuleArgs>>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// Resource GUID property of the application gateway resource.
    pub resource_guid: Option<Input<String>>,
    /// Rewrite rules for the application gateway resource.
    pub rewrite_rule_sets: Option<Vec<Input<network::v20181001::ApplicationGatewayRewriteRuleSetArgs>>>,
    /// SKU of the application gateway resource.
    pub sku: Option<Input<network::v20181001::ApplicationGatewaySkuArgs>>,
    /// SSL certificates of the application gateway resource.
    pub ssl_certificates: Option<Vec<Input<network::v20181001::ApplicationGatewaySslCertificateArgs>>>,
    /// SSL policy of the application gateway resource.
    pub ssl_policy: Option<Input<network::v20181001::ApplicationGatewaySslPolicyArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// Trusted Root certificates of the application gateway resource.
    pub trusted_root_certificates: Option<Vec<Input<network::v20181001::ApplicationGatewayTrustedRootCertificateArgs>>>,
    /// URL path map of the application gateway resource.
    pub url_path_maps: Option<Vec<Input<network::v20181001::ApplicationGatewayUrlPathMapArgs>>>,
    /// Web application firewall configuration.
    pub web_application_firewall_configuration: Option<Input<network::v20181001::ApplicationGatewayWebApplicationFirewallConfigurationArgs>>,
...
impl ApplicationGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181001:ApplicationGateway";
