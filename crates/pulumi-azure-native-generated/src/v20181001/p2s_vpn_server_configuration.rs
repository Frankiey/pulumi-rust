...
pub struct P2sVpnServerConfigurationArgs {
    ...
    pub properties: Option<Input<network::v20181001::P2SVpnServerConfigurationPropertiesArgs>>,
...
impl P2sVpnServerConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181001:P2sVpnServerConfiguration";
