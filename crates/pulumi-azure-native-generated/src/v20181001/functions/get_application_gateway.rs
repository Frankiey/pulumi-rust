...
pub struct GetApplicationGatewayResult {
    ...
    pub authentication_certificates: Option<Vec<network::v20181001::ApplicationGatewayAuthenticationCertificateResponse>>,
    /// Autoscale Configuration.
    pub autoscale_configuration: Option<network::v20181001::ApplicationGatewayAutoscaleConfigurationResponse>,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// Backend address pool of the application gateway resource.
    pub backend_address_pools: Option<Vec<network::v20181001::ApplicationGatewayBackendAddressPoolResponse>>,
    /// Backend http settings of the application gateway resource.
    pub backend_http_settings_collection: Option<Vec<network::v20181001::ApplicationGatewayBackendHttpSettingsResponse>>,
    /// Custom error configurations of the application gateway resource.
    pub custom_error_configurations: Option<Vec<network::v20181001::ApplicationGatewayCustomErrorResponse>>,
    ...
    pub frontend_ip_configurations: Option<Vec<network::v20181001::ApplicationGatewayFrontendIPConfigurationResponse>>,
    /// Frontend ports of the application gateway resource.
    pub frontend_ports: Option<Vec<network::v20181001::ApplicationGatewayFrontendPortResponse>>,
    /// Subnets of application the gateway resource.
    pub gateway_ip_configurations: Option<Vec<network::v20181001::ApplicationGatewayIPConfigurationResponse>>,
    /// Http listeners of the application gateway resource.
    pub http_listeners: Option<Vec<network::v20181001::ApplicationGatewayHttpListenerResponse>>,
    /// Resource ID.
    pub id: Option<String>,
    /// The identity of the application gateway, if configured.
    pub identity: Option<network::v20181001::ManagedServiceIdentityResponse>,
    /// Resource location.
    ...
    pub probes: Option<Vec<network::v20181001::ApplicationGatewayProbeResponse>>,
    /// Provisioning state of the application gateway resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
    pub provisioning_state: Option<String>,
    /// Redirect configurations of the application gateway resource.
    pub redirect_configurations: Option<Vec<network::v20181001::ApplicationGatewayRedirectConfigurationResponse>>,
    /// Request routing rules of the application gateway resource.
    pub request_routing_rules: Option<Vec<network::v20181001::ApplicationGatewayRequestRoutingRuleResponse>>,
    /// Resource GUID property of the application gateway resource.
    pub resource_guid: Option<String>,
    /// Rewrite rules for the application gateway resource.
    pub rewrite_rule_sets: Option<Vec<network::v20181001::ApplicationGatewayRewriteRuleSetResponse>>,
    /// SKU of the application gateway resource.
    pub sku: Option<network::v20181001::ApplicationGatewaySkuResponse>,
    /// SSL certificates of the application gateway resource.
    pub ssl_certificates: Option<Vec<network::v20181001::ApplicationGatewaySslCertificateResponse>>,
    /// SSL policy of the application gateway resource.
    pub ssl_policy: Option<network::v20181001::ApplicationGatewaySslPolicyResponse>,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// Trusted Root certificates of the application gateway resource.
    pub trusted_root_certificates: Option<Vec<network::v20181001::ApplicationGatewayTrustedRootCertificateResponse>>,
    /// Resource type.
    pub type_: String,
    /// URL path map of the application gateway resource.
    pub url_path_maps: Option<Vec<network::v20181001::ApplicationGatewayUrlPathMapResponse>>,
    /// Web application firewall configuration.
    pub web_application_firewall_configuration: Option<network::v20181001::ApplicationGatewayWebApplicationFirewallConfigurationResponse>,
...
pub async fn get_application_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20181001:getApplicationGateway", invoke_args, &opts).await?;
