...
pub struct GetExpressRouteCircuitResult {
    ...
    pub authorizations: Option<Vec<network::v20181001::ExpressRouteCircuitAuthorizationResponse>>,
    ...
    pub express_route_port: Option<network::v20181001::SubResourceResponse>,
    ...
    pub peerings: Option<Vec<network::v20181001::ExpressRouteCircuitPeeringResponse>>,
    ...
    pub service_provider_properties: Option<network::v20181001::ExpressRouteCircuitServiceProviderPropertiesResponse>,
    /// The ServiceProviderProvisioningState state of the resource. Possible values are 'NotProvisioned', 'Provisioning', 'Provisioned', and 'Deprovisioning'.
    pub service_provider_provisioning_state: Option<String>,
    /// The SKU.
    pub sku: Option<network::v20181001::ExpressRouteCircuitSkuResponse>,
...
pub async fn get_express_route_circuit(
    ...
    let result = ctx.invoke("azure-native:network/v20181001:getExpressRouteCircuit", invoke_args, &opts).await?;
    ...
    Ok(GetExpressRouteCircuitResult {
        ...
        allow_global_reach: result.fields.get("allowGlobalReach").cloned().map(serde_json::from_value).transpose()?,
