...
pub struct GetP2sVpnGatewayResult {
    ...
    pub p2s_vpn_server_configuration: Option<network::v20181001::SubResourceResponse>,
    ...
    pub virtual_hub: Option<network::v20181001::SubResourceResponse>,
    /// The reference of the address space resource which represents Address space for P2S VpnClient.
    pub vpn_client_address_pool: Option<network::v20181001::AddressSpaceResponse>,
    /// All P2S VPN clients' connection health status.
    pub vpn_client_connection_health: network::v20181001::VpnClientConnectionHealthResponse,
...
pub async fn get_p2s_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20181001:getP2sVpnGateway", invoke_args, &opts).await?;
