...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20181001::BgpSettingsResponse>,
    /// The device properties
    pub device_properties: Option<network::v20181001::DevicePropertiesResponse>,
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20181001:getVpnSite", invoke_args, &opts).await?;
