...
pub struct AdminRuleArgs {
    ...
    pub destinations: Option<Vec<Input<network::AddressPrefixItemArgs>>>,
    ...
    pub sources: Option<Vec<Input<network::AddressPrefixItemArgs>>>,
}
...
impl AdminRule {
    const TYPE_TOKEN: &'static str = "azure-native:network:AdminRule";
