...
pub struct VirtualWanArgs {
    ...
    pub p2s_vpn_server_configurations: Option<Vec<Input<network::v20180801::P2SVpnServerConfigurationArgs>>>,
...
impl VirtualWan {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180801:VirtualWan";
