...
pub struct GetNetworkSecurityGroupResult {
    ...
    pub default_security_rules: Option<Vec<network::v20180801::SecurityRuleResponse>>,
    ...
    pub network_interfaces: Vec<network::v20180801::NetworkInterfaceResponse>,
    /// The provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
    pub provisioning_state: Option<String>,
    /// The resource GUID property of the network security group resource.
    pub resource_guid: Option<String>,
    /// A collection of security rules of the network security group.
    pub security_rules: Option<Vec<network::v20180801::SecurityRuleResponse>>,
    /// A collection of references to subnets.
    pub subnets: Vec<network::v20180801::SubnetResponse>,
    /// Resource tags.
...
pub async fn get_network_security_group(
    ...
    let result = ctx.invoke("azure-native:network/v20180801:getNetworkSecurityGroup", invoke_args, &opts).await?;
