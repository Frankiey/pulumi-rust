...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20180801::BgpSettingsResponse>,
    /// The device properties
    pub device_properties: Option<network::v20180801::DevicePropertiesResponse>,
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20180801:getVpnSite", invoke_args, &opts).await?;
