...
pub struct GetSubnetResult {
    ...
    pub delegations: Option<Vec<network::v20180801::DelegationResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: Option<String>,
    /// Resource ID.
    pub id: Option<String>,
    /// An array of references to interface endpoints 
    pub interface_endpoints: Vec<network::v20180801::InterfaceEndpointResponse>,
    /// Array of IP configuration profiles which reference this subnet.
    pub ip_configuration_profiles: Vec<network::v20180801::IPConfigurationProfileResponse>,
    /// Gets an array of references to the network interface IP configurations using subnet.
    pub ip_configurations: Vec<network::v20180801::IPConfigurationResponse>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<String>,
    /// The reference of the NetworkSecurityGroup resource.
    pub network_security_group: Option<network::v20180801::NetworkSecurityGroupResponse>,
    /// The provisioning state of the resource.
    pub provisioning_state: Option<String>,
    /// A read-only string identifying the intention of use for this subnet based on delegations and other user-defined properties.
    pub purpose: String,
    /// Gets an array of references to the external resources using subnet.
    pub resource_navigation_links: Option<Vec<network::v20180801::ResourceNavigationLinkResponse>>,
    /// The reference of the RouteTable resource.
    pub route_table: Option<network::v20180801::RouteTableResponse>,
    /// Gets an array of references to services injecting into this subnet.
    pub service_association_links: Option<Vec<network::v20180801::ServiceAssociationLinkResponse>>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<network::v20180801::ServiceEndpointPolicyResponse>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<network::v20180801::ServiceEndpointPropertiesFormatResponse>>,
}
...
pub async fn get_subnet(
    ...
    let result = ctx.invoke("azure-native:network/v20180801:getSubnet", invoke_args, &opts).await?;
