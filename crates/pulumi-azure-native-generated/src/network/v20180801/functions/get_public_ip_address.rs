...
pub struct GetPublicIPAddressResult {
    ...
    pub dns_settings: Option<network::v20180801::PublicIPAddressDnsSettingsResponse>,
    ...
    pub ip_configuration: network::v20180801::IPConfigurationResponse,
    /// The list of tags associated with the public IP address.
    pub ip_tags: Option<Vec<network::v20180801::IpTagResponse>>,
    /// Resource location.
    ...
    pub public_ip_prefix: Option<network::v20180801::SubResourceResponse>,
    /// The resource GUID property of the public IP resource.
    pub resource_guid: Option<String>,
    /// The public IP address SKU.
    pub sku: Option<network::v20180801::PublicIPAddressSkuResponse>,
    /// Resource tags.
...
pub async fn get_public_ip_address(
    ...
    let result = ctx.invoke("azure-native:network/v20180801:getPublicIPAddress", invoke_args, &opts).await?;
