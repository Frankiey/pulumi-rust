...
pub struct PublicIPAddressArgs {
    ...
    pub dns_settings: Option<Input<network::v20180801::PublicIPAddressDnsSettingsArgs>>,
    /// Resource ID.
    ...
    pub ip_tags: Option<Vec<Input<network::v20180801::IpTagArgs>>>,
    /// Resource location.
    ...
    pub public_ip_prefix: Option<Input<network::v20180801::SubResourceArgs>>,
    ...
    pub sku: Option<Input<network::v20180801::PublicIPAddressSkuArgs>>,
    /// Resource tags.
...
impl PublicIPAddress {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180801:PublicIPAddress";
