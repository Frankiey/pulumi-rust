...
pub struct GetVirtualNetworkGatewayVpnclientConnectionHealthResult {
    ...
    pub value: Option<Vec<network::v20230901::VpnClientConnectionHealthDetailResponse>>,
}
...
pub async fn get_virtual_network_gateway_vpnclient_connection_health(
    ...
    let result = ctx.invoke("azure-native:network/v20230901:getVirtualNetworkGatewayVpnclientConnectionHealth", invoke_args, &opts).await?;
