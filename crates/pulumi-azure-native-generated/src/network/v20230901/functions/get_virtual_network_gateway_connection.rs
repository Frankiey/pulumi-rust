...
pub struct GetVirtualNetworkGatewayConnectionResult {
    ...
    pub egress_nat_rules: Option<Vec<network::v20230901::SubResourceResponse>>,
    /// EnableBgp flag.
    ...
    pub gateway_custom_bgp_ip_addresses: Option<Vec<network::v20230901::GatewayCustomBgpIpAddressIpConfigurationResponse>>,
    /// Resource ID.
    pub id: Option<String>,
    /// The ingress bytes transferred in this connection.
    pub ingress_bytes_transferred: f64,
    /// List of ingress NatRules.
    pub ingress_nat_rules: Option<Vec<network::v20230901::SubResourceResponse>>,
    /// The IPSec Policies to be considered by this connection.
    pub ipsec_policies: Option<Vec<network::v20230901::IpsecPolicyResponse>>,
    /// The reference to local network gateway resource.
    pub local_network_gateway2: Option<network::v20230901::LocalNetworkGatewayResponse>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// The reference to peerings resource.
    pub peer: Option<network::v20230901::SubResourceResponse>,
    ...
    pub traffic_selector_policies: Option<Vec<network::v20230901::TrafficSelectorPolicyResponse>>,
    /// Collection of all tunnels' connection health status.
    pub tunnel_connection_status: Vec<network::v20230901::TunnelConnectionHealthResponse>,
    /// Resource type.
    pub type_: String,
    ...
    pub virtual_network_gateway1: network::v20230901::VirtualNetworkGatewayResponse,
    /// The reference to virtual network gateway resource.
    pub virtual_network_gateway2: Option<network::v20230901::VirtualNetworkGatewayResponse>,
}
...
pub async fn get_virtual_network_gateway_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20230901:getVirtualNetworkGatewayConnection", invoke_args, &opts).await?;
