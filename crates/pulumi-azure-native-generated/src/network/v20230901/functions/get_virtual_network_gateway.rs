...
pub struct GetVirtualNetworkGatewayResult {
    ...
    pub auto_scale_configuration: Option<network::v20230901::VirtualNetworkGatewayAutoScaleConfigurationResponse>,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// Virtual network gateway's BGP speaker settings.
    pub bgp_settings: Option<network::v20230901::BgpSettingsResponse>,
    /// The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
    pub custom_routes: Option<network::v20230901::AddressSpaceResponse>,
    ...
    pub gateway_default_site: Option<network::v20230901::SubResourceResponse>,
    ...
    pub ip_configurations: Option<Vec<network::v20230901::VirtualNetworkGatewayIPConfigurationResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// NatRules for virtual network gateway.
    pub nat_rules: Option<Vec<network::v20230901::VirtualNetworkGatewayNatRuleResponse>>,
    /// The provisioning state of the virtual network gateway resource.
    pub provisioning_state: String,
    /// The resource GUID property of the virtual network gateway resource.
    pub resource_guid: String,
    /// The reference to the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
    pub sku: Option<network::v20230901::VirtualNetworkGatewaySkuResponse>,
    /// Resource tags.
    ...
    pub virtual_network_gateway_policy_groups: Option<Vec<network::v20230901::VirtualNetworkGatewayPolicyGroupResponse>>,
    /// The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<network::v20230901::VpnClientConfigurationResponse>,
...
pub async fn get_virtual_network_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20230901:getVirtualNetworkGateway", invoke_args, &opts).await?;
