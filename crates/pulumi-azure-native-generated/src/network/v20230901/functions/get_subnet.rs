...
pub struct GetSubnetResult {
    ...
    pub application_gateway_ip_configurations: Option<Vec<network::v20230901::ApplicationGatewayIPConfigurationResponse>>,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// Set this property to false to disable default outbound connectivity for all VMs in the subnet. This property can only be set at the time of subnet creation and cannot be updated for an existing subnet.
    pub default_outbound_access: Option<bool>,
    /// An array of references to the delegations on the subnet.
    pub delegations: Option<Vec<network::v20230901::DelegationResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// Resource ID.
    pub id: Option<String>,
    /// Array of IpAllocation which reference this subnet.
    pub ip_allocations: Option<Vec<network::v20230901::SubResourceResponse>>,
    /// Array of IP configuration profiles which reference this subnet.
    pub ip_configuration_profiles: Vec<network::v20230901::IPConfigurationProfileResponse>,
    /// An array of references to the network interface IP configurations using subnet.
    pub ip_configurations: Vec<network::v20230901::IPConfigurationResponse>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<String>,
    /// Nat gateway associated with this subnet.
    pub nat_gateway: Option<network::v20230901::SubResourceResponse>,
    /// The reference to the NetworkSecurityGroup resource.
    pub network_security_group: Option<network::v20230901::NetworkSecurityGroupResponse>,
    /// Enable or Disable apply network policies on private end point in the subnet.
    pub private_endpoint_network_policies: Option<String>,
    /// An array of references to private endpoints.
    pub private_endpoints: Vec<network::v20230901::PrivateEndpointResponse>,
    ...
    pub resource_navigation_links: Vec<network::v20230901::ResourceNavigationLinkResponse>,
    /// The reference to the RouteTable resource.
    pub route_table: Option<network::v20230901::RouteTableResponse>,
    /// An array of references to services injecting into this subnet.
    pub service_association_links: Vec<network::v20230901::ServiceAssociationLinkResponse>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<network::v20230901::ServiceEndpointPolicyResponse>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<network::v20230901::ServiceEndpointPropertiesFormatResponse>>,
    /// Resource type.
...
pub async fn get_subnet(
    ...
    let result = ctx.invoke("azure-native:network/v20230901:getSubnet", invoke_args, &opts).await?;
