...
impl ExpressRouteLinkMacSecCipher {
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::GcmAesXpn128 => "GcmAesXpn128",
            Self::GcmAesXpn256 => "GcmAesXpn256",
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for ExpressRouteLinkMacSecCipher {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> std::result::Result<Self, D::Error> {
        ...
        match s.as_str() {
            ...
            "GcmAesXpn128" => Ok(Self::GcmAesXpn128),
            "GcmAesXpn256" => Ok(Self::GcmAesXpn256),
            _ => Err(serde::de::Error::unknown_variant(&s, &["GcmAes256", "GcmAes128", "GcmAesXpn128", "GcmAesXpn256"])),
        }
    }
}
