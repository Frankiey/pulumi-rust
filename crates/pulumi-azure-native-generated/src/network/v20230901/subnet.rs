...
pub struct SubnetArgs {
    ...
    pub application_gateway_ip_configurations: Option<Vec<Input<network::v20230901::ApplicationGatewayIPConfigurationArgs>>>,
    /// Set this property to false to disable default outbound connectivity for all VMs in the subnet. This property can only be set at the time of subnet creation and cannot be updated for an existing subnet.
    pub default_outbound_access: Option<Input<bool>>,
    /// An array of references to the delegations on the subnet.
    pub delegations: Option<Vec<Input<network::v20230901::DelegationArgs>>>,
    /// Resource ID.
    ...
    pub nat_gateway: Option<Input<network::v20230901::SubResourceArgs>>,
    ...
    pub route_table: Option<Input<network::v20230901::RouteTableArgs>>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<Input<network::v20230901::ServiceEndpointPolicyArgs>>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<Input<network::v20230901::ServiceEndpointPropertiesFormatArgs>>>,
...
impl Subnet {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230901:Subnet";
