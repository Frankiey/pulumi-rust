...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20230901::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20230901::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub network_security_group: Option<Input<network::v20230901::NetworkSecurityGroupArgs>>,
    /// Type of Network Interface resource.
    pub nic_type: Option<Input<serde_json::Value>>,
    /// Privatelinkservice of the network interface resource.
    pub private_link_service: Option<Input<network::v20230901::PrivateLinkServiceArgs>>,
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230901:NetworkInterface";
