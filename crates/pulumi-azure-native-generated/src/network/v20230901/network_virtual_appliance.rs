...
pub struct NetworkVirtualApplianceArgs {
    ...
    pub additional_nics: Option<Vec<Input<network::v20230901::VirtualApplianceAdditionalNicPropertiesArgs>>>,
    ...
    pub delegation: Option<Input<network::v20230901::DelegationPropertiesArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// The service principal that has read access to cloud-init and config blob.
    pub identity: Option<Input<network::v20230901::ManagedServiceIdentityArgs>>,
    /// List of Resource Uri of Public IPs for Internet Ingress Scenario.
    pub internet_ingress_public_ips: Option<Vec<Input<network::v20230901::InternetIngressPublicIpsPropertiesArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The name of Network Virtual Appliance.
    pub network_virtual_appliance_name: Option<Input<String>>,
    /// Network Virtual Appliance SKU.
    pub nva_sku: Option<Input<network::v20230901::VirtualApplianceSkuPropertiesArgs>>,
...
impl NetworkVirtualAppliance {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230901:NetworkVirtualAppliance";
