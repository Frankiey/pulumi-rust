...
pub struct GetPrivateLinkServiceResult {
    ...
    pub auto_approval: Option<network::v20240301::PrivateLinkServicePropertiesResponseAutoApproval>,
    ...
    pub ip_configurations: Option<Vec<network::v20240301::PrivateLinkServiceIpConfigurationResponse>>,
    /// An array of references to the load balancer IP configurations.
    pub load_balancer_frontend_ip_configurations: Option<Vec<network::v20240301::FrontendIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint_connections: Vec<network::v20240301::PrivateEndpointConnectionResponse>,
    ...
    pub visibility: Option<network::v20240301::PrivateLinkServicePropertiesResponseVisibility>,
}
...
pub async fn get_private_link_service(
    ...
    let result = ctx.invoke("azure-native:network/v20240301:getPrivateLinkService", invoke_args, &opts).await?;
    ...
    Ok(GetPrivateLinkServiceResult {
        ...
        azure_api_version: serde_json::from_value(result.fields.get("azureApiVersion").cloned().unwrap_or_default())?
            ,
        destination_ip_address: result.fields.get("destinationIPAddress").cloned().map(serde_json::from_value).transpose()?,
