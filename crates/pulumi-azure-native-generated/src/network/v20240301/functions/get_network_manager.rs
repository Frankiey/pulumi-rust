...
pub struct GetNetworkManagerResult {
    ...
    pub network_manager_scopes: network::v20240301::NetworkManagerPropertiesResponseNetworkManagerScopes,
...
pub async fn get_network_manager(
    ...
    let result = ctx.invoke("azure-native:network/v20240301:getNetworkManager", invoke_args, &opts).await?;
