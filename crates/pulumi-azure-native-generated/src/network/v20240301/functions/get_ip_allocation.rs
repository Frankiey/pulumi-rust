...
pub struct GetIpAllocationResult {
    ...
    pub subnet: network::v20240301::SubResourceResponse,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// Resource type.
    pub type_: String,
    /// The VirtualNetwork that using the prefix of this IpAllocation resource.
    pub virtual_network: network::v20240301::SubResourceResponse,
}
...
pub async fn get_ip_allocation(
    ...
    let result = ctx.invoke("azure-native:network/v20240301:getIpAllocation", invoke_args, &opts).await?;
