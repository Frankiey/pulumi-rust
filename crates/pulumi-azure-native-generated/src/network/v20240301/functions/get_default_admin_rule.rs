...
pub struct GetDefaultAdminRuleResult {
    ...
    pub destinations: Vec<network::v20240301::AddressPrefixItemResponse>,
    ...
    pub sources: Vec<network::v20240301::AddressPrefixItemResponse>,
...
pub async fn get_default_admin_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20240301:getDefaultAdminRule", invoke_args, &opts).await?;
