...
pub struct GetNetworkVirtualApplianceConnectionResult {
    ...
    pub properties: network::v20240301::NetworkVirtualApplianceConnectionPropertiesResponse,
}
...
pub async fn get_network_virtual_appliance_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20240301:getNetworkVirtualApplianceConnection", invoke_args, &opts).await?;
