...
pub struct GetPrivateLinkServicePrivateEndpointConnectionResult {
    ...
    pub private_link_service_connection_state: Option<network::v20240301::PrivateLinkServiceConnectionStateResponse>,
...
pub async fn get_private_link_service_private_endpoint_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20240301:getPrivateLinkServicePrivateEndpointConnection", invoke_args, &opts).await?;
