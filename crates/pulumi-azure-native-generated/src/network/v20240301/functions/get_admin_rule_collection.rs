...
pub struct GetAdminRuleCollectionResult {
    ...
    pub applies_to_groups: Vec<network::v20240301::NetworkManagerSecurityGroupItemResponse>,
...
pub async fn get_admin_rule_collection(
    ...
    let result = ctx.invoke("azure-native:network/v20240301:getAdminRuleCollection", invoke_args, &opts).await?;
