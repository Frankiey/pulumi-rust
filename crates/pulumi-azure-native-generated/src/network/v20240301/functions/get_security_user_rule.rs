...
pub struct GetSecurityUserRuleResult {
    ...
    pub destinations: Option<Vec<network::v20240301::AddressPrefixItemResponse>>,
    ...
    pub sources: Option<Vec<network::v20240301::AddressPrefixItemResponse>>,
...
pub async fn get_security_user_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20240301:getSecurityUserRule", invoke_args, &opts).await?;
