...
pub struct ExpressRouteCircuitArgs {
    ...
    pub authorizations: Option<Vec<Input<network::v20230201::ExpressRouteCircuitAuthorizationArgs>>>,
    ...
    pub express_route_port: Option<Input<network::v20230201::SubResourceArgs>>,
    ...
    pub peerings: Option<Vec<Input<network::v20230201::ExpressRouteCircuitPeeringArgs>>>,
    ...
    pub service_provider_properties: Option<Input<network::v20230201::ExpressRouteCircuitServiceProviderPropertiesArgs>>,
    /// The ServiceProviderProvisioningState state of the resource.
    pub service_provider_provisioning_state: Option<Input<serde_json::Value>>,
    /// The SKU.
    pub sku: Option<Input<network::v20230201::ExpressRouteCircuitSkuArgs>>,
    /// Resource tags.
...
impl ExpressRouteCircuit {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230201:ExpressRouteCircuit";
