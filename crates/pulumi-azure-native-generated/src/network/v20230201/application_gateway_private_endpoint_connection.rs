...
pub struct ApplicationGatewayPrivateEndpointConnectionArgs {
    ...
    pub private_link_service_connection_state: Option<Input<network::v20230201::PrivateLinkServiceConnectionStateArgs>>,
...
impl ApplicationGatewayPrivateEndpointConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230201:ApplicationGatewayPrivateEndpointConnection";
