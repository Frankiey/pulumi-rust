...
pub struct ConnectivityConfigurationArgs {
    ...
    pub applies_to_groups: Vec<Input<network::v20230201::ConnectivityGroupItemArgs>>,
    ...
    /// List of hubItems
    pub hubs: Option<Vec<Input<network::v20230201::HubArgs>>>,
...
impl ConnectivityConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230201:ConnectivityConfiguration";
