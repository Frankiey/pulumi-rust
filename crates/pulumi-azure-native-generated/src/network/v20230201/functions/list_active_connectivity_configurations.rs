...
pub struct ListActiveConnectivityConfigurationsResult {
    ...
    pub value: Option<Vec<network::v20230201::ActiveConnectivityConfigurationResponse>>,
}
...
pub async fn list_active_connectivity_configurations(
    ...
    let result = ctx.invoke("azure-native:network/v20230201:listActiveConnectivityConfigurations", invoke_args, &opts).await?;
