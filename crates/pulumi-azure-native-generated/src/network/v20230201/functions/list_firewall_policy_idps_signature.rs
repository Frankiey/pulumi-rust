...
pub struct ListFirewallPolicyIdpsSignatureArgs {
    ...
    pub filters: Option<Vec<network::v20230201::FilterItems>>,
    /// The name of the Firewall Policy.
    pub firewall_policy_name: String,
    /// Column to sort response by
    pub order_by: Option<network::v20230201::OrderBy>,
...
pub struct ListFirewallPolicyIdpsSignatureResult {
    ...
    pub signatures: Option<Vec<network::v20230201::SingleQueryResultResponse>>,
}
...
pub async fn list_firewall_policy_idps_signature(
    ...
    let result = ctx.invoke("azure-native:network/v20230201:listFirewallPolicyIdpsSignature", invoke_args, &opts).await?;
