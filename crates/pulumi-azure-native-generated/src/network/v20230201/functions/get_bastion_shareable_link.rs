...
pub struct GetBastionShareableLinkArgs {
    ...
    pub vms: Option<Vec<network::v20230201::BastionShareableLink>>,
}
...
pub struct GetBastionShareableLinkResult {
    ...
    pub value: Option<Vec<network::v20230201::BastionShareableLinkResponse>>,
}
...
pub async fn get_bastion_shareable_link(
    ...
    let result = ctx.invoke("azure-native:network/v20230201:getBastionShareableLink", invoke_args, &opts).await?;
