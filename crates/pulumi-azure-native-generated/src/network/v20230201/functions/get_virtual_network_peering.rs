...
pub struct GetVirtualNetworkPeeringResult {
    ...
    pub remote_address_space: Option<network::v20230201::AddressSpaceResponse>,
    /// The reference to the remote virtual network's Bgp Communities.
    pub remote_bgp_communities: Option<network::v20230201::VirtualNetworkBgpCommunitiesResponse>,
    /// The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
    pub remote_virtual_network: Option<network::v20230201::SubResourceResponse>,
    /// The reference to the current address space of the remote virtual network.
    pub remote_virtual_network_address_space: Option<network::v20230201::AddressSpaceResponse>,
    /// The reference to the remote virtual network's encryption
    pub remote_virtual_network_encryption: network::v20230201::VirtualNetworkEncryptionResponse,
...
pub async fn get_virtual_network_peering(
    ...
    let result = ctx.invoke("azure-native:network/v20230201:getVirtualNetworkPeering", invoke_args, &opts).await?;
