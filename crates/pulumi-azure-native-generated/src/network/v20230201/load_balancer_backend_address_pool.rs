...
pub struct LoadBalancerBackendAddressPoolArgs {
    ...
    pub load_balancer_backend_addresses: Option<Vec<Input<network::v20230201::LoadBalancerBackendAddressArgs>>>,
    ...
    pub tunnel_interfaces: Option<Vec<Input<network::v20230201::GatewayLoadBalancerTunnelInterfaceArgs>>>,
    /// A reference to a virtual network.
    pub virtual_network: Option<Input<network::v20230201::SubResourceArgs>>,
}
...
impl LoadBalancerBackendAddressPool {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230201:LoadBalancerBackendAddressPool";
