...
pub struct SubnetArgs {
    ...
    pub delegations: Option<Vec<Input<network::v20200301::DelegationArgs>>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// Array of IpAllocation which reference this subnet.
    pub ip_allocations: Option<Vec<Input<network::v20200301::SubResourceArgs>>>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<Input<String>>,
    /// Nat gateway associated with this subnet.
    pub nat_gateway: Option<Input<network::v20200301::SubResourceArgs>>,
    /// The reference to the NetworkSecurityGroup resource.
    pub network_security_group: Option<Input<network::v20200301::NetworkSecurityGroupArgs>>,
    ...
    pub route_table: Option<Input<network::v20200301::RouteTableArgs>>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<Input<network::v20200301::ServiceEndpointPolicyArgs>>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<Input<network::v20200301::ServiceEndpointPropertiesFormatArgs>>>,
...
impl Subnet {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200301:Subnet";
