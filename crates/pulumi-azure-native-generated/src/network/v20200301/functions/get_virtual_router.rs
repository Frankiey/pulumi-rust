...
pub struct GetVirtualRouterResult {
    ...
    pub hosted_gateway: Option<network::v20200301::SubResourceResponse>,
    /// The Subnet on which VirtualRouter is hosted.
    pub hosted_subnet: Option<network::v20200301::SubResourceResponse>,
    /// Resource ID.
    ...
    pub peerings: Vec<network::v20200301::SubResourceResponse>,
...
pub async fn get_virtual_router(
    ...
    let result = ctx.invoke("azure-native:network/v20200301:getVirtualRouter", invoke_args, &opts).await?;
