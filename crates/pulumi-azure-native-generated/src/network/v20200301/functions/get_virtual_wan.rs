...
pub struct GetVirtualWanResult {
    ...
    pub virtual_hubs: Vec<network::v20200301::SubResourceResponse>,
    /// List of VpnSites in the VirtualWAN.
    pub vpn_sites: Vec<network::v20200301::SubResourceResponse>,
}
...
pub async fn get_virtual_wan(
    ...
    let result = ctx.invoke("azure-native:network/v20200301:getVirtualWan", invoke_args, &opts).await?;
