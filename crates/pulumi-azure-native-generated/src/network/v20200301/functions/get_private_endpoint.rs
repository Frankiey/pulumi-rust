...
pub struct GetPrivateEndpointResult {
    ...
    pub custom_dns_configs: Option<Vec<network::v20200301::CustomDnsConfigPropertiesFormatResponse>>,
    ...
    pub manual_private_link_service_connections: Option<Vec<network::v20200301::PrivateLinkServiceConnectionResponse>>,
    /// Resource name.
    pub name: String,
    /// An array of references to the network interfaces created for this private endpoint.
    pub network_interfaces: Vec<network::v20200301::NetworkInterfaceResponse>,
    /// A grouping of information about the connection to the remote resource.
    pub private_link_service_connections: Option<Vec<network::v20200301::PrivateLinkServiceConnectionResponse>>,
    /// The provisioning state of the private endpoint resource.
    pub provisioning_state: String,
    /// The ID of the subnet from which the private IP will be allocated.
    pub subnet: Option<network::v20200301::SubnetResponse>,
    /// Resource tags.
...
pub async fn get_private_endpoint(
    ...
    let result = ctx.invoke("azure-native:network/v20200301:getPrivateEndpoint", invoke_args, &opts).await?;
