...
pub struct NetworkVirtualApplianceArgs {
    ...
    pub sku: Option<Input<network::v20200301::VirtualApplianceSkuPropertiesArgs>>,
    /// Resource tags.
...
impl NetworkVirtualAppliance {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200301:NetworkVirtualAppliance";
