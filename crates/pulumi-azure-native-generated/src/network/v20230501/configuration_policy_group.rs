...
pub struct ConfigurationPolicyGroupArgs {
    ...
    pub policy_members: Option<Vec<Input<network::v20230501::VpnServerConfigurationPolicyGroupMemberArgs>>>,
...
impl ConfigurationPolicyGroup {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230501:ConfigurationPolicyGroup";
