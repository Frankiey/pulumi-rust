...
pub struct GetRoutingIntentResult {
    ...
    pub routing_policies: Option<Vec<network::v20230501::RoutingPolicyResponse>>,
    /// Resource type.
    pub type_: String,
}
...
pub async fn get_routing_intent(
    ...
    let result = ctx.invoke("azure-native:network/v20230501:getRoutingIntent", invoke_args, &opts).await?;
