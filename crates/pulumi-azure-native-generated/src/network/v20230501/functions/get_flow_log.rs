...
pub struct GetFlowLogResult {
    ...
    pub flow_analytics_configuration: Option<network::v20230501::TrafficAnalyticsPropertiesResponse>,
    /// Parameters that define the flow log format.
    pub format: Option<network::v20230501::FlowLogFormatParametersResponse>,
    /// Resource ID.
    ...
    pub retention_policy: Option<network::v20230501::RetentionPolicyParametersResponse>,
...
pub async fn get_flow_log(
    ...
    let result = ctx.invoke("azure-native:network/v20230501:getFlowLog", invoke_args, &opts).await?;
