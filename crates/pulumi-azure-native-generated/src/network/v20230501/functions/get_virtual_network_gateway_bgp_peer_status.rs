...
pub struct GetVirtualNetworkGatewayBgpPeerStatusResult {
    /// List of BGP peers.
    pub value: Option<Vec<network::v20230501::BgpPeerStatusResponse>>,
}
...
pub async fn get_virtual_network_gateway_bgp_peer_status(
    ...
    let result = ctx.invoke("azure-native:network/v20230501:getVirtualNetworkGatewayBgpPeerStatus", invoke_args, &opts).await?;
