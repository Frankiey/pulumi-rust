...
pub struct GetVpnGatewayResult {
    ...
    pub connections: Option<Vec<network::v20230501::VpnConnectionResponse>>,
    ...
    pub ip_configurations: Vec<network::v20230501::VpnGatewayIpConfigurationResponse>,
    ...
    pub nat_rules: Option<Vec<network::v20230501::VpnGatewayNatRuleResponse>>,
...
pub async fn get_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20230501:getVpnGateway", invoke_args, &opts).await?;
