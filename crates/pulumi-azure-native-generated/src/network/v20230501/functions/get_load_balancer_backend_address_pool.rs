...
pub struct GetLoadBalancerBackendAddressPoolResult {
    ...
    pub backend_ip_configurations: Vec<network::v20230501::NetworkInterfaceIPConfigurationResponse>,
    ...
    pub inbound_nat_rules: Vec<network::v20230501::SubResourceResponse>,
    /// An array of backend addresses.
    pub load_balancer_backend_addresses: Option<Vec<network::v20230501::LoadBalancerBackendAddressResponse>>,
    /// An array of references to load balancing rules that use this backend address pool.
    pub load_balancing_rules: Vec<network::v20230501::SubResourceResponse>,
    /// The location of the backend address pool.
    pub location: Option<String>,
    /// The name of the resource that is unique within the set of backend address pools used by the load balancer. This name can be used to access the resource.
    pub name: Option<String>,
    /// A reference to an outbound rule that uses this backend address pool.
    pub outbound_rule: network::v20230501::SubResourceResponse,
    /// An array of references to outbound rules that use this backend address pool.
    pub outbound_rules: Vec<network::v20230501::SubResourceResponse>,
    /// The provisioning state of the backend address pool resource.
    pub provisioning_state: String,
    /// Backend address synchronous mode for the backend pool
    pub sync_mode: Option<String>,
    /// An array of gateway load balancer tunnel interfaces.
    pub tunnel_interfaces: Option<Vec<network::v20230501::GatewayLoadBalancerTunnelInterfaceResponse>>,
    /// Type of the resource.
    pub type_: String,
    /// A reference to a virtual network.
    pub virtual_network: Option<network::v20230501::SubResourceResponse>,
}
...
pub async fn get_load_balancer_backend_address_pool(
    ...
    let result = ctx.invoke("azure-native:network/v20230501:getLoadBalancerBackendAddressPool", invoke_args, &opts).await?;
