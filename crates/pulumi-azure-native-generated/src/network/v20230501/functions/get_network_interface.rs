...
pub struct GetNetworkInterfaceResult {
    ...
    pub dns_settings: Option<network::v20230501::NetworkInterfaceDnsSettingsResponse>,
    /// A reference to the dscp configuration to which the network interface is linked.
    pub dscp_configuration: network::v20230501::SubResourceResponse,
    ...
    pub ip_configurations: Option<Vec<network::v20230501::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint: network::v20230501::PrivateEndpointResponse,
    /// Privatelinkservice of the network interface resource.
    pub private_link_service: Option<network::v20230501::PrivateLinkServiceResponse>,
    ...
    pub tap_configurations: Vec<network::v20230501::NetworkInterfaceTapConfigurationResponse>,
    /// Resource type.
    pub type_: String,
    /// The reference to a virtual machine.
    pub virtual_machine: network::v20230501::SubResourceResponse,
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network/v20230501:getNetworkInterface", invoke_args, &opts).await?;
