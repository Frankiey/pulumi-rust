...
pub struct VirtualNetworkTapArgs {
    ...
    pub destination_load_balancer_front_end_ip_configuration: Option<Input<network::v20230501::FrontendIPConfigurationArgs>>,
    /// The reference to the private IP Address of the collector nic that will receive the tap.
    pub destination_network_interface_ip_configuration: Option<Input<network::v20230501::NetworkInterfaceIPConfigurationArgs>>,
...
impl VirtualNetworkTap {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230501:VirtualNetworkTap";
