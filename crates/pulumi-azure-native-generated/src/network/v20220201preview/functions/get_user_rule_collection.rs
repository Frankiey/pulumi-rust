...
pub struct GetUserRuleCollectionResult {
    ...
    pub applies_to_groups: Vec<network::v20220201preview::NetworkManagerSecurityGroupItemResponse>,
...
pub async fn get_user_rule_collection(
    ...
    let result = ctx.invoke("azure-native:network/v20220201preview:getUserRuleCollection", invoke_args, &opts).await?;
