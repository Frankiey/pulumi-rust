...
pub struct GetNetworkManagerResult {
    ...
    pub network_manager_scopes: network::v20220201preview::NetworkManagerPropertiesResponseNetworkManagerScopes,
...
pub async fn get_network_manager(
    ...
    let result = ctx.invoke("azure-native:network/v20220201preview:getNetworkManager", invoke_args, &opts).await?;
