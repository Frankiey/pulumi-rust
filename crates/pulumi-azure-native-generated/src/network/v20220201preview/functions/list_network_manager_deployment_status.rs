...
pub struct ListNetworkManagerDeploymentStatusResult {
    ...
    pub value: Option<Vec<network::v20220201preview::NetworkManagerDeploymentStatusResponse>>,
}
...
pub async fn list_network_manager_deployment_status(
    ...
    let result = ctx.invoke("azure-native:network/v20220201preview:listNetworkManagerDeploymentStatus", invoke_args, &opts).await?;
