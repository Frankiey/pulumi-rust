...
pub struct UserRuleCollectionArgs {
    ...
    pub applies_to_groups: Vec<Input<network::v20220201preview::NetworkManagerSecurityGroupItemArgs>>,
...
impl UserRuleCollection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220201preview:UserRuleCollection";
