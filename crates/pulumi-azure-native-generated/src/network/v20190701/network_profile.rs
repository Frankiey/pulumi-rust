...
pub struct NetworkProfileArgs {
    ...
    pub container_network_interface_configurations: Option<Vec<Input<network::v20190701::ContainerNetworkInterfaceConfigurationArgs>>>,
    /// List of child container network interfaces.
    pub container_network_interfaces: Option<Vec<Input<network::v20190701::ContainerNetworkInterfaceArgs>>>,
    /// Resource ID.
...
impl NetworkProfile {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190701:NetworkProfile";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.container_network_interfaces {
            pulumi_sdk::resolve_input_vec("containerNetworkInterfaces", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
