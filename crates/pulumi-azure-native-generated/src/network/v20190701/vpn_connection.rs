...
pub struct VpnConnectionArgs {
    ...
    pub remote_vpn_site: Option<Input<network::v20190701::SubResourceArgs>>,
    ...
    pub vpn_link_connections: Option<Vec<Input<network::v20190701::VpnSiteLinkConnectionArgs>>>,
}
...
impl VpnConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190701:VpnConnection";
