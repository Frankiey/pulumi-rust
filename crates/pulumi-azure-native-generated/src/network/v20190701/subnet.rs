...
pub struct SubnetArgs {
    ...
    pub delegations: Option<Vec<Input<network::v20190701::DelegationArgs>>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<Input<String>>,
    /// Nat gateway associated with this subnet.
    pub nat_gateway: Option<Input<network::v20190701::SubResourceArgs>>,
    /// The reference of the NetworkSecurityGroup resource.
    pub network_security_group: Option<Input<network::v20190701::NetworkSecurityGroupArgs>>,
    ...
    pub resource_navigation_links: Option<Vec<Input<network::v20190701::ResourceNavigationLinkArgs>>>,
    /// The reference of the RouteTable resource.
    pub route_table: Option<Input<network::v20190701::RouteTableArgs>>,
    /// An array of references to services injecting into this subnet.
    pub service_association_links: Option<Vec<Input<network::v20190701::ServiceAssociationLinkArgs>>>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<Input<network::v20190701::ServiceEndpointPolicyArgs>>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<Input<network::v20190701::ServiceEndpointPropertiesFormatArgs>>>,
...
impl Subnet {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190701:Subnet";
