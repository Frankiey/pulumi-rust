...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20190701::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20190701::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub tap_configurations: Option<Vec<Input<network::v20190701::NetworkInterfaceTapConfigurationArgs>>>,
}
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190701:NetworkInterface";
