...
pub struct GetVirtualNetworkGatewayResult {
    ...
    pub bgp_settings: Option<network::v20190701::BgpSettingsResponse>,
    ...
    pub gateway_default_site: Option<network::v20190701::SubResourceResponse>,
    /// The type of this virtual network gateway.
    pub gateway_type: Option<String>,
    /// Resource ID.
    pub id: Option<String>,
    /// IP configurations for virtual network gateway.
    pub ip_configurations: Option<Vec<network::v20190701::VirtualNetworkGatewayIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub sku: Option<network::v20190701::VirtualNetworkGatewaySkuResponse>,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// Resource type.
    pub type_: String,
    /// The reference of the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<network::v20190701::VpnClientConfigurationResponse>,
...
pub async fn get_virtual_network_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20190701:getVirtualNetworkGateway", invoke_args, &opts).await?;
