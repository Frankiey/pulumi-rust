...
pub struct GetP2sVpnServerConfigurationResult {
    ...
    pub properties: network::v20190701::P2SVpnServerConfigurationPropertiesResponse,
}
...
pub async fn get_p2s_vpn_server_configuration(
    ...
    let result = ctx.invoke("azure-native:network/v20190701:getP2sVpnServerConfiguration", invoke_args, &opts).await?;
