...
pub struct VpnSiteArgs {
    ...
    pub bgp_properties: Option<Input<network::v20240701::BgpSettingsArgs>>,
    /// The device properties.
    pub device_properties: Option<Input<network::v20240701::DevicePropertiesArgs>>,
    /// Resource ID.
    ...
    /// Office365 Policy.
    pub o365policy: Option<Input<network::v20240701::O365PolicyPropertiesArgs>>,
    ...
    pub vpn_site_links: Option<Vec<Input<network::v20240701::VpnSiteLinkArgs>>>,
...
impl VpnSite {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:VpnSite";
