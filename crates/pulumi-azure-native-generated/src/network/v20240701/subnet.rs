...
pub struct SubnetArgs {
    ...
    pub application_gateway_ip_configurations: Option<Vec<Input<network::v20240701::ApplicationGatewayIPConfigurationArgs>>>,
    /// Set this property to false to disable default outbound connectivity for all VMs in the subnet. This property can only be set at the time of subnet creation and cannot be updated for an existing subnet.
    pub default_outbound_access: Option<Input<bool>>,
    /// An array of references to the delegations on the subnet.
    pub delegations: Option<Vec<Input<network::v20240701::DelegationArgs>>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// Array of IpAllocation which reference this subnet.
    pub ip_allocations: Option<Vec<Input<network::v20240701::SubResourceArgs>>>,
    /// A list of IPAM Pools for allocating IP address prefixes.
    pub ipam_pool_prefix_allocations: Option<Vec<Input<network::v20240701::IpamPoolPrefixAllocationArgs>>>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<Input<String>>,
    /// Nat gateway associated with this subnet.
    pub nat_gateway: Option<Input<network::v20240701::SubResourceArgs>>,
    ...
    pub route_table: Option<Input<network::v20240701::RouteTableArgs>>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<Input<network::v20240701::ServiceEndpointPolicyArgs>>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<Input<network::v20240701::ServiceEndpointPropertiesFormatArgs>>>,
...
impl Subnet {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:Subnet";
