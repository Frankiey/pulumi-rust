...
pub struct ConnectivityConfigurationArgs {
    ...
    pub applies_to_groups: Vec<Input<network::v20240701::ConnectivityGroupItemArgs>>,
    ...
    pub connectivity_capabilities: Option<Input<network::v20240701::ConnectivityConfigurationPropertiesConnectivityCapabilitiesArgs>>,
    ...
    /// List of hubItems
    pub hubs: Option<Vec<Input<network::v20240701::HubArgs>>>,
...
pub struct ConnectivityConfiguration {
    ...
    /// Collection of additional settings to enhance specific topology behaviors of the connectivity configuration resource.
    pub connectivity_capabilities: Output<serde_json::Value>,
    /// Connectivity topology type.
...
impl ConnectivityConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:ConnectivityConfiguration";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.connectivity_capabilities {
            pulumi_sdk::resolve_input("connectivityCapabilities", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            azure_api_version: registered.outputs.get("azureApiVersion")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            connectivity_capabilities: registered.outputs.get("connectivityCapabilities")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
