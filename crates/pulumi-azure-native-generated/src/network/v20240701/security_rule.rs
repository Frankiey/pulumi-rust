...
pub struct SecurityRuleArgs {
    ...
    pub destination_application_security_groups: Option<Vec<Input<network::v20240701::ApplicationSecurityGroupArgs>>>,
    ...
    pub source_application_security_groups: Option<Vec<Input<network::v20240701::ApplicationSecurityGroupArgs>>>,
...
impl SecurityRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:SecurityRule";
