...
pub struct ReachabilityAnalysisRunArgs {
    ...
    pub properties: Input<network::v20240701::ReachabilityAnalysisRunPropertiesArgs>,
...
impl ReachabilityAnalysisRun {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:ReachabilityAnalysisRun";
