...
pub struct NatGatewayArgs {
    ...
    pub public_ip_addresses: Option<Vec<Input<network::v20240701::SubResourceArgs>>>,
    /// An array of public ip addresses V6 associated with the nat gateway resource.
    pub public_ip_addresses_v6: Option<Vec<Input<network::v20240701::SubResourceArgs>>>,
    /// An array of public ip prefixes V4 associated with the nat gateway resource.
    pub public_ip_prefixes: Option<Vec<Input<network::v20240701::SubResourceArgs>>>,
    /// An array of public ip prefixes V6 associated with the nat gateway resource.
    pub public_ip_prefixes_v6: Option<Vec<Input<network::v20240701::SubResourceArgs>>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The nat gateway SKU.
    pub sku: Option<Input<network::v20240701::NatGatewaySkuArgs>>,
    /// A reference to the source virtual network using this nat gateway resource.
    pub source_virtual_network: Option<Input<network::v20240701::SubResourceArgs>>,
    /// Resource tags.
...
impl NatGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:NatGateway";
