...
pub struct ReachabilityAnalysisIntentArgs {
    ...
    pub properties: Input<network::v20240701::ReachabilityAnalysisIntentPropertiesArgs>,
...
impl ReachabilityAnalysisIntent {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:ReachabilityAnalysisIntent";
