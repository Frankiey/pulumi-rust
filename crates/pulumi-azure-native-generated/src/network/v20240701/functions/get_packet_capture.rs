...
pub struct GetPacketCaptureResult {
    ...
    pub capture_settings: Option<network::v20240701::PacketCaptureSettingsResponse>,
    ...
    pub filters: Option<Vec<network::v20240701::PacketCaptureFilterResponse>>,
    ...
    pub scope: Option<network::v20240701::PacketCaptureMachineScopeResponse>,
    /// The storage location for a packet capture session.
    pub storage_location: network::v20240701::PacketCaptureStorageLocationResponse,
...
pub async fn get_packet_capture(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getPacketCapture", invoke_args, &opts).await?;
