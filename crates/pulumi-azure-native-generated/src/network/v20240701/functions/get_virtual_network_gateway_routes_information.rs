...
pub struct GetVirtualNetworkGatewayRoutesInformationResult {
    ...
    pub circuits_metadata_map: Option<HashMap<String, network::v20240701::CircuitMetadataMapResponse>>,
    ...
    pub route_sets: Option<Vec<network::v20240701::GatewayRouteSetResponse>>,
}
...
pub async fn get_virtual_network_gateway_routes_information(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getVirtualNetworkGatewayRoutesInformation", invoke_args, &opts).await?;
