...
pub struct GetStaticCidrResult {
    ...
    pub properties: network::v20240701::StaticCidrPropertiesResponse,
...
pub async fn get_static_cidr(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getStaticCidr", invoke_args, &opts).await?;
