...
#[derive(Default)]
pub struct GetNetworkSecurityPerimeterLinkArgs {
...
pub struct GetNetworkSecurityPerimeterLinkResult {
...
/// Gets the specified NSP link resource.
pub async fn get_network_security_perimeter_link(
    ctx: &Context,
    args: GetNetworkSecurityPerimeterLinkArgs,
    opts: Option<InvokeOptions>,
) -> Result<GetNetworkSecurityPerimeterLinkResult> {
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getNetworkSecurityPerimeterLink", invoke_args, &opts).await?;

    Ok(GetNetworkSecurityPerimeterLinkResult {
