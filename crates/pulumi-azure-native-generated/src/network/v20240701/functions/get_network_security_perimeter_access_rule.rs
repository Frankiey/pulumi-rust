...
pub struct GetNetworkSecurityPerimeterAccessRuleResult {
    ...
    pub network_security_perimeters: Vec<network::v20240701::PerimeterBasedAccessRuleResponse>,
    ...
    pub subscriptions: Option<Vec<network::v20240701::SubscriptionIdResponse>>,
...
pub async fn get_network_security_perimeter_access_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getNetworkSecurityPerimeterAccessRule", invoke_args, &opts).await?;
