...
pub struct GetConfigurationPolicyGroupResult {
    ...
    pub p2s_connection_configurations: Vec<network::v20240701::SubResourceResponse>,
    /// Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
    pub policy_members: Option<Vec<network::v20240701::VpnServerConfigurationPolicyGroupMemberResponse>>,
...
pub async fn get_configuration_policy_group(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getConfigurationPolicyGroup", invoke_args, &opts).await?;
