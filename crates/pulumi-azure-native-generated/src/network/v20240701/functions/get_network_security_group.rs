...
pub struct GetNetworkSecurityGroupResult {
    ...
    pub default_security_rules: Vec<network::v20240701::SecurityRuleResponse>,
    ...
    pub security_rules: Option<Vec<network::v20240701::SecurityRuleResponse>>,
    /// A collection of references to subnets.
    pub subnets: Vec<network::v20240701::SubnetResponse>,
    /// Resource tags.
...
pub async fn get_network_security_group(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getNetworkSecurityGroup", invoke_args, &opts).await?;
