...
pub struct GetReachabilityAnalysisIntentResult {
    ...
    pub properties: network::v20240701::ReachabilityAnalysisIntentPropertiesResponse,
...
pub async fn get_reachability_analysis_intent(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getReachabilityAnalysisIntent", invoke_args, &opts).await?;
