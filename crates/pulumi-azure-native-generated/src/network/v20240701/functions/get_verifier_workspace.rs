...
pub struct GetVerifierWorkspaceResult {
    ...
    pub properties: network::v20240701::VerifierWorkspacePropertiesResponse,
...
pub async fn get_verifier_workspace(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getVerifierWorkspace", invoke_args, &opts).await?;
