...
pub struct GetNetworkSecurityPerimeterAssociationResult {
    ...
    pub private_link_resource: Option<network::v20240701::SubResourceResponse>,
    /// Profile id to which the PaaS resource is associated.
    pub profile: Option<network::v20240701::SubResourceResponse>,
...
pub async fn get_network_security_perimeter_association(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getNetworkSecurityPerimeterAssociation", invoke_args, &opts).await?;
