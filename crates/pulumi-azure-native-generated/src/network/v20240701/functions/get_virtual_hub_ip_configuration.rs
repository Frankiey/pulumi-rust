...
pub struct GetVirtualHubIpConfigurationResult {
    ...
    pub public_ip_address: Option<network::v20240701::PublicIPAddressResponse>,
...
pub async fn get_virtual_hub_ip_configuration(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getVirtualHubIpConfiguration", invoke_args, &opts).await?;
