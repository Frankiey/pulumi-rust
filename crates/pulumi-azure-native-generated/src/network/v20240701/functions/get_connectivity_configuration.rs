...
pub struct GetConnectivityConfigurationResult {
    ...
    pub applies_to_groups: Vec<network::v20240701::ConnectivityGroupItemResponse>,
    ...
    pub connectivity_capabilities: Option<network::v20240701::ConnectivityConfigurationPropertiesResponseConnectivityCapabilities>,
    ...
    pub etag: String,
    /// List of hubItems
    pub hubs: Option<Vec<network::v20240701::HubResponse>>,
    /// Resource ID.
    pub id: String,
...
pub async fn get_connectivity_configuration(
    ...
    let result = ctx.invoke("azure-native:network/v20240701:getConnectivityConfiguration", invoke_args, &opts).await?;
    ...
    Ok(GetConnectivityConfigurationResult {
        ...
        azure_api_version: serde_json::from_value(result.fields.get("azureApiVersion").cloned().unwrap_or_default())?
            ,
        connectivity_capabilities: result.fields.get("connectivityCapabilities").cloned().map(serde_json::from_value).transpose()?,
