...
pub struct PublicIPAddressArgs {
    ...
    pub ddos_settings: Option<Input<network::v20240701::DdosSettingsArgs>>,
    /// Specify what happens to the public IP address when the VM using it is deleted
    pub delete_option: Option<Input<serde_json::Value>>,
    /// The FQDN of the DNS record associated with the public IP address.
    pub dns_settings: Option<Input<network::v20240701::PublicIPAddressDnsSettingsArgs>>,
    ...
    pub ip_tags: Option<Vec<Input<network::v20240701::IpTagArgs>>>,
    /// The linked public IP address of the public IP address resource.
    pub linked_public_ip_address: Option<Input<network::v20240701::PublicIPAddressArgs>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// Migration phase of Public IP Address.
    pub migration_phase: Option<Input<serde_json::Value>>,
    /// The NatGateway for the Public IP address.
    pub nat_gateway: Option<Input<network::v20240701::NatGatewayArgs>>,
    ...
    pub public_ip_prefix: Option<Input<network::v20240701::SubResourceArgs>>,
    /// The name of the public IP address.
    pub public_ip_address_name: Option<Input<String>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The service public IP address of the public IP address resource.
    pub service_public_ip_address: Option<Input<network::v20240701::PublicIPAddressArgs>>,
    /// The public IP address SKU.
    pub sku: Option<Input<network::v20240701::PublicIPAddressSkuArgs>>,
    /// Resource tags.
...
impl PublicIPAddress {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:PublicIPAddress";
