...
pub struct BastionHostArgs {
    ...
    pub enable_private_only_bastion: Option<Input<bool>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20240701::BastionHostIPConfigurationArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    pub network_acls: Option<Input<network::v20240701::BastionHostPropertiesFormatNetworkAclsArgs>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The scale units for the Bastion Host resource.
    pub scale_units: Option<Input<i64>>,
    /// The sku of this Bastion Host.
    pub sku: Option<Input<network::v20240701::SkuArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// Reference to an existing virtual network required for Developer Bastion Host only.
    pub virtual_network: Option<Input<network::v20240701::SubResourceArgs>>,
...
pub struct BastionHost {
    ...
    /// Enable/Disable Private Only feature of the Bastion Host resource.
    pub enable_private_only_bastion: Output<serde_json::Value>,
    /// Enable/Disable Session Recording feature of the Bastion Host resource.
...
impl BastionHost {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:BastionHost";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.enable_private_only_bastion {
            pulumi_sdk::resolve_input("enablePrivateOnlyBastion", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            enable_kerberos: registered.outputs.get("enableKerberos")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            enable_private_only_bastion: registered.outputs.get("enablePrivateOnlyBastion")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
