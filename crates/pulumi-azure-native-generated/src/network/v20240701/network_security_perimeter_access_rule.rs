...
pub struct NetworkSecurityPerimeterAccessRuleArgs {
    ...
    pub subscriptions: Option<Vec<Input<network::v20240701::SubscriptionIdArgs>>>,
}
...
impl NetworkSecurityPerimeterAccessRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:NetworkSecurityPerimeterAccessRule";
