...
pub struct VirtualNetworkGatewayArgs {
    ...
    pub admin_state: Option<Input<serde_json::Value>>,
    ...
    pub auto_scale_configuration: Option<Input<network::v20240701::VirtualNetworkGatewayAutoScaleConfigurationArgs>>,
    /// Virtual network gateway's BGP speaker settings.
    pub bgp_settings: Option<Input<network::v20240701::BgpSettingsArgs>>,
    /// The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
    pub custom_routes: Option<Input<network::v20240701::AddressSpaceArgs>>,
    ...
    pub enable_high_bandwidth_vpn_gateway: Option<Input<bool>>,
    /// Whether private IP needs to be enabled on this gateway for connections or not.
    pub enable_private_ip_address: Option<Input<bool>>,
    /// The extended location of type local virtual network gateway.
    pub extended_location: Option<Input<network::v20240701::ExtendedLocationArgs>>,
    /// The reference to the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
    pub gateway_default_site: Option<Input<network::v20240701::SubResourceArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20240701::VirtualNetworkGatewayIPConfigurationArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// NatRules for virtual network gateway.
    pub nat_rules: Option<Vec<Input<network::v20240701::VirtualNetworkGatewayNatRuleArgs>>>,
    /// Property to indicate if the Express Route Gateway has resiliency model of MultiHomed or SingleHomed
    pub resiliency_model: Option<Input<serde_json::Value>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The reference to the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
    pub sku: Option<Input<network::v20240701::VirtualNetworkGatewaySkuArgs>>,
    /// Resource tags.
    ...
    pub virtual_network_gateway_migration_status: Option<Input<network::v20240701::VirtualNetworkGatewayMigrationStatusArgs>>,
    /// The name of the virtual network gateway.
    pub virtual_network_gateway_name: Option<Input<String>>,
    /// The reference to the VirtualNetworkGatewayPolicyGroup resource which represents the available VirtualNetworkGatewayPolicyGroup for the gateway.
    pub virtual_network_gateway_policy_groups: Option<Vec<Input<network::v20240701::VirtualNetworkGatewayPolicyGroupArgs>>>,
    /// The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<Input<network::v20240701::VpnClientConfigurationArgs>>,
...
pub struct VirtualNetworkGateway {
    ...
    /// Property to indicate if the Express Route Gateway serves traffic when there are multiple Express Route Gateways in the vnet
    pub admin_state: Output<serde_json::Value>,
    /// Configure this gateway to accept traffic from other Azure Virtual Networks. This configuration does not support connectivity to Azure Virtual WAN.
    ...
    /// To enable Advanced Connectivity feature for VPN gateway
    pub enable_high_bandwidth_vpn_gateway: Output<serde_json::Value>,
    /// Whether private IP needs to be enabled on this gateway for connections or not.
    ...
    /// Property to indicate if the Express Route Gateway has resiliency model of MultiHomed or SingleHomed
    pub resiliency_model: Output<serde_json::Value>,
    ...
    /// The reference to the VirtualNetworkGatewayMigrationStatus which represents the status of migration.
    pub virtual_network_gateway_migration_status: Output<serde_json::Value>,
    /// The reference to the VirtualNetworkGatewayPolicyGroup resource which represents the available VirtualNetworkGatewayPolicyGroup for the gateway.
...
impl VirtualNetworkGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240701:VirtualNetworkGateway";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.admin_state {
            pulumi_sdk::resolve_input("adminState", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        if let Some(v) = args.enable_high_bandwidth_vpn_gateway {
            pulumi_sdk::resolve_input("enableHighBandwidthVpnGateway", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        if let Some(v) = args.resiliency_model {
            pulumi_sdk::resolve_input("resiliencyModel", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        if let Some(v) = args.virtual_network_gateway_migration_status {
            pulumi_sdk::resolve_input("virtualNetworkGatewayMigrationStatus", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            active_active: registered.outputs.get("activeActive")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            admin_state: registered.outputs.get("adminState")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            enable_dns_forwarding: registered.outputs.get("enableDnsForwarding")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            enable_high_bandwidth_vpn_gateway: registered.outputs.get("enableHighBandwidthVpnGateway")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            provisioning_state: registered.outputs.get("provisioningState")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            resiliency_model: registered.outputs.get("resiliencyModel")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            v_net_extended_location_resource_id: registered.outputs.get("vNetExtendedLocationResourceId")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            virtual_network_gateway_migration_status: registered.outputs.get("virtualNetworkGatewayMigrationStatus")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
