...
pub struct DdosCustomPolicyArgs {
    ...
    pub protocol_custom_settings: Option<Vec<Input<network::v20181201::ProtocolCustomSettingsFormatArgs>>>,
...
impl DdosCustomPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181201:DdosCustomPolicy";
