...
pub struct VirtualNetworkPeeringArgs {
    ...
    pub remote_address_space: Option<Input<network::v20181201::AddressSpaceArgs>>,
    ...
    pub remote_virtual_network: Option<Input<network::v20181201::SubResourceArgs>>,
...
impl VirtualNetworkPeering {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181201:VirtualNetworkPeering";
