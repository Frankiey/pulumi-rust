...
pub struct GetPublicIPAddressResult {
    ...
    pub ddos_settings: Option<network::v20181201::DdosSettingsResponse>,
    /// The FQDN of the DNS record associated with the public IP address.
    pub dns_settings: Option<network::v20181201::PublicIPAddressDnsSettingsResponse>,
    ...
    pub ip_configuration: network::v20181201::IPConfigurationResponse,
    ...
    pub public_ip_prefix: Option<network::v20181201::SubResourceResponse>,
    /// The resource GUID property of the public IP resource.
    pub resource_guid: Option<String>,
    /// The public IP address SKU.
    pub sku: Option<network::v20181201::PublicIPAddressSkuResponse>,
    /// Resource tags.
...
pub async fn get_public_ip_address(
    ...
    let result = ctx.invoke("azure-native:network/v20181201:getPublicIPAddress", invoke_args, &opts).await?;
