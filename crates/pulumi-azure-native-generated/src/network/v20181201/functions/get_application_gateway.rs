...
pub struct GetApplicationGatewayResult {
    ...
    pub authentication_certificates: Option<Vec<network::v20181201::ApplicationGatewayAuthenticationCertificateResponse>>,
    /// Autoscale Configuration.
    pub autoscale_configuration: Option<network::v20181201::ApplicationGatewayAutoscaleConfigurationResponse>,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// Backend address pool of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    pub backend_address_pools: Option<Vec<network::v20181201::ApplicationGatewayBackendAddressPoolResponse>>,
    /// Backend http settings of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    pub backend_http_settings_collection: Option<Vec<network::v20181201::ApplicationGatewayBackendHttpSettingsResponse>>,
    /// Custom error configurations of the application gateway resource.
    pub custom_error_configurations: Option<Vec<network::v20181201::ApplicationGatewayCustomErrorResponse>>,
    ...
    pub firewall_policy: Option<network::v20181201::SubResourceResponse>,
    /// Frontend IP addresses of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    pub frontend_ip_configurations: Option<Vec<network::v20181201::ApplicationGatewayFrontendIPConfigurationResponse>>,
    /// Frontend ports of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    pub frontend_ports: Option<Vec<network::v20181201::ApplicationGatewayFrontendPortResponse>>,
    /// Subnets of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    pub gateway_ip_configurations: Option<Vec<network::v20181201::ApplicationGatewayIPConfigurationResponse>>,
    /// Http listeners of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    pub http_listeners: Option<Vec<network::v20181201::ApplicationGatewayHttpListenerResponse>>,
    /// Resource ID.
    pub id: Option<String>,
    /// The identity of the application gateway, if configured.
    pub identity: Option<network::v20181201::ManagedServiceIdentityResponse>,
    /// Resource location.
    ...
    pub probes: Option<Vec<network::v20181201::ApplicationGatewayProbeResponse>>,
    /// Provisioning state of the application gateway resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
    pub provisioning_state: Option<String>,
    /// Redirect configurations of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    pub redirect_configurations: Option<Vec<network::v20181201::ApplicationGatewayRedirectConfigurationResponse>>,
    /// Request routing rules of the application gateway resource.
    pub request_routing_rules: Option<Vec<network::v20181201::ApplicationGatewayRequestRoutingRuleResponse>>,
    /// Resource GUID property of the application gateway resource.
    pub resource_guid: Option<String>,
    /// Rewrite rules for the application gateway resource.
    pub rewrite_rule_sets: Option<Vec<network::v20181201::ApplicationGatewayRewriteRuleSetResponse>>,
    /// SKU of the application gateway resource.
    pub sku: Option<network::v20181201::ApplicationGatewaySkuResponse>,
    /// SSL certificates of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    pub ssl_certificates: Option<Vec<network::v20181201::ApplicationGatewaySslCertificateResponse>>,
    /// SSL policy of the application gateway resource.
    pub ssl_policy: Option<network::v20181201::ApplicationGatewaySslPolicyResponse>,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// Trusted Root certificates of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    pub trusted_root_certificates: Option<Vec<network::v20181201::ApplicationGatewayTrustedRootCertificateResponse>>,
    /// Resource type.
    pub type_: String,
    /// URL path map of the application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
    pub url_path_maps: Option<Vec<network::v20181201::ApplicationGatewayUrlPathMapResponse>>,
    /// Web application firewall configuration.
    pub web_application_firewall_configuration: Option<network::v20181201::ApplicationGatewayWebApplicationFirewallConfigurationResponse>,
...
pub async fn get_application_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20181201:getApplicationGateway", invoke_args, &opts).await?;
