...
pub struct VirtualHubArgs {
    ...
    pub express_route_gateway: Option<Input<network::v20181201::SubResourceArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The P2SVpnGateway associated with this VirtualHub
    pub p2s_vpn_gateway: Option<Input<network::v20181201::SubResourceArgs>>,
    /// The resource group name of the VirtualHub.
    pub resource_group_name: Input<String>,
    /// The routeTable associated with this virtual hub.
    pub route_table: Option<Input<network::v20181201::VirtualHubRouteTableArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The name of the VirtualHub.
    pub virtual_hub_name: Option<Input<String>>,
    /// List of all vnet connections with this VirtualHub.
    pub virtual_network_connections: Option<Vec<Input<network::v20181201::HubVirtualNetworkConnectionArgs>>>,
    /// The VirtualWAN to which the VirtualHub belongs
    pub virtual_wan: Option<Input<network::v20181201::SubResourceArgs>>,
    /// The VpnGateway associated with this VirtualHub
    pub vpn_gateway: Option<Input<network::v20181201::SubResourceArgs>>,
}
...
impl VirtualHub {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181201:VirtualHub";
