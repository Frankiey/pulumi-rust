...
pub struct VirtualNetworkArgs {
    ...
    pub address_space: Option<Input<network::v20250501::AddressSpaceArgs>>,
    /// Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.
    pub bgp_communities: Option<Input<network::v20250501::VirtualNetworkBgpCommunitiesArgs>>,
    /// The DDoS protection plan associated with the virtual network.
    pub ddos_protection_plan: Option<Input<network::v20250501::SubResourceArgs>>,
    /// The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
    pub dhcp_options: Option<Input<network::v20250501::DhcpOptionsArgs>>,
    ...
    pub encryption: Option<Input<network::v20250501::VirtualNetworkEncryptionArgs>>,
    ...
    pub ip_allocations: Option<Vec<Input<network::v20250501::SubResourceArgs>>>,
    /// Resource location.
    ...
    pub subnets: Option<Vec<Input<network::v20250501::SubnetArgs>>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The name of the virtual network.
    pub virtual_network_name: Option<Input<String>>,
    /// A list of peerings in a Virtual Network.
    pub virtual_network_peerings: Option<Vec<Input<network::v20250501::VirtualNetworkPeeringArgs>>>,
}
...
impl VirtualNetwork {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250501:VirtualNetwork";
