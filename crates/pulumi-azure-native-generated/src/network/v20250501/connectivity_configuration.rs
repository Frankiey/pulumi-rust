...
pub struct ConnectivityConfigurationArgs {
    ...
    pub applies_to_groups: Vec<Input<network::v20250501::ConnectivityGroupItemArgs>>,
    ...
    pub connectivity_capabilities: Option<Input<network::v20250501::ConnectivityConfigurationPropertiesConnectivityCapabilitiesArgs>>,
    ...
    /// List of hubItems
    pub hubs: Option<Vec<Input<network::v20250501::HubArgs>>>,
...
impl ConnectivityConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250501:ConnectivityConfiguration";
