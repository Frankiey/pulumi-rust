...
pub struct FirewallPolicyArgs {
    ...
    pub sku: Option<Input<network::v20250501::FirewallPolicySkuArgs>>,
    ...
    pub transport_security: Option<Input<network::v20250501::FirewallPolicyTransportSecurityArgs>>,
}
...
impl FirewallPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250501:FirewallPolicy";
