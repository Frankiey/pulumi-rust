...
pub struct VirtualHubIpConfigurationArgs {
    ...
    pub public_ip_address: Option<Input<network::v20250501::PublicIPAddressArgs>>,
...
impl VirtualHubIpConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250501:VirtualHubIpConfiguration";
