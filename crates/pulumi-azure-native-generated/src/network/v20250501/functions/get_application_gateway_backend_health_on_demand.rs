...
pub struct GetApplicationGatewayBackendHealthOnDemandArgs {
    ...
    pub backend_address_pool: Option<network::v20250501::SubResource>,
    /// Reference to backend http setting of application gateway to be used for test probe.
    pub backend_http_settings: Option<network::v20250501::SubResource>,
    ...
    pub match_: Option<network::v20250501::ApplicationGatewayProbeHealthResponseMatch>,
...
pub struct GetApplicationGatewayBackendHealthOnDemandResult {
    ...
    pub backend_address_pool: Option<network::v20250501::ApplicationGatewayBackendAddressPoolResponse>,
    /// Application gateway BackendHealthHttp settings.
    pub backend_health_http_settings: Option<network::v20250501::ApplicationGatewayBackendHealthHttpSettingsResponse>,
}
...
pub async fn get_application_gateway_backend_health_on_demand(
    ...
    if let Some(v) = args.enable_probe_proxy_protocol_header {
        invoke_args.insert("enableProbeProxyProtocolHeader".to_string(), json!(v));
    }
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getApplicationGatewayBackendHealthOnDemand", invoke_args, &opts).await?;
