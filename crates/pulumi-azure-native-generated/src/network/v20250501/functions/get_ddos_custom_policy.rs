...
pub struct GetDdosCustomPolicyResult {
    ...
    pub detection_rules: Option<Vec<network::v20250501::DdosDetectionRuleResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The list of frontend IP configurations associated with the custom policy.
    pub front_end_ip_configuration: Option<Vec<network::v20250501::SubResourceResponse>>,
    /// Resource ID.
...
pub async fn get_ddos_custom_policy(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getDdosCustomPolicy", invoke_args, &opts).await?;
