...
pub struct GetExpressRouteCircuitResult {
    ...
    pub authorizations: Option<Vec<network::v20250501::ExpressRouteCircuitAuthorizationResponse>>,
    ...
    pub express_route_port: Option<network::v20250501::SubResourceResponse>,
    ...
    pub peerings: Option<Vec<network::v20250501::ExpressRouteCircuitPeeringResponse>>,
    ...
    pub service_provider_properties: Option<network::v20250501::ExpressRouteCircuitServiceProviderPropertiesResponse>,
    /// The ServiceProviderProvisioningState state of the resource.
    pub service_provider_provisioning_state: Option<String>,
    /// The SKU.
    pub sku: Option<network::v20250501::ExpressRouteCircuitSkuResponse>,
...
pub async fn get_express_route_circuit(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getExpressRouteCircuit", invoke_args, &opts).await?;
