...
pub struct GetNatRuleResult {
    ...
    pub egress_vpn_site_link_connections: Vec<network::v20250501::SubResourceResponse>,
    ...
    pub ingress_vpn_site_link_connections: Vec<network::v20250501::SubResourceResponse>,
...
pub async fn get_nat_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getNatRule", invoke_args, &opts).await?;
