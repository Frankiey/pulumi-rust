...
pub struct GetPublicIPPrefixResult {
    ...
    pub custom_ip_prefix: Option<network::v20250501::SubResourceResponse>,
    ...
    pub load_balancer_frontend_ip_configuration: network::v20250501::SubResourceResponse,
    /// Resource location.
    ...
    pub public_ip_addresses: Vec<network::v20250501::ReferencedPublicIpAddressResponse>,
    /// The resource GUID property of the public IP prefix resource.
    pub resource_guid: String,
    /// The public IP prefix SKU.
    pub sku: Option<network::v20250501::PublicIPPrefixSkuResponse>,
    /// Resource tags.
...
pub async fn get_public_ip_prefix(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getPublicIPPrefix", invoke_args, &opts).await?;

    Ok(GetPublicIPPrefixResult {
        azure_api_version: serde_json::from_value(result.fields.get("azureApiVersion").cloned().unwrap_or_default())?
            ,
        custom_ip_prefix: result.fields.get("customIPPrefix").cloned().map(serde_json::from_value).transpose()?,
