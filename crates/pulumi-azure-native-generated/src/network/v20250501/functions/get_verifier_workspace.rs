...
pub struct GetVerifierWorkspaceResult {
    ...
    pub properties: network::v20250501::VerifierWorkspacePropertiesResponse,
...
pub async fn get_verifier_workspace(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getVerifierWorkspace", invoke_args, &opts).await?;
