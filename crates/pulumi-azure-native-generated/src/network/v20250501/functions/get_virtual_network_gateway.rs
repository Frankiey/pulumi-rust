...
pub struct GetVirtualNetworkGatewayResult {
    ...
    pub auto_scale_configuration: Option<network::v20250501::VirtualNetworkGatewayAutoScaleConfigurationResponse>,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// Virtual network gateway's BGP speaker settings.
    pub bgp_settings: Option<network::v20250501::BgpSettingsResponse>,
    /// The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
    pub custom_routes: Option<network::v20250501::AddressSpaceResponse>,
    ...
    pub enable_high_bandwidth_vpn_gateway: Option<bool>,
    /// Whether private IP needs to be enabled on this gateway for connections or not.
    pub enable_private_ip_address: Option<bool>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The extended location of type local virtual network gateway.
    pub extended_location: Option<network::v20250501::ExtendedLocationResponse>,
    /// The reference to the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
    pub gateway_default_site: Option<network::v20250501::SubResourceResponse>,
    ...
    pub ip_configurations: Option<Vec<network::v20250501::VirtualNetworkGatewayIPConfigurationResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// NatRules for virtual network gateway.
    pub nat_rules: Option<Vec<network::v20250501::VirtualNetworkGatewayNatRuleResponse>>,
    /// The provisioning state of the virtual network gateway resource.
    pub provisioning_state: String,
    /// Property to indicate if the Express Route Gateway has resiliency model of MultiHomed or SingleHomed
    pub resiliency_model: Option<String>,
    /// The resource GUID property of the virtual network gateway resource.
    pub resource_guid: String,
    /// The reference to the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
    pub sku: Option<network::v20250501::VirtualNetworkGatewaySkuResponse>,
    /// Resource tags.
    ...
    pub virtual_network_gateway_migration_status: Option<network::v20250501::VirtualNetworkGatewayMigrationStatusResponse>,
    /// The reference to the VirtualNetworkGatewayPolicyGroup resource which represents the available VirtualNetworkGatewayPolicyGroup for the gateway.
    pub virtual_network_gateway_policy_groups: Option<Vec<network::v20250501::VirtualNetworkGatewayPolicyGroupResponse>>,
    /// The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<network::v20250501::VpnClientConfigurationResponse>,
...
pub async fn get_virtual_network_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getVirtualNetworkGateway", invoke_args, &opts).await?;
    ...
    Ok(GetVirtualNetworkGatewayResult {
        ...
        enable_high_bandwidth_vpn_gateway: result.fields.get("enableHighBandwidthVpnGateway").cloned().map(serde_json::from_value).transpose()?,
        ...
        provisioning_state: serde_json::from_value(result.fields.get("provisioningState").cloned().unwrap_or_default())?
            ,
        resiliency_model: result.fields.get("resiliencyModel").cloned().map(serde_json::from_value).transpose()?,
        ...
        virtual_network_gateway_migration_status: result.fields.get("virtualNetworkGatewayMigrationStatus").cloned().map(serde_json::from_value).transpose()?,
