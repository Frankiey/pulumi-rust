...
pub struct GetExpressRoutePortResult {
    ...
    pub circuits: Vec<network::v20250501::SubResourceResponse>,
    ...
    pub links: Option<Vec<network::v20250501::ExpressRouteLinkResponse>>,
    /// Resource location.
...
pub async fn get_express_route_port(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getExpressRoutePort", invoke_args, &opts).await?;
    ...
    Ok(GetExpressRoutePortResult {
        ...
        billing_type: result.fields.get("billingType").cloned().map(serde_json::from_value).transpose()?,
