...
pub struct GetPrivateLinkServicePrivateEndpointConnectionResult {
    ...
    pub private_endpoint_location: String,
    /// A collection of information about the state of the connection between service consumer and provider.
    pub private_link_service_connection_state: Option<network::v20250501::PrivateLinkServiceConnectionStateResponse>,
...
pub async fn get_private_link_service_private_endpoint_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getPrivateLinkServicePrivateEndpointConnection", invoke_args, &opts).await?;
    ...
    Ok(GetPrivateLinkServicePrivateEndpointConnectionResult {
        ...
        private_endpoint: serde_json::from_value(result.fields.get("privateEndpoint").cloned().unwrap_or_default())?
            ,
        private_endpoint_location: serde_json::from_value(result.fields.get("privateEndpointLocation").cloned().unwrap_or_default())?
            ,
