...
pub struct GetVirtualNetworkApplianceResult {
    ...
    pub ip_configurations: Vec<network::v20250501::VirtualNetworkApplianceIpConfigurationResponse>,
    /// Resource location.
...
pub async fn get_virtual_network_appliance(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getVirtualNetworkAppliance", invoke_args, &opts).await?;
