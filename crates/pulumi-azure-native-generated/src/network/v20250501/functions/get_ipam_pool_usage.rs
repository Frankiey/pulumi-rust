...
pub struct GetIpamPoolUsageResult {
    ...
    pub child_pools: Vec<network::v20250501::ResourceBasicsResponse>,
...
pub async fn get_ipam_pool_usage(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getIpamPoolUsage", invoke_args, &opts).await?;
