...
pub struct GetConfigurationPolicyGroupResult {
    ...
    pub p2s_connection_configurations: Vec<network::v20250501::SubResourceResponse>,
    /// Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
    pub policy_members: Option<Vec<network::v20250501::VpnServerConfigurationPolicyGroupMemberResponse>>,
...
pub async fn get_configuration_policy_group(
    ...
    let result = ctx.invoke("azure-native:network/v20250501:getConfigurationPolicyGroup", invoke_args, &opts).await?;
