...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20220101::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20220101::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub private_link_service: Option<Input<network::v20220101::PrivateLinkServiceArgs>>,
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220101:NetworkInterface";
