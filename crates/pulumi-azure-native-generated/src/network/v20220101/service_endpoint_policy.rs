...
pub struct ServiceEndpointPolicyArgs {
    ...
    pub contextual_service_endpoint_policies: Option<Vec<Input<String>>>,
    /// Resource ID.
    ...
    pub service_alias: Option<Input<String>>,
    /// A collection of service endpoint policy definitions of the service endpoint policy.
    pub service_endpoint_policy_definitions: Option<Vec<Input<network::v20220101::ServiceEndpointPolicyDefinitionArgs>>>,
...
pub struct ServiceEndpointPolicy {
    ...
    /// A collection of contextual service endpoint policy.
    pub contextual_service_endpoint_policies: Output<serde_json::Value>,
    ...
    /// The alias indicating if the policy belongs to a service
    pub service_alias: Output<serde_json::Value>,
    /// A collection of service endpoint policy definitions of the service endpoint policy.
...
impl ServiceEndpointPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220101:ServiceEndpointPolicy";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.contextual_service_endpoint_policies {
            pulumi_sdk::resolve_input_vec("contextualServiceEndpointPolicies", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        if let Some(v) = args.service_alias {
            pulumi_sdk::resolve_input("serviceAlias", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            azure_api_version: registered.outputs.get("azureApiVersion")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            contextual_service_endpoint_policies: registered.outputs.get("contextualServiceEndpointPolicies")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            resource_guid: registered.outputs.get("resourceGuid")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            service_alias: registered.outputs.get("serviceAlias")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
