...
pub struct GetPrivateDnsZoneGroupResult {
    ...
    pub private_dns_zone_configs: Option<Vec<network::v20220101::PrivateDnsZoneConfigResponse>>,
...
pub async fn get_private_dns_zone_group(
    ...
    let result = ctx.invoke("azure-native:network/v20220101:getPrivateDnsZoneGroup", invoke_args, &opts).await?;
