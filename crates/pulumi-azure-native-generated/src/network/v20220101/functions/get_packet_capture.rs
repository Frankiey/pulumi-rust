...
pub struct GetPacketCaptureResult {
    ...
    pub filters: Option<Vec<network::v20220101::PacketCaptureFilterResponse>>,
    ...
    pub scope: Option<network::v20220101::PacketCaptureMachineScopeResponse>,
    /// The storage location for a packet capture session.
    pub storage_location: network::v20220101::PacketCaptureStorageLocationResponse,
...
pub async fn get_packet_capture(
    ...
    let result = ctx.invoke("azure-native:network/v20220101:getPacketCapture", invoke_args, &opts).await?;
