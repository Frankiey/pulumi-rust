...
pub struct LoadBalancerBackendAddressPoolArgs {
    ...
    pub load_balancer_backend_addresses: Option<Vec<Input<network::v20220101::LoadBalancerBackendAddressArgs>>>,
    ...
    pub tunnel_interfaces: Option<Vec<Input<network::v20220101::GatewayLoadBalancerTunnelInterfaceArgs>>>,
}
...
impl LoadBalancerBackendAddressPool {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220101:LoadBalancerBackendAddressPool";
