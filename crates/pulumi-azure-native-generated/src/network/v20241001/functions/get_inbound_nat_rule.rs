...
pub struct GetInboundNatRuleResult {
    ...
    pub backend_address_pool: Option<network::v20241001::SubResourceResponse>,
    /// A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
    pub backend_ip_configuration: network::v20241001::NetworkInterfaceIPConfigurationResponse,
    ...
    pub frontend_ip_configuration: Option<network::v20241001::SubResourceResponse>,
...
pub async fn get_inbound_nat_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getInboundNatRule", invoke_args, &opts).await?;
