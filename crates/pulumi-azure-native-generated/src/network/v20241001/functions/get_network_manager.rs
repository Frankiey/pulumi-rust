...
pub struct GetNetworkManagerResult {
    ...
    pub network_manager_scopes: network::v20241001::NetworkManagerPropertiesResponseNetworkManagerScopes,
...
pub async fn get_network_manager(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getNetworkManager", invoke_args, &opts).await?;
