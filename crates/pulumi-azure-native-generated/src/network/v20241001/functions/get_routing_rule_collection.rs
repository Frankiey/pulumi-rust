...
pub struct GetRoutingRuleCollectionResult {
    ...
    pub applies_to: Vec<network::v20241001::NetworkManagerRoutingGroupItemResponse>,
...
pub async fn get_routing_rule_collection(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getRoutingRuleCollection", invoke_args, &opts).await?;
