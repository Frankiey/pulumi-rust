...
pub struct GetFirewallPolicyResult {
    ...
    pub base_policy: Option<network::v20241001::SubResourceResponse>,
    /// List of references to Child Firewall Policies.
    pub child_policies: Vec<network::v20241001::SubResourceResponse>,
    /// DNS Proxy Settings definition.
    pub dns_settings: Option<network::v20241001::DnsSettingsResponse>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// Explicit Proxy Settings definition.
    pub explicit_proxy: Option<network::v20241001::ExplicitProxyResponse>,
    /// List of references to Azure Firewalls that this Firewall Policy is associated with.
    pub firewalls: Vec<network::v20241001::SubResourceResponse>,
    /// Resource ID.
    pub id: Option<String>,
    /// The identity of the firewall policy.
    pub identity: Option<network::v20241001::ManagedServiceIdentityResponse>,
    /// Insights on Firewall Policy.
    pub insights: Option<network::v20241001::FirewallPolicyInsightsResponse>,
    /// The configuration for Intrusion detection.
    pub intrusion_detection: Option<network::v20241001::FirewallPolicyIntrusionDetectionResponse>,
    /// Resource location.
    ...
    pub rule_collection_groups: Vec<network::v20241001::SubResourceResponse>,
    /// A read-only string that represents the size of the FirewallPolicyPropertiesFormat in MB. (ex 0.5MB)
    pub size: String,
    /// The Firewall Policy SKU.
    pub sku: Option<network::v20241001::FirewallPolicySkuResponse>,
    /// The private IP addresses/IP ranges to which traffic will not be SNAT.
    pub snat: Option<network::v20241001::FirewallPolicySNATResponse>,
    /// SQL Settings definition.
    pub sql: Option<network::v20241001::FirewallPolicySQLResponse>,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// The operation mode for Threat Intelligence.
    pub threat_intel_mode: Option<String>,
    /// ThreatIntel Whitelist for Firewall Policy.
    pub threat_intel_whitelist: Option<network::v20241001::FirewallPolicyThreatIntelWhitelistResponse>,
    /// TLS Configuration definition.
    pub transport_security: Option<network::v20241001::FirewallPolicyTransportSecurityResponse>,
    /// Resource type.
    pub type_: String,
}
...
pub async fn get_firewall_policy(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getFirewallPolicy", invoke_args, &opts).await?;
