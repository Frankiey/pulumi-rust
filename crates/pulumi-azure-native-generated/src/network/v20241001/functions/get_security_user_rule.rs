...
pub struct GetSecurityUserRuleResult {
    ...
    pub destinations: Option<Vec<network::v20241001::AddressPrefixItemResponse>>,
    ...
    pub sources: Option<Vec<network::v20241001::AddressPrefixItemResponse>>,
...
pub async fn get_security_user_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getSecurityUserRule", invoke_args, &opts).await?;
