...
pub struct GetNetworkInterfaceResult {
    ...
    pub dns_settings: Option<network::v20241001::NetworkInterfaceDnsSettingsResponse>,
    /// A reference to the dscp configuration to which the network interface is linked.
    pub dscp_configuration: network::v20241001::SubResourceResponse,
    ...
    pub ip_configurations: Option<Vec<network::v20241001::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint: network::v20241001::PrivateEndpointResponse,
    /// Privatelinkservice of the network interface resource.
    pub private_link_service: Option<network::v20241001::PrivateLinkServiceResponse>,
    ...
    pub tap_configurations: Vec<network::v20241001::NetworkInterfaceTapConfigurationResponse>,
    /// Resource type.
    pub type_: String,
    /// The reference to a virtual machine.
    pub virtual_machine: network::v20241001::SubResourceResponse,
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getNetworkInterface", invoke_args, &opts).await?;
