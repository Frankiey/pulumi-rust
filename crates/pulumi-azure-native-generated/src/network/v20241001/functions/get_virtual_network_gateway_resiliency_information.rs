...
pub struct GetVirtualNetworkGatewayResiliencyInformationResult {
    ...
    pub components: Option<Vec<network::v20241001::ResiliencyRecommendationComponentsResponse>>,
...
pub async fn get_virtual_network_gateway_resiliency_information(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getVirtualNetworkGatewayResiliencyInformation", invoke_args, &opts).await?;
