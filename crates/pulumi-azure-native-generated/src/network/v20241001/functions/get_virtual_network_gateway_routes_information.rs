...
pub struct GetVirtualNetworkGatewayRoutesInformationResult {
    ...
    pub circuits_metadata_map: Option<HashMap<String, network::v20241001::CircuitMetadataMapResponse>>,
    ...
    pub route_sets: Option<Vec<network::v20241001::GatewayRouteSetResponse>>,
}
...
pub async fn get_virtual_network_gateway_routes_information(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getVirtualNetworkGatewayRoutesInformation", invoke_args, &opts).await?;
