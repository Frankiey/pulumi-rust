...
pub struct ListVpnServerConfigurationRadiusSecretsResult {
    ...
    pub value: Option<Vec<network::v20241001::RadiusAuthServerResponse>>,
}
...
pub async fn list_vpn_server_configuration_radius_secrets(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:listVpnServerConfigurationRadiusSecrets", invoke_args, &opts).await?;
