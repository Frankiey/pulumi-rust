...
pub struct GetStaticCidrResult {
    ...
    pub properties: network::v20241001::StaticCidrPropertiesResponse,
...
pub async fn get_static_cidr(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getStaticCidr", invoke_args, &opts).await?;
