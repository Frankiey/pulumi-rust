...
pub struct GetRoutingRuleResult {
    ...
    pub destination: network::v20241001::RoutingRuleRouteDestinationResponse,
    ...
    pub next_hop: network::v20241001::RoutingRuleNextHopResponse,
...
pub async fn get_routing_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getRoutingRule", invoke_args, &opts).await?;
