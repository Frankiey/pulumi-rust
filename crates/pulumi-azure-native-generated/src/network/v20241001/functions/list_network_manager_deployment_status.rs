...
pub struct ListNetworkManagerDeploymentStatusResult {
    ...
    pub value: Option<Vec<network::v20241001::NetworkManagerDeploymentStatusResponse>>,
}
...
pub async fn list_network_manager_deployment_status(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:listNetworkManagerDeploymentStatus", invoke_args, &opts).await?;
