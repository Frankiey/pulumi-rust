...
pub struct GetNetworkVirtualApplianceConnectionResult {
    ...
    pub properties: network::v20241001::NetworkVirtualApplianceConnectionPropertiesResponse,
}
...
pub async fn get_network_virtual_appliance_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20241001:getNetworkVirtualApplianceConnection", invoke_args, &opts).await?;
