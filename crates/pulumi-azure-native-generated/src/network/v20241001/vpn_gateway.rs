...
pub struct VpnGatewayArgs {
    ...
    pub connections: Option<Vec<Input<network::v20241001::VpnConnectionArgs>>>,
    ...
    pub nat_rules: Option<Vec<Input<network::v20241001::VpnGatewayNatRuleArgs>>>,
...
impl VpnGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20241001:VpnGateway";
