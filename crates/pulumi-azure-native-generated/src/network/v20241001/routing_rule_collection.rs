...
pub struct RoutingRuleCollectionArgs {
    ...
    pub applies_to: Vec<Input<network::v20241001::NetworkManagerRoutingGroupItemArgs>>,
...
impl RoutingRuleCollection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20241001:RoutingRuleCollection";
