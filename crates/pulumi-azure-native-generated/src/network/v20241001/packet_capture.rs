...
pub struct PacketCaptureArgs {
    ...
    pub capture_settings: Option<Input<network::v20241001::PacketCaptureSettingsArgs>>,
    ...
    pub filters: Option<Vec<Input<network::v20241001::PacketCaptureFilterArgs>>>,
    ...
    pub scope: Option<Input<network::v20241001::PacketCaptureMachineScopeArgs>>,
    /// The storage location for a packet capture session.
    pub storage_location: Input<network::v20241001::PacketCaptureStorageLocationArgs>,
    /// The ID of the targeted resource, only AzureVM and AzureVMSS as target type are currently supported.
    pub target: Input<String>,
    /// Target type of the resource provided.
    pub target_type: Option<Input<network::v20241001::PacketCaptureTargetTypeArgs>>,
...
impl PacketCapture {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20241001:PacketCapture";
