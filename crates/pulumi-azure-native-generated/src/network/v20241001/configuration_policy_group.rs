...
pub struct ConfigurationPolicyGroupArgs {
    ...
    pub policy_members: Option<Vec<Input<network::v20241001::VpnServerConfigurationPolicyGroupMemberArgs>>>,
...
impl ConfigurationPolicyGroup {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20241001:ConfigurationPolicyGroup";
