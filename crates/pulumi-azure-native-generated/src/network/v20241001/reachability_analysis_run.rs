...
pub struct ReachabilityAnalysisRunArgs {
    ...
    pub properties: Input<network::v20241001::ReachabilityAnalysisRunPropertiesArgs>,
...
impl ReachabilityAnalysisRun {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20241001:ReachabilityAnalysisRun";
