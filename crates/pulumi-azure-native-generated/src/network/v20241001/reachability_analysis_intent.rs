...
pub struct ReachabilityAnalysisIntentArgs {
    ...
    pub properties: Input<network::v20241001::ReachabilityAnalysisIntentPropertiesArgs>,
...
impl ReachabilityAnalysisIntent {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20241001:ReachabilityAnalysisIntent";
