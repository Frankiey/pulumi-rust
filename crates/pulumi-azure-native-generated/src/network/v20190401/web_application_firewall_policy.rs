...
pub struct WebApplicationFirewallPolicyArgs {
    ...
    pub custom_rules: Option<Vec<Input<network::v20190401::WebApplicationFirewallCustomRuleArgs>>>,
    /// Resource ID.
    ...
    pub policy_settings: Option<Input<network::v20190401::PolicySettingsArgs>>,
...
impl WebApplicationFirewallPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190401:WebApplicationFirewallPolicy";
