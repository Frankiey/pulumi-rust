...
pub struct GetWebApplicationFirewallPolicyResult {
    ...
    pub application_gateways: Vec<network::v20190401::ApplicationGatewayResponse>,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// Describes custom rules inside the policy.
    pub custom_rules: Option<Vec<network::v20190401::WebApplicationFirewallCustomRuleResponse>>,
    ...
    pub policy_settings: Option<network::v20190401::PolicySettingsResponse>,
...
pub async fn get_web_application_firewall_policy(
    ...
    let result = ctx.invoke("azure-native:network/v20190401:getWebApplicationFirewallPolicy", invoke_args, &opts).await?;
