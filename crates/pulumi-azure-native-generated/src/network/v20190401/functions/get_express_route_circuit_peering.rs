...
pub struct GetExpressRouteCircuitPeeringResult {
    ...
    pub connections: Option<Vec<network::v20190401::ExpressRouteCircuitConnectionResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The ExpressRoute connection.
    pub express_route_connection: Option<network::v20190401::ExpressRouteConnectionIdResponse>,
    ...
    pub peered_connections: Vec<network::v20190401::PeerExpressRouteCircuitConnectionResponse>,
    /// The peering type.
    ...
    pub route_filter: Option<network::v20190401::SubResourceResponse>,
    /// The secondary port.
    ...
    /// Gets peering stats.
    pub stats: Option<network::v20190401::ExpressRouteCircuitStatsResponse>,
...
pub async fn get_express_route_circuit_peering(
    ...
    let result = ctx.invoke("azure-native:network/v20190401:getExpressRouteCircuitPeering", invoke_args, &opts).await?;
