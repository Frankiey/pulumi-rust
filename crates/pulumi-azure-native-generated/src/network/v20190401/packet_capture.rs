...
pub struct PacketCaptureArgs {
    ...
    pub filters: Option<Vec<Input<network::v20190401::PacketCaptureFilterArgs>>>,
    ...
    pub storage_location: Input<network::v20190401::PacketCaptureStorageLocationArgs>,
...
impl PacketCapture {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190401:PacketCapture";
