...
pub struct GetExpressRouteCircuitConnectionResult {
    ...
    pub express_route_circuit_peering: Option<network::v20220901::SubResourceResponse>,
    /// Resource ID.
    pub id: Option<String>,
    /// IPv6 Address PrefixProperties of the express route circuit connection.
    pub ipv6circuit_connection_config: Option<network::v20220901::Ipv6CircuitConnectionConfigResponse>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<String>,
    /// Reference to Express Route Circuit Private Peering Resource of the peered circuit.
    pub peer_express_route_circuit_peering: Option<network::v20220901::SubResourceResponse>,
...
pub async fn get_express_route_circuit_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20220901:getExpressRouteCircuitConnection", invoke_args, &opts).await?;
