...
pub struct GetAzureFirewallResult {
    ...
    pub application_rule_collections: Option<Vec<network::v20220901::AzureFirewallApplicationRuleCollectionResponse>>,
    ...
    pub hub_ip_addresses: Option<network::v20220901::HubIPAddressesResponse>,
    /// Resource ID.
    pub id: Option<String>,
    /// IP configuration of the Azure Firewall resource.
    pub ip_configurations: Option<Vec<network::v20220901::AzureFirewallIPConfigurationResponse>>,
    /// IpGroups associated with AzureFirewall.
    pub ip_groups: Vec<network::v20220901::AzureFirewallIpGroupsResponse>,
    /// Resource location.
    pub location: Option<String>,
    /// IP configuration of the Azure Firewall used for management traffic.
    pub management_ip_configuration: Option<network::v20220901::AzureFirewallIPConfigurationResponse>,
    /// Resource name.
    pub name: String,
    /// Collection of NAT rule collections used by Azure Firewall.
    pub nat_rule_collections: Option<Vec<network::v20220901::AzureFirewallNatRuleCollectionResponse>>,
    /// Collection of network rule collections used by Azure Firewall.
    pub network_rule_collections: Option<Vec<network::v20220901::AzureFirewallNetworkRuleCollectionResponse>>,
    /// The provisioning state of the Azure firewall resource.
    pub provisioning_state: String,
    /// The Azure Firewall Resource SKU.
    pub sku: Option<network::v20220901::AzureFirewallSkuResponse>,
    /// Resource tags.
    ...
    pub virtual_hub: Option<network::v20220901::SubResourceResponse>,
...
pub async fn get_azure_firewall(
    ...
    let result = ctx.invoke("azure-native:network/v20220901:getAzureFirewall", invoke_args, &opts).await?;
