...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20220901::BgpSettingsResponse>,
    /// The device properties.
    pub device_properties: Option<network::v20220901::DevicePropertiesResponse>,
    ...
    pub name: String,
    /// Office365 Policy.
    pub o365policy: Option<network::v20220901::O365PolicyPropertiesResponse>,
    ...
    pub vpn_site_links: Option<Vec<network::v20220901::VpnSiteLinkResponse>>,
}
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20220901:getVpnSite", invoke_args, &opts).await?;
