...
pub struct PrivateLinkServicePrivateEndpointConnectionArgs {
    ...
    pub private_link_service_connection_state: Option<Input<network::v20220901::PrivateLinkServiceConnectionStateArgs>>,
...
impl PrivateLinkServicePrivateEndpointConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220901:PrivateLinkServicePrivateEndpointConnection";
