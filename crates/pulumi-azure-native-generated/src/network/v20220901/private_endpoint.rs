...
pub struct PrivateEndpointArgs {
    ...
    pub application_security_groups: Option<Vec<Input<network::v20220901::ApplicationSecurityGroupArgs>>>,
    /// An array of custom dns configurations.
    pub custom_dns_configs: Option<Vec<Input<network::v20220901::CustomDnsConfigPropertiesFormatArgs>>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20220901::PrivateEndpointIPConfigurationArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// A grouping of information about the connection to the remote resource. Used when the network admin does not have access to approve connections to the remote resource.
    pub manual_private_link_service_connections: Option<Vec<Input<network::v20220901::PrivateLinkServiceConnectionArgs>>>,
    /// The name of the private endpoint.
    pub private_endpoint_name: Option<Input<String>>,
    /// A grouping of information about the connection to the remote resource.
    pub private_link_service_connections: Option<Vec<Input<network::v20220901::PrivateLinkServiceConnectionArgs>>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The ID of the subnet from which the private IP will be allocated.
    pub subnet: Option<Input<network::v20220901::SubnetArgs>>,
    /// Resource tags.
...
impl PrivateEndpoint {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220901:PrivateEndpoint";
