...
pub struct NetworkVirtualApplianceArgs {
    ...
    pub delegation: Option<Input<network::v20220901::DelegationPropertiesArgs>>,
    /// Resource ID.
    ...
    pub nva_sku: Option<Input<network::v20220901::VirtualApplianceSkuPropertiesArgs>>,
...
impl NetworkVirtualAppliance {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220901:NetworkVirtualAppliance";
