...
pub struct GetNspAccessRuleResult {
    ...
    pub network_security_perimeters: Vec<network::v20230801preview::PerimeterBasedAccessRuleResponse>,
    ...
    pub subscriptions: Option<Vec<network::v20230801preview::SubscriptionIdResponse>>,
    /// Resource tags.
...
pub async fn get_nsp_access_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20230801preview:getNspAccessRule", invoke_args, &opts).await?;
