...
pub struct GetNspAssociationResult {
    ...
    pub private_link_resource: Option<network::v20230801preview::SubResourceResponse>,
    /// Profile id to which the PaaS resource is associated.
    pub profile: Option<network::v20230801preview::SubResourceResponse>,
...
pub async fn get_nsp_association(
    ...
    let result = ctx.invoke("azure-native:network/v20230801preview:getNspAssociation", invoke_args, &opts).await?;
