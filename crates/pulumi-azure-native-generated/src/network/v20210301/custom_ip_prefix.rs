...
pub struct CustomIPPrefixArgs {
    ...
    pub custom_ip_prefix_parent: Option<Input<network::v20210301::CustomIpPrefixArgs>>,
...
impl CustomIPPrefix {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210301:CustomIPPrefix";
