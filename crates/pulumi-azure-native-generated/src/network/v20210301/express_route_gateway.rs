...
pub struct ExpressRouteGatewayArgs {
    ...
    pub auto_scale_configuration: Option<Input<network::v20210301::ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>>,
    ...
    pub virtual_hub: Input<network::v20210301::VirtualHubIdArgs>,
}
...
impl ExpressRouteGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210301:ExpressRouteGateway";
