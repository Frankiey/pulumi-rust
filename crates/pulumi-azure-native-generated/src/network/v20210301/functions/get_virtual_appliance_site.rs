...
pub struct GetVirtualApplianceSiteResult {
    ...
    /// Office 365 Policy.
    pub o365policy: Option<network::v20210301::Office365PolicyPropertiesResponse>,
...
pub async fn get_virtual_appliance_site(
    ...
    let result = ctx.invoke("azure-native:network/v20210301:getVirtualApplianceSite", invoke_args, &opts).await?;
