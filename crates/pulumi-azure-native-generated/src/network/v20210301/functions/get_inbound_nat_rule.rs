...
pub struct GetInboundNatRuleResult {
    ...
    pub backend_address_pool: Option<network::v20210301::SubResourceResponse>,
    /// A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
    pub backend_ip_configuration: network::v20210301::NetworkInterfaceIPConfigurationResponse,
    ...
    pub frontend_ip_configuration: Option<network::v20210301::SubResourceResponse>,
...
pub async fn get_inbound_nat_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20210301:getInboundNatRule", invoke_args, &opts).await?;
