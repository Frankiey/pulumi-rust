...
pub struct PublicIPPrefixArgs {
    ...
    pub custom_ip_prefix: Option<Input<network::v20210301::SubResourceArgs>>,
    ...
    pub sku: Option<Input<network::v20210301::PublicIPPrefixSkuArgs>>,
    /// Resource tags.
...
impl PublicIPPrefix {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210301:PublicIPPrefix";
