...
pub struct ConnectionMonitorArgs {
    ...
    pub destination: Option<Input<network::v20210301::ConnectionMonitorDestinationArgs>>,
    /// List of connection monitor endpoints.
    pub endpoints: Option<Vec<Input<network::v20210301::ConnectionMonitorEndpointArgs>>>,
    ...
    pub outputs: Option<Vec<Input<network::v20210301::ConnectionMonitorOutputArgs>>>,
    /// The name of the resource group containing Network Watcher.
    pub resource_group_name: Input<String>,
    /// Describes the source of connection monitor.
    pub source: Option<Input<network::v20210301::ConnectionMonitorSourceArgs>>,
    /// Connection monitor tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// List of connection monitor test configurations.
    pub test_configurations: Option<Vec<Input<network::v20210301::ConnectionMonitorTestConfigurationArgs>>>,
    /// List of connection monitor test groups.
    pub test_groups: Option<Vec<Input<network::v20210301::ConnectionMonitorTestGroupArgs>>>,
}
...
impl ConnectionMonitor {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210301:ConnectionMonitor";
