...
pub struct ExpressRouteCircuitConnectionArgs {
    ...
    pub express_route_circuit_peering: Option<Input<network::v20190201::SubResourceArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<Input<String>>,
    /// Reference to Express Route Circuit Private Peering Resource of the peered circuit.
    pub peer_express_route_circuit_peering: Option<Input<network::v20190201::SubResourceArgs>>,
...
impl ExpressRouteCircuitConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190201:ExpressRouteCircuitConnection";
