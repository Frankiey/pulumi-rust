...
pub struct P2sVpnGatewayArgs {
    ...
    pub p2s_vpn_server_configuration: Option<Input<network::v20190201::SubResourceArgs>>,
    /// The resource group name of the P2SVpnGateway.
    pub resource_group_name: Input<String>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The VirtualHub to which the gateway belongs
    pub virtual_hub: Option<Input<network::v20190201::SubResourceArgs>>,
    /// The reference of the address space resource which represents Address space for P2S VpnClient.
    pub vpn_client_address_pool: Option<Input<network::v20190201::AddressSpaceArgs>>,
...
impl P2sVpnGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190201:P2sVpnGateway";
