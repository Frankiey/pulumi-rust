...
pub struct GetNetworkInterfaceTapConfigurationResult {
    ...
    pub virtual_network_tap: Option<network::v20190201::VirtualNetworkTapResponse>,
}
...
pub async fn get_network_interface_tap_configuration(
    ...
    let result = ctx.invoke("azure-native:network/v20190201:getNetworkInterfaceTapConfiguration", invoke_args, &opts).await?;
