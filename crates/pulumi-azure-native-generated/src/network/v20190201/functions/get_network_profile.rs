...
pub struct GetNetworkProfileResult {
    ...
    pub container_network_interface_configurations: Option<Vec<network::v20190201::ContainerNetworkInterfaceConfigurationResponse>>,
    /// List of child container network interfaces.
    pub container_network_interfaces: Option<Vec<network::v20190201::ContainerNetworkInterfaceResponse>>,
...
pub async fn get_network_profile(
    ...
    let result = ctx.invoke("azure-native:network/v20190201:getNetworkProfile", invoke_args, &opts).await?;
