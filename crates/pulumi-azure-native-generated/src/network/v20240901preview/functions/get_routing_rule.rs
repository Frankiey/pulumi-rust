...
pub struct GetRoutingRuleResult {
    ...
    pub destination: network::v20240901preview::RoutingRuleRouteDestinationResponse,
    ...
    pub next_hop: network::v20240901preview::RoutingRuleNextHopResponse,
...
pub async fn get_routing_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20240901preview:getRoutingRule", invoke_args, &opts).await?;
