...
pub struct GetRoutingRuleCollectionResult {
    ...
    pub applies_to: Vec<network::v20240901preview::NetworkManagerRoutingGroupItemResponse>,
    ...
    pub disable_bgp_route_propagation: Option<String>,
    ...
    pub peering_route_propagation_rules: Option<Vec<network::v20240901preview::PeeringRoutePropagationRuleResponse>>,
    /// The provisioning state of the resource.
    pub provisioning_state: String,
    /// Unique identifier for this resource.
    pub resource_guid: String,
    /// The system metadata related to this resource.
    pub system_data: network::v20240901preview::SystemDataResponse,
    /// Resource type.
    pub type_: String,
}
...
pub async fn get_routing_rule_collection(
    ...
    let result = ctx.invoke("azure-native:network/v20240901preview:getRoutingRuleCollection", invoke_args, &opts).await?;
    ...
    Ok(GetRoutingRuleCollectionResult {
        ...
        name: serde_json::from_value(result.fields.get("name").cloned().unwrap_or_default())?
            ,
        peering_route_propagation_rules: result.fields.get("peeringRoutePropagationRules").cloned().map(serde_json::from_value).transpose()?,
