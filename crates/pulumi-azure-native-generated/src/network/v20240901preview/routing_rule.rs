...
pub struct RoutingRuleArgs {
    ...
    pub destination: Input<network::v20240901preview::RoutingRuleRouteDestinationArgs>,
    /// The name of the network manager.
    pub network_manager_name: Input<String>,
    /// Indicates the next hop for this particular rule.
    pub next_hop: Input<network::v20240901preview::RoutingRuleNextHopArgs>,
...
impl RoutingRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240901preview:RoutingRule";
