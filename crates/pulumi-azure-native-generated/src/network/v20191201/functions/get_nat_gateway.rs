...
pub struct GetNatGatewayResult {
    ...
    pub public_ip_addresses: Option<Vec<network::v20191201::SubResourceResponse>>,
    /// An array of public ip prefixes associated with the nat gateway resource.
    pub public_ip_prefixes: Option<Vec<network::v20191201::SubResourceResponse>>,
    /// The resource GUID property of the NAT gateway resource.
    pub resource_guid: String,
    /// The nat gateway SKU.
    pub sku: Option<network::v20191201::NatGatewaySkuResponse>,
    /// An array of references to the subnets using this nat gateway resource.
    pub subnets: Vec<network::v20191201::SubResourceResponse>,
    /// Resource tags.
...
pub async fn get_nat_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20191201:getNatGateway", invoke_args, &opts).await?;
