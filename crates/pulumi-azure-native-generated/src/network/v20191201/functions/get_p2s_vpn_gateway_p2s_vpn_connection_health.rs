...
pub struct GetP2sVpnGatewayP2sVpnConnectionHealthResult {
    ...
    pub p2s_connection_configurations: Option<Vec<network::v20191201::P2SConnectionConfigurationResponse>>,
    ...
    pub vpn_client_connection_health: network::v20191201::VpnClientConnectionHealthResponse,
    /// The scale unit for this p2s vpn gateway.
    pub vpn_gateway_scale_unit: Option<i64>,
    /// The VpnServerConfiguration to which the p2sVpnGateway is attached to.
    pub vpn_server_configuration: Option<network::v20191201::SubResourceResponse>,
}
...
pub async fn get_p2s_vpn_gateway_p2s_vpn_connection_health(
    ...
    let result = ctx.invoke("azure-native:network/v20191201:getP2sVpnGatewayP2sVpnConnectionHealth", invoke_args, &opts).await?;
