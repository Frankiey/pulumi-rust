...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20191201::BgpSettingsResponse>,
    /// The device properties.
    pub device_properties: Option<network::v20191201::DevicePropertiesResponse>,
    ...
    pub vpn_site_links: Option<Vec<network::v20191201::VpnSiteLinkResponse>>,
}
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20191201:getVpnSite", invoke_args, &opts).await?;
