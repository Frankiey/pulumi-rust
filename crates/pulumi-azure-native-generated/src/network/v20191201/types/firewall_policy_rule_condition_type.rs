...
impl FirewallPolicyRuleConditionType {
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::NatRuleCondition => "NatRuleCondition",
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for FirewallPolicyRuleConditionType {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> std::result::Result<Self, D::Error> {
        ...
        match s.as_str() {
            ...
            "NatRuleCondition" => Ok(Self::NatRuleCondition),
            _ => Err(serde::de::Error::unknown_variant(&s, &["ApplicationRuleCondition", "NetworkRuleCondition", "NatRuleCondition"])),
        }
    }
}
