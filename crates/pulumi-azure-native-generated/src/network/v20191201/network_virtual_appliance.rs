...
pub struct NetworkVirtualApplianceArgs {
    ...
    pub sku: Option<Input<network::v20191201::VirtualApplianceSkuPropertiesArgs>>,
    /// Resource tags.
...
impl NetworkVirtualAppliance {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20191201:NetworkVirtualAppliance";
