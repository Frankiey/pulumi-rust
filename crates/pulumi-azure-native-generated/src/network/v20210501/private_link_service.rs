...
pub struct PrivateLinkServiceArgs {
    ...
    pub auto_approval: Option<Input<network::v20210501::PrivateLinkServicePropertiesAutoApprovalArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20210501::PrivateLinkServiceIpConfigurationArgs>>>,
    /// An array of references to the load balancer IP configurations.
    pub load_balancer_frontend_ip_configurations: Option<Vec<Input<network::v20210501::FrontendIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub visibility: Option<Input<network::v20210501::PrivateLinkServicePropertiesVisibilityArgs>>,
}
...
impl PrivateLinkService {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210501:PrivateLinkService";
