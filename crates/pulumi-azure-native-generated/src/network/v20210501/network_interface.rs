...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20210501::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20210501::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub private_link_service: Option<Input<network::v20210501::PrivateLinkServiceArgs>>,
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210501:NetworkInterface";
