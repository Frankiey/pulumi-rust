...
pub struct VirtualHubBgpConnectionArgs {
    ...
    pub hub_virtual_network_connection: Option<Input<network::v20210501::SubResourceArgs>>,
    /// Resource ID.
...
impl VirtualHubBgpConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210501:VirtualHubBgpConnection";
