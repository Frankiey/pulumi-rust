...
pub struct GetPublicIPAddressResult {
    ...
    pub ddos_settings: Option<network::v20210501::DdosSettingsResponse>,
    /// Specify what happens to the public IP address when the VM using it is deleted
    pub delete_option: Option<String>,
    /// The FQDN of the DNS record associated with the public IP address.
    pub dns_settings: Option<network::v20210501::PublicIPAddressDnsSettingsResponse>,
    ...
    pub ip_configuration: network::v20210501::IPConfigurationResponse,
    /// The list of tags associated with the public IP address.
    pub ip_tags: Option<Vec<network::v20210501::IpTagResponse>>,
    /// The linked public IP address of the public IP address resource.
    pub linked_public_ip_address: Option<network::v20210501::PublicIPAddressResponse>,
    /// Resource location.
    ...
    pub nat_gateway: Option<network::v20210501::NatGatewayResponse>,
    ...
    pub public_ip_prefix: Option<network::v20210501::SubResourceResponse>,
    /// The resource GUID property of the public IP address resource.
    pub resource_guid: String,
    /// The service public IP address of the public IP address resource.
    pub service_public_ip_address: Option<network::v20210501::PublicIPAddressResponse>,
    /// The public IP address SKU.
    pub sku: Option<network::v20210501::PublicIPAddressSkuResponse>,
    /// Resource tags.
...
pub async fn get_public_ip_address(
    ...
    let result = ctx.invoke("azure-native:network/v20210501:getPublicIPAddress", invoke_args, &opts).await?;
