...
pub struct GetNetworkVirtualApplianceResult {
    ...
    pub inbound_security_rules: Vec<network::v20210501::SubResourceResponse>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// Network Virtual Appliance SKU.
    pub nva_sku: Option<network::v20210501::VirtualApplianceSkuPropertiesResponse>,
    ...
    pub virtual_appliance_nics: Vec<network::v20210501::VirtualApplianceNicPropertiesResponse>,
    /// List of references to VirtualApplianceSite.
    pub virtual_appliance_sites: Vec<network::v20210501::SubResourceResponse>,
...
pub async fn get_network_virtual_appliance(
    ...
    let result = ctx.invoke("azure-native:network/v20210501:getNetworkVirtualAppliance", invoke_args, &opts).await?;
