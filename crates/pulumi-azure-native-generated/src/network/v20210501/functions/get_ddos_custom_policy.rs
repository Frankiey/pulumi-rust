...
pub struct GetDdosCustomPolicyResult {
    ...
    pub protocol_custom_settings: Option<Vec<network::v20210501::ProtocolCustomSettingsFormatResponse>>,
    /// The provisioning state of the DDoS custom policy resource.
    pub provisioning_state: String,
    /// The list of public IPs associated with the DDoS custom policy resource. This list is read-only.
    pub public_ip_addresses: Vec<network::v20210501::SubResourceResponse>,
...
pub async fn get_ddos_custom_policy(
    ...
    let result = ctx.invoke("azure-native:network/v20210501:getDdosCustomPolicy", invoke_args, &opts).await?;
