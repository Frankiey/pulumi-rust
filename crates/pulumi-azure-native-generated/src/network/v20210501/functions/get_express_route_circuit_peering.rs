...
pub struct GetExpressRouteCircuitPeeringResult {
    ...
    pub connections: Option<Vec<network::v20210501::ExpressRouteCircuitConnectionResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The ExpressRoute connection.
    pub express_route_connection: Option<network::v20210501::ExpressRouteConnectionIdResponse>,
    /// The GatewayManager Etag.
    pub gateway_manager_etag: Option<String>,
    /// Resource ID.
    pub id: Option<String>,
    /// The IPv6 peering configuration.
    pub ipv6peering_config: Option<network::v20210501::Ipv6ExpressRouteCircuitPeeringConfigResponse>,
    /// Who was the last to modify the peering.
    pub last_modified_by: String,
    /// The Microsoft peering configuration.
    pub microsoft_peering_config: Option<network::v20210501::ExpressRouteCircuitPeeringConfigResponse>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<String>,
    /// The peer ASN.
    pub peer_asn: Option<f64>,
    /// The list of peered circuit connections associated with Azure Private Peering for this circuit.
    pub peered_connections: Vec<network::v20210501::PeerExpressRouteCircuitConnectionResponse>,
    /// The peering type.
    ...
    pub route_filter: Option<network::v20210501::SubResourceResponse>,
    /// The secondary port.
    ...
    pub stats: Option<network::v20210501::ExpressRouteCircuitStatsResponse>,
...
pub async fn get_express_route_circuit_peering(
    ...
    let result = ctx.invoke("azure-native:network/v20210501:getExpressRouteCircuitPeering", invoke_args, &opts).await?;
