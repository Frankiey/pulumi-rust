...
pub struct GetPrivateLinkServiceResult {
    ...
    pub auto_approval: Option<network::v20210501::PrivateLinkServicePropertiesResponseAutoApproval>,
    ...
    pub ip_configurations: Option<Vec<network::v20210501::PrivateLinkServiceIpConfigurationResponse>>,
    /// An array of references to the load balancer IP configurations.
    pub load_balancer_frontend_ip_configurations: Option<Vec<network::v20210501::FrontendIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint_connections: Vec<network::v20210501::PrivateEndpointConnectionResponse>,
    ...
    pub visibility: Option<network::v20210501::PrivateLinkServicePropertiesResponseVisibility>,
}
...
pub async fn get_private_link_service(
    ...
    let result = ctx.invoke("azure-native:network/v20210501:getPrivateLinkService", invoke_args, &opts).await?;
