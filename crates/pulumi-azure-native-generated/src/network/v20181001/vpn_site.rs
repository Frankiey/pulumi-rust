...
pub struct VpnSiteArgs {
    ...
    pub bgp_properties: Option<Input<network::v20181001::BgpSettingsArgs>>,
    /// The device properties
    pub device_properties: Option<Input<network::v20181001::DevicePropertiesArgs>>,
    /// Resource ID.
...
impl VpnSite {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181001:VpnSite";
