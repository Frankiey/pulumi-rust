...
pub struct PublicIPPrefixArgs {
    ...
    pub public_ip_addresses: Option<Vec<Input<network::v20181001::ReferencedPublicIpAddressArgs>>>,
    ...
    pub sku: Option<Input<network::v20181001::PublicIPPrefixSkuArgs>>,
    /// Resource tags.
...
impl PublicIPPrefix {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181001:PublicIPPrefix";
