...
pub struct GetPacketCaptureResult {
    ...
    pub filters: Option<Vec<network::v20181001::PacketCaptureFilterResponse>>,
    ...
    pub storage_location: network::v20181001::PacketCaptureStorageLocationResponse,
...
pub async fn get_packet_capture(
    ...
    let result = ctx.invoke("azure-native:network/v20181001:getPacketCapture", invoke_args, &opts).await?;
