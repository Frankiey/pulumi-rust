...
pub struct GetConnectionMonitorResult {
    ...
    pub destination: network::v20181001::ConnectionMonitorDestinationResponse,
    ...
    pub source: network::v20181001::ConnectionMonitorSourceResponse,
...
pub async fn get_connection_monitor(
    ...
    let result = ctx.invoke("azure-native:network/v20181001:getConnectionMonitor", invoke_args, &opts).await?;
