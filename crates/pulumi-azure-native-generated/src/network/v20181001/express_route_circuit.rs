...
pub struct ExpressRouteCircuitArgs {
    ...
    pub allow_global_reach: Option<Input<bool>>,
    /// The list of authorizations.
    pub authorizations: Option<Vec<Input<network::v20181001::ExpressRouteCircuitAuthorizationArgs>>>,
    ...
    pub express_route_port: Option<Input<network::v20181001::SubResourceArgs>>,
    ...
    pub peerings: Option<Vec<Input<network::v20181001::ExpressRouteCircuitPeeringArgs>>>,
    ...
    pub service_provider_properties: Option<Input<network::v20181001::ExpressRouteCircuitServiceProviderPropertiesArgs>>,
    /// The ServiceProviderProvisioningState state of the resource. Possible values are 'NotProvisioned', 'Provisioning', 'Provisioned', and 'Deprovisioning'.
    pub service_provider_provisioning_state: Option<Input<serde_json::Value>>,
    /// The SKU.
    pub sku: Option<Input<network::v20181001::ExpressRouteCircuitSkuArgs>>,
    /// Resource tags.
...
pub struct ExpressRouteCircuit {
    ...
    /// Flag to enable Global Reach on the circuit.
    pub allow_global_reach: Output<serde_json::Value>,
    /// The list of authorizations.
...
impl ExpressRouteCircuit {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181001:ExpressRouteCircuit";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.allow_global_reach {
            pulumi_sdk::resolve_input("allowGlobalReach", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            allow_classic_operations: registered.outputs.get("allowClassicOperations")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            allow_global_reach: registered.outputs.get("allowGlobalReach")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
