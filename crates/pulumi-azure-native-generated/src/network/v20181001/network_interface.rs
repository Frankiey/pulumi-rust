...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20181001::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20181001::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub network_security_group: Option<Input<network::v20181001::NetworkSecurityGroupArgs>>,
    ...
    pub tap_configurations: Option<Vec<Input<network::v20181001::NetworkInterfaceTapConfigurationArgs>>>,
}
...
pub struct NetworkInterface {
    ...
    pub interface_endpoint: Output<serde_json::Value>,
    /// A list of IPConfigurations of the network interface.
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181001:NetworkInterface";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.tap_configurations {
            pulumi_sdk::resolve_input_vec("tapConfigurations", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            hosted_workloads: registered.outputs.get("hostedWorkloads")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            interface_endpoint: registered.outputs.get("interfaceEndpoint")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
