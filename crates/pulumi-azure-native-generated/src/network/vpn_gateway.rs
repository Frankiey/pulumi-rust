...
pub struct VpnGatewayArgs {
    ...
    pub connections: Option<Vec<Input<network::VpnConnectionArgs>>>,
    ...
    pub nat_rules: Option<Vec<Input<network::VpnGatewayNatRuleArgs>>>,
...
impl VpnGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network:VpnGateway";
