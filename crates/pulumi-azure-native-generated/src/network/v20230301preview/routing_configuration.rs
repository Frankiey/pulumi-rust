...
pub struct RoutingConfigurationArgs {
...
impl RoutingConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230301preview:RoutingConfiguration";

    /// Create a new RoutingConfiguration resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
        args: RoutingConfigurationArgs,
