...
pub struct GetRoutingRuleResult {
    ...
    pub destination: network::v20230301preview::RoutingRuleRouteDestinationResponse,
    ...
    pub next_hop: network::v20230301preview::RoutingRuleNextHopResponse,
...
pub async fn get_routing_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20230301preview:getRoutingRule", invoke_args, &opts).await?;
