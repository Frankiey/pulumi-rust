...
#[derive(Default)]
pub struct GetRoutingConfigurationArgs {
...
pub struct GetRoutingConfigurationResult {
...
pub async fn get_routing_configuration(
    ctx: &Context,
    args: GetRoutingConfigurationArgs,
    opts: Option<InvokeOptions>,
) -> Result<GetRoutingConfigurationResult> {
    ...
    let result = ctx.invoke("azure-native:network/v20230301preview:getRoutingConfiguration", invoke_args, &opts).await?;

    Ok(GetRoutingConfigurationResult {
