...
pub struct VirtualApplianceSiteArgs {
    ...
    /// Office 365 Policy.
    pub o365policy: Option<Input<network::v20210801::Office365PolicyPropertiesArgs>>,
...
impl VirtualApplianceSite {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210801:VirtualApplianceSite";
