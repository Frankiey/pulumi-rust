...
pub struct VpnGatewayArgs {
    ...
    pub connections: Option<Vec<Input<network::v20210801::VpnConnectionArgs>>>,
    ...
    pub nat_rules: Option<Vec<Input<network::v20210801::VpnGatewayNatRuleArgs>>>,
...
impl VpnGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210801:VpnGateway";
