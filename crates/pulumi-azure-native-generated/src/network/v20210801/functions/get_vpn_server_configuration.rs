...
pub struct GetVpnServerConfigurationResult {
    ...
    pub properties: network::v20210801::VpnServerConfigurationPropertiesResponse,
    /// Resource tags.
...
pub async fn get_vpn_server_configuration(
    ...
    let result = ctx.invoke("azure-native:network/v20210801:getVpnServerConfiguration", invoke_args, &opts).await?;
