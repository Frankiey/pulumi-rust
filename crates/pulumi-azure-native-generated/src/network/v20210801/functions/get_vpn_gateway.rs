...
pub struct GetVpnGatewayResult {
    ...
    pub connections: Option<Vec<network::v20210801::VpnConnectionResponse>>,
    ...
    pub ip_configurations: Vec<network::v20210801::VpnGatewayIpConfigurationResponse>,
    ...
    pub nat_rules: Option<Vec<network::v20210801::VpnGatewayNatRuleResponse>>,
...
pub async fn get_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20210801:getVpnGateway", invoke_args, &opts).await?;
