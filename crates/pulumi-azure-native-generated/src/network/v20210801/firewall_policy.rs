...
pub struct FirewallPolicyArgs {
    ...
    pub base_policy: Option<Input<network::v20210801::SubResourceArgs>>,
    /// DNS Proxy Settings definition.
    pub dns_settings: Option<Input<network::v20210801::DnsSettingsArgs>>,
    /// Explicit Proxy Settings definition.
    pub explicit_proxy_settings: Option<Input<network::v20210801::ExplicitProxySettingsArgs>>,
    ...
    pub insights: Option<Input<network::v20210801::FirewallPolicyInsightsArgs>>,
    /// The configuration for Intrusion detection.
    pub intrusion_detection: Option<Input<network::v20210801::FirewallPolicyIntrusionDetectionArgs>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The Firewall Policy SKU.
    pub sku: Option<Input<network::v20210801::FirewallPolicySkuArgs>>,
    /// The private IP addresses/IP ranges to which traffic will not be SNAT.
    pub snat: Option<Input<network::v20210801::FirewallPolicySNATArgs>>,
    /// SQL Settings definition.
    pub sql: Option<Input<network::v20210801::FirewallPolicySQLArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The operation mode for Threat Intelligence.
    pub threat_intel_mode: Option<Input<serde_json::Value>>,
    /// ThreatIntel Whitelist for Firewall Policy.
    pub threat_intel_whitelist: Option<Input<network::v20210801::FirewallPolicyThreatIntelWhitelistArgs>>,
    /// TLS Configuration definition.
    pub transport_security: Option<Input<network::v20210801::FirewallPolicyTransportSecurityArgs>>,
}
...
pub struct FirewallPolicy {
    ...
    /// Explicit Proxy Settings definition.
    pub explicit_proxy_settings: Output<serde_json::Value>,
...
impl FirewallPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210801:FirewallPolicy";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.explicit_proxy_settings {
            pulumi_sdk::resolve_input("explicitProxySettings", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            etag: registered.outputs.get("etag")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            explicit_proxy_settings: registered.outputs.get("explicitProxySettings")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
