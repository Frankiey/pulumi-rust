...
pub struct ConfigurationPolicyGroupArgs {
    ...
    pub policy_members: Option<Vec<Input<network::v20210801::VpnServerConfigurationPolicyGroupMemberArgs>>>,
...
impl ConfigurationPolicyGroup {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210801:ConfigurationPolicyGroup";
