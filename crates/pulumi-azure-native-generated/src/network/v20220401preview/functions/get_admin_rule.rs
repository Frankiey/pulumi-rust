...
pub struct GetAdminRuleResult {
    ...
    pub destinations: Option<Vec<network::v20220401preview::AddressPrefixItemResponse>>,
    ...
    pub sources: Option<Vec<network::v20220401preview::AddressPrefixItemResponse>>,
...
pub async fn get_admin_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20220401preview:getAdminRule", invoke_args, &opts).await?;
