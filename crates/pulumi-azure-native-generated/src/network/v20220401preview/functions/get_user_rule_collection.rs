...
pub struct GetUserRuleCollectionResult {
    ...
    pub applies_to_groups: Vec<network::v20220401preview::NetworkManagerSecurityGroupItemResponse>,
    ...
    pub system_data: network::v20220401preview::SystemDataResponse,
    /// Resource type.
    pub type_: String,
}
...
pub async fn get_user_rule_collection(
    ...
    let result = ctx.invoke("azure-native:network/v20220401preview:getUserRuleCollection", invoke_args, &opts).await?;
