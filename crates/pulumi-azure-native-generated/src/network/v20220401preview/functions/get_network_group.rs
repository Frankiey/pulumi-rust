...
pub async fn get_network_group(
    ...
    let result = ctx.invoke("azure-native:network/v20220401preview:getNetworkGroup", invoke_args, &opts).await?;
    ...
    Ok(GetNetworkGroupResult {
        ...
        id: serde_json::from_value(result.fields.get("id").cloned().unwrap_or_default())?
            ,
        member_type: serde_json::from_value(result.fields.get("memberType").cloned().unwrap_or_default())?
            ,
