...
pub struct GetNetworkManagerResult {
    ...
    pub name: String,
    /// Scope Access.
    pub network_manager_scope_accesses: Vec<String>,
    /// Scope of Network Manager.
    pub network_manager_scopes: network::v20220401preview::NetworkManagerPropertiesResponseNetworkManagerScopes,
...
pub async fn get_network_manager(
    ...
    let result = ctx.invoke("azure-native:network/v20220401preview:getNetworkManager", invoke_args, &opts).await?;
    ...
    Ok(GetNetworkManagerResult {
        ...
        name: serde_json::from_value(result.fields.get("name").cloned().unwrap_or_default())?
            ,
        network_manager_scope_accesses: serde_json::from_value(result.fields.get("networkManagerScopeAccesses").cloned().unwrap_or_default())?
            ,
