...
pub struct ListListEffectiveVirtualNetworkByNetworkGroupResult {
    ...
    pub value: Option<Vec<network::v20220401preview::EffectiveVirtualNetworkResponse>>,
}
...
pub async fn list_list_effective_virtual_network_by_network_group(
    ...
    let result = ctx.invoke("azure-native:network/v20220401preview:listListEffectiveVirtualNetworkByNetworkGroup", invoke_args, &opts).await?;
