...
impl NetworkGroup {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220401preview:NetworkGroup";
    ...
    pub async fn new(
        ...
        pulumi_sdk::resolve_input("memberType", args.member_type, &mut inputs, &mut deps, &mut prop_deps).await;
