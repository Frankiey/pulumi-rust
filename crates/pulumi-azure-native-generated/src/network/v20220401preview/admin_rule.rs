...
pub struct AdminRuleArgs {
    ...
    pub destinations: Option<Vec<Input<network::v20220401preview::AddressPrefixItemArgs>>>,
    ...
    pub sources: Option<Vec<Input<network::v20220401preview::AddressPrefixItemArgs>>>,
}
...
impl AdminRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220401preview:AdminRule";

    /// Create a new AdminRule resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
        args: AdminRuleArgs,
        ...
        pulumi_sdk::resolve_input("priority", args.priority, &mut inputs, &mut deps, &mut prop_deps).await;
