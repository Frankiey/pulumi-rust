...
pub struct ManagementGroupNetworkManagerConnectionArgs {
...
/// The Network Manager Connection resource
pub struct ManagementGroupNetworkManagerConnection {
...
impl ManagementGroupNetworkManagerConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220401preview:ManagementGroupNetworkManagerConnection";

    /// Create a new ManagementGroupNetworkManagerConnection resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
