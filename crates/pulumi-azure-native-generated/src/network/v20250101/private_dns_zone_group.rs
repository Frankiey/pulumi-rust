...
pub struct PrivateDnsZoneGroupArgs {
    ...
    pub private_dns_zone_configs: Option<Vec<Input<network::v20250101::PrivateDnsZoneConfigArgs>>>,
...
impl PrivateDnsZoneGroup {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:PrivateDnsZoneGroup";
