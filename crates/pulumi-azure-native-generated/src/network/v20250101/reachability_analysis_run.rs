...
pub struct ReachabilityAnalysisRunArgs {
    ...
    pub properties: Input<network::v20250101::ReachabilityAnalysisRunPropertiesArgs>,
...
impl ReachabilityAnalysisRun {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:ReachabilityAnalysisRun";
