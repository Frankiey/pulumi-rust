...
pub struct NetworkManagerArgs {
    ...
    pub network_manager_scopes: Input<network::v20250101::NetworkManagerPropertiesNetworkManagerScopesArgs>,
...
impl NetworkManager {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:NetworkManager";
