...
pub struct ReachabilityAnalysisIntentArgs {
    ...
    pub properties: Input<network::v20250101::ReachabilityAnalysisIntentPropertiesArgs>,
...
impl ReachabilityAnalysisIntent {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:ReachabilityAnalysisIntent";
