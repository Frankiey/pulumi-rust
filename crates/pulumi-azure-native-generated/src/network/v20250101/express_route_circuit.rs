...
pub struct ExpressRouteCircuitArgs {
    ...
    pub authorizations: Option<Vec<Input<network::v20250101::ExpressRouteCircuitAuthorizationArgs>>>,
    ...
    pub enable_direct_port_rate_limit: Option<Input<bool>>,
    /// The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
    pub express_route_port: Option<Input<network::v20250101::SubResourceArgs>>,
    ...
    pub peerings: Option<Vec<Input<network::v20250101::ExpressRouteCircuitPeeringArgs>>>,
    ...
    pub service_provider_properties: Option<Input<network::v20250101::ExpressRouteCircuitServiceProviderPropertiesArgs>>,
    /// The ServiceProviderProvisioningState state of the resource.
    pub service_provider_provisioning_state: Option<Input<serde_json::Value>>,
    /// The SKU.
    pub sku: Option<Input<network::v20250101::ExpressRouteCircuitSkuArgs>>,
    /// Resource tags.
...
pub struct ExpressRouteCircuit {
    ...
    /// Flag denoting rate-limiting status of the ExpressRoute direct-port circuit.
    pub enable_direct_port_rate_limit: Output<serde_json::Value>,
...
impl ExpressRouteCircuit {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:ExpressRouteCircuit";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.enable_direct_port_rate_limit {
            pulumi_sdk::resolve_input("enableDirectPortRateLimit", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            circuit_provisioning_state: registered.outputs.get("circuitProvisioningState")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            enable_direct_port_rate_limit: registered.outputs.get("enableDirectPortRateLimit")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
