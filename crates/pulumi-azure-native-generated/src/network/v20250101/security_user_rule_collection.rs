...
pub struct SecurityUserRuleCollectionArgs {
    /// Groups for configuration
    pub applies_to_groups: Vec<Input<network::v20250101::SecurityUserGroupItemArgs>>,
...
/// Defines the security user rule collection.
pub struct SecurityUserRuleCollection {
...
impl SecurityUserRuleCollection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:SecurityUserRuleCollection";

    /// Create a new SecurityUserRuleCollection resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
