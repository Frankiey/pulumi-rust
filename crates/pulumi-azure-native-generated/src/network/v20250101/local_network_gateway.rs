...
pub struct LocalNetworkGatewayArgs {
    ...
    pub local_network_address_space: Option<Input<network::v20250101::AddressSpaceArgs>>,
...
impl LocalNetworkGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:LocalNetworkGateway";
