...
pub struct VerifierWorkspaceArgs {
    ...
    pub properties: Option<Input<network::v20250101::VerifierWorkspacePropertiesArgs>>,
...
impl VerifierWorkspace {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:VerifierWorkspace";
