...
pub struct VirtualNetworkGatewayNatRuleArgs {
    ...
    pub external_mappings: Option<Vec<Input<network::v20250101::VpnNatRuleMappingArgs>>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// The private IP address internal mapping for NAT.
    pub internal_mappings: Option<Vec<Input<network::v20250101::VpnNatRuleMappingArgs>>>,
...
impl VirtualNetworkGatewayNatRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:VirtualNetworkGatewayNatRule";
