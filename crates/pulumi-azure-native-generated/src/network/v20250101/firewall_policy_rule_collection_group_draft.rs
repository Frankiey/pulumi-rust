...
pub struct FirewallPolicyRuleCollectionGroupDraftArgs {
    ...
    pub rule_collection_group_name: Input<String>,
    /// Group of Firewall Policy rule collections.
    pub rule_collections: Option<Vec<Input<serde_json::Value>>>,
}

/// Rule Collection Group resource.
pub struct FirewallPolicyRuleCollectionGroupDraft {
...
impl FirewallPolicyRuleCollectionGroupDraft {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:FirewallPolicyRuleCollectionGroupDraft";

    /// Create a new FirewallPolicyRuleCollectionGroupDraft resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
        ...
        pulumi_sdk::resolve_input("ruleCollectionGroupName", args.rule_collection_group_name, &mut inputs, &mut deps, &mut prop_deps).await;
