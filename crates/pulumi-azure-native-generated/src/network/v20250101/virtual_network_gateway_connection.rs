...
pub struct VirtualNetworkGatewayConnectionArgs {
    ...
    pub authentication_type: Option<Input<serde_json::Value>>,
    ...
    pub certificate_authentication: Option<Input<network::v20250101::CertificateAuthenticationArgs>>,
    ...
    pub egress_nat_rules: Option<Vec<Input<network::v20250101::SubResourceArgs>>>,
    /// EnableBgp flag.
    ...
    pub gateway_custom_bgp_ip_addresses: Option<Vec<Input<network::v20250101::GatewayCustomBgpIpAddressIpConfigurationArgs>>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// List of ingress NatRules.
    pub ingress_nat_rules: Option<Vec<Input<network::v20250101::SubResourceArgs>>>,
    /// The IPSec Policies to be considered by this connection.
    pub ipsec_policies: Option<Vec<Input<network::v20250101::IpsecPolicyArgs>>>,
    /// The reference to local network gateway resource.
    pub local_network_gateway2: Option<Input<network::v20250101::LocalNetworkGatewayArgs>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The reference to peerings resource.
    pub peer: Option<Input<network::v20250101::SubResourceArgs>>,
    ...
    pub traffic_selector_policies: Option<Vec<Input<network::v20250101::TrafficSelectorPolicyArgs>>>,
    /// Tunnel properties for virtual network gateway connection
    pub tunnel_properties: Option<Vec<Input<network::v20250101::VirtualNetworkGatewayConnectionTunnelPropertiesArgs>>>,
    ...
    pub virtual_network_gateway1: Input<network::v20250101::VirtualNetworkGatewayArgs>,
    /// The reference to virtual network gateway resource.
    pub virtual_network_gateway2: Option<Input<network::v20250101::VirtualNetworkGatewayArgs>>,
...
pub struct VirtualNetworkGatewayConnection {
    ...
    /// Gateway connection authentication type.
    pub authentication_type: Output<serde_json::Value>,
    /// The authorizationKey.
    pub authorization_key: Output<serde_json::Value>,
    /// The Azure API version of the resource.
    pub azure_api_version: Output<serde_json::Value>,
    /// Certificate Authentication information for a certificate based authentication connection.
    pub certificate_authentication: Output<serde_json::Value>,
    /// The connection mode for this connection.
    ...
    /// Tunnel properties for virtual network gateway connection
    pub tunnel_properties: Output<serde_json::Value>,
    /// Resource type.
...
impl VirtualNetworkGatewayConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:VirtualNetworkGatewayConnection";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.authentication_type {
            pulumi_sdk::resolve_input("authenticationType", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        if let Some(v) = args.authorization_key {
            pulumi_sdk::resolve_input("authorizationKey", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        if let Some(v) = args.certificate_authentication {
            pulumi_sdk::resolve_input("certificateAuthentication", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        if let Some(v) = args.tunnel_properties {
            pulumi_sdk::resolve_input_vec("tunnelProperties", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            authentication_type: registered.outputs.get("authenticationType")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            azure_api_version: registered.outputs.get("azureApiVersion")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            certificate_authentication: registered.outputs.get("certificateAuthentication")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            tunnel_connection_status: registered.outputs.get("tunnelConnectionStatus")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            tunnel_properties: registered.outputs.get("tunnelProperties")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
