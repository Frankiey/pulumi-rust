...
pub struct GetRoutingRuleResult {
    ...
    pub destination: network::v20250101::RoutingRuleRouteDestinationResponse,
    ...
    pub next_hop: network::v20250101::RoutingRuleNextHopResponse,
...
pub async fn get_routing_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20250101:getRoutingRule", invoke_args, &opts).await?;
