...
pub struct ListNetworkManagerEffectiveConnectivityConfigurationsResult {
    ...
    pub value: Option<Vec<network::v20250101::EffectiveConnectivityConfigurationResponse>>,
}
...
pub async fn list_network_manager_effective_connectivity_configurations(
    ...
    let result = ctx.invoke("azure-native:network/v20250101:listNetworkManagerEffectiveConnectivityConfigurations", invoke_args, &opts).await?;
