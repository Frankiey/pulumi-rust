...
pub struct GetNatGatewayResult {
    ...
    pub public_ip_addresses: Option<Vec<network::v20250101::SubResourceResponse>>,
    /// An array of public ip addresses V6 associated with the nat gateway resource.
    pub public_ip_addresses_v6: Option<Vec<network::v20250101::SubResourceResponse>>,
    /// An array of public ip prefixes V4 associated with the nat gateway resource.
    pub public_ip_prefixes: Option<Vec<network::v20250101::SubResourceResponse>>,
    /// An array of public ip prefixes V6 associated with the nat gateway resource.
    pub public_ip_prefixes_v6: Option<Vec<network::v20250101::SubResourceResponse>>,
    /// The resource GUID property of the NAT gateway resource.
    pub resource_guid: String,
    /// The nat gateway SKU.
    pub sku: Option<network::v20250101::NatGatewaySkuResponse>,
    /// A reference to the source virtual network using this nat gateway resource.
    pub source_virtual_network: Option<network::v20250101::SubResourceResponse>,
    /// An array of references to the subnets using this nat gateway resource.
    pub subnets: Vec<network::v20250101::SubResourceResponse>,
    /// Resource tags.
...
pub async fn get_nat_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20250101:getNatGateway", invoke_args, &opts).await?;
