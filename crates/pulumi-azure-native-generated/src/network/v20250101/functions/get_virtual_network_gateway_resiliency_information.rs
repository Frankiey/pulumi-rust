...
pub struct GetVirtualNetworkGatewayResiliencyInformationResult {
    ...
    pub components: Option<Vec<network::v20250101::ResiliencyRecommendationComponentsResponse>>,
...
pub async fn get_virtual_network_gateway_resiliency_information(
    ...
    let result = ctx.invoke("azure-native:network/v20250101:getVirtualNetworkGatewayResiliencyInformation", invoke_args, &opts).await?;
