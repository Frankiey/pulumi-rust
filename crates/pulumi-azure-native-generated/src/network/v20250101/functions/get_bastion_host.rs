...
pub struct GetBastionHostResult {
    ...
    pub enable_private_only_bastion: Option<bool>,
    ...
    pub ip_configurations: Option<Vec<network::v20250101::BastionHostIPConfigurationResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    pub network_acls: Option<network::v20250101::BastionHostPropertiesFormatResponseNetworkAcls>,
    /// The provisioning state of the bastion host resource.
    pub provisioning_state: String,
    /// The scale units for the Bastion Host resource.
    pub scale_units: Option<i64>,
    /// The sku of this Bastion Host.
    pub sku: Option<network::v20250101::SkuResponse>,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// Resource type.
    pub type_: String,
    /// Reference to an existing virtual network required for Developer Bastion Host only.
    pub virtual_network: Option<network::v20250101::SubResourceResponse>,
...
pub async fn get_bastion_host(
    ...
    let result = ctx.invoke("azure-native:network/v20250101:getBastionHost", invoke_args, &opts).await?;
    ...
    Ok(GetBastionHostResult {
        ...
        enable_private_only_bastion: result.fields.get("enablePrivateOnlyBastion").cloned().map(serde_json::from_value).transpose()?,
        enable_session_recording: result.fields.get("enableSessionRecording").cloned().map(serde_json::from_value).transpose()?,
        ...
        name: serde_json::from_value(result.fields.get("name").cloned().unwrap_or_default())?
            ,
        network_acls: result.fields.get("networkAcls").cloned().map(serde_json::from_value).transpose()?,
