...
pub struct ListIpamPoolAssociatedResourcesResult {
    ...
    pub value: Option<Vec<network::v20250101::PoolAssociationResponse>>,
}
...
pub async fn list_ipam_pool_associated_resources(
    ...
    let result = ctx.invoke("azure-native:network/v20250101:listIpamPoolAssociatedResources", invoke_args, &opts).await?;
