...
pub struct NetworkVirtualApplianceArgs {
    ...
    pub additional_nics: Option<Vec<Input<network::v20250101::VirtualApplianceAdditionalNicPropertiesArgs>>>,
    ...
    pub delegation: Option<Input<network::v20250101::DelegationPropertiesArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// The service principal that has read access to cloud-init and config blob.
    pub identity: Option<Input<network::v20250101::ManagedServiceIdentityArgs>>,
    /// List of Resource Uri of Public IPs for Internet Ingress Scenario.
    pub internet_ingress_public_ips: Option<Vec<Input<network::v20250101::InternetIngressPublicIpsPropertiesArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// Network Profile containing configurations for Public and Private NIC.
    pub network_profile: Option<Input<network::v20250101::NetworkVirtualAppliancePropertiesFormatNetworkProfileArgs>>,
    /// The name of Network Virtual Appliance.
    pub network_virtual_appliance_name: Option<Input<String>>,
    /// The NVA in VNet interface configurations
    pub nva_interface_configurations: Option<Vec<Input<network::v20250101::NvaInterfaceConfigurationsPropertiesArgs>>>,
    /// Network Virtual Appliance SKU.
    pub nva_sku: Option<Input<network::v20250101::VirtualApplianceSkuPropertiesArgs>>,
    ...
    pub virtual_hub: Option<Input<network::v20250101::SubResourceArgs>>,
}
...
pub struct NetworkVirtualAppliance {
    ...
    /// The NVA in VNet interface configurations
    pub nva_interface_configurations: Output<serde_json::Value>,
    /// Network Virtual Appliance SKU.
...
impl NetworkVirtualAppliance {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:NetworkVirtualAppliance";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.nva_interface_configurations {
            pulumi_sdk::resolve_input_vec("nvaInterfaceConfigurations", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            network_profile: registered.outputs.get("networkProfile")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            nva_interface_configurations: registered.outputs.get("nvaInterfaceConfigurations")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
