...
pub struct VirtualHubArgs {
    ...
    pub azure_firewall: Option<Input<network::v20250101::SubResourceArgs>>,
    /// The expressRouteGateway associated with this VirtualHub.
    pub express_route_gateway: Option<Input<network::v20250101::SubResourceArgs>>,
    ...
    pub p2s_vpn_gateway: Option<Input<network::v20250101::SubResourceArgs>>,
    /// The preferred gateway to route on-prem traffic
    pub preferred_routing_gateway: Option<Input<serde_json::Value>>,
    /// The resource group name of the VirtualHub.
    pub resource_group_name: Input<String>,
    /// The routeTable associated with this virtual hub.
    pub route_table: Option<Input<network::v20250101::VirtualHubRouteTableArgs>>,
    /// The securityPartnerProvider associated with this VirtualHub.
    pub security_partner_provider: Option<Input<network::v20250101::SubResourceArgs>>,
    ...
    pub virtual_hub_route_table_v2s: Option<Vec<Input<network::v20250101::VirtualHubRouteTableV2Args>>>,
    /// VirtualRouter ASN.
    pub virtual_router_asn: Option<Input<f64>>,
    /// The VirtualHub Router autoscale configuration.
    pub virtual_router_auto_scale_configuration: Option<Input<network::v20250101::VirtualRouterAutoScaleConfigurationArgs>>,
    /// VirtualRouter IPs.
    pub virtual_router_ips: Option<Vec<Input<String>>>,
    /// The VirtualWAN to which the VirtualHub belongs.
    pub virtual_wan: Option<Input<network::v20250101::SubResourceArgs>>,
    /// The VpnGateway associated with this VirtualHub.
    pub vpn_gateway: Option<Input<network::v20250101::SubResourceArgs>>,
}
...
impl VirtualHub {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250101:VirtualHub";
