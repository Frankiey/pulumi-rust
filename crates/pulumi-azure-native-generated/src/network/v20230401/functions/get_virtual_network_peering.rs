...
pub struct GetVirtualNetworkPeeringResult {
    ...
    pub remote_address_space: Option<network::v20230401::AddressSpaceResponse>,
    /// The reference to the remote virtual network's Bgp Communities.
    pub remote_bgp_communities: Option<network::v20230401::VirtualNetworkBgpCommunitiesResponse>,
    ...
    pub remote_virtual_network_address_space: Option<network::v20230401::AddressSpaceResponse>,
    /// The reference to the remote virtual network's encryption
    pub remote_virtual_network_encryption: network::v20230401::VirtualNetworkEncryptionResponse,
...
pub async fn get_virtual_network_peering(
    ...
    let result = ctx.invoke("azure-native:network/v20230401:getVirtualNetworkPeering", invoke_args, &opts).await?;
