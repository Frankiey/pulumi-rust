...
pub struct GetPrivateLinkServiceResult {
    ...
    pub auto_approval: Option<network::v20230401::PrivateLinkServicePropertiesResponseAutoApproval>,
    ...
    pub ip_configurations: Option<Vec<network::v20230401::PrivateLinkServiceIpConfigurationResponse>>,
    /// An array of references to the load balancer IP configurations.
    pub load_balancer_frontend_ip_configurations: Option<Vec<network::v20230401::FrontendIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint_connections: Vec<network::v20230401::PrivateEndpointConnectionResponse>,
    ...
    pub visibility: Option<network::v20230401::PrivateLinkServicePropertiesResponseVisibility>,
}
...
pub async fn get_private_link_service(
    ...
    let result = ctx.invoke("azure-native:network/v20230401:getPrivateLinkService", invoke_args, &opts).await?;
