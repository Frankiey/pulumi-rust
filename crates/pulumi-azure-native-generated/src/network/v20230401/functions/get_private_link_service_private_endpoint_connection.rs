...
pub struct GetPrivateLinkServicePrivateEndpointConnectionResult {
    ...
    pub private_link_service_connection_state: Option<network::v20230401::PrivateLinkServiceConnectionStateResponse>,
...
pub async fn get_private_link_service_private_endpoint_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20230401:getPrivateLinkServicePrivateEndpointConnection", invoke_args, &opts).await?;
