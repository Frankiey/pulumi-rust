...
pub struct GetNetworkManagerResult {
    ...
    pub network_manager_scopes: network::v20230401::NetworkManagerPropertiesResponseNetworkManagerScopes,
    /// The provisioning state of the network manager resource.
    pub provisioning_state: String,
    /// Unique identifier for this resource.
    pub resource_guid: String,
    /// The system metadata related to this resource.
    pub system_data: network::v20230401::SystemDataResponse,
    /// Resource tags.
...
pub async fn get_network_manager(
    ...
    let result = ctx.invoke("azure-native:network/v20230401:getNetworkManager", invoke_args, &opts).await?;
