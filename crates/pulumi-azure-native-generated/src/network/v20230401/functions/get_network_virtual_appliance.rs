...
pub struct GetNetworkVirtualApplianceResult {
    ...
    pub additional_nics: Option<Vec<network::v20230401::VirtualApplianceAdditionalNicPropertiesResponse>>,
    /// Address Prefix.
    ...
    pub delegation: Option<network::v20230401::DelegationPropertiesResponse>,
    ...
    pub inbound_security_rules: Vec<network::v20230401::SubResourceResponse>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// Network Virtual Appliance SKU.
    pub nva_sku: Option<network::v20230401::VirtualApplianceSkuPropertiesResponse>,
    /// The delegation for the Virtual Appliance
    pub partner_managed_resource: Option<network::v20230401::PartnerManagedResourcePropertiesResponse>,
    ...
    pub virtual_appliance_nics: Vec<network::v20230401::VirtualApplianceNicPropertiesResponse>,
    /// List of references to VirtualApplianceSite.
    pub virtual_appliance_sites: Vec<network::v20230401::SubResourceResponse>,
...
pub async fn get_network_virtual_appliance(
    ...
    let result = ctx.invoke("azure-native:network/v20230401:getNetworkVirtualAppliance", invoke_args, &opts).await?;
