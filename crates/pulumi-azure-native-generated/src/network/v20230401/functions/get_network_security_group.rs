...
pub struct GetNetworkSecurityGroupResult {
    ...
    pub default_security_rules: Vec<network::v20230401::SecurityRuleResponse>,
    ...
    pub security_rules: Option<Vec<network::v20230401::SecurityRuleResponse>>,
...
pub async fn get_network_security_group(
    ...
    let result = ctx.invoke("azure-native:network/v20230401:getNetworkSecurityGroup", invoke_args, &opts).await?;
