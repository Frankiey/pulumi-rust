...
pub struct GetAdminRuleResult {
    ...
    pub destinations: Option<Vec<network::v20230401::AddressPrefixItemResponse>>,
    ...
    pub sources: Option<Vec<network::v20230401::AddressPrefixItemResponse>>,
...
pub async fn get_admin_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20230401:getAdminRule", invoke_args, &opts).await?;
