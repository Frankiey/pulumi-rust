...
impl<'de> serde::Deserialize<'de> for ApplicationGatewayCustomErrorStatusCode {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> std::result::Result<Self, D::Error> {
        ...
        match s.as_str() {
            ...
            _ => Err(serde::de::Error::unknown_variant(&s, &["HttpStatus400", "HttpStatus403", "HttpStatus404", "HttpStatus405", "HttpStatus408", "HttpStatus500", "HttpStatus502", "HttpStatus503", "HttpStatus504"])),
        }
    }
}
