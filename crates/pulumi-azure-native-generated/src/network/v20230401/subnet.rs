...
pub struct SubnetArgs {
    ...
    pub application_gateway_ip_configurations: Option<Vec<Input<network::v20230401::ApplicationGatewayIPConfigurationArgs>>>,
    /// An array of references to the delegations on the subnet.
    pub delegations: Option<Vec<Input<network::v20230401::DelegationArgs>>>,
    /// Resource ID.
    ...
    pub nat_gateway: Option<Input<network::v20230401::SubResourceArgs>>,
    ...
    pub route_table: Option<Input<network::v20230401::RouteTableArgs>>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<Input<network::v20230401::ServiceEndpointPolicyArgs>>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<Input<network::v20230401::ServiceEndpointPropertiesFormatArgs>>>,
...
impl Subnet {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230401:Subnet";
