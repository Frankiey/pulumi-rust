...
pub struct ExpressRouteCircuitConnectionArgs {
    ...
    pub express_route_circuit_peering: Option<Input<network::v20230401::SubResourceArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// IPv6 Address PrefixProperties of the express route circuit connection.
    pub ipv6circuit_connection_config: Option<Input<network::v20230401::Ipv6CircuitConnectionConfigArgs>>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<Input<String>>,
    /// Reference to Express Route Circuit Private Peering Resource of the peered circuit.
    pub peer_express_route_circuit_peering: Option<Input<network::v20230401::SubResourceArgs>>,
...
impl ExpressRouteCircuitConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230401:ExpressRouteCircuitConnection";
