...
pub struct InboundNatRuleArgs {
    ...
    pub backend_address_pool: Option<Input<network::v20230401::SubResourceArgs>>,
    ...
    pub frontend_ip_configuration: Option<Input<network::v20230401::SubResourceArgs>>,
...
impl InboundNatRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230401:InboundNatRule";
