...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub private_link_service: Option<Input<network::PrivateLinkServiceArgs>>,
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network:NetworkInterface";
