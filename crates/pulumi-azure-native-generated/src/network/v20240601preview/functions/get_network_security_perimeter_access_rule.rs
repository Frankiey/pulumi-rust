...
pub struct GetNetworkSecurityPerimeterAccessRuleResult {
    ...
    pub network_security_perimeters: Vec<network::v20240601preview::PerimeterBasedAccessRuleResponse>,
    ...
    pub subscriptions: Option<Vec<network::v20240601preview::SubscriptionIdResponse>>,
    /// Resource tags.
...
pub async fn get_network_security_perimeter_access_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20240601preview:getNetworkSecurityPerimeterAccessRule", invoke_args, &opts).await?;
