...
pub struct GetNetworkSecurityPerimeterLoggingConfigurationResult {
    ...
    pub properties: network::v20240601preview::NspLoggingConfigurationPropertiesResponse,
    /// Resource type.
    pub type_: String,
}
...
pub async fn get_network_security_perimeter_logging_configuration(
    ...
    let result = ctx.invoke("azure-native:network/v20240601preview:getNetworkSecurityPerimeterLoggingConfiguration", invoke_args, &opts).await?;
