...
pub struct NetworkVirtualApplianceArgs {
    ...
    pub delegation: Option<Input<network::v20220701::DelegationPropertiesArgs>>,
    /// Resource ID.
    ...
    pub nva_sku: Option<Input<network::v20220701::VirtualApplianceSkuPropertiesArgs>>,
...
impl NetworkVirtualAppliance {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220701:NetworkVirtualAppliance";
