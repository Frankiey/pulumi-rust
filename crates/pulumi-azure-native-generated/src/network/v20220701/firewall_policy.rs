...
pub struct FirewallPolicyArgs {
    ...
    pub base_policy: Option<Input<network::v20220701::SubResourceArgs>>,
    /// DNS Proxy Settings definition.
    pub dns_settings: Option<Input<network::v20220701::DnsSettingsArgs>>,
    /// Explicit Proxy Settings definition.
    pub explicit_proxy: Option<Input<network::v20220701::ExplicitProxyArgs>>,
    ...
    pub insights: Option<Input<network::v20220701::FirewallPolicyInsightsArgs>>,
    /// The configuration for Intrusion detection.
    pub intrusion_detection: Option<Input<network::v20220701::FirewallPolicyIntrusionDetectionArgs>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The Firewall Policy SKU.
    pub sku: Option<Input<network::v20220701::FirewallPolicySkuArgs>>,
    /// The private IP addresses/IP ranges to which traffic will not be SNAT.
    pub snat: Option<Input<network::v20220701::FirewallPolicySNATArgs>>,
    /// SQL Settings definition.
    pub sql: Option<Input<network::v20220701::FirewallPolicySQLArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The operation mode for Threat Intelligence.
    pub threat_intel_mode: Option<Input<serde_json::Value>>,
    /// ThreatIntel Whitelist for Firewall Policy.
    pub threat_intel_whitelist: Option<Input<network::v20220701::FirewallPolicyThreatIntelWhitelistArgs>>,
    /// TLS Configuration definition.
    pub transport_security: Option<Input<network::v20220701::FirewallPolicyTransportSecurityArgs>>,
}
...
impl FirewallPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220701:FirewallPolicy";
