...
pub struct LocalNetworkGatewayArgs {
    ...
    pub local_network_address_space: Option<Input<network::v20220701::AddressSpaceArgs>>,
...
impl LocalNetworkGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220701:LocalNetworkGateway";
