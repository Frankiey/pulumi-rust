...
pub struct BastionHostArgs {
    ...
    pub ip_configurations: Option<Vec<Input<network::v20220701::BastionHostIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub sku: Option<Input<network::v20220701::SkuArgs>>,
    /// Resource tags.
...
impl BastionHost {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220701:BastionHost";
