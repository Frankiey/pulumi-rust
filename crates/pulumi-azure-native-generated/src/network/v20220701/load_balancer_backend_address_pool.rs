...
pub struct LoadBalancerBackendAddressPoolArgs {
    ...
    pub load_balancer_backend_addresses: Option<Vec<Input<network::v20220701::LoadBalancerBackendAddressArgs>>>,
    ...
    pub tunnel_interfaces: Option<Vec<Input<network::v20220701::GatewayLoadBalancerTunnelInterfaceArgs>>>,
    /// A reference to a virtual network.
    pub virtual_network: Option<Input<network::v20220701::SubResourceArgs>>,
}
...
impl LoadBalancerBackendAddressPool {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220701:LoadBalancerBackendAddressPool";
