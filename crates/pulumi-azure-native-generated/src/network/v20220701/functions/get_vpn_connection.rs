...
pub struct GetVpnConnectionResult {
    ...
    pub remote_vpn_site: Option<network::v20220701::SubResourceResponse>,
    /// The Routing Configuration indicating the associated and propagated route tables on this connection.
    pub routing_configuration: Option<network::v20220701::RoutingConfigurationResponse>,
    ...
    pub vpn_link_connections: Option<Vec<network::v20220701::VpnSiteLinkConnectionResponse>>,
}
...
pub async fn get_vpn_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20220701:getVpnConnection", invoke_args, &opts).await?;
