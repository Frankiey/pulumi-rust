...
pub struct GetBastionHostResult {
    ...
    pub ip_configurations: Option<Vec<network::v20220701::BastionHostIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub sku: Option<network::v20220701::SkuResponse>,
    /// Resource tags.
...
pub async fn get_bastion_host(
    ...
    let result = ctx.invoke("azure-native:network/v20220701:getBastionHost", invoke_args, &opts).await?;
