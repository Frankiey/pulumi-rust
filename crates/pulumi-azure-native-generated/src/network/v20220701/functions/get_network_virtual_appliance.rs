...
pub struct GetNetworkVirtualApplianceResult {
    ...
    pub delegation: Option<network::v20220701::DelegationPropertiesResponse>,
    ...
    pub inbound_security_rules: Vec<network::v20220701::SubResourceResponse>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// Network Virtual Appliance SKU.
    pub nva_sku: Option<network::v20220701::VirtualApplianceSkuPropertiesResponse>,
    /// The delegation for the Virtual Appliance
    pub partner_managed_resource: Option<network::v20220701::PartnerManagedResourcePropertiesResponse>,
    ...
    pub virtual_appliance_nics: Vec<network::v20220701::VirtualApplianceNicPropertiesResponse>,
    /// List of references to VirtualApplianceSite.
    pub virtual_appliance_sites: Vec<network::v20220701::SubResourceResponse>,
...
pub async fn get_network_virtual_appliance(
    ...
    let result = ctx.invoke("azure-native:network/v20220701:getNetworkVirtualAppliance", invoke_args, &opts).await?;
