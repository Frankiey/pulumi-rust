...
pub struct ListActiveConnectivityConfigurationsResult {
    ...
    pub value: Option<Vec<network::v20220701::ActiveConnectivityConfigurationResponse>>,
}
...
pub async fn list_active_connectivity_configurations(
    ...
    let result = ctx.invoke("azure-native:network/v20220701:listActiveConnectivityConfigurations", invoke_args, &opts).await?;
