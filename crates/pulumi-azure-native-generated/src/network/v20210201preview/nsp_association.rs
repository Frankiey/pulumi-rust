...
pub struct NspAssociationArgs {
    ...
    pub private_link_resource: Option<Input<network::v20210201preview::SubResourceArgs>>,
    /// Profile id to which the PaaS resource is associated.
    pub profile: Option<Input<network::v20210201preview::SubResourceArgs>>,
...
impl NspAssociation {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210201preview:NspAssociation";
