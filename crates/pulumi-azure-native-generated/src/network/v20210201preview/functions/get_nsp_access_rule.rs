...
pub struct GetNspAccessRuleResult {
    ...
    pub network_security_perimeters: Vec<network::v20210201preview::PerimeterBasedAccessRuleResponse>,
    /// Outbound rules phone number format.
    pub phone_numbers: Option<Vec<String>>,
    /// The provisioning state of the scope assignment resource.
    pub provisioning_state: String,
    /// List of subscription ids
    pub subscriptions: Option<Vec<network::v20210201preview::SubscriptionIdResponse>>,
    /// Resource tags.
...
pub async fn get_nsp_access_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20210201preview:getNspAccessRule", invoke_args, &opts).await?;
