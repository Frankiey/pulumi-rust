...
pub struct ListEffectiveConnectivityConfigurationResult {
    ...
    pub value: Option<Vec<network::v20210201preview::EffectiveConnectivityConfigurationResponse>>,
}
...
pub async fn list_effective_connectivity_configuration(
    ...
    let result = ctx.invoke("azure-native:network/v20210201preview:listEffectiveConnectivityConfiguration", invoke_args, &opts).await?;
