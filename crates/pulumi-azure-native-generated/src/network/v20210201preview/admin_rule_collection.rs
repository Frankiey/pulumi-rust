...
pub struct AdminRuleCollectionArgs {
...
impl AdminRuleCollection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210201preview:AdminRuleCollection";

    /// Create a new AdminRuleCollection resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
