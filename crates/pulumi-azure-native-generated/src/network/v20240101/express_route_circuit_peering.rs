...
pub struct ExpressRouteCircuitPeeringArgs {
    ...
    pub connections: Option<Vec<Input<network::v20240101::ExpressRouteCircuitConnectionArgs>>>,
    /// The GatewayManager Etag.
    pub gateway_manager_etag: Option<Input<String>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// The IPv6 peering configuration.
    pub ipv6peering_config: Option<Input<network::v20240101::Ipv6ExpressRouteCircuitPeeringConfigArgs>>,
    /// The Microsoft peering configuration.
    pub microsoft_peering_config: Option<Input<network::v20240101::ExpressRouteCircuitPeeringConfigArgs>>,
    ...
    pub route_filter: Option<Input<network::v20240101::SubResourceArgs>>,
    /// The secondary port.
    ...
    pub stats: Option<Input<network::v20240101::ExpressRouteCircuitStatsArgs>>,
    /// The VLAN ID.
...
impl ExpressRouteCircuitPeering {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101:ExpressRouteCircuitPeering";
