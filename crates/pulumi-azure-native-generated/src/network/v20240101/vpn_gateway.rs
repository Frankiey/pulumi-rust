...
pub struct VpnGatewayArgs {
    ...
    pub connections: Option<Vec<Input<network::v20240101::VpnConnectionArgs>>>,
    ...
    pub nat_rules: Option<Vec<Input<network::v20240101::VpnGatewayNatRuleArgs>>>,
...
impl VpnGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101:VpnGateway";
