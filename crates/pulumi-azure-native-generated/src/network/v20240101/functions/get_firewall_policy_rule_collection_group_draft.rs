...
#[derive(Default)]
pub struct GetFirewallPolicyRuleCollectionGroupDraftArgs {
...
pub struct GetFirewallPolicyRuleCollectionGroupDraftResult {
...
/// Get Rule Collection Group Draft.
pub async fn get_firewall_policy_rule_collection_group_draft(
    ctx: &Context,
    args: GetFirewallPolicyRuleCollectionGroupDraftArgs,
    opts: Option<InvokeOptions>,
) -> Result<GetFirewallPolicyRuleCollectionGroupDraftResult> {
    ...
    let result = ctx.invoke("azure-native:network/v20240101:getFirewallPolicyRuleCollectionGroupDraft", invoke_args, &opts).await?;

    Ok(GetFirewallPolicyRuleCollectionGroupDraftResult {
