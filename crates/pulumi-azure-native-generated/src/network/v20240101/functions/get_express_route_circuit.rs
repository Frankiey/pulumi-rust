...
pub struct GetExpressRouteCircuitResult {
    ...
    pub authorizations: Option<Vec<network::v20240101::ExpressRouteCircuitAuthorizationResponse>>,
    ...
    pub enable_direct_port_rate_limit: Option<bool>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
    pub express_route_port: Option<network::v20240101::SubResourceResponse>,
    ...
    pub peerings: Option<Vec<network::v20240101::ExpressRouteCircuitPeeringResponse>>,
    ...
    pub service_provider_properties: Option<network::v20240101::ExpressRouteCircuitServiceProviderPropertiesResponse>,
    /// The ServiceProviderProvisioningState state of the resource.
    pub service_provider_provisioning_state: Option<String>,
    /// The SKU.
    pub sku: Option<network::v20240101::ExpressRouteCircuitSkuResponse>,
...
pub async fn get_express_route_circuit(
    ...
    let result = ctx.invoke("azure-native:network/v20240101:getExpressRouteCircuit", invoke_args, &opts).await?;
    ...
    Ok(GetExpressRouteCircuitResult {
        ...
        authorization_status: serde_json::from_value(result.fields.get("authorizationStatus").cloned().unwrap_or_default())?
            ,
        ...
        enable_direct_port_rate_limit: result.fields.get("enableDirectPortRateLimit").cloned().map(serde_json::from_value).transpose()?,
