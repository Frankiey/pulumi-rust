...
pub struct ConnectivityConfigurationArgs {
    ...
    pub applies_to_groups: Vec<Input<network::v20240101::ConnectivityGroupItemArgs>>,
    ...
    /// List of hubItems
    pub hubs: Option<Vec<Input<network::v20240101::HubArgs>>>,
...
impl ConnectivityConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101:ConnectivityConfiguration";
