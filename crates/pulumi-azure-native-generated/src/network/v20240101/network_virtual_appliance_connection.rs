...
pub struct NetworkVirtualApplianceConnectionArgs {
    ...
    pub properties: Option<Input<network::v20240101::NetworkVirtualApplianceConnectionPropertiesArgs>>,
...
impl NetworkVirtualApplianceConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101:NetworkVirtualApplianceConnection";
