...
pub struct WebApplicationFirewallPolicyArgs {
    ...
    pub custom_rules: Option<Vec<Input<network::v20240101::WebApplicationFirewallCustomRuleArgs>>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// Describes the managedRules structure.
    pub managed_rules: Input<network::v20240101::ManagedRulesDefinitionArgs>,
    /// The name of the policy.
    pub policy_name: Option<Input<String>>,
    /// The PolicySettings for policy.
    pub policy_settings: Option<Input<network::v20240101::PolicySettingsArgs>>,
...
impl WebApplicationFirewallPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101:WebApplicationFirewallPolicy";
