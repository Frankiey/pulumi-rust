...
pub struct ConfigurationPolicyGroupArgs {
    ...
    pub policy_members: Option<Vec<Input<network::v20240101::VpnServerConfigurationPolicyGroupMemberArgs>>>,
...
impl ConfigurationPolicyGroup {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101:ConfigurationPolicyGroup";
