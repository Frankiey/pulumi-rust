...
pub struct ServiceEndpointPolicyArgs {
    ...
    pub service_endpoint_policy_definitions: Option<Vec<Input<network::v20240101::ServiceEndpointPolicyDefinitionArgs>>>,
...
impl ServiceEndpointPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101:ServiceEndpointPolicy";
