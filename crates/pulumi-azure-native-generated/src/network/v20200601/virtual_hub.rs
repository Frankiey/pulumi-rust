...
pub struct VirtualHubArgs {
    ...
    pub azure_firewall: Option<Input<network::v20200601::SubResourceArgs>>,
    /// Flag to control route propogation for VirtualRouter hub.
    pub enable_virtual_router_route_propogation: Option<Input<bool>>,
    /// The expressRouteGateway associated with this VirtualHub.
    pub express_route_gateway: Option<Input<network::v20200601::SubResourceArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The P2SVpnGateway associated with this VirtualHub.
    pub p2s_vpn_gateway: Option<Input<network::v20200601::SubResourceArgs>>,
    /// The resource group name of the VirtualHub.
    pub resource_group_name: Input<String>,
    /// The routeTable associated with this virtual hub.
    pub route_table: Option<Input<network::v20200601::VirtualHubRouteTableArgs>>,
    /// The securityPartnerProvider associated with this VirtualHub.
    pub security_partner_provider: Option<Input<network::v20200601::SubResourceArgs>>,
    ...
    pub virtual_hub_route_table_v2s: Option<Vec<Input<network::v20200601::VirtualHubRouteTableV2Args>>>,
    /// VirtualRouter ASN.
    pub virtual_router_asn: Option<Input<f64>>,
    /// VirtualRouter IPs.
    pub virtual_router_ips: Option<Vec<Input<String>>>,
    /// The VirtualWAN to which the VirtualHub belongs.
    pub virtual_wan: Option<Input<network::v20200601::SubResourceArgs>>,
    /// The VpnGateway associated with this VirtualHub.
    pub vpn_gateway: Option<Input<network::v20200601::SubResourceArgs>>,
}
...
pub struct VirtualHub {
    ...
    /// Flag to control route propogation for VirtualRouter hub.
    pub enable_virtual_router_route_propogation: Output<serde_json::Value>,
...
impl VirtualHub {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200601:VirtualHub";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.enable_virtual_router_route_propogation {
            pulumi_sdk::resolve_input("enableVirtualRouterRoutePropogation", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            bgp_connections: registered.outputs.get("bgpConnections")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            enable_virtual_router_route_propogation: registered.outputs.get("enableVirtualRouterRoutePropogation")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
