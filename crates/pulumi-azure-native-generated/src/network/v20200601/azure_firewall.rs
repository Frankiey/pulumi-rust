...
pub struct AzureFirewallArgs {
    ...
    pub application_rule_collections: Option<Vec<Input<network::v20200601::AzureFirewallApplicationRuleCollectionArgs>>>,
    ...
    pub hub_ip_addresses: Option<Input<network::v20200601::HubIPAddressesArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// IP configuration of the Azure Firewall resource.
    pub ip_configurations: Option<Vec<Input<network::v20200601::AzureFirewallIPConfigurationArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// IP configuration of the Azure Firewall used for management traffic.
    pub management_ip_configuration: Option<Input<network::v20200601::AzureFirewallIPConfigurationArgs>>,
    /// Collection of NAT rule collections used by Azure Firewall.
    pub nat_rule_collections: Option<Vec<Input<network::v20200601::AzureFirewallNatRuleCollectionArgs>>>,
    /// Collection of network rule collections used by Azure Firewall.
    pub network_rule_collections: Option<Vec<Input<network::v20200601::AzureFirewallNetworkRuleCollectionArgs>>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The Azure Firewall Resource SKU.
    pub sku: Option<Input<network::v20200601::AzureFirewallSkuArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The operation mode for Threat Intelligence.
    pub threat_intel_mode: Option<Input<serde_json::Value>>,
    /// The virtualHub to which the firewall belongs.
    pub virtual_hub: Option<Input<network::v20200601::SubResourceArgs>>,
...
impl AzureFirewall {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200601:AzureFirewall";
