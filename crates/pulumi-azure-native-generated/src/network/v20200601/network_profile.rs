...
pub struct NetworkProfileArgs {
    ...
    pub container_network_interface_configurations: Option<Vec<Input<network::v20200601::ContainerNetworkInterfaceConfigurationArgs>>>,
    /// Resource ID.
...
impl NetworkProfile {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200601:NetworkProfile";
