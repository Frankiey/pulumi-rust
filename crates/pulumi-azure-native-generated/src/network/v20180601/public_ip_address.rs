...
pub struct PublicIPAddressArgs {
    ...
    pub dns_settings: Option<Input<network::v20180601::PublicIPAddressDnsSettingsArgs>>,
    /// Resource ID.
    ...
    pub ip_tags: Option<Vec<Input<network::v20180601::IpTagArgs>>>,
    /// Resource location.
    ...
    pub sku: Option<Input<network::v20180601::PublicIPAddressSkuArgs>>,
    /// Resource tags.
...
impl PublicIPAddress {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180601:PublicIPAddress";
