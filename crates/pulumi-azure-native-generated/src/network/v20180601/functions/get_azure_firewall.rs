...
pub struct GetAzureFirewallResult {
    ...
    pub application_rule_collections: Option<Vec<network::v20180601::AzureFirewallApplicationRuleCollectionResponse>>,
    ...
    pub ip_configurations: Option<Vec<network::v20180601::AzureFirewallIPConfigurationResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// Collection of network rule collections used by a Azure Firewall.
    pub network_rule_collections: Option<Vec<network::v20180601::AzureFirewallNetworkRuleCollectionResponse>>,
...
pub async fn get_azure_firewall(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getAzureFirewall", invoke_args, &opts).await?;
