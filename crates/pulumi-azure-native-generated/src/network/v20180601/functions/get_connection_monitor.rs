...
pub struct GetConnectionMonitorResult {
    ...
    pub destination: network::v20180601::ConnectionMonitorDestinationResponse,
    ...
    pub source: network::v20180601::ConnectionMonitorSourceResponse,
...
pub async fn get_connection_monitor(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getConnectionMonitor", invoke_args, &opts).await?;
