...
pub struct GetNetworkInterfaceResult {
    ...
    pub dns_settings: Option<network::v20180601::NetworkInterfaceDnsSettingsResponse>,
    ...
    pub ip_configurations: Option<Vec<network::v20180601::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub virtual_machine: Option<network::v20180601::SubResourceResponse>,
}
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getNetworkInterface", invoke_args, &opts).await?;
