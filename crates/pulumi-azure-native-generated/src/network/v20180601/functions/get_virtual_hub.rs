...
pub struct GetVirtualHubResult {
    ...
    pub hub_virtual_network_connections: Option<Vec<network::v20180601::HubVirtualNetworkConnectionResponse>>,
    /// Resource ID.
...
pub async fn get_virtual_hub(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getVirtualHub", invoke_args, &opts).await?;
