...
pub struct GetVpnGatewayResult {
    ...
    pub connections: Option<Vec<network::v20180601::VpnConnectionResponse>>,
    ...
    pub policies: Option<network::v20180601::PoliciesResponse>,
    ...
    pub virtual_hub: Option<network::v20180601::SubResourceResponse>,
}
...
pub async fn get_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getVpnGateway", invoke_args, &opts).await?;
