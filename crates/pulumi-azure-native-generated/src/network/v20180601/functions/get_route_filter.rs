...
pub struct GetRouteFilterResult {
    ...
    pub rules: Option<Vec<network::v20180601::RouteFilterRuleResponse>>,
    /// Resource tags.
...
pub async fn get_route_filter(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getRouteFilter", invoke_args, &opts).await?;
