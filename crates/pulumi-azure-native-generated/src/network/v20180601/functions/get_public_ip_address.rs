...
pub struct GetPublicIPAddressResult {
    ...
    pub dns_settings: Option<network::v20180601::PublicIPAddressDnsSettingsResponse>,
    ...
    pub ip_configuration: network::v20180601::IPConfigurationResponse,
    /// The list of tags associated with the public IP address.
    pub ip_tags: Option<Vec<network::v20180601::IpTagResponse>>,
    /// Resource location.
    ...
    pub sku: Option<network::v20180601::PublicIPAddressSkuResponse>,
    /// Resource tags.
...
pub async fn get_public_ip_address(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getPublicIPAddress", invoke_args, &opts).await?;
