...
pub struct VirtualNetworkGatewayArgs {
    ...
    pub gateway_default_site: Option<Input<network::v20180601::SubResourceArgs>>,
    /// The type of this virtual network gateway. Possible values are: 'Vpn' and 'ExpressRoute'.
    pub gateway_type: Option<Input<serde_json::Value>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// IP configurations for virtual network gateway.
    pub ip_configurations: Option<Vec<Input<network::v20180601::VirtualNetworkGatewayIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub sku: Option<Input<network::v20180601::VirtualNetworkGatewaySkuArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The name of the virtual network gateway.
    pub virtual_network_gateway_name: Option<Input<String>>,
    /// The reference of the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<Input<network::v20180601::VpnClientConfigurationArgs>>,
...
impl VirtualNetworkGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180601:VirtualNetworkGateway";
