...
pub struct VpnConnectionArgs {
    ...
    pub remote_vpn_site: Option<Input<network::v20230601::SubResourceArgs>>,
    /// The resource group name of the VpnGateway.
    pub resource_group_name: Input<String>,
    /// The Routing Configuration indicating the associated and propagated route tables on this connection.
    pub routing_configuration: Option<Input<network::v20230601::RoutingConfigurationArgs>>,
    ...
    pub vpn_link_connections: Option<Vec<Input<network::v20230601::VpnSiteLinkConnectionArgs>>>,
}
...
impl VpnConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230601:VpnConnection";
