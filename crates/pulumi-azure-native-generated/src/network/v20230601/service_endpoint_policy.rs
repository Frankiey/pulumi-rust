...
pub struct ServiceEndpointPolicyArgs {
    ...
    pub service_endpoint_policy_definitions: Option<Vec<Input<network::v20230601::ServiceEndpointPolicyDefinitionArgs>>>,
...
impl ServiceEndpointPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230601:ServiceEndpointPolicy";
