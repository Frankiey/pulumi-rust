...
pub struct AdminRuleArgs {
    ...
    pub destinations: Option<Vec<Input<network::v20230601::AddressPrefixItemArgs>>>,
    ...
    pub sources: Option<Vec<Input<network::v20230601::AddressPrefixItemArgs>>>,
}
...
impl AdminRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230601:AdminRule";
