...
pub struct GetDefaultAdminRuleResult {
    ...
    pub destinations: Vec<network::v20230601::AddressPrefixItemResponse>,
    ...
    pub sources: Vec<network::v20230601::AddressPrefixItemResponse>,
...
pub async fn get_default_admin_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20230601:getDefaultAdminRule", invoke_args, &opts).await?;
