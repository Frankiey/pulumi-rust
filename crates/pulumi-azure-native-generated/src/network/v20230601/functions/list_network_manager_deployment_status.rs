...
pub struct ListNetworkManagerDeploymentStatusResult {
    ...
    pub value: Option<Vec<network::v20230601::NetworkManagerDeploymentStatusResponse>>,
}
...
pub async fn list_network_manager_deployment_status(
    ...
    let result = ctx.invoke("azure-native:network/v20230601:listNetworkManagerDeploymentStatus", invoke_args, &opts).await?;
