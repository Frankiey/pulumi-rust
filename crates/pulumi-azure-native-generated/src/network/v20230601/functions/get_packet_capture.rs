...
pub struct GetPacketCaptureResult {
    ...
    pub filters: Option<Vec<network::v20230601::PacketCaptureFilterResponse>>,
    ...
    pub scope: Option<network::v20230601::PacketCaptureMachineScopeResponse>,
    /// The storage location for a packet capture session.
    pub storage_location: network::v20230601::PacketCaptureStorageLocationResponse,
...
pub async fn get_packet_capture(
    ...
    let result = ctx.invoke("azure-native:network/v20230601:getPacketCapture", invoke_args, &opts).await?;
