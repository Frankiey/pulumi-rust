...
pub struct GetNetworkVirtualApplianceResult {
    ...
    pub additional_nics: Option<Vec<network::v20230601::VirtualApplianceAdditionalNicPropertiesResponse>>,
    /// Address Prefix.
    ...
    pub delegation: Option<network::v20230601::DelegationPropertiesResponse>,
    ...
    pub inbound_security_rules: Vec<network::v20230601::SubResourceResponse>,
    /// List of Resource Uri of Public IPs for Internet Ingress Scenario.
    pub internet_ingress_public_ips: Option<Vec<network::v20230601::InternetIngressPublicIpsPropertiesResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// Network Virtual Appliance SKU.
    pub nva_sku: Option<network::v20230601::VirtualApplianceSkuPropertiesResponse>,
    /// The delegation for the Virtual Appliance
    pub partner_managed_resource: Option<network::v20230601::PartnerManagedResourcePropertiesResponse>,
    ...
    pub virtual_appliance_connections: Vec<network::v20230601::SubResourceResponse>,
    /// List of Virtual Appliance Network Interfaces.
    pub virtual_appliance_nics: Vec<network::v20230601::VirtualApplianceNicPropertiesResponse>,
    /// List of references to VirtualApplianceSite.
    pub virtual_appliance_sites: Vec<network::v20230601::SubResourceResponse>,
...
pub async fn get_network_virtual_appliance(
    ...
    let result = ctx.invoke("azure-native:network/v20230601:getNetworkVirtualAppliance", invoke_args, &opts).await?;
