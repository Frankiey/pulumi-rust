...
pub struct GetConnectivityConfigurationResult {
    ...
    pub applies_to_groups: Vec<network::v20230601::ConnectivityGroupItemResponse>,
    ...
    pub etag: String,
    /// List of hubItems
    pub hubs: Option<Vec<network::v20230601::HubResponse>>,
    /// Resource ID.
    pub id: String,
...
pub async fn get_connectivity_configuration(
    ...
    let result = ctx.invoke("azure-native:network/v20230601:getConnectivityConfiguration", invoke_args, &opts).await?;
