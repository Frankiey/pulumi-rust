...
pub struct GetExpressRouteCircuitResult {
    ...
    pub authorizations: Option<Vec<network::v20230601::ExpressRouteCircuitAuthorizationResponse>>,
    ...
    pub express_route_port: Option<network::v20230601::SubResourceResponse>,
    ...
    pub peerings: Option<Vec<network::v20230601::ExpressRouteCircuitPeeringResponse>>,
    ...
    pub service_provider_properties: Option<network::v20230601::ExpressRouteCircuitServiceProviderPropertiesResponse>,
    /// The ServiceProviderProvisioningState state of the resource.
    pub service_provider_provisioning_state: Option<String>,
    /// The SKU.
    pub sku: Option<network::v20230601::ExpressRouteCircuitSkuResponse>,
...
pub async fn get_express_route_circuit(
    ...
    let result = ctx.invoke("azure-native:network/v20230601:getExpressRouteCircuit", invoke_args, &opts).await?;
