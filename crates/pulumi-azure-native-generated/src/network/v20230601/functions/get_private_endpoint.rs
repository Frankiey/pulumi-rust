...
pub struct GetPrivateEndpointResult {
    ...
    pub application_security_groups: Option<Vec<network::v20230601::ApplicationSecurityGroupResponse>>,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// An array of custom dns configurations.
    pub custom_dns_configs: Option<Vec<network::v20230601::CustomDnsConfigPropertiesFormatResponse>>,
    /// The custom name of the network interface attached to the private endpoint.
    pub custom_network_interface_name: Option<String>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The extended location of the load balancer.
    pub extended_location: Option<network::v20230601::ExtendedLocationResponse>,
    /// Resource ID.
    pub id: Option<String>,
    /// A list of IP configurations of the private endpoint. This will be used to map to the First Party Service's endpoints.
    pub ip_configurations: Option<Vec<network::v20230601::PrivateEndpointIPConfigurationResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// A grouping of information about the connection to the remote resource. Used when the network admin does not have access to approve connections to the remote resource.
    pub manual_private_link_service_connections: Option<Vec<network::v20230601::PrivateLinkServiceConnectionResponse>>,
    /// Resource name.
    pub name: String,
    /// An array of references to the network interfaces created for this private endpoint.
    pub network_interfaces: Vec<network::v20230601::NetworkInterfaceResponse>,
    /// A grouping of information about the connection to the remote resource.
    pub private_link_service_connections: Option<Vec<network::v20230601::PrivateLinkServiceConnectionResponse>>,
    /// The provisioning state of the private endpoint resource.
    pub provisioning_state: String,
    /// The ID of the subnet from which the private IP will be allocated.
    pub subnet: Option<network::v20230601::SubnetResponse>,
    /// Resource tags.
...
pub async fn get_private_endpoint(
    ...
    let result = ctx.invoke("azure-native:network/v20230601:getPrivateEndpoint", invoke_args, &opts).await?;
