...
pub struct AdminRuleCollectionArgs {
    ...
    pub applies_to_groups: Vec<Input<network::v20230601::NetworkManagerSecurityGroupItemArgs>>,
...
impl AdminRuleCollection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230601:AdminRuleCollection";
