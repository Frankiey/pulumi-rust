...
pub struct PrivateLinkServicePrivateEndpointConnectionArgs {
    ...
    pub private_link_service_connection_state: Option<Input<network::v20230601::PrivateLinkServiceConnectionStateArgs>>,
...
impl PrivateLinkServicePrivateEndpointConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230601:PrivateLinkServicePrivateEndpointConnection";
