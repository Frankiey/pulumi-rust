...
pub struct NetworkVirtualApplianceArgs {
    ...
    pub additional_nics: Option<Vec<Input<network::v20230601::VirtualApplianceAdditionalNicPropertiesArgs>>>,
    ...
    pub delegation: Option<Input<network::v20230601::DelegationPropertiesArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// The service principal that has read access to cloud-init and config blob.
    pub identity: Option<Input<network::v20230601::ManagedServiceIdentityArgs>>,
    /// List of Resource Uri of Public IPs for Internet Ingress Scenario.
    pub internet_ingress_public_ips: Option<Vec<Input<network::v20230601::InternetIngressPublicIpsPropertiesArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The name of Network Virtual Appliance.
    pub network_virtual_appliance_name: Option<Input<String>>,
    /// Network Virtual Appliance SKU.
    pub nva_sku: Option<Input<network::v20230601::VirtualApplianceSkuPropertiesArgs>>,
...
impl NetworkVirtualAppliance {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230601:NetworkVirtualAppliance";
