...
pub struct NetworkSecurityGroupArgs {
    ...
    pub default_security_rules: Option<Vec<Input<network::v20181101::SecurityRuleArgs>>>,
    /// Resource ID.
    ...
    pub security_rules: Option<Vec<Input<network::v20181101::SecurityRuleArgs>>>,
    /// Resource tags.
...
impl NetworkSecurityGroup {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181101:NetworkSecurityGroup";
