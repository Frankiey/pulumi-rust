...
pub struct GetExpressRouteCircuitPeeringResult {
    ...
    pub connections: Option<Vec<network::v20181101::ExpressRouteCircuitConnectionResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The ExpressRoute connection.
    pub express_route_connection: Option<network::v20181101::ExpressRouteConnectionIdResponse>,
    /// The GatewayManager Etag.
    pub gateway_manager_etag: Option<String>,
    /// Resource ID.
    pub id: Option<String>,
    /// The IPv6 peering configuration.
    pub ipv6peering_config: Option<network::v20181101::Ipv6ExpressRouteCircuitPeeringConfigResponse>,
    /// Gets whether the provider or the customer last modified the peering.
    pub last_modified_by: Option<String>,
    /// The Microsoft peering configuration.
    pub microsoft_peering_config: Option<network::v20181101::ExpressRouteCircuitPeeringConfigResponse>,
    ...
    pub route_filter: Option<network::v20181101::RouteFilterResponse>,
    /// The secondary port.
    ...
    /// Gets peering stats.
    pub stats: Option<network::v20181101::ExpressRouteCircuitStatsResponse>,
    /// The VLAN ID.
...
pub async fn get_express_route_circuit_peering(
    ...
    let result = ctx.invoke("azure-native:network/v20181101:getExpressRouteCircuitPeering", invoke_args, &opts).await?;
