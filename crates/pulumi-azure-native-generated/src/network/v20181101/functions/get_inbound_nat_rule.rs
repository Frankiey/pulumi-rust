...
pub struct GetInboundNatRuleResult {
    ...
    pub backend_ip_configuration: network::v20181101::NetworkInterfaceIPConfigurationResponse,
    ...
    pub frontend_ip_configuration: Option<network::v20181101::SubResourceResponse>,
...
pub async fn get_inbound_nat_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20181101:getInboundNatRule", invoke_args, &opts).await?;
