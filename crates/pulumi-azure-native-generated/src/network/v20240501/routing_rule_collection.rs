...
pub struct RoutingRuleCollectionArgs {
    ...
    pub applies_to: Vec<Input<network::v20240501::NetworkManagerRoutingGroupItemArgs>>,
...
impl RoutingRuleCollection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240501:RoutingRuleCollection";
