...
pub struct P2sVpnGatewayArgs {
    ...
    pub p2s_connection_configurations: Option<Vec<Input<network::v20240501::P2SConnectionConfigurationArgs>>>,
    ...
    pub vpn_server_configuration: Option<Input<network::v20240501::SubResourceArgs>>,
}
...
impl P2sVpnGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240501:P2sVpnGateway";
