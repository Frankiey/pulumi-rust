...
pub struct VpnServerConfigurationArgs {
    ...
    pub properties: Option<Input<network::v20240501::VpnServerConfigurationPropertiesArgs>>,
...
impl VpnServerConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240501:VpnServerConfiguration";
