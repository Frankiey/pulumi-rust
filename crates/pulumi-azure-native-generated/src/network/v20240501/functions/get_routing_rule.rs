...
pub struct GetRoutingRuleResult {
    ...
    pub destination: network::v20240501::RoutingRuleRouteDestinationResponse,
    ...
    pub next_hop: network::v20240501::RoutingRuleNextHopResponse,
...
pub async fn get_routing_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20240501:getRoutingRule", invoke_args, &opts).await?;
