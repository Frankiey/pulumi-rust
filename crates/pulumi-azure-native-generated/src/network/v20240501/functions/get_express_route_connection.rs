...
pub struct GetExpressRouteConnectionResult {
    ...
    pub express_route_circuit_peering: network::v20240501::ExpressRouteCircuitPeeringIdResponse,
...
pub async fn get_express_route_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20240501:getExpressRouteConnection", invoke_args, &opts).await?;
