...
pub struct ListVpnLinkConnectionDefaultSharedKeyResult {
    ...
    pub properties: network::v20240501::SharedKeyPropertiesResponse,
    /// Resource type.
    pub type_: String,
}
...
pub async fn list_vpn_link_connection_default_shared_key(
    ...
    let result = ctx.invoke("azure-native:network/v20240501:listVpnLinkConnectionDefaultSharedKey", invoke_args, &opts).await?;
