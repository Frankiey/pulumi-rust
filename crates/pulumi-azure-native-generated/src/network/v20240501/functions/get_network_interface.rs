...
pub struct GetNetworkInterfaceResult {
    ...
    pub default_outbound_connectivity_enabled: bool,
    /// Indicates whether to disable tcp state tracking.
    pub disable_tcp_state_tracking: Option<bool>,
    /// The DNS settings in network interface.
    pub dns_settings: Option<network::v20240501::NetworkInterfaceDnsSettingsResponse>,
    /// A reference to the dscp configuration to which the network interface is linked.
    pub dscp_configuration: network::v20240501::SubResourceResponse,
    ...
    pub ip_configurations: Option<Vec<network::v20240501::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint: network::v20240501::PrivateEndpointResponse,
    /// Privatelinkservice of the network interface resource.
    pub private_link_service: Option<network::v20240501::PrivateLinkServiceResponse>,
    ...
    pub tap_configurations: Vec<network::v20240501::NetworkInterfaceTapConfigurationResponse>,
    /// Resource type.
    pub type_: String,
    /// The reference to a virtual machine.
    pub virtual_machine: network::v20240501::SubResourceResponse,
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network/v20240501:getNetworkInterface", invoke_args, &opts).await?;
    ...
    Ok(GetNetworkInterfaceResult {
        ...
        azure_api_version: serde_json::from_value(result.fields.get("azureApiVersion").cloned().unwrap_or_default())?
            ,
        default_outbound_connectivity_enabled: serde_json::from_value(result.fields.get("defaultOutboundConnectivityEnabled").cloned().unwrap_or_default())?
            ,
