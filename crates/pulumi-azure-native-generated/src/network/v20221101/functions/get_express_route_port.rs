...
pub struct GetExpressRoutePortResult {
    ...
    pub circuits: Vec<network::v20221101::SubResourceResponse>,
    ...
    pub links: Option<Vec<network::v20221101::ExpressRouteLinkResponse>>,
    /// Resource location.
...
pub async fn get_express_route_port(
    ...
    let result = ctx.invoke("azure-native:network/v20221101:getExpressRoutePort", invoke_args, &opts).await?;
