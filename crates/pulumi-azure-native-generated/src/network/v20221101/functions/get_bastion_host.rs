...
pub struct GetBastionHostResult {
    ...
    pub ip_configurations: Option<Vec<network::v20221101::BastionHostIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub sku: Option<network::v20221101::SkuResponse>,
    /// Resource tags.
...
pub async fn get_bastion_host(
    ...
    let result = ctx.invoke("azure-native:network/v20221101:getBastionHost", invoke_args, &opts).await?;
