...
pub struct GetPrivateLinkServiceResult {
    ...
    pub auto_approval: Option<network::v20221101::PrivateLinkServicePropertiesResponseAutoApproval>,
    ...
    pub ip_configurations: Option<Vec<network::v20221101::PrivateLinkServiceIpConfigurationResponse>>,
    /// An array of references to the load balancer IP configurations.
    pub load_balancer_frontend_ip_configurations: Option<Vec<network::v20221101::FrontendIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint_connections: Vec<network::v20221101::PrivateEndpointConnectionResponse>,
    ...
    pub visibility: Option<network::v20221101::PrivateLinkServicePropertiesResponseVisibility>,
}
...
pub async fn get_private_link_service(
    ...
    let result = ctx.invoke("azure-native:network/v20221101:getPrivateLinkService", invoke_args, &opts).await?;
