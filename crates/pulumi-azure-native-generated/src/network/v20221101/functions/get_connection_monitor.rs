...
pub struct GetConnectionMonitorResult {
    ...
    pub destination: Option<network::v20221101::ConnectionMonitorDestinationResponse>,
    /// List of connection monitor endpoints.
    pub endpoints: Option<Vec<network::v20221101::ConnectionMonitorEndpointResponse>>,
    ...
    pub outputs: Option<Vec<network::v20221101::ConnectionMonitorOutputResponse>>,
    /// The provisioning state of the connection monitor.
    pub provisioning_state: String,
    /// Describes the source of connection monitor.
    pub source: Option<network::v20221101::ConnectionMonitorSourceResponse>,
    /// The date and time when the connection monitor was started.
    pub start_time: String,
    /// Connection monitor tags.
    pub tags: Option<HashMap<String, String>>,
    /// List of connection monitor test configurations.
    pub test_configurations: Option<Vec<network::v20221101::ConnectionMonitorTestConfigurationResponse>>,
    /// List of connection monitor test groups.
    pub test_groups: Option<Vec<network::v20221101::ConnectionMonitorTestGroupResponse>>,
...
pub async fn get_connection_monitor(
    ...
    let result = ctx.invoke("azure-native:network/v20221101:getConnectionMonitor", invoke_args, &opts).await?;
