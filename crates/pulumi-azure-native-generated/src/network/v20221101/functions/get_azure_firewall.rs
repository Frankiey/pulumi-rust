...
pub struct GetAzureFirewallResult {
    ...
    pub application_rule_collections: Option<Vec<network::v20221101::AzureFirewallApplicationRuleCollectionResponse>>,
    ...
    pub hub_ip_addresses: Option<network::v20221101::HubIPAddressesResponse>,
    /// Resource ID.
    pub id: Option<String>,
    /// IP configuration of the Azure Firewall resource.
    pub ip_configurations: Option<Vec<network::v20221101::AzureFirewallIPConfigurationResponse>>,
    /// IpGroups associated with AzureFirewall.
    pub ip_groups: Vec<network::v20221101::AzureFirewallIpGroupsResponse>,
    /// Resource location.
    pub location: Option<String>,
    /// IP configuration of the Azure Firewall used for management traffic.
    pub management_ip_configuration: Option<network::v20221101::AzureFirewallIPConfigurationResponse>,
    /// Resource name.
    pub name: String,
    /// Collection of NAT rule collections used by Azure Firewall.
    pub nat_rule_collections: Option<Vec<network::v20221101::AzureFirewallNatRuleCollectionResponse>>,
    /// Collection of network rule collections used by Azure Firewall.
    pub network_rule_collections: Option<Vec<network::v20221101::AzureFirewallNetworkRuleCollectionResponse>>,
    /// The provisioning state of the Azure firewall resource.
    pub provisioning_state: String,
    /// The Azure Firewall Resource SKU.
    pub sku: Option<network::v20221101::AzureFirewallSkuResponse>,
    /// Resource tags.
    ...
    pub virtual_hub: Option<network::v20221101::SubResourceResponse>,
...
pub async fn get_azure_firewall(
    ...
    let result = ctx.invoke("azure-native:network/v20221101:getAzureFirewall", invoke_args, &opts).await?;
