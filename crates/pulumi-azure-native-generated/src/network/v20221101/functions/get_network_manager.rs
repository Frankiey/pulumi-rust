...
pub struct GetNetworkManagerResult {
    ...
    pub network_manager_scopes: network::v20221101::NetworkManagerPropertiesResponseNetworkManagerScopes,
    /// The provisioning state of the network manager resource.
    pub provisioning_state: String,
    /// The system metadata related to this resource.
    pub system_data: network::v20221101::SystemDataResponse,
    /// Resource tags.
...
pub async fn get_network_manager(
    ...
    let result = ctx.invoke("azure-native:network/v20221101:getNetworkManager", invoke_args, &opts).await?;
