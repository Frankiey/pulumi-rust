...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20221101::BgpSettingsResponse>,
    /// The device properties.
    pub device_properties: Option<network::v20221101::DevicePropertiesResponse>,
    ...
    pub name: String,
    /// Office365 Policy.
    pub o365policy: Option<network::v20221101::O365PolicyPropertiesResponse>,
    ...
    pub vpn_site_links: Option<Vec<network::v20221101::VpnSiteLinkResponse>>,
}
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20221101:getVpnSite", invoke_args, &opts).await?;
