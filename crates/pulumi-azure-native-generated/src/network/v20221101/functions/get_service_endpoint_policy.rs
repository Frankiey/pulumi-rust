...
pub struct GetServiceEndpointPolicyResult {
    ...
    pub service_endpoint_policy_definitions: Option<Vec<network::v20221101::ServiceEndpointPolicyDefinitionResponse>>,
...
pub async fn get_service_endpoint_policy(
    ...
    let result = ctx.invoke("azure-native:network/v20221101:getServiceEndpointPolicy", invoke_args, &opts).await?;
