...
pub struct GetExpressRouteConnectionResult {
    ...
    pub express_route_circuit_peering: network::v20221101::ExpressRouteCircuitPeeringIdResponse,
...
pub async fn get_express_route_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20221101:getExpressRouteConnection", invoke_args, &opts).await?;
