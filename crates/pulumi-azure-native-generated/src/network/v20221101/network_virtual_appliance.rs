...
pub struct NetworkVirtualApplianceArgs {
    ...
    pub additional_nics: Option<Vec<Input<network::v20221101::VirtualApplianceAdditionalNicPropertiesArgs>>>,
    ...
    pub delegation: Option<Input<network::v20221101::DelegationPropertiesArgs>>,
    /// Resource ID.
    ...
    pub nva_sku: Option<Input<network::v20221101::VirtualApplianceSkuPropertiesArgs>>,
...
impl NetworkVirtualAppliance {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20221101:NetworkVirtualAppliance";
