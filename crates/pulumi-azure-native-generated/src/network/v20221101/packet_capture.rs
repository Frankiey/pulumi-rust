...
pub struct PacketCaptureArgs {
    ...
    pub filters: Option<Vec<Input<network::v20221101::PacketCaptureFilterArgs>>>,
    ...
    pub scope: Option<Input<network::v20221101::PacketCaptureMachineScopeArgs>>,
    /// The storage location for a packet capture session.
    pub storage_location: Input<network::v20221101::PacketCaptureStorageLocationArgs>,
    /// The ID of the targeted resource, only AzureVM and AzureVMSS as target type are currently supported.
    pub target: Input<String>,
    /// Target type of the resource provided.
    pub target_type: Option<Input<network::v20221101::PacketCaptureTargetTypeArgs>>,
...
impl PacketCapture {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20221101:PacketCapture";
