...
pub struct VirtualNetworkGatewayArgs {
    ...
    pub bgp_settings: Option<Input<network::v20221101::BgpSettingsArgs>>,
    /// The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
    pub custom_routes: Option<Input<network::v20221101::AddressSpaceArgs>>,
    ...
    pub gateway_default_site: Option<Input<network::v20221101::SubResourceArgs>>,
    /// The type of this virtual network gateway.
    pub gateway_type: Option<Input<serde_json::Value>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// IP configurations for virtual network gateway.
    pub ip_configurations: Option<Vec<Input<network::v20221101::VirtualNetworkGatewayIPConfigurationArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// NatRules for virtual network gateway.
    pub nat_rules: Option<Vec<Input<network::v20221101::VirtualNetworkGatewayNatRuleArgs>>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The reference to the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
    pub sku: Option<Input<network::v20221101::VirtualNetworkGatewaySkuArgs>>,
    /// Resource tags.
    ...
    pub virtual_network_gateway_policy_groups: Option<Vec<Input<network::v20221101::VirtualNetworkGatewayPolicyGroupArgs>>>,
    /// The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<Input<network::v20221101::VpnClientConfigurationArgs>>,
...
impl VirtualNetworkGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20221101:VirtualNetworkGateway";
