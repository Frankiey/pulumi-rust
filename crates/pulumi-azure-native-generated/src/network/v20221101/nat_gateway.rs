...
pub struct NatGatewayArgs {
    ...
    pub public_ip_addresses: Option<Vec<Input<network::v20221101::SubResourceArgs>>>,
    /// An array of public ip prefixes associated with the nat gateway resource.
    pub public_ip_prefixes: Option<Vec<Input<network::v20221101::SubResourceArgs>>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The nat gateway SKU.
    pub sku: Option<Input<network::v20221101::NatGatewaySkuArgs>>,
    /// Resource tags.
...
impl NatGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20221101:NatGateway";
