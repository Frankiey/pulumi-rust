...
pub struct GetPublicIPAddressResult {
    ...
    pub ddos_settings: Option<network::v20201101::DdosSettingsResponse>,
    /// The FQDN of the DNS record associated with the public IP address.
    pub dns_settings: Option<network::v20201101::PublicIPAddressDnsSettingsResponse>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The extended location of the public ip address.
    pub extended_location: Option<network::v20201101::ExtendedLocationResponse>,
    /// Resource ID.
    ...
    pub ip_configuration: network::v20201101::IPConfigurationResponse,
    /// The list of tags associated with the public IP address.
    pub ip_tags: Option<Vec<network::v20201101::IpTagResponse>>,
    /// The linked public IP address of the public IP address resource.
    pub linked_public_ip_address: Option<network::v20201101::PublicIPAddressResponse>,
    /// Resource location.
    ...
    pub nat_gateway: Option<network::v20201101::NatGatewayResponse>,
    ...
    pub public_ip_prefix: Option<network::v20201101::SubResourceResponse>,
    /// The resource GUID property of the public IP address resource.
    pub resource_guid: String,
    /// The service public IP address of the public IP address resource.
    pub service_public_ip_address: Option<network::v20201101::PublicIPAddressResponse>,
    /// The public IP address SKU.
    pub sku: Option<network::v20201101::PublicIPAddressSkuResponse>,
    /// Resource tags.
...
pub async fn get_public_ip_address(
    ...
    let result = ctx.invoke("azure-native:network/v20201101:getPublicIPAddress", invoke_args, &opts).await?;
