...
pub struct GetVpnGatewayResult {
    ...
    pub connections: Option<Vec<network::v20201101::VpnConnectionResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// Resource ID.
    pub id: Option<String>,
    /// List of all IPs configured on the gateway.
    pub ip_configurations: Vec<network::v20201101::VpnGatewayIpConfigurationResponse>,
    ...
    pub nat_rules: Option<Vec<network::v20201101::VpnGatewayNatRuleResponse>>,
...
pub async fn get_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20201101:getVpnGateway", invoke_args, &opts).await?;
