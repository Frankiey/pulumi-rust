...
pub struct GetVirtualNetworkGatewayResult {
    ...
    pub bgp_settings: Option<network::v20201101::BgpSettingsResponse>,
    /// The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
    pub custom_routes: Option<network::v20201101::AddressSpaceResponse>,
    ...
    pub gateway_default_site: Option<network::v20201101::SubResourceResponse>,
    ...
    pub ip_configurations: Option<Vec<network::v20201101::VirtualNetworkGatewayIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub sku: Option<network::v20201101::VirtualNetworkGatewaySkuResponse>,
    /// Resource tags.
    ...
    pub vpn_client_configuration: Option<network::v20201101::VpnClientConfigurationResponse>,
...
pub async fn get_virtual_network_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20201101:getVirtualNetworkGateway", invoke_args, &opts).await?;
