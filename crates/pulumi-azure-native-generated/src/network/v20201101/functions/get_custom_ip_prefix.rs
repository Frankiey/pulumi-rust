...
pub struct GetCustomIPPrefixResult {
    ...
    pub public_ip_prefixes: Vec<network::v20201101::SubResourceResponse>,
...
pub async fn get_custom_ip_prefix(
    ...
    let result = ctx.invoke("azure-native:network/v20201101:getCustomIPPrefix", invoke_args, &opts).await?;
