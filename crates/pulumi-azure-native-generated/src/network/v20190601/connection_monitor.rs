...
pub struct ConnectionMonitorArgs {
    ...
    pub destination: Input<network::v20190601::ConnectionMonitorDestinationArgs>,
    ...
    pub source: Input<network::v20190601::ConnectionMonitorSourceArgs>,
...
impl ConnectionMonitor {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190601:ConnectionMonitor";
