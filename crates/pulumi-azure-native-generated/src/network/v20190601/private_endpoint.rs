...
pub struct PrivateEndpointArgs {
    ...
    pub manual_private_link_service_connections: Option<Vec<Input<network::v20190601::PrivateLinkServiceConnectionArgs>>>,
    /// The name of the private endpoint.
    pub private_endpoint_name: Option<Input<String>>,
    /// A grouping of information about the connection to the remote resource.
    pub private_link_service_connections: Option<Vec<Input<network::v20190601::PrivateLinkServiceConnectionArgs>>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The ID of the subnet from which the private IP will be allocated.
    pub subnet: Option<Input<network::v20190601::SubnetArgs>>,
    /// Resource tags.
...
impl PrivateEndpoint {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190601:PrivateEndpoint";
