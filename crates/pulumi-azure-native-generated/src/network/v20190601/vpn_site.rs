...
pub struct VpnSiteArgs {
    ...
    pub bgp_properties: Option<Input<network::v20190601::BgpSettingsArgs>>,
    /// The device properties.
    pub device_properties: Option<Input<network::v20190601::DevicePropertiesArgs>>,
    /// Resource ID.
    ...
    pub vpn_site_links: Option<Vec<Input<network::v20190601::VpnSiteLinkArgs>>>,
...
impl VpnSite {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190601:VpnSite";
