...
pub struct GetVirtualNetworkGatewayAdvertisedRoutesResult {
    ...
    pub value: Option<Vec<network::v20190601::GatewayRouteResponse>>,
}
...
pub async fn get_virtual_network_gateway_advertised_routes(
    ...
    let result = ctx.invoke("azure-native:network/v20190601:getVirtualNetworkGatewayAdvertisedRoutes", invoke_args, &opts).await?;
