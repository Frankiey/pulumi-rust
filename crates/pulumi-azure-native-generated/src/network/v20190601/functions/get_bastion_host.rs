...
pub struct GetBastionHostResult {
    ...
    pub ip_configurations: Option<Vec<network::v20190601::BastionHostIPConfigurationResponse>>,
    /// Resource location.
...
pub async fn get_bastion_host(
    ...
    let result = ctx.invoke("azure-native:network/v20190601:getBastionHost", invoke_args, &opts).await?;
