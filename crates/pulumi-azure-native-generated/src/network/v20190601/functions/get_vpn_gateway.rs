...
pub struct GetVpnGatewayResult {
    ...
    pub connections: Option<Vec<network::v20190601::VpnConnectionResponse>>,
...
pub async fn get_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20190601:getVpnGateway", invoke_args, &opts).await?;
