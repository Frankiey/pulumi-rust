...
pub struct FirewallPolicyArgs {
    ...
    pub base_policy: Option<Input<network::v20200401::SubResourceArgs>>,
    ...
    pub threat_intel_whitelist: Option<Input<network::v20200401::FirewallPolicyThreatIntelWhitelistArgs>>,
}
...
impl FirewallPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200401:FirewallPolicy";
