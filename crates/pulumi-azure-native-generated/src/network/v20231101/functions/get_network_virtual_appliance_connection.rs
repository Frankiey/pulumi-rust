...
pub struct GetNetworkVirtualApplianceConnectionResult {
    ...
    pub properties: network::v20231101::NetworkVirtualApplianceConnectionPropertiesResponse,
}
...
pub async fn get_network_virtual_appliance_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20231101:getNetworkVirtualApplianceConnection", invoke_args, &opts).await?;
