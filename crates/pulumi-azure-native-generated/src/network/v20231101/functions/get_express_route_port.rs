...
pub struct GetExpressRoutePortResult {
    ...
    pub circuits: Vec<network::v20231101::SubResourceResponse>,
    ...
    pub links: Option<Vec<network::v20231101::ExpressRouteLinkResponse>>,
    /// Resource location.
...
pub async fn get_express_route_port(
    ...
    let result = ctx.invoke("azure-native:network/v20231101:getExpressRoutePort", invoke_args, &opts).await?;
