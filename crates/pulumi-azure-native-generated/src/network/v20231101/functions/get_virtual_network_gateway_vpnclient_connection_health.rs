...
pub struct GetVirtualNetworkGatewayVpnclientConnectionHealthResult {
    ...
    pub value: Option<Vec<network::v20231101::VpnClientConnectionHealthDetailResponse>>,
}
...
pub async fn get_virtual_network_gateway_vpnclient_connection_health(
    ...
    let result = ctx.invoke("azure-native:network/v20231101:getVirtualNetworkGatewayVpnclientConnectionHealth", invoke_args, &opts).await?;
