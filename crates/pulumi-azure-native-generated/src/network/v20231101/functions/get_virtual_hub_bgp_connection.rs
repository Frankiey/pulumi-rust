...
pub struct GetVirtualHubBgpConnectionResult {
    ...
    pub hub_virtual_network_connection: Option<network::v20231101::SubResourceResponse>,
    /// Resource ID.
...
pub async fn get_virtual_hub_bgp_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20231101:getVirtualHubBgpConnection", invoke_args, &opts).await?;
