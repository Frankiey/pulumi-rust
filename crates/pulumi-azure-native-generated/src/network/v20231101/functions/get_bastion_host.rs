...
pub struct GetBastionHostResult {
    ...
    pub ip_configurations: Option<Vec<network::v20231101::BastionHostIPConfigurationResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    pub network_acls: Option<network::v20231101::BastionHostPropertiesFormatResponseNetworkAcls>,
    /// The provisioning state of the bastion host resource.
    pub provisioning_state: String,
    /// The scale units for the Bastion Host resource.
    pub scale_units: Option<i64>,
    /// The sku of this Bastion Host.
    pub sku: Option<network::v20231101::SkuResponse>,
    /// Resource tags.
...
pub async fn get_bastion_host(
    ...
    let result = ctx.invoke("azure-native:network/v20231101:getBastionHost", invoke_args, &opts).await?;
