...
pub struct InboundNatRuleArgs {
    ...
    pub backend_address_pool: Option<Input<network::v20231101::SubResourceArgs>>,
    ...
    pub frontend_ip_configuration: Option<Input<network::v20231101::SubResourceArgs>>,
...
impl InboundNatRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20231101:InboundNatRule";
