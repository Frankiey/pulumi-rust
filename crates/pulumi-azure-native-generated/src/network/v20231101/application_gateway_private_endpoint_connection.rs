...
pub struct ApplicationGatewayPrivateEndpointConnectionArgs {
    ...
    pub private_link_service_connection_state: Option<Input<network::v20231101::PrivateLinkServiceConnectionStateArgs>>,
...
impl ApplicationGatewayPrivateEndpointConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20231101:ApplicationGatewayPrivateEndpointConnection";
