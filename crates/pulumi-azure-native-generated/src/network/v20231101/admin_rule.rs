...
pub struct AdminRuleArgs {
    ...
    pub destinations: Option<Vec<Input<network::v20231101::AddressPrefixItemArgs>>>,
    ...
    pub sources: Option<Vec<Input<network::v20231101::AddressPrefixItemArgs>>>,
}
...
impl AdminRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20231101:AdminRule";
