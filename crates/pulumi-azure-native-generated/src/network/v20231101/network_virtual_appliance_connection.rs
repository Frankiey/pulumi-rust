...
pub struct NetworkVirtualApplianceConnectionArgs {
    ...
    pub properties: Option<Input<network::v20231101::NetworkVirtualApplianceConnectionPropertiesArgs>>,
...
impl NetworkVirtualApplianceConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20231101:NetworkVirtualApplianceConnection";
