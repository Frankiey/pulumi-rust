...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20180701::BgpSettingsResponse>,
    /// The device properties
    pub device_properties: Option<network::v20180701::DevicePropertiesResponse>,
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20180701:getVpnSite", invoke_args, &opts).await?;
