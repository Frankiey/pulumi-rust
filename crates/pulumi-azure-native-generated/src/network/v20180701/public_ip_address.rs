...
pub struct PublicIPAddressArgs {
    ...
    pub dns_settings: Option<Input<network::v20180701::PublicIPAddressDnsSettingsArgs>>,
    /// Resource ID.
    ...
    pub public_ip_prefix: Option<Input<network::v20180701::SubResourceArgs>>,
    ...
    pub sku: Option<Input<network::v20180701::PublicIPAddressSkuArgs>>,
    /// Resource tags.
...
impl PublicIPAddress {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180701:PublicIPAddress";
