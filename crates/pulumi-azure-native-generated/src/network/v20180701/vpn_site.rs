...
pub struct VpnSiteArgs {
    ...
    pub bgp_properties: Option<Input<network::v20180701::BgpSettingsArgs>>,
    /// The device properties
    pub device_properties: Option<Input<network::v20180701::DevicePropertiesArgs>>,
    /// Resource ID.
    ...
    pub virtual_wan: Option<Input<network::v20180701::SubResourceArgs>>,
...
impl VpnSite {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180701:VpnSite";
