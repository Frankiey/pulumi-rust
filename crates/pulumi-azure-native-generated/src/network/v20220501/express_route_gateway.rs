...
pub struct ExpressRouteGatewayArgs {
    ...
    pub auto_scale_configuration: Option<Input<network::v20220501::ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>>,
    /// List of ExpressRoute connections to the ExpressRoute gateway.
    pub express_route_connections: Option<Vec<Input<network::v20220501::ExpressRouteConnectionArgs>>>,
    ...
    pub virtual_hub: Input<network::v20220501::VirtualHubIdArgs>,
}
...
impl ExpressRouteGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220501:ExpressRouteGateway";
