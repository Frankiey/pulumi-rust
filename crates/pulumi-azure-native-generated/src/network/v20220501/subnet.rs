...
pub struct SubnetArgs {
    ...
    pub application_gateway_ip_configurations: Option<Vec<Input<network::v20220501::ApplicationGatewayIPConfigurationArgs>>>,
    /// An array of references to the delegations on the subnet.
    pub delegations: Option<Vec<Input<network::v20220501::DelegationArgs>>>,
    /// Resource ID.
    ...
    pub nat_gateway: Option<Input<network::v20220501::SubResourceArgs>>,
    ...
    pub route_table: Option<Input<network::v20220501::RouteTableArgs>>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<Input<network::v20220501::ServiceEndpointPolicyArgs>>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<Input<network::v20220501::ServiceEndpointPropertiesFormatArgs>>>,
...
impl Subnet {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220501:Subnet";
