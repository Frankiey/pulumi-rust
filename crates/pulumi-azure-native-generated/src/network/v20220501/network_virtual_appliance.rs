...
pub struct NetworkVirtualApplianceArgs {
    ...
    pub nva_sku: Option<Input<network::v20220501::VirtualApplianceSkuPropertiesArgs>>,
...
impl NetworkVirtualAppliance {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220501:NetworkVirtualAppliance";
