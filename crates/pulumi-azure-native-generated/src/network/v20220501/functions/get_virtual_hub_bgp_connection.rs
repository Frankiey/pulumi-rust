...
pub struct GetVirtualHubBgpConnectionResult {
    ...
    pub hub_virtual_network_connection: Option<network::v20220501::SubResourceResponse>,
    /// Resource ID.
...
pub async fn get_virtual_hub_bgp_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20220501:getVirtualHubBgpConnection", invoke_args, &opts).await?;
