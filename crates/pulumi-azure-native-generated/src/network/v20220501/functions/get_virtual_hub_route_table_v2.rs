...
pub struct GetVirtualHubRouteTableV2Result {
    ...
    /// List of all routes.
    pub routes: Option<Vec<network::v20220501::VirtualHubRouteV2Response>>,
}
...
pub async fn get_virtual_hub_route_table_v2(
    ...
    let result = ctx.invoke("azure-native:network/v20220501:getVirtualHubRouteTableV2", invoke_args, &opts).await?;
