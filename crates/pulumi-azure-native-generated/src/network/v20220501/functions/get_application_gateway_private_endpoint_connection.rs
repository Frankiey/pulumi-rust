...
pub struct GetApplicationGatewayPrivateEndpointConnectionResult {
    ...
    pub private_link_service_connection_state: Option<network::v20220501::PrivateLinkServiceConnectionStateResponse>,
...
pub async fn get_application_gateway_private_endpoint_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20220501:getApplicationGatewayPrivateEndpointConnection", invoke_args, &opts).await?;
