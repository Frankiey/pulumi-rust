...
pub struct GetDdosProtectionPlanResult {
    ...
    pub public_ip_addresses: Vec<network::v20220501::SubResourceResponse>,
    ...
    pub virtual_networks: Vec<network::v20220501::SubResourceResponse>,
}
...
pub async fn get_ddos_protection_plan(
    ...
    let result = ctx.invoke("azure-native:network/v20220501:getDdosProtectionPlan", invoke_args, &opts).await?;
