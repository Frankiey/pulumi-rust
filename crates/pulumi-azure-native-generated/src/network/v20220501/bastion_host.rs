...
pub struct BastionHostArgs {
    ...
    pub ip_configurations: Option<Vec<Input<network::v20220501::BastionHostIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub sku: Option<Input<network::v20220501::SkuArgs>>,
    /// Resource tags.
...
impl BastionHost {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220501:BastionHost";
