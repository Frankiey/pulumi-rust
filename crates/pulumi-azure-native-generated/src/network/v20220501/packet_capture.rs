...
pub struct PacketCaptureArgs {
    ...
    pub filters: Option<Vec<Input<network::v20220501::PacketCaptureFilterArgs>>>,
    ...
    pub scope: Option<Input<network::v20220501::PacketCaptureMachineScopeArgs>>,
    /// The storage location for a packet capture session.
    pub storage_location: Input<network::v20220501::PacketCaptureStorageLocationArgs>,
    /// The ID of the targeted resource, only AzureVM and AzureVMSS as target type are currently supported.
    pub target: Input<String>,
    /// Target type of the resource provided.
    pub target_type: Option<Input<network::v20220501::PacketCaptureTargetTypeArgs>>,
...
impl PacketCapture {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20220501:PacketCapture";
