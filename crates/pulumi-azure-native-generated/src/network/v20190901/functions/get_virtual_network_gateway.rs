...
pub struct GetVirtualNetworkGatewayResult {
    ...
    pub bgp_settings: Option<network::v20190901::BgpSettingsResponse>,
    ...
    pub custom_routes: Option<network::v20190901::AddressSpaceResponse>,
    ...
    pub gateway_default_site: Option<network::v20190901::SubResourceResponse>,
    ...
    pub ip_configurations: Option<Vec<network::v20190901::VirtualNetworkGatewayIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub sku: Option<network::v20190901::VirtualNetworkGatewaySkuResponse>,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// Resource type.
    pub type_: String,
    /// The reference of the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<network::v20190901::VpnClientConfigurationResponse>,
...
pub async fn get_virtual_network_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20190901:getVirtualNetworkGateway", invoke_args, &opts).await?;
