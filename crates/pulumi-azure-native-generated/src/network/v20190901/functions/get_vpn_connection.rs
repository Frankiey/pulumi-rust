...
pub struct GetVpnConnectionResult {
    ...
    pub remote_vpn_site: Option<network::v20190901::SubResourceResponse>,
    ...
    pub vpn_link_connections: Option<Vec<network::v20190901::VpnSiteLinkConnectionResponse>>,
}
...
pub async fn get_vpn_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20190901:getVpnConnection", invoke_args, &opts).await?;
