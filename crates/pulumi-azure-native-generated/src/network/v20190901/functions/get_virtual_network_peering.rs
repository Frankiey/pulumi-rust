...
pub struct GetVirtualNetworkPeeringResult {
    ...
    pub remote_address_space: Option<network::v20190901::AddressSpaceResponse>,
    ...
    pub remote_virtual_network: Option<network::v20190901::SubResourceResponse>,
...
pub async fn get_virtual_network_peering(
    ...
    let result = ctx.invoke("azure-native:network/v20190901:getVirtualNetworkPeering", invoke_args, &opts).await?;
