...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20190901::BgpSettingsResponse>,
    /// The device properties.
    pub device_properties: Option<network::v20190901::DevicePropertiesResponse>,
    ...
    pub vpn_site_links: Option<Vec<network::v20190901::VpnSiteLinkResponse>>,
}
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20190901:getVpnSite", invoke_args, &opts).await?;
