...
pub struct GetInboundNatRuleResult {
    ...
    pub backend_ip_configuration: network::v20190901::NetworkInterfaceIPConfigurationResponse,
    ...
    pub frontend_ip_configuration: Option<network::v20190901::SubResourceResponse>,
...
pub async fn get_inbound_nat_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20190901:getInboundNatRule", invoke_args, &opts).await?;
