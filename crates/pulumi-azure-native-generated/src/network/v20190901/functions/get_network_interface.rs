...
pub struct GetNetworkInterfaceResult {
    ...
    pub dns_settings: Option<network::v20190901::NetworkInterfaceDnsSettingsResponse>,
    ...
    pub ip_configurations: Option<Vec<network::v20190901::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint: network::v20190901::PrivateEndpointResponse,
    ...
    pub tap_configurations: Vec<network::v20190901::NetworkInterfaceTapConfigurationResponse>,
    /// Resource type.
    pub type_: String,
    /// The reference of a virtual machine.
    pub virtual_machine: network::v20190901::SubResourceResponse,
}
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network/v20190901:getNetworkInterface", invoke_args, &opts).await?;
