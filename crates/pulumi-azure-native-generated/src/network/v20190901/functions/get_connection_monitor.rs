...
pub struct GetConnectionMonitorResult {
    ...
    pub destination: network::v20190901::ConnectionMonitorDestinationResponse,
    ...
    pub source: network::v20190901::ConnectionMonitorSourceResponse,
...
pub async fn get_connection_monitor(
    ...
    let result = ctx.invoke("azure-native:network/v20190901:getConnectionMonitor", invoke_args, &opts).await?;
