...
pub struct VirtualNetworkGatewayArgs {
    ...
    pub bgp_settings: Option<Input<network::v20190901::BgpSettingsArgs>>,
    ...
    pub custom_routes: Option<Input<network::v20190901::AddressSpaceArgs>>,
    ...
    pub gateway_default_site: Option<Input<network::v20190901::SubResourceArgs>>,
    /// The type of this virtual network gateway.
    pub gateway_type: Option<Input<serde_json::Value>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// IP configurations for virtual network gateway.
    pub ip_configurations: Option<Vec<Input<network::v20190901::VirtualNetworkGatewayIPConfigurationArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The reference of the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
    pub sku: Option<Input<network::v20190901::VirtualNetworkGatewaySkuArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The name of the virtual network gateway.
    pub virtual_network_gateway_name: Option<Input<String>>,
    /// The reference of the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<Input<network::v20190901::VpnClientConfigurationArgs>>,
...
impl VirtualNetworkGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190901:VirtualNetworkGateway";
