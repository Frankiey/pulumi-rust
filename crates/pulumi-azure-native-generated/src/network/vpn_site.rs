...
pub struct VpnSiteArgs {
    ...
    pub bgp_properties: Option<Input<network::BgpSettingsArgs>>,
    /// The device properties.
    pub device_properties: Option<Input<network::DevicePropertiesArgs>>,
    /// Resource ID.
    ...
    /// Office365 Policy.
    pub o365policy: Option<Input<network::O365PolicyPropertiesArgs>>,
    ...
    pub vpn_site_links: Option<Vec<Input<network::VpnSiteLinkArgs>>>,
...
impl VpnSite {
    const TYPE_TOKEN: &'static str = "azure-native:network:VpnSite";
