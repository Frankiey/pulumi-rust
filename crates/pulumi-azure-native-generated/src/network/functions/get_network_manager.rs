...
pub struct GetNetworkManagerResult {
    ...
    pub network_manager_scopes: network::NetworkManagerPropertiesResponseNetworkManagerScopes,
...
pub async fn get_network_manager(
    ...
    let result = ctx.invoke("azure-native:network:getNetworkManager", invoke_args, &opts).await?;
