...
pub struct GetConfigurationPolicyGroupResult {
    ...
    pub p2s_connection_configurations: Vec<network::SubResourceResponse>,
    /// Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
    pub policy_members: Option<Vec<network::VpnServerConfigurationPolicyGroupMemberResponse>>,
...
pub async fn get_configuration_policy_group(
    ...
    let result = ctx.invoke("azure-native:network:getConfigurationPolicyGroup", invoke_args, &opts).await?;
