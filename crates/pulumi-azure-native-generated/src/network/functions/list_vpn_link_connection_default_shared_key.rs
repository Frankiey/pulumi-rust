...
pub struct ListVpnLinkConnectionDefaultSharedKeyResult {
    ...
    pub properties: network::SharedKeyPropertiesResponse,
    /// Resource type.
    pub type_: String,
}
...
pub async fn list_vpn_link_connection_default_shared_key(
    ...
    let result = ctx.invoke("azure-native:network:listVpnLinkConnectionDefaultSharedKey", invoke_args, &opts).await?;
