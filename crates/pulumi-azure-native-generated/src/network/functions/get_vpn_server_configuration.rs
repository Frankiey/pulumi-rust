...
pub struct GetVpnServerConfigurationResult {
    ...
    pub properties: network::VpnServerConfigurationPropertiesResponse,
    /// Resource tags.
...
pub async fn get_vpn_server_configuration(
    ...
    let result = ctx.invoke("azure-native:network:getVpnServerConfiguration", invoke_args, &opts).await?;
