...
pub struct GetVirtualNetworkGatewayResiliencyInformationResult {
    ...
    pub components: Option<Vec<network::ResiliencyRecommendationComponentsResponse>>,
...
pub async fn get_virtual_network_gateway_resiliency_information(
    ...
    let result = ctx.invoke("azure-native:network:getVirtualNetworkGatewayResiliencyInformation", invoke_args, &opts).await?;
