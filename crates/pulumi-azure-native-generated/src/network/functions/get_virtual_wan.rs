...
pub struct GetVirtualWanResult {
    ...
    pub virtual_hubs: Vec<network::SubResourceResponse>,
    /// List of VpnSites in the VirtualWAN.
    pub vpn_sites: Vec<network::SubResourceResponse>,
}
...
pub async fn get_virtual_wan(
    ...
    let result = ctx.invoke("azure-native:network:getVirtualWan", invoke_args, &opts).await?;
