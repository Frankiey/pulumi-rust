...
pub struct GetBastionShareableLinkArgs {
    ...
    pub vms: Option<Vec<network::BastionShareableLink>>,
}
...
pub struct GetBastionShareableLinkResult {
    ...
    pub value: Option<Vec<network::BastionShareableLinkResponse>>,
}
...
pub async fn get_bastion_shareable_link(
    ...
    let result = ctx.invoke("azure-native:network:getBastionShareableLink", invoke_args, &opts).await?;
