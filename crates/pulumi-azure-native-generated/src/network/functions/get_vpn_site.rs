...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::BgpSettingsResponse>,
    /// The device properties.
    pub device_properties: Option<network::DevicePropertiesResponse>,
    ...
    pub name: String,
    /// Office365 Policy.
    pub o365policy: Option<network::O365PolicyPropertiesResponse>,
    ...
    pub vpn_site_links: Option<Vec<network::VpnSiteLinkResponse>>,
}
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network:getVpnSite", invoke_args, &opts).await?;
