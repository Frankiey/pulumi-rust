...
pub struct GetRoutingRuleResult {
    ...
    pub destination: network::RoutingRuleRouteDestinationResponse,
    ...
    pub next_hop: network::RoutingRuleNextHopResponse,
...
pub async fn get_routing_rule(
    ...
    let result = ctx.invoke("azure-native:network:getRoutingRule", invoke_args, &opts).await?;
