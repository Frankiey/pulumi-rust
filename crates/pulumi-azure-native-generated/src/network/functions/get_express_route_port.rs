...
pub struct GetExpressRoutePortResult {
    ...
    pub circuits: Vec<network::SubResourceResponse>,
    ...
    pub links: Option<Vec<network::ExpressRouteLinkResponse>>,
    /// Resource location.
...
pub async fn get_express_route_port(
    ...
    let result = ctx.invoke("azure-native:network:getExpressRoutePort", invoke_args, &opts).await?;
