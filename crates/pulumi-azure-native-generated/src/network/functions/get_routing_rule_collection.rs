...
pub struct GetRoutingRuleCollectionResult {
    ...
    pub applies_to: Vec<network::NetworkManagerRoutingGroupItemResponse>,
...
pub async fn get_routing_rule_collection(
    ...
    let result = ctx.invoke("azure-native:network:getRoutingRuleCollection", invoke_args, &opts).await?;
