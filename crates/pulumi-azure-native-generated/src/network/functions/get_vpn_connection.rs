...
pub struct GetVpnConnectionResult {
    ...
    pub remote_vpn_site: Option<network::SubResourceResponse>,
    /// The Routing Configuration indicating the associated and propagated route tables on this connection.
    pub routing_configuration: Option<network::RoutingConfigurationResponse>,
    ...
    pub vpn_link_connections: Option<Vec<network::VpnSiteLinkConnectionResponse>>,
}
...
pub async fn get_vpn_connection(
    ...
    let result = ctx.invoke("azure-native:network:getVpnConnection", invoke_args, &opts).await?;
