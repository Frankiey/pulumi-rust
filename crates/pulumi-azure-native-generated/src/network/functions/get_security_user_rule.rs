...
pub struct GetSecurityUserRuleResult {
    ...
    pub destinations: Option<Vec<network::AddressPrefixItemResponse>>,
    ...
    pub sources: Option<Vec<network::AddressPrefixItemResponse>>,
...
pub async fn get_security_user_rule(
    ...
    let result = ctx.invoke("azure-native:network:getSecurityUserRule", invoke_args, &opts).await?;
