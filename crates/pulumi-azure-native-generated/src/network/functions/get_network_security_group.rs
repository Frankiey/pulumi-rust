...
pub struct GetNetworkSecurityGroupResult {
    ...
    pub default_security_rules: Vec<network::SecurityRuleResponse>,
    ...
    pub security_rules: Option<Vec<network::SecurityRuleResponse>>,
    /// A collection of references to subnets.
    pub subnets: Vec<network::SubnetResponse>,
    /// Resource tags.
...
pub async fn get_network_security_group(
    ...
    let result = ctx.invoke("azure-native:network:getNetworkSecurityGroup", invoke_args, &opts).await?;
