...
pub struct GetServiceGatewayResult {
    ...
    pub route_target_address: Option<network::RouteTargetAddressPropertiesFormatResponse>,
    /// Route Target address V6 of Service gateway
    pub route_target_address_v6: Option<network::RouteTargetAddressPropertiesFormatResponse>,
    /// The service gateway SKU.
    pub sku: Option<network::ServiceGatewaySkuResponse>,
    ...
    pub virtual_network: Option<network::VirtualNetworkResponse>,
...
pub async fn get_service_gateway(
    ...
    let result = ctx.invoke("azure-native:network:getServiceGateway", invoke_args, &opts).await?;
