...
pub struct ListActiveConnectivityConfigurationsResult {
    ...
    pub value: Option<Vec<network::ActiveConnectivityConfigurationResponseV1>>,
}
...
pub async fn list_active_connectivity_configurations(
    ...
    let result = ctx.invoke("azure-native:network:listActiveConnectivityConfigurations", invoke_args, &opts).await?;
