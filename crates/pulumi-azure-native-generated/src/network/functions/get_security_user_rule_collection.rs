...
pub struct GetSecurityUserRuleCollectionResult {
    ...
    pub applies_to_groups: Vec<network::SecurityUserGroupItemResponse>,
...
pub async fn get_security_user_rule_collection(
    ...
    let result = ctx.invoke("azure-native:network:getSecurityUserRuleCollection", invoke_args, &opts).await?;
