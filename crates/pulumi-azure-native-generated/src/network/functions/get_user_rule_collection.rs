...
pub struct GetUserRuleCollectionResult {
    ...
    pub applies_to_groups: Vec<network::NetworkManagerSecurityGroupItemResponse>,
...
pub async fn get_user_rule_collection(
    ...
    let result = ctx.invoke("azure-native:network:getUserRuleCollection", invoke_args, &opts).await?;
