...
pub struct GetExpressRouteConnectionResult {
    ...
    pub express_route_circuit_peering: network::ExpressRouteCircuitPeeringIdResponse,
...
pub async fn get_express_route_connection(
    ...
    let result = ctx.invoke("azure-native:network:getExpressRouteConnection", invoke_args, &opts).await?;
