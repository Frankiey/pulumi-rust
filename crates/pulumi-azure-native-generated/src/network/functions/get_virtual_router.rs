...
pub struct GetVirtualRouterResult {
    ...
    pub hosted_gateway: Option<network::SubResourceResponse>,
    /// The Subnet on which VirtualRouter is hosted.
    pub hosted_subnet: Option<network::SubResourceResponse>,
    /// Resource ID.
    ...
    pub peerings: Vec<network::SubResourceResponse>,
...
pub async fn get_virtual_router(
    ...
    let result = ctx.invoke("azure-native:network:getVirtualRouter", invoke_args, &opts).await?;
