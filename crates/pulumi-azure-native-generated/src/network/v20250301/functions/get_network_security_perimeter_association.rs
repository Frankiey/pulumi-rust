...
pub struct GetNetworkSecurityPerimeterAssociationResult {
    ...
    pub private_link_resource: Option<network::v20250301::SubResourceResponse>,
    /// Profile id to which the PaaS resource is associated.
    pub profile: Option<network::v20250301::SubResourceResponse>,
...
pub async fn get_network_security_perimeter_association(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getNetworkSecurityPerimeterAssociation", invoke_args, &opts).await?;
