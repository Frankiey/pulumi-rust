...
pub struct GetPacketCaptureResult {
    ...
    pub capture_settings: Option<network::v20250301::PacketCaptureSettingsResponse>,
    ...
    pub filters: Option<Vec<network::v20250301::PacketCaptureFilterResponse>>,
    ...
    pub scope: Option<network::v20250301::PacketCaptureMachineScopeResponse>,
    /// The storage location for a packet capture session.
    pub storage_location: network::v20250301::PacketCaptureStorageLocationResponse,
...
pub async fn get_packet_capture(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getPacketCapture", invoke_args, &opts).await?;
