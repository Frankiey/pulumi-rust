...
pub struct GetFirewallPolicyResult {
    ...
    pub child_policies: Vec<network::v20250301::SubResourceResponse>,
    ...
    pub firewalls: Vec<network::v20250301::SubResourceResponse>,
    /// Resource ID.
    ...
    pub rule_collection_groups: Vec<network::v20250301::SubResourceResponse>,
    /// A read-only string that represents the size of the FirewallPolicyPropertiesFormat in MB. (ex 0.5MB)
    pub size: String,
    /// The Firewall Policy SKU.
    pub sku: Option<network::v20250301::FirewallPolicySkuResponse>,
    ...
    pub transport_security: Option<network::v20250301::FirewallPolicyTransportSecurityResponse>,
    /// Resource type.
    pub type_: String,
}
...
pub async fn get_firewall_policy(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getFirewallPolicy", invoke_args, &opts).await?;
