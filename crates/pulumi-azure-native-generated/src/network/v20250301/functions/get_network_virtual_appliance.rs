...
pub struct GetNetworkVirtualApplianceResult {
    ...
    pub additional_nics: Option<Vec<network::v20250301::VirtualApplianceAdditionalNicPropertiesResponse>>,
    /// Address Prefix.
    ...
    pub delegation: Option<network::v20250301::DelegationPropertiesResponse>,
    ...
    pub inbound_security_rules: Vec<network::v20250301::SubResourceResponse>,
    /// List of Resource Uri of Public IPs for Internet Ingress Scenario.
    pub internet_ingress_public_ips: Option<Vec<network::v20250301::InternetIngressPublicIpsPropertiesResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// Network Profile containing configurations for Public and Private NIC.
    pub network_profile: Option<network::v20250301::NetworkVirtualAppliancePropertiesFormatResponseNetworkProfile>,
    /// The NVA in VNet interface configurations
    pub nva_interface_configurations: Option<Vec<network::v20250301::NvaInterfaceConfigurationsPropertiesResponse>>,
    /// Network Virtual Appliance SKU.
    pub nva_sku: Option<network::v20250301::VirtualApplianceSkuPropertiesResponse>,
    /// The delegation for the Virtual Appliance
    pub partner_managed_resource: Option<network::v20250301::PartnerManagedResourcePropertiesResponse>,
    ...
    pub virtual_appliance_connections: Vec<network::v20250301::SubResourceResponse>,
    /// List of Virtual Appliance Network Interfaces.
    pub virtual_appliance_nics: Vec<network::v20250301::VirtualApplianceNicPropertiesResponse>,
    /// List of references to VirtualApplianceSite.
    pub virtual_appliance_sites: Vec<network::v20250301::SubResourceResponse>,
    /// The Virtual Hub where Network Virtual Appliance is being deployed.
    pub virtual_hub: Option<network::v20250301::SubResourceResponse>,
}
...
pub async fn get_network_virtual_appliance(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getNetworkVirtualAppliance", invoke_args, &opts).await?;
