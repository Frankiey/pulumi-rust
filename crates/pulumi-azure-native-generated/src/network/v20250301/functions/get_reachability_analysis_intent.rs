...
pub struct GetReachabilityAnalysisIntentResult {
    ...
    pub properties: network::v20250301::ReachabilityAnalysisIntentPropertiesResponse,
...
pub async fn get_reachability_analysis_intent(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getReachabilityAnalysisIntent", invoke_args, &opts).await?;
