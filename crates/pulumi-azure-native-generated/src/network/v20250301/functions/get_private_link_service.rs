...
pub struct GetPrivateLinkServiceResult {
    ...
    pub auto_approval: Option<network::v20250301::PrivateLinkServicePropertiesResponseAutoApproval>,
    ...
    pub ip_configurations: Option<Vec<network::v20250301::PrivateLinkServiceIpConfigurationResponse>>,
    /// An array of references to the load balancer IP configurations.
    pub load_balancer_frontend_ip_configurations: Option<Vec<network::v20250301::FrontendIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint_connections: Vec<network::v20250301::PrivateEndpointConnectionResponse>,
    ...
    pub visibility: Option<network::v20250301::PrivateLinkServicePropertiesResponseVisibility>,
}
...
pub async fn get_private_link_service(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getPrivateLinkService", invoke_args, &opts).await?;
