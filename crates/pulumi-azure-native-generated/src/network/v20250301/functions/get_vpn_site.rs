...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20250301::BgpSettingsResponse>,
    /// The device properties.
    pub device_properties: Option<network::v20250301::DevicePropertiesResponse>,
    ...
    pub name: String,
    /// Office365 Policy.
    pub o365policy: Option<network::v20250301::O365PolicyPropertiesResponse>,
    ...
    pub vpn_site_links: Option<Vec<network::v20250301::VpnSiteLinkResponse>>,
}
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getVpnSite", invoke_args, &opts).await?;
