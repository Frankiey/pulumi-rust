...
pub struct GetSecurityRuleResult {
    ...
    pub destination_application_security_groups: Option<Vec<network::v20250301::ApplicationSecurityGroupResponse>>,
    ...
    pub source_application_security_groups: Option<Vec<network::v20250301::ApplicationSecurityGroupResponse>>,
...
pub async fn get_security_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getSecurityRule", invoke_args, &opts).await?;
