...
pub struct GetWebApplicationFirewallPolicyResult {
    ...
    pub application_gateway_for_containers: Vec<network::v20250301::ApplicationGatewayForContainersReferenceDefinitionResponse>,
    /// A collection of references to application gateways.
    pub application_gateways: Vec<network::v20250301::ApplicationGatewayResponse>,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// The custom rules inside the policy.
    pub custom_rules: Option<Vec<network::v20250301::WebApplicationFirewallCustomRuleResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// A collection of references to application gateway http listeners.
    pub http_listeners: Vec<network::v20250301::SubResourceResponse>,
    /// Resource ID.
    pub id: Option<String>,
    /// Resource location.
    pub location: Option<String>,
    /// Describes the managedRules structure.
    pub managed_rules: network::v20250301::ManagedRulesDefinitionResponse,
    /// Resource name.
    pub name: String,
    /// A collection of references to application gateway path rules.
    pub path_based_rules: Vec<network::v20250301::SubResourceResponse>,
    /// The PolicySettings for policy.
    pub policy_settings: Option<network::v20250301::PolicySettingsResponse>,
...
pub async fn get_web_application_firewall_policy(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getWebApplicationFirewallPolicy", invoke_args, &opts).await?;
