...
pub struct GetNetworkSecurityGroupResult {
    ...
    pub default_security_rules: Vec<network::v20250301::SecurityRuleResponse>,
    ...
    pub security_rules: Option<Vec<network::v20250301::SecurityRuleResponse>>,
    /// A collection of references to subnets.
    pub subnets: Vec<network::v20250301::SubnetResponse>,
    /// Resource tags.
...
pub async fn get_network_security_group(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getNetworkSecurityGroup", invoke_args, &opts).await?;
