...
pub struct GetVirtualHubBgpConnectionResult {
    ...
    pub hub_virtual_network_connection: Option<network::v20250301::SubResourceResponse>,
    /// Resource ID.
...
pub async fn get_virtual_hub_bgp_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20250301:getVirtualHubBgpConnection", invoke_args, &opts).await?;
