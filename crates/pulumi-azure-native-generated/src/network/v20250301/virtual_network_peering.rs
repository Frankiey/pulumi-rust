...
pub struct VirtualNetworkPeeringArgs {
    ...
    pub local_address_space: Option<Input<network::v20250301::AddressSpaceArgs>>,
    /// List of local subnet names that are subnet peered with remote virtual network.
    pub local_subnet_names: Option<Vec<Input<String>>>,
    /// The current local address space of the local virtual network that is peered.
    pub local_virtual_network_address_space: Option<Input<network::v20250301::AddressSpaceArgs>>,
    ...
    pub remote_address_space: Option<Input<network::v20250301::AddressSpaceArgs>>,
    /// The reference to the remote virtual network's Bgp Communities.
    pub remote_bgp_communities: Option<Input<network::v20250301::VirtualNetworkBgpCommunitiesArgs>>,
    /// List of remote subnet names from remote virtual network that are subnet peered.
    pub remote_subnet_names: Option<Vec<Input<String>>>,
    /// The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
    pub remote_virtual_network: Option<Input<network::v20250301::SubResourceArgs>>,
    /// The reference to the current address space of the remote virtual network.
    pub remote_virtual_network_address_space: Option<Input<network::v20250301::AddressSpaceArgs>>,
...
impl VirtualNetworkPeering {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:VirtualNetworkPeering";
