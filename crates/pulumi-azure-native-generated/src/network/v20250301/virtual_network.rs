...
pub struct VirtualNetworkArgs {
    ...
    pub address_space: Option<Input<network::v20250301::AddressSpaceArgs>>,
    /// Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.
    pub bgp_communities: Option<Input<network::v20250301::VirtualNetworkBgpCommunitiesArgs>>,
    /// The DDoS protection plan associated with the virtual network.
    pub ddos_protection_plan: Option<Input<network::v20250301::SubResourceArgs>>,
    /// The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
    pub dhcp_options: Option<Input<network::v20250301::DhcpOptionsArgs>>,
    ...
    pub encryption: Option<Input<network::v20250301::VirtualNetworkEncryptionArgs>>,
    ...
    pub ip_allocations: Option<Vec<Input<network::v20250301::SubResourceArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// Private Endpoint VNet Policies.
    pub private_endpoint_v_net_policies: Option<Input<serde_json::Value>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// A list of subnets in a Virtual Network.
    pub subnets: Option<Vec<Input<network::v20250301::SubnetArgs>>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The name of the virtual network.
    pub virtual_network_name: Option<Input<String>>,
    /// A list of peerings in a Virtual Network.
    pub virtual_network_peerings: Option<Vec<Input<network::v20250301::VirtualNetworkPeeringArgs>>>,
}
...
pub struct VirtualNetwork {
    ...
    pub default_public_nat_gateway: Output<serde_json::Value>,
    /// The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
    ...
    pub flow_logs: Output<serde_json::Value>,
    /// The FlowTimeout value (in minutes) for the Virtual Network
    ...
    /// Private Endpoint VNet Policies.
    pub private_endpoint_v_net_policies: Output<serde_json::Value>,
...
impl VirtualNetwork {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:VirtualNetwork";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.private_endpoint_v_net_policies {
            pulumi_sdk::resolve_input("privateEndpointVNetPolicies", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            ddos_protection_plan: registered.outputs.get("ddosProtectionPlan")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            default_public_nat_gateway: registered.outputs.get("defaultPublicNatGateway")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            extended_location: registered.outputs.get("extendedLocation")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            flow_logs: registered.outputs.get("flowLogs")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ...
            name: registered.outputs.get("name")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            private_endpoint_v_net_policies: registered.outputs.get("privateEndpointVNetPolicies")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
