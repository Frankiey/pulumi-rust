...
pub struct BastionHostArgs {
    ...
    pub ip_configurations: Option<Vec<Input<network::v20250301::BastionHostIPConfigurationArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    pub network_acls: Option<Input<network::v20250301::BastionHostPropertiesFormatNetworkAclsArgs>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The scale units for the Bastion Host resource.
    pub scale_units: Option<Input<i64>>,
    /// The sku of this Bastion Host.
    pub sku: Option<Input<network::v20250301::SkuArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// Reference to an existing virtual network required for Developer Bastion Host only.
    pub virtual_network: Option<Input<network::v20250301::SubResourceArgs>>,
...
impl BastionHost {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:BastionHost";
