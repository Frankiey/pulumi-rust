...
pub struct RoutingRuleArgs {
    ...
    pub destination: Input<network::v20250301::RoutingRuleRouteDestinationArgs>,
    /// The name of the network manager.
    pub network_manager_name: Input<String>,
    /// Indicates the next hop for this particular rule.
    pub next_hop: Input<network::v20250301::RoutingRuleNextHopArgs>,
...
impl RoutingRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:RoutingRule";
