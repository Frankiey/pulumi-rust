...
pub struct PrivateEndpointArgs {
    ...
    pub application_security_groups: Option<Vec<Input<network::v20250301::ApplicationSecurityGroupArgs>>>,
    /// An array of custom dns configurations.
    pub custom_dns_configs: Option<Vec<Input<network::v20250301::CustomDnsConfigPropertiesFormatArgs>>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20250301::PrivateEndpointIPConfigurationArgs>>>,
    /// Specifies the IP version type for the private IPs of the private endpoint. If not defined, this defaults to IPv4.
    pub ip_version_type: Option<Input<serde_json::Value>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// A grouping of information about the connection to the remote resource. Used when the network admin does not have access to approve connections to the remote resource.
    pub manual_private_link_service_connections: Option<Vec<Input<network::v20250301::PrivateLinkServiceConnectionArgs>>>,
    /// The name of the private endpoint.
    pub private_endpoint_name: Option<Input<String>>,
    /// A grouping of information about the connection to the remote resource.
    pub private_link_service_connections: Option<Vec<Input<network::v20250301::PrivateLinkServiceConnectionArgs>>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The ID of the subnet from which the private IP will be allocated.
    pub subnet: Option<Input<network::v20250301::SubnetArgs>>,
    /// Resource tags.
...
pub struct PrivateEndpoint {
    ...
    /// Specifies the IP version type for the private IPs of the private endpoint. If not defined, this defaults to IPv4.
    pub ip_version_type: Output<serde_json::Value>,
    /// Resource location.
...
impl PrivateEndpoint {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:PrivateEndpoint";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.ip_version_type {
            pulumi_sdk::resolve_input("ipVersionType", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            ip_configurations: registered.outputs.get("ipConfigurations")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            ip_version_type: registered.outputs.get("ipVersionType")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
