...
pub struct NetworkInterfaceArgs {
    ...
    pub auxiliary_sku: Option<Input<serde_json::Value>>,
    /// Indicates whether to disable tcp state tracking.
    pub disable_tcp_state_tracking: Option<Input<bool>>,
    /// The DNS settings in network interface.
    pub dns_settings: Option<Input<network::v20250301::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20250301::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub network_security_group: Option<Input<network::v20250301::NetworkSecurityGroupArgs>>,
    /// Type of Network Interface resource.
    pub nic_type: Option<Input<serde_json::Value>>,
    /// Privatelinkservice of the network interface resource.
    pub private_link_service: Option<Input<network::v20250301::PrivateLinkServiceArgs>>,
...
pub struct NetworkInterface {
    ...
    /// Auxiliary sku of Network Interface resource.
    pub auxiliary_sku: Output<serde_json::Value>,
    /// The Azure API version of the resource.
    pub azure_api_version: Output<serde_json::Value>,
    /// Whether default outbound connectivity for nic was configured or not.
    pub default_outbound_connectivity_enabled: Output<serde_json::Value>,
    /// Indicates whether to disable tcp state tracking.
    pub disable_tcp_state_tracking: Output<serde_json::Value>,
    /// The DNS settings in network interface.
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:NetworkInterface";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.auxiliary_sku {
            pulumi_sdk::resolve_input("auxiliarySku", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        if let Some(v) = args.disable_tcp_state_tracking {
            pulumi_sdk::resolve_input("disableTcpStateTracking", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            auxiliary_mode: registered.outputs.get("auxiliaryMode")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            auxiliary_sku: registered.outputs.get("auxiliarySku")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            azure_api_version: registered.outputs.get("azureApiVersion")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            default_outbound_connectivity_enabled: registered.outputs.get("defaultOutboundConnectivityEnabled")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            disable_tcp_state_tracking: registered.outputs.get("disableTcpStateTracking")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
