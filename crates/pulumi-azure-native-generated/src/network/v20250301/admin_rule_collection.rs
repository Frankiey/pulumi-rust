...
pub struct AdminRuleCollectionArgs {
    ...
    pub applies_to_groups: Vec<Input<network::v20250301::NetworkManagerSecurityGroupItemArgs>>,
...
impl AdminRuleCollection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:AdminRuleCollection";
