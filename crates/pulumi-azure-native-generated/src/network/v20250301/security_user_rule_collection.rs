...
pub struct SecurityUserRuleCollectionArgs {
    ...
    pub applies_to_groups: Vec<Input<network::v20250301::SecurityUserGroupItemArgs>>,
...
impl SecurityUserRuleCollection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:SecurityUserRuleCollection";
