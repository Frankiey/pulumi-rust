...
pub struct NetworkVirtualApplianceArgs {
    ...
    pub additional_nics: Option<Vec<Input<network::v20250301::VirtualApplianceAdditionalNicPropertiesArgs>>>,
    ...
    pub delegation: Option<Input<network::v20250301::DelegationPropertiesArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// The service principal that has read access to cloud-init and config blob.
    pub identity: Option<Input<network::v20250301::ManagedServiceIdentityArgs>>,
    /// List of Resource Uri of Public IPs for Internet Ingress Scenario.
    pub internet_ingress_public_ips: Option<Vec<Input<network::v20250301::InternetIngressPublicIpsPropertiesArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// Network Profile containing configurations for Public and Private NIC.
    pub network_profile: Option<Input<network::v20250301::NetworkVirtualAppliancePropertiesFormatNetworkProfileArgs>>,
    /// The name of Network Virtual Appliance.
    pub network_virtual_appliance_name: Option<Input<String>>,
    /// The NVA in VNet interface configurations
    pub nva_interface_configurations: Option<Vec<Input<network::v20250301::NvaInterfaceConfigurationsPropertiesArgs>>>,
    /// Network Virtual Appliance SKU.
    pub nva_sku: Option<Input<network::v20250301::VirtualApplianceSkuPropertiesArgs>>,
    ...
    pub virtual_hub: Option<Input<network::v20250301::SubResourceArgs>>,
}
...
impl NetworkVirtualAppliance {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:NetworkVirtualAppliance";
