...
pub struct NetworkSecurityPerimeterAssociationArgs {
    ...
    pub private_link_resource: Option<Input<network::v20250301::SubResourceArgs>>,
    /// Profile id to which the PaaS resource is associated.
    pub profile: Option<Input<network::v20250301::SubResourceArgs>>,
...
impl NetworkSecurityPerimeterAssociation {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:NetworkSecurityPerimeterAssociation";
