...
pub struct VirtualNetworkGatewayConnectionArgs {
    ...
    pub certificate_authentication: Option<Input<network::v20250301::CertificateAuthenticationArgs>>,
    ...
    pub egress_nat_rules: Option<Vec<Input<network::v20250301::SubResourceArgs>>>,
    /// EnableBgp flag.
    ...
    pub gateway_custom_bgp_ip_addresses: Option<Vec<Input<network::v20250301::GatewayCustomBgpIpAddressIpConfigurationArgs>>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// List of ingress NatRules.
    pub ingress_nat_rules: Option<Vec<Input<network::v20250301::SubResourceArgs>>>,
    /// The IPSec Policies to be considered by this connection.
    pub ipsec_policies: Option<Vec<Input<network::v20250301::IpsecPolicyArgs>>>,
    /// The reference to local network gateway resource.
    pub local_network_gateway2: Option<Input<network::v20250301::LocalNetworkGatewayArgs>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The reference to peerings resource.
    pub peer: Option<Input<network::v20250301::SubResourceArgs>>,
    ...
    pub traffic_selector_policies: Option<Vec<Input<network::v20250301::TrafficSelectorPolicyArgs>>>,
    /// Tunnel properties for virtual network gateway connection
    pub tunnel_properties: Option<Vec<Input<network::v20250301::VirtualNetworkGatewayConnectionTunnelPropertiesArgs>>>,
    ...
    pub virtual_network_gateway1: Input<network::v20250301::VirtualNetworkGatewayArgs>,
    /// The reference to virtual network gateway resource.
    pub virtual_network_gateway2: Option<Input<network::v20250301::VirtualNetworkGatewayArgs>>,
...
impl VirtualNetworkGatewayConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:VirtualNetworkGatewayConnection";
