...
pub struct FlowLogArgs {
    ...
    pub flow_analytics_configuration: Option<Input<network::v20250301::TrafficAnalyticsPropertiesArgs>>,
    /// The name of the flow log.
    pub flow_log_name: Option<Input<String>>,
    /// Parameters that define the flow log format.
    pub format: Option<Input<network::v20250301::FlowLogFormatParametersArgs>>,
    /// Resource ID.
    ...
    pub record_types: Option<Input<String>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// Parameters that define the retention policy for flow log.
    pub retention_policy: Option<Input<network::v20250301::RetentionPolicyParametersArgs>>,
...
pub struct FlowLog {
    ...
    /// Optional field to filter network traffic logs based on flow states. Value of this field could be any comma separated combination string of letters B,C,E or D. B represents Begin, when a flow is created. C represents Continue for an ongoing flow generated at every five-minute interval. E represents End, when a flow is terminated. D represents Deny, when a flow is denied. If not specified, all network traffic will be logged.
    pub record_types: Output<serde_json::Value>,
    /// Parameters that define the retention policy for flow log.
...
impl FlowLog {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:FlowLog";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.record_types {
            pulumi_sdk::resolve_input("recordTypes", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            provisioning_state: registered.outputs.get("provisioningState")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            record_types: registered.outputs.get("recordTypes")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
