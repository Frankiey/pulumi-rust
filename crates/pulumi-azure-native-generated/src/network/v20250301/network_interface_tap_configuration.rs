...
pub struct NetworkInterfaceTapConfigurationArgs {
    ...
    pub virtual_network_tap: Option<Input<network::v20250301::VirtualNetworkTapArgs>>,
}
...
impl NetworkInterfaceTapConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20250301:NetworkInterfaceTapConfiguration";
