...
pub struct NatRuleArgs {
    ...
    pub external_mappings: Option<Vec<Input<network::v20200801::VpnNatRuleMappingArgs>>>,
    /// The name of the gateway.
    pub gateway_name: Input<String>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// The private IP address internal mapping for NAT.
    pub internal_mappings: Option<Vec<Input<network::v20200801::VpnNatRuleMappingArgs>>>,
...
impl NatRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200801:NatRule";
