...
pub struct LoadBalancerBackendAddressPoolArgs {
    ...
    pub load_balancer_backend_addresses: Option<Vec<Input<network::v20200801::LoadBalancerBackendAddressArgs>>>,
...
impl LoadBalancerBackendAddressPool {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200801:LoadBalancerBackendAddressPool";
