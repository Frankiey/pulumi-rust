...
pub struct GetPacketCaptureResult {
    ...
    pub filters: Option<Vec<network::v20200801::PacketCaptureFilterResponse>>,
    ...
    pub storage_location: network::v20200801::PacketCaptureStorageLocationResponse,
...
pub async fn get_packet_capture(
    ...
    let result = ctx.invoke("azure-native:network/v20200801:getPacketCapture", invoke_args, &opts).await?;
