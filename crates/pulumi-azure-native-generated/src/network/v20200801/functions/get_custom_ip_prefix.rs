...
pub struct GetCustomIPPrefixResult {
    ...
    pub public_ip_prefixes: Vec<network::v20200801::SubResourceResponse>,
...
pub async fn get_custom_ip_prefix(
    ...
    let result = ctx.invoke("azure-native:network/v20200801:getCustomIPPrefix", invoke_args, &opts).await?;
