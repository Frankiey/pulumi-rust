...
pub struct BastionHostArgs {
    ...
    pub ip_configurations: Option<Vec<Input<network::v20200801::BastionHostIPConfigurationArgs>>>,
    /// Resource location.
...
impl BastionHost {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200801:BastionHost";
