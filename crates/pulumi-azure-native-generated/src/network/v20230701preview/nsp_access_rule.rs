...
pub struct NspAccessRuleArgs {
    ...
    pub subscriptions: Option<Vec<Input<network::v20230701preview::SubscriptionIdArgs>>>,
    /// Resource tags.
...
impl NspAccessRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230701preview:NspAccessRule";
