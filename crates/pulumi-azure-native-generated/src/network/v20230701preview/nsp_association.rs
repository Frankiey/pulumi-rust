...
pub struct NspAssociationArgs {
    ...
    pub private_link_resource: Option<Input<network::v20230701preview::SubResourceArgs>>,
    /// Profile id to which the PaaS resource is associated.
    pub profile: Option<Input<network::v20230701preview::SubResourceArgs>>,
...
impl NspAssociation {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20230701preview:NspAssociation";
