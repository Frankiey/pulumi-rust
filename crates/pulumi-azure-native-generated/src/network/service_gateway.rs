...
pub struct ServiceGatewayArgs {
    ...
    pub route_target_address: Option<Input<network::RouteTargetAddressPropertiesFormatArgs>>,
    /// Route Target address V6 of Service gateway
    pub route_target_address_v6: Option<Input<network::RouteTargetAddressPropertiesFormatArgs>>,
    /// The name of the service gateway.
    pub service_gateway_name: Option<Input<String>>,
    /// The service gateway SKU.
    pub sku: Option<Input<network::ServiceGatewaySkuArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// Reference to an existing virtual network.
    pub virtual_network: Option<Input<network::VirtualNetworkArgs>>,
...
impl ServiceGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network:ServiceGateway";
