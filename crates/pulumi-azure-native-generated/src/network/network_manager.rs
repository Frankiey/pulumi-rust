...
pub struct NetworkManagerArgs {
    ...
    pub network_manager_scopes: Input<network::NetworkManagerPropertiesNetworkManagerScopesArgs>,
...
impl NetworkManager {
    const TYPE_TOKEN: &'static str = "azure-native:network:NetworkManager";
