...
pub struct VirtualRouterArgs {
    ...
    pub hosted_gateway: Option<Input<network::v20200701::SubResourceArgs>>,
    /// The Subnet on which VirtualRouter is hosted.
    pub hosted_subnet: Option<Input<network::v20200701::SubResourceArgs>>,
    /// Resource ID.
...
impl VirtualRouter {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200701:VirtualRouter";
