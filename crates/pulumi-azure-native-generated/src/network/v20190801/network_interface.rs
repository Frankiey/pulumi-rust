...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20190801::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20190801::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub tap_configurations: Option<Vec<Input<network::v20190801::NetworkInterfaceTapConfigurationArgs>>>,
}
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190801:NetworkInterface";
