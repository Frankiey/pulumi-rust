...
pub struct GetConnectionMonitorResult {
    ...
    pub destination: network::v20190801::ConnectionMonitorDestinationResponse,
    ...
    pub source: network::v20190801::ConnectionMonitorSourceResponse,
...
pub async fn get_connection_monitor(
    ...
    let result = ctx.invoke("azure-native:network/v20190801:getConnectionMonitor", invoke_args, &opts).await?;
