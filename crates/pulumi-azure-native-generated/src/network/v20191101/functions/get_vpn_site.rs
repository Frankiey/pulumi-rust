...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20191101::BgpSettingsResponse>,
    /// The device properties.
    pub device_properties: Option<network::v20191101::DevicePropertiesResponse>,
    ...
    pub vpn_site_links: Option<Vec<network::v20191101::VpnSiteLinkResponse>>,
}
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20191101:getVpnSite", invoke_args, &opts).await?;
