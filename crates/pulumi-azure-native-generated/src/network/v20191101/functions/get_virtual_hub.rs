...
pub struct GetVirtualHubResult {
    ...
    pub azure_firewall: Option<network::v20191101::SubResourceResponse>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The expressRouteGateway associated with this VirtualHub.
    pub express_route_gateway: Option<network::v20191101::SubResourceResponse>,
    /// Resource ID.
    ...
    pub p2s_vpn_gateway: Option<network::v20191101::SubResourceResponse>,
    /// The provisioning state of the virtual hub resource.
    pub provisioning_state: String,
    /// The routeTable associated with this virtual hub.
    pub route_table: Option<network::v20191101::VirtualHubRouteTableResponse>,
    ...
    pub virtual_hub_route_table_v2s: Option<Vec<network::v20191101::VirtualHubRouteTableV2Response>>,
    /// List of all vnet connections with this VirtualHub.
    pub virtual_network_connections: Option<Vec<network::v20191101::HubVirtualNetworkConnectionResponse>>,
    /// The VirtualWAN to which the VirtualHub belongs.
    pub virtual_wan: Option<network::v20191101::SubResourceResponse>,
    /// The VpnGateway associated with this VirtualHub.
    pub vpn_gateway: Option<network::v20191101::SubResourceResponse>,
}
...
pub async fn get_virtual_hub(
    ...
    let result = ctx.invoke("azure-native:network/v20191101:getVirtualHub", invoke_args, &opts).await?;
