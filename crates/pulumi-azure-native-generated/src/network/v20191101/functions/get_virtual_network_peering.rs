...
pub struct GetVirtualNetworkPeeringResult {
    ...
    pub remote_address_space: Option<network::v20191101::AddressSpaceResponse>,
    /// The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
    pub remote_virtual_network: Option<network::v20191101::SubResourceResponse>,
...
pub async fn get_virtual_network_peering(
    ...
    let result = ctx.invoke("azure-native:network/v20191101:getVirtualNetworkPeering", invoke_args, &opts).await?;
