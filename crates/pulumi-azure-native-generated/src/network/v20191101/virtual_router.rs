...
pub struct VirtualRouterArgs {
    ...
    pub hosted_gateway: Option<Input<network::v20191101::SubResourceArgs>>,
    /// The Subnet on which VirtualRouter is hosted.
    pub hosted_subnet: Option<Input<network::v20191101::SubResourceArgs>>,
    /// Resource ID.
...
impl VirtualRouter {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20191101:VirtualRouter";
