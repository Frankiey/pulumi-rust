...
pub struct FlowLogArgs {
    ...
    pub flow_analytics_configuration: Option<Input<network::v20191101::TrafficAnalyticsPropertiesArgs>>,
    /// The name of the flow log.
    pub flow_log_name: Option<Input<String>>,
    /// Parameters that define the flow log format.
    pub format: Option<Input<network::v20191101::FlowLogFormatParametersArgs>>,
    /// Resource ID.
    ...
    pub retention_policy: Option<Input<network::v20191101::RetentionPolicyParametersArgs>>,
...
impl FlowLog {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20191101:FlowLog";
