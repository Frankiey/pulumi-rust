...
pub struct VirtualNetworkGatewayConnectionArgs {
    ...
    pub egress_nat_rules: Option<Vec<Input<network::v20210201::SubResourceArgs>>>,
    /// EnableBgp flag.
    ...
    pub ingress_nat_rules: Option<Vec<Input<network::v20210201::SubResourceArgs>>>,
    /// The IPSec Policies to be considered by this connection.
    pub ipsec_policies: Option<Vec<Input<network::v20210201::IpsecPolicyArgs>>>,
    /// The reference to local network gateway resource.
    pub local_network_gateway2: Option<Input<network::v20210201::LocalNetworkGatewayArgs>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The reference to peerings resource.
    pub peer: Option<Input<network::v20210201::SubResourceArgs>>,
    ...
    pub traffic_selector_policies: Option<Vec<Input<network::v20210201::TrafficSelectorPolicyArgs>>>,
    ...
    pub virtual_network_gateway1: Input<network::v20210201::VirtualNetworkGatewayArgs>,
    /// The reference to virtual network gateway resource.
    pub virtual_network_gateway2: Option<Input<network::v20210201::VirtualNetworkGatewayArgs>>,
...
impl VirtualNetworkGatewayConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210201:VirtualNetworkGatewayConnection";
