...
pub struct GetServiceEndpointPolicyResult {
    ...
    pub service_endpoint_policy_definitions: Option<Vec<network::v20210201::ServiceEndpointPolicyDefinitionResponse>>,
...
pub async fn get_service_endpoint_policy(
    ...
    let result = ctx.invoke("azure-native:network/v20210201:getServiceEndpointPolicy", invoke_args, &opts).await?;
