...
pub struct GetExpressRouteGatewayResult {
    ...
    pub auto_scale_configuration: Option<network::v20210201::ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration>,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// List of ExpressRoute connections to the ExpressRoute gateway.
    pub express_route_connections: Vec<network::v20210201::ExpressRouteConnectionResponse>,
    /// Resource ID.
    ...
    pub virtual_hub: network::v20210201::VirtualHubIdResponse,
}
...
pub async fn get_express_route_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20210201:getExpressRouteGateway", invoke_args, &opts).await?;
