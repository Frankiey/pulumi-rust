...
pub struct GetActiveSessionsResult {
    ...
    pub value: Option<Vec<network::v20210201::BastionActiveSessionResponse>>,
}
...
pub async fn get_active_sessions(
    ...
    let result = ctx.invoke("azure-native:network/v20210201:getActiveSessions", invoke_args, &opts).await?;
