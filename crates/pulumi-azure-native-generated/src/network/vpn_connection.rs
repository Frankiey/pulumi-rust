...
pub struct VpnConnectionArgs {
    ...
    pub remote_vpn_site: Option<Input<network::SubResourceArgs>>,
    ...
    pub vpn_link_connections: Option<Vec<Input<network::VpnSiteLinkConnectionArgs>>>,
}
...
impl VpnConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network:VpnConnection";
