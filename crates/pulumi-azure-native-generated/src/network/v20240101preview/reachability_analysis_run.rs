...
pub struct ReachabilityAnalysisRunArgs {
    ...
    pub properties: Input<network::v20240101preview::ReachabilityAnalysisRunPropertiesArgs>,
...
impl ReachabilityAnalysisRun {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101preview:ReachabilityAnalysisRun";
