...
pub struct AdminRuleArgs {
    ...
    pub destinations: Option<Vec<Input<network::v20240101preview::AddressPrefixItemArgs>>>,
    ...
    pub sources: Option<Vec<Input<network::v20240101preview::AddressPrefixItemArgs>>>,
}
...
impl AdminRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101preview:AdminRule";
