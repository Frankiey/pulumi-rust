...
pub struct GetStaticCidrResult {
    ...
    pub properties: network::v20240101preview::StaticCidrPropertiesResponse,
...
pub async fn get_static_cidr(
    ...
    let result = ctx.invoke("azure-native:network/v20240101preview:getStaticCidr", invoke_args, &opts).await?;
