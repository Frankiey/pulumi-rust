...
pub struct GetReachabilityAnalysisIntentResult {
    ...
    pub properties: network::v20240101preview::ReachabilityAnalysisIntentPropertiesResponse,
...
pub async fn get_reachability_analysis_intent(
    ...
    let result = ctx.invoke("azure-native:network/v20240101preview:getReachabilityAnalysisIntent", invoke_args, &opts).await?;
