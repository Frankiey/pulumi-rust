...
pub struct GetAdminRuleResult {
    ...
    pub destinations: Option<Vec<network::v20240101preview::AddressPrefixItemResponse>>,
    ...
    pub sources: Option<Vec<network::v20240101preview::AddressPrefixItemResponse>>,
...
pub async fn get_admin_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20240101preview:getAdminRule", invoke_args, &opts).await?;
