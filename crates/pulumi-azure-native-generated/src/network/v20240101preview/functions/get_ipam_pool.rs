...
pub struct GetIpamPoolResult {
    ...
    pub properties: network::v20240101preview::IpamPoolPropertiesResponse,
...
/// Instance of Pool resource.
pub async fn get_ipam_pool(
    ctx: &Context,
    args: GetIpamPoolArgs,
    opts: Option<InvokeOptions>,
) -> Result<GetIpamPoolResult> {
    ...
    let result = ctx.invoke("azure-native:network/v20240101preview:getIpamPool", invoke_args, &opts).await?;

    Ok(GetIpamPoolResult {
