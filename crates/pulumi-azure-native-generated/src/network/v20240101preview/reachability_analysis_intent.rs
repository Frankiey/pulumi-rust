...
pub struct ReachabilityAnalysisIntentArgs {
    /// The name of the network manager.
    pub network_manager_name: Input<String>,
    /// Represents the Reachability Analysis Intent properties.
    pub properties: Input<network::v20240101preview::ReachabilityAnalysisIntentPropertiesArgs>,
    /// Reachability Analysis Intent name.
    pub reachability_analysis_intent_name: Option<Input<String>>,
...
/// Configuration information or intent on which to do the analysis on.
pub struct ReachabilityAnalysisIntent {
...
impl ReachabilityAnalysisIntent {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101preview:ReachabilityAnalysisIntent";

    /// Create a new ReachabilityAnalysisIntent resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
        ...
        if let Some(v) = args.reachability_analysis_intent_name {
            pulumi_sdk::resolve_input("reachabilityAnalysisIntentName", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
