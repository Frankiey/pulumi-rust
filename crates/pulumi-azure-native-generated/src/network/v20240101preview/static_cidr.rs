...
pub struct StaticCidrArgs {
    ...
    pub properties: Option<Input<network::v20240101preview::StaticCidrPropertiesArgs>>,
...
impl StaticCidr {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101preview:StaticCidr";
