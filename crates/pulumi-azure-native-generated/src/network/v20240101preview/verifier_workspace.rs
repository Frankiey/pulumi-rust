...
pub struct VerifierWorkspaceArgs {
    ...
    pub properties: Option<Input<network::v20240101preview::VerifierWorkspacePropertiesArgs>>,
...
impl VerifierWorkspace {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20240101preview:VerifierWorkspace";
