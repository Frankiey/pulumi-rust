...
pub struct DdosCustomPolicyArgs {
    ...
    pub protocol_custom_settings: Option<Vec<Input<network::v20200501::ProtocolCustomSettingsFormatArgs>>>,
...
impl DdosCustomPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200501:DdosCustomPolicy";
