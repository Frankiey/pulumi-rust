...
pub struct VirtualNetworkPeeringArgs {
    ...
    pub remote_address_space: Option<Input<network::v20200501::AddressSpaceArgs>>,
...
impl VirtualNetworkPeering {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200501:VirtualNetworkPeering";
