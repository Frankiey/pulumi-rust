...
pub struct GetExpressRoutePortResult {
    ...
    pub circuits: Vec<network::v20200501::SubResourceResponse>,
    ...
    pub links: Option<Vec<network::v20200501::ExpressRouteLinkResponse>>,
    /// Resource location.
...
pub async fn get_express_route_port(
    ...
    let result = ctx.invoke("azure-native:network/v20200501:getExpressRoutePort", invoke_args, &opts).await?;
