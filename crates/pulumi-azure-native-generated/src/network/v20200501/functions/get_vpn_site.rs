...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20200501::BgpSettingsResponse>,
    /// The device properties.
    pub device_properties: Option<network::v20200501::DevicePropertiesResponse>,
    ...
    pub vpn_site_links: Option<Vec<network::v20200501::VpnSiteLinkResponse>>,
}
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20200501:getVpnSite", invoke_args, &opts).await?;
