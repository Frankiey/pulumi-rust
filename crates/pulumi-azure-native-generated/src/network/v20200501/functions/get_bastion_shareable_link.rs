...
pub struct GetBastionShareableLinkArgs {
    ...
    pub vms: Option<Vec<network::v20200501::BastionShareableLink>>,
}
...
pub struct GetBastionShareableLinkResult {
    ...
    pub value: Option<Vec<network::v20200501::BastionShareableLinkResponse>>,
}
...
pub async fn get_bastion_shareable_link(
    ...
    let result = ctx.invoke("azure-native:network/v20200501:getBastionShareableLink", invoke_args, &opts).await?;
