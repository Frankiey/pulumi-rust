...
pub struct GetHubVirtualNetworkConnectionResult {
    ...
    pub remote_virtual_network: Option<network::v20200501::SubResourceResponse>,
...
pub async fn get_hub_virtual_network_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20200501:getHubVirtualNetworkConnection", invoke_args, &opts).await?;
