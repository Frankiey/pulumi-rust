...
pub struct GetVirtualNetworkGatewayResult {
    ...
    pub bgp_settings: Option<network::v20200501::BgpSettingsResponse>,
    /// The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
    pub custom_routes: Option<network::v20200501::AddressSpaceResponse>,
    ...
    pub gateway_default_site: Option<network::v20200501::SubResourceResponse>,
    ...
    pub ip_configurations: Option<Vec<network::v20200501::VirtualNetworkGatewayIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub sku: Option<network::v20200501::VirtualNetworkGatewaySkuResponse>,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// Resource type.
    pub type_: String,
    /// The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<network::v20200501::VpnClientConfigurationResponse>,
...
pub async fn get_virtual_network_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20200501:getVirtualNetworkGateway", invoke_args, &opts).await?;
