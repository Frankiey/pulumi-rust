...
pub struct GetRouteFilterResult {
    ...
    pub ipv6peerings: Vec<network::v20191101::ExpressRouteCircuitPeeringResponse>,
    /// Resource location.
    pub location: String,
    /// Resource name.
    pub name: String,
    /// A collection of references to express route circuit peerings.
    pub peerings: Vec<network::v20191101::ExpressRouteCircuitPeeringResponse>,
    /// The provisioning state of the route filter resource.
    pub provisioning_state: String,
    /// Collection of RouteFilterRules contained within a route filter.
    pub rules: Option<Vec<network::v20191101::RouteFilterRuleResponse>>,
    /// Resource tags.
...
pub async fn get_route_filter(
    ...
    let result = ctx.invoke("azure-native:network/v20191101:getRouteFilter", invoke_args, &opts).await?;
