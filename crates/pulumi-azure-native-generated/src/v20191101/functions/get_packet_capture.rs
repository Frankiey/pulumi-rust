...
pub struct GetPacketCaptureResult {
    ...
    pub filters: Option<Vec<network::v20191101::PacketCaptureFilterResponse>>,
    ...
    pub storage_location: network::v20191101::PacketCaptureStorageLocationResponse,
...
pub async fn get_packet_capture(
    ...
    let result = ctx.invoke("azure-native:network/v20191101:getPacketCapture", invoke_args, &opts).await?;
