...
pub struct GetVirtualNetworkTapResult {
    ...
    pub destination_load_balancer_front_end_ip_configuration: Option<network::v20191101::FrontendIPConfigurationResponse>,
    /// The reference to the private IP Address of the collector nic that will receive the tap.
    pub destination_network_interface_ip_configuration: Option<network::v20191101::NetworkInterfaceIPConfigurationResponse>,
    ...
    pub network_interface_tap_configurations: Vec<network::v20191101::NetworkInterfaceTapConfigurationResponse>,
...
pub async fn get_virtual_network_tap(
    ...
    let result = ctx.invoke("azure-native:network/v20191101:getVirtualNetworkTap", invoke_args, &opts).await?;
