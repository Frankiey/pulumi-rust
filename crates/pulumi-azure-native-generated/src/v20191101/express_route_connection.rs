...
pub struct ExpressRouteConnectionArgs {
    ...
    pub express_route_circuit_peering: Input<network::v20191101::ExpressRouteCircuitPeeringIdArgs>,
...
impl ExpressRouteConnection {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20191101:ExpressRouteConnection";
