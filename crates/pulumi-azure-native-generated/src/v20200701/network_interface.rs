...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20200701::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20200701::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub private_link_service: Option<Input<network::v20200701::PrivateLinkServiceArgs>>,
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200701:NetworkInterface";
