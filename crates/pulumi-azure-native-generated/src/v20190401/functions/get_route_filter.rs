...
pub struct GetRouteFilterResult {
    ...
    pub ipv6peerings: Option<Vec<network::v20190401::ExpressRouteCircuitPeeringResponse>>,
    /// Resource location.
    pub location: String,
    /// Resource name.
    pub name: String,
    ...
    pub rules: Option<Vec<network::v20190401::RouteFilterRuleResponse>>,
    /// Resource tags.
...
pub async fn get_route_filter(
    ...
    let result = ctx.invoke("azure-native:network/v20190401:getRouteFilter", invoke_args, &opts).await?;
    ...
    Ok(GetRouteFilterResult {
        ...
        ipv6peerings: result.fields.get("ipv6Peerings").cloned().map(serde_json::from_value).transpose()?,
