...
pub struct GetSubnetResult {
    ...
    pub delegations: Option<Vec<network::v20190401::DelegationResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: Option<String>,
    /// Resource ID.
    pub id: Option<String>,
    /// Array of IP configuration profiles which reference this subnet.
    pub ip_configuration_profiles: Vec<network::v20190401::IPConfigurationProfileResponse>,
    /// Gets an array of references to the network interface IP configurations using subnet.
    pub ip_configurations: Vec<network::v20190401::IPConfigurationResponse>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<String>,
    /// Nat gateway associated with this subnet.
    pub nat_gateway: Option<network::v20190401::SubResourceResponse>,
    /// The reference of the NetworkSecurityGroup resource.
    pub network_security_group: Option<network::v20190401::NetworkSecurityGroupResponse>,
    /// Enable or Disable private end point on the subnet.
    pub private_endpoint_network_policies: Option<String>,
    /// An array of references to private endpoints.
    pub private_endpoints: Vec<network::v20190401::PrivateEndpointResponse>,
    ...
    pub resource_navigation_links: Option<Vec<network::v20190401::ResourceNavigationLinkResponse>>,
    /// The reference of the RouteTable resource.
    pub route_table: Option<network::v20190401::RouteTableResponse>,
    /// Gets an array of references to services injecting into this subnet.
    pub service_association_links: Option<Vec<network::v20190401::ServiceAssociationLinkResponse>>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<network::v20190401::ServiceEndpointPolicyResponse>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<network::v20190401::ServiceEndpointPropertiesFormatResponse>>,
}
...
pub async fn get_subnet(
    ...
    let result = ctx.invoke("azure-native:network/v20190401:getSubnet", invoke_args, &opts).await?;
