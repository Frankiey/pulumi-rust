...
#[derive(Default)]
pub struct GetP2sVpnGatewayP2sVpnConnectionHealthArgs {
...
pub struct GetP2sVpnGatewayP2sVpnConnectionHealthResult {
    ...
    pub custom_routes: Option<network::v20190401::AddressSpaceResponse>,
    ...
    pub p2s_vpn_server_configuration: Option<network::v20190401::SubResourceResponse>,
    ...
    pub virtual_hub: Option<network::v20190401::SubResourceResponse>,
    /// The reference of the address space resource which represents Address space for P2S VpnClient.
    pub vpn_client_address_pool: Option<network::v20190401::AddressSpaceResponse>,
    /// All P2S VPN clients' connection health status.
    pub vpn_client_connection_health: network::v20190401::VpnClientConnectionHealthResponse,
    /// The scale unit for this p2s vpn gateway.
    pub vpn_gateway_scale_unit: Option<i64>,
}

/// Gets the connection health of P2S clients of the virtual wan P2SVpnGateway in the specified resource group.
pub async fn get_p2s_vpn_gateway_p2s_vpn_connection_health(
    ctx: &Context,
    args: GetP2sVpnGatewayP2sVpnConnectionHealthArgs,
    opts: Option<InvokeOptions>,
) -> Result<GetP2sVpnGatewayP2sVpnConnectionHealthResult> {
    let mut invoke_args = HashMap::new();
    invoke_args.insert("gatewayName".to_string(), json!(args.gateway_name));
    invoke_args.insert("resourceGroupName".to_string(), json!(args.resource_group_name));

    let opts = opts.unwrap_or_default();
    let result = ctx.invoke("azure-native:network/v20190401:getP2sVpnGatewayP2sVpnConnectionHealth", invoke_args, &opts).await?;

    Ok(GetP2sVpnGatewayP2sVpnConnectionHealthResult {
