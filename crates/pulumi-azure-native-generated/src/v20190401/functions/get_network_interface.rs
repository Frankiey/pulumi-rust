...
pub struct GetNetworkInterfaceResult {
    ...
    pub dns_settings: Option<network::v20190401::NetworkInterfaceDnsSettingsResponse>,
    ...
    pub ip_configurations: Option<Vec<network::v20190401::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint: network::v20190401::PrivateEndpointResponse,
    ...
    pub tap_configurations: Option<Vec<network::v20190401::NetworkInterfaceTapConfigurationResponse>>,
    /// Resource type.
    pub type_: String,
    /// The reference of a virtual machine.
    pub virtual_machine: network::v20190401::SubResourceResponse,
}
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network/v20190401:getNetworkInterface", invoke_args, &opts).await?;
