...
pub struct GetVirtualWanResult {
    ...
    pub p2s_vpn_server_configurations: Option<Vec<network::v20190401::P2SVpnServerConfigurationResponse>>,
    ...
    pub virtual_hubs: Vec<network::v20190401::SubResourceResponse>,
    /// List of VpnSites in the VirtualWAN.
    pub vpn_sites: Vec<network::v20190401::SubResourceResponse>,
}
...
pub async fn get_virtual_wan(
    ...
    let result = ctx.invoke("azure-native:network/v20190401:getVirtualWan", invoke_args, &opts).await?;
    ...
    Ok(GetVirtualWanResult {
        ...
        office365local_breakout_category: serde_json::from_value(result.fields.get("office365LocalBreakoutCategory").cloned().unwrap_or_default())?
            ,
        p2s_vpn_server_configurations: result.fields.get("p2SVpnServerConfigurations").cloned().map(serde_json::from_value).transpose()?,
