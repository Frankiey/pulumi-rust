...
pub struct NetworkInterfaceArgs {
    ...
    pub dns_settings: Option<Input<network::v20190401::NetworkInterfaceDnsSettingsArgs>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20190401::NetworkInterfaceIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub tap_configurations: Option<Vec<Input<network::v20190401::NetworkInterfaceTapConfigurationArgs>>>,
}
...
impl NetworkInterface {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190401:NetworkInterface";
