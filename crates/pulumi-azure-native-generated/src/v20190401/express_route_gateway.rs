...
pub struct ExpressRouteGatewayArgs {
    ...
    pub auto_scale_configuration: Option<Input<network::v20190401::ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>>,
    ...
    pub virtual_hub: Input<network::v20190401::VirtualHubIdArgs>,
}
...
impl ExpressRouteGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190401:ExpressRouteGateway";
