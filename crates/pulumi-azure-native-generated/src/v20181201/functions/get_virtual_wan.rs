...
pub struct GetVirtualWanResult {
    ...
    pub p2s_vpn_server_configurations: Option<Vec<network::v20181201::P2SVpnServerConfigurationResponse>>,
    ...
    pub virtual_hubs: Vec<network::v20181201::SubResourceResponse>,
    pub vpn_sites: Vec<network::v20181201::SubResourceResponse>,
}
...
pub async fn get_virtual_wan(
    ...
    let result = ctx.invoke("azure-native:network/v20181201:getVirtualWan", invoke_args, &opts).await?;
