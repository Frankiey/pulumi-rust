...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20181201::BgpSettingsResponse>,
    /// The device properties
    pub device_properties: Option<network::v20181201::DevicePropertiesResponse>,
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20181201:getVpnSite", invoke_args, &opts).await?;
