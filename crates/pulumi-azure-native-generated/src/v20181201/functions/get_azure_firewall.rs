...
pub struct GetAzureFirewallResult {
    ...
    pub application_rule_collections: Option<Vec<network::v20181201::AzureFirewallApplicationRuleCollectionResponse>>,
    ...
    pub ip_configurations: Option<Vec<network::v20181201::AzureFirewallIPConfigurationResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// Collection of NAT rule collections used by Azure Firewall.
    pub nat_rule_collections: Option<Vec<network::v20181201::AzureFirewallNatRuleCollectionResponse>>,
    /// Collection of network rule collections used by Azure Firewall.
    pub network_rule_collections: Option<Vec<network::v20181201::AzureFirewallNetworkRuleCollectionResponse>>,
...
pub async fn get_azure_firewall(
    ...
    let result = ctx.invoke("azure-native:network/v20181201:getAzureFirewall", invoke_args, &opts).await?;
