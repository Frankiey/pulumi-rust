...
pub struct GetVirtualNetworkResult {
    ...
    pub address_space: Option<network::v20181201::AddressSpaceResponse>,
    /// The Azure API version of the resource.
    pub azure_api_version: String,
    /// The DDoS protection plan associated with the virtual network.
    pub ddos_protection_plan: Option<network::v20181201::SubResourceResponse>,
    /// The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
    pub dhcp_options: Option<network::v20181201::DhcpOptionsResponse>,
    ...
    pub subnets: Option<Vec<network::v20181201::SubnetResponse>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// Resource type.
    pub type_: String,
    /// A list of peerings in a Virtual Network.
    pub virtual_network_peerings: Option<Vec<network::v20181201::VirtualNetworkPeeringResponse>>,
}
...
pub async fn get_virtual_network(
    ...
    let result = ctx.invoke("azure-native:network/v20181201:getVirtualNetwork", invoke_args, &opts).await?;
