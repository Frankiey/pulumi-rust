...
pub struct GetVirtualNetworkGatewayResult {
    ...
    pub bgp_settings: Option<network::v20181201::BgpSettingsResponse>,
    /// Whether BGP is enabled for this virtual network gateway or not.
    pub enable_bgp: Option<bool>,
    /// Gets a unique read-only string that changes whenever the resource is updated.
    pub etag: Option<String>,
    /// The reference of the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
    pub gateway_default_site: Option<network::v20181201::SubResourceResponse>,
    /// The type of this virtual network gateway. Possible values are: 'Vpn' and 'ExpressRoute'.
    pub gateway_type: Option<String>,
    /// Resource ID.
    pub id: Option<String>,
    /// IP configurations for virtual network gateway.
    pub ip_configurations: Option<Vec<network::v20181201::VirtualNetworkGatewayIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub sku: Option<network::v20181201::VirtualNetworkGatewaySkuResponse>,
    /// Resource tags.
    pub tags: Option<HashMap<String, String>>,
    /// Resource type.
    pub type_: String,
    /// The reference of the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<network::v20181201::VpnClientConfigurationResponse>,
...
pub async fn get_virtual_network_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20181201:getVirtualNetworkGateway", invoke_args, &opts).await?;
