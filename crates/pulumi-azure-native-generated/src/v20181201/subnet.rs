...
pub struct SubnetArgs {
    ...
    pub delegations: Option<Vec<Input<network::v20181201::DelegationArgs>>>,
    /// Resource ID.
    ...
    pub resource_navigation_links: Option<Vec<Input<network::v20181201::ResourceNavigationLinkArgs>>>,
    /// The reference of the RouteTable resource.
    pub route_table: Option<Input<network::v20181201::RouteTableArgs>>,
    /// Gets an array of references to services injecting into this subnet.
    pub service_association_links: Option<Vec<Input<network::v20181201::ServiceAssociationLinkArgs>>>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<Input<network::v20181201::ServiceEndpointPolicyArgs>>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<Input<network::v20181201::ServiceEndpointPropertiesFormatArgs>>>,
...
impl Subnet {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181201:Subnet";
