...
pub struct ConnectionMonitorArgs {
    ...
    pub destination: Input<network::v20181201::ConnectionMonitorDestinationArgs>,
    ...
    pub source: Input<network::v20181201::ConnectionMonitorSourceArgs>,
...
impl ConnectionMonitor {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181201:ConnectionMonitor";
