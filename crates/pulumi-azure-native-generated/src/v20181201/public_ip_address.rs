...
pub struct PublicIPAddressArgs {
    ...
    pub ddos_settings: Option<Input<network::v20181201::DdosSettingsArgs>>,
    /// The FQDN of the DNS record associated with the public IP address.
    pub dns_settings: Option<Input<network::v20181201::PublicIPAddressDnsSettingsArgs>>,
    /// Resource ID.
    ...
    pub ip_tags: Option<Vec<Input<network::v20181201::IpTagArgs>>>,
    /// Resource location.
    ...
    pub public_ip_prefix: Option<Input<network::v20181201::SubResourceArgs>>,
    ...
    pub sku: Option<Input<network::v20181201::PublicIPAddressSkuArgs>>,
    /// Resource tags.
...
impl PublicIPAddress {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20181201:PublicIPAddress";
