...
pub struct VpnSiteArgs {
    ...
    pub bgp_properties: Option<Input<network::v20190701::BgpSettingsArgs>>,
    /// The device properties.
    pub device_properties: Option<Input<network::v20190701::DevicePropertiesArgs>>,
    /// Resource ID.
    ...
    pub vpn_site_links: Option<Vec<Input<network::v20190701::VpnSiteLinkArgs>>>,
...
impl VpnSite {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190701:VpnSite";
