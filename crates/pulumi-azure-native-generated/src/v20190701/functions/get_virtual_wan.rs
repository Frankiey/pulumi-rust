...
pub struct GetVirtualWanResult {
    ...
    pub p2s_vpn_server_configurations: Option<Vec<network::v20190701::P2SVpnServerConfigurationResponse>>,
    ...
    pub virtual_hubs: Vec<network::v20190701::SubResourceResponse>,
    /// List of VpnSites in the VirtualWAN.
    pub vpn_sites: Vec<network::v20190701::SubResourceResponse>,
}
...
pub async fn get_virtual_wan(
    ...
    let result = ctx.invoke("azure-native:network/v20190701:getVirtualWan", invoke_args, &opts).await?;
