...
pub struct GetApplicationGatewayBackendHealthOnDemandArgs {
    ...
    pub backend_address_pool: Option<network::v20190701::SubResource>,
    /// Reference of backend http setting of application gateway to be used for test probe.
    pub backend_http_settings: Option<network::v20190701::SubResource>,
    /// Expands BackendAddressPool and BackendHttpSettings referenced in backend health.
    pub expand: Option<String>,
    /// Host name to send the probe to.
    pub host: Option<String>,
    /// Criterion for classifying a healthy probe response.
    pub match_: Option<network::v20190701::ApplicationGatewayProbeHealthResponseMatch>,
...
pub struct GetApplicationGatewayBackendHealthOnDemandResult {
    ...
    pub backend_address_pool: Option<network::v20190701::ApplicationGatewayBackendAddressPoolResponse>,
    /// Application gateway BackendHealthHttp settings.
    pub backend_health_http_settings: Option<network::v20190701::ApplicationGatewayBackendHealthHttpSettingsResponse>,
}
...
pub async fn get_application_gateway_backend_health_on_demand(
    ...
    let result = ctx.invoke("azure-native:network/v20190701:getApplicationGatewayBackendHealthOnDemand", invoke_args, &opts).await?;
