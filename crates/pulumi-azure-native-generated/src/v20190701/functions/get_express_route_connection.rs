...
pub struct GetExpressRouteConnectionResult {
    ...
    pub express_route_circuit_peering: network::v20190701::ExpressRouteCircuitPeeringIdResponse,
    /// Resource ID.
...
pub async fn get_express_route_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20190701:getExpressRouteConnection", invoke_args, &opts).await?;
