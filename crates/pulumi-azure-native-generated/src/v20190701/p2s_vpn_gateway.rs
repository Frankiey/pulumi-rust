...
pub struct P2sVpnGatewayArgs {
    ...
    pub p2s_vpn_server_configuration: Option<Input<network::v20190701::SubResourceArgs>>,
    ...
    pub vpn_client_address_pool: Option<Input<network::v20190701::AddressSpaceArgs>>,
...
impl P2sVpnGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190701:P2sVpnGateway";
