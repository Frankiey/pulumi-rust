...
pub struct VirtualNetworkGatewayArgs {
    ...
    pub bgp_settings: Option<Input<network::v20190701::BgpSettingsArgs>>,
    ...
    pub custom_routes: Option<Input<network::v20190701::AddressSpaceArgs>>,
    /// Whether BGP is enabled for this virtual network gateway or not.
    pub enable_bgp: Option<Input<bool>>,
    /// The reference of the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
    pub gateway_default_site: Option<Input<network::v20190701::SubResourceArgs>>,
    /// The type of this virtual network gateway.
    pub gateway_type: Option<Input<serde_json::Value>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// IP configurations for virtual network gateway.
    pub ip_configurations: Option<Vec<Input<network::v20190701::VirtualNetworkGatewayIPConfigurationArgs>>>,
    /// Resource location.
    ...
    pub sku: Option<Input<network::v20190701::VirtualNetworkGatewaySkuArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The name of the virtual network gateway.
    pub virtual_network_gateway_name: Option<Input<String>>,
    /// The reference of the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
    pub vpn_client_configuration: Option<Input<network::v20190701::VpnClientConfigurationArgs>>,
...
impl VirtualNetworkGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190701:VirtualNetworkGateway";
