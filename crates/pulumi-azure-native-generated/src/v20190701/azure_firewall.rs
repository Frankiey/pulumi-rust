...
pub struct AzureFirewallArgs {
    ...
    pub application_rule_collections: Option<Vec<Input<network::v20190701::AzureFirewallApplicationRuleCollectionArgs>>>,
    ...
    pub ip_configurations: Option<Vec<Input<network::v20190701::AzureFirewallIPConfigurationArgs>>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// Collection of NAT rule collections used by Azure Firewall.
    pub nat_rule_collections: Option<Vec<Input<network::v20190701::AzureFirewallNatRuleCollectionArgs>>>,
    /// Collection of network rule collections used by Azure Firewall.
    pub network_rule_collections: Option<Vec<Input<network::v20190701::AzureFirewallNetworkRuleCollectionArgs>>>,
    ...
    pub virtual_hub: Option<Input<network::v20190701::SubResourceArgs>>,
...
impl AzureFirewall {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190701:AzureFirewall";
