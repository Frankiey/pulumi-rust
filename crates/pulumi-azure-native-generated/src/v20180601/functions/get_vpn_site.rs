...
pub struct GetVpnSiteResult {
    ...
    pub bgp_properties: Option<network::v20180601::BgpSettingsResponse>,
    /// The device properties
    pub device_properties: Option<network::v20180601::DevicePropertiesResponse>,
    ...
    pub virtual_wan: Option<network::v20180601::SubResourceResponse>,
}
...
pub async fn get_vpn_site(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getVpnSite", invoke_args, &opts).await?;
