...
pub struct GetVirtualWANResult {
    ...
    pub virtual_hubs: Vec<network::v20180601::SubResourceResponse>,
    pub vpn_sites: Vec<network::v20180601::SubResourceResponse>,
}
...
pub async fn get_virtual_wan(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getVirtualWAN", invoke_args, &opts).await?;
