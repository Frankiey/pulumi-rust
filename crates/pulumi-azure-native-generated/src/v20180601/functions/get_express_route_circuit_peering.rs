...
pub struct GetExpressRouteCircuitPeeringResult {
    ...
    pub connections: Option<Vec<network::v20180601::ExpressRouteCircuitConnectionResponse>>,
    ...
    pub ipv6peering_config: Option<network::v20180601::Ipv6ExpressRouteCircuitPeeringConfigResponse>,
    /// Gets whether the provider or the customer last modified the peering.
    pub last_modified_by: Option<String>,
    /// The Microsoft peering configuration.
    pub microsoft_peering_config: Option<network::v20180601::ExpressRouteCircuitPeeringConfigResponse>,
    ...
    pub route_filter: Option<network::v20180601::RouteFilterResponse>,
    /// The secondary port.
    ...
    /// Gets peering stats.
    pub stats: Option<network::v20180601::ExpressRouteCircuitStatsResponse>,
    /// The VLAN ID.
...
pub async fn get_express_route_circuit_peering(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getExpressRouteCircuitPeering", invoke_args, &opts).await?;
