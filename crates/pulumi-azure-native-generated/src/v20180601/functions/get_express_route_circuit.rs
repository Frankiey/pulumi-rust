...
pub struct GetExpressRouteCircuitResult {
    ...
    pub authorizations: Option<Vec<network::v20180601::ExpressRouteCircuitAuthorizationResponse>>,
    ...
    pub peerings: Option<Vec<network::v20180601::ExpressRouteCircuitPeeringResponse>>,
    ...
    pub service_provider_properties: Option<network::v20180601::ExpressRouteCircuitServiceProviderPropertiesResponse>,
    /// The ServiceProviderProvisioningState state of the resource. Possible values are 'NotProvisioned', 'Provisioning', 'Provisioned', and 'Deprovisioning'.
    pub service_provider_provisioning_state: Option<String>,
    /// The SKU.
    pub sku: Option<network::v20180601::ExpressRouteCircuitSkuResponse>,
    /// Resource tags.
...
pub async fn get_express_route_circuit(
    ...
    let result = ctx.invoke("azure-native:network/v20180601:getExpressRouteCircuit", invoke_args, &opts).await?;
