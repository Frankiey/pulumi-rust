...
pub struct PacketCaptureArgs {
    ...
    pub bytes_to_capture_per_packet: Option<Input<i64>>,
    pub filters: Option<Vec<Input<network::v20180601::PacketCaptureFilterArgs>>>,
    ...
    pub storage_location: Input<network::v20180601::PacketCaptureStorageLocationArgs>,
    /// The ID of the targeted resource, only VM is currently supported.
    pub target: Input<String>,
    /// Maximum duration of the capture session in seconds.
    pub time_limit_in_seconds: Option<Input<i64>>,
    /// Maximum size of the capture output.
    pub total_bytes_per_session: Option<Input<i64>>,
}
...
impl PacketCapture {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180601:PacketCapture";
