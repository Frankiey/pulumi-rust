...
pub struct ExpressRouteCircuitPeeringArgs {
    ...
    pub connections: Option<Vec<Input<network::v20180601::ExpressRouteCircuitConnectionArgs>>>,
    /// The GatewayManager Etag.
    pub gateway_manager_etag: Option<Input<String>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// The IPv6 peering configuration.
    pub ipv6peering_config: Option<Input<network::v20180601::Ipv6ExpressRouteCircuitPeeringConfigArgs>>,
    /// Gets whether the provider or the customer last modified the peering.
    pub last_modified_by: Option<Input<String>>,
    /// The Microsoft peering configuration.
    pub microsoft_peering_config: Option<Input<network::v20180601::ExpressRouteCircuitPeeringConfigArgs>>,
    ...
    pub route_filter: Option<Input<network::v20180601::RouteFilterArgs>>,
    /// The secondary port.
    ...
    /// Gets peering stats.
    pub stats: Option<Input<network::v20180601::ExpressRouteCircuitStatsArgs>>,
    /// The VLAN ID.
...
impl ExpressRouteCircuitPeering {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180601:ExpressRouteCircuitPeering";
