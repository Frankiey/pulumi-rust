...
pub struct VpnGatewayArgs {
    ...
    pub bgp_settings: Option<Input<network::v20180601::BgpSettingsArgs>>,
    /// list of all vpn connections to the gateway.
    pub connections: Option<Vec<Input<network::v20180601::VpnConnectionArgs>>>,
    ...
    pub policies: Option<Input<network::v20180601::PoliciesArgs>>,
    /// The resource group name of the VpnGateway.
    pub resource_group_name: Input<String>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The VirtualHub to which the gateway belongs
    pub virtual_hub: Option<Input<network::v20180601::SubResourceArgs>>,
}
...
impl VpnGateway {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20180601:VpnGateway";
