...
pub struct GetResourceGroupResult {
    ...
    pub properties: resources::v20210401::ResourceGroupPropertiesResponse,
...
pub async fn get_resource_group(
    ...
    let result = ctx.invoke("azure-native:resources/v20210401:getResourceGroup", invoke_args, &opts).await?;
