...
pub struct ResourceArgs {
    ...
    pub extended_location: Option<Input<resources::ExtendedLocationArgs>>,
    /// The identity of the resource.
    pub identity: Option<Input<resources::IdentityArgs>>,
    ...
    pub plan: Option<Input<resources::PlanArgs>>,
    ...
    pub sku: Option<Input<resources::SkuArgs>>,
    /// Resource tags
...
impl Resource {
    const TYPE_TOKEN: &'static str = "azure-native:resources:Resource";
