...
pub struct GetInterfaceEndpointResult {
    ...
    pub endpoint_service: Option<network::v20190201::EndpointServiceResponse>,
    ...
    pub subnet: Option<network::v20190201::SubnetResponse>,
    /// Resource tags.
...
pub async fn get_interface_endpoint(
    ...
    let result = ctx.invoke("azure-native:network/v20190201:getInterfaceEndpoint", invoke_args, &opts).await?;
