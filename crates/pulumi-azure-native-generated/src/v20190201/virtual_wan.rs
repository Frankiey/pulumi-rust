...
pub struct VirtualWanArgs {
    ...
    pub p2s_vpn_server_configurations: Option<Vec<Input<network::v20190201::P2SVpnServerConfigurationArgs>>>,
...
pub struct VirtualWan {
    ...
    /// List of all P2SVpnServerConfigurations associated with the virtual wan.
    pub p2s_vpn_server_configurations: Output<serde_json::Value>,
...
impl VirtualWan {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190201:VirtualWan";
    ...
    pub async fn new(
        ...
        if let Some(v) = args.p2s_vpn_server_configurations {
            pulumi_sdk::resolve_input_vec("p2SVpnServerConfigurations", v, &mut inputs, &mut deps, &mut prop_deps).await;
        }
        ...
        Ok(Self {
            ...
            office365local_breakout_category: registered.outputs.get("office365LocalBreakoutCategory")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
            p2s_vpn_server_configurations: registered.outputs.get("p2SVpnServerConfigurations")
                .cloned()
                .unwrap_or_else(|| Output::unknown(vec![registered.urn.clone()])),
