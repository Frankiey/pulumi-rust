...
pub struct NetworkInterfaceTapConfigurationArgs {
    ...
    pub virtual_network_tap: Option<Input<network::v20201101::VirtualNetworkTapArgs>>,
}
...
impl NetworkInterfaceTapConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20201101:NetworkInterfaceTapConfiguration";
