...
pub struct GetVirtualHubResult {
    ...
    pub azure_firewall: Option<network::v20201101::SubResourceResponse>,
    /// List of references to Bgp Connections.
    pub bgp_connections: Vec<network::v20201101::SubResourceResponse>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The expressRouteGateway associated with this VirtualHub.
    pub express_route_gateway: Option<network::v20201101::SubResourceResponse>,
    /// Resource ID.
    pub id: Option<String>,
    /// List of references to IpConfigurations.
    pub ip_configurations: Vec<network::v20201101::SubResourceResponse>,
    /// Resource location.
    pub location: String,
    /// Resource name.
    pub name: String,
    /// The P2SVpnGateway associated with this VirtualHub.
    pub p2s_vpn_gateway: Option<network::v20201101::SubResourceResponse>,
    /// The provisioning state of the virtual hub resource.
    pub provisioning_state: String,
    /// The routeTable associated with this virtual hub.
    pub route_table: Option<network::v20201101::VirtualHubRouteTableResponse>,
    /// The routing state.
    pub routing_state: String,
    /// The securityPartnerProvider associated with this VirtualHub.
    pub security_partner_provider: Option<network::v20201101::SubResourceResponse>,
    ...
    pub virtual_hub_route_table_v2s: Option<Vec<network::v20201101::VirtualHubRouteTableV2Response>>,
    /// VirtualRouter ASN.
    pub virtual_router_asn: Option<f64>,
    /// VirtualRouter IPs.
    pub virtual_router_ips: Option<Vec<String>>,
    /// The VirtualWAN to which the VirtualHub belongs.
    pub virtual_wan: Option<network::v20201101::SubResourceResponse>,
    /// The VpnGateway associated with this VirtualHub.
    pub vpn_gateway: Option<network::v20201101::SubResourceResponse>,
}
...
pub async fn get_virtual_hub(
    ...
    let result = ctx.invoke("azure-native:network/v20201101:getVirtualHub", invoke_args, &opts).await?;
