...
pub struct GetNetworkSecurityGroupResult {
    ...
    pub default_security_rules: Vec<network::v20201101::SecurityRuleResponse>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// A collection of references to flow log resources.
    pub flow_logs: Vec<network::v20201101::FlowLogResponse>,
    /// Resource ID.
    ...
    pub security_rules: Option<Vec<network::v20201101::SecurityRuleResponse>>,
    /// A collection of references to subnets.
    pub subnets: Vec<network::v20201101::SubnetResponse>,
    /// Resource tags.
...
pub async fn get_network_security_group(
    ...
    let result = ctx.invoke("azure-native:network/v20201101:getNetworkSecurityGroup", invoke_args, &opts).await?;
