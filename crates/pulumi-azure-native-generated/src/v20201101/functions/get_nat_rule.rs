...
pub struct GetNatRuleResult {
    ...
    pub egress_vpn_site_link_connections: Vec<network::v20201101::SubResourceResponse>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// The private IP address external mapping for NAT.
    pub external_mappings: Option<Vec<network::v20201101::VpnNatRuleMappingResponse>>,
    /// Resource ID.
    pub id: Option<String>,
    /// List of ingress VpnSiteLinkConnections.
    pub ingress_vpn_site_link_connections: Vec<network::v20201101::SubResourceResponse>,
    /// The private IP address internal mapping for NAT.
    pub internal_mappings: Option<Vec<network::v20201101::VpnNatRuleMappingResponse>>,
...
pub async fn get_nat_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20201101:getNatRule", invoke_args, &opts).await?;
