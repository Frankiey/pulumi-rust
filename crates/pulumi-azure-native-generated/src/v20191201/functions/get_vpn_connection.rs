...
pub struct GetVpnConnectionResult {
    ...
    pub remote_vpn_site: Option<network::v20191201::SubResourceResponse>,
    ...
    pub vpn_link_connections: Option<Vec<network::v20191201::VpnSiteLinkConnectionResponse>>,
}
...
pub async fn get_vpn_connection(
    ...
    let result = ctx.invoke("azure-native:network/v20191201:getVpnConnection", invoke_args, &opts).await?;
