...
pub struct GetSecurityRuleResult {
    ...
    pub destination_application_security_groups: Option<Vec<network::v20191201::ApplicationSecurityGroupResponse>>,
    ...
    pub source_application_security_groups: Option<Vec<network::v20191201::ApplicationSecurityGroupResponse>>,
...
pub async fn get_security_rule(
    ...
    let result = ctx.invoke("azure-native:network/v20191201:getSecurityRule", invoke_args, &opts).await?;
