...
pub struct DeploymentStacksWhatIfResultsAtResourceGroupArgs {
...
/// 
/// Uses Azure REST API version 2025-07-01.
pub struct DeploymentStacksWhatIfResultsAtResourceGroup {
...
impl DeploymentStacksWhatIfResultsAtResourceGroup {
    const TYPE_TOKEN: &'static str = "azure-native:resources:DeploymentStacksWhatIfResultsAtResourceGroup";

    /// Create a new DeploymentStacksWhatIfResultsAtResourceGroup resource.
    pub async fn new(
        ctx: &Context,
        name: &str,
