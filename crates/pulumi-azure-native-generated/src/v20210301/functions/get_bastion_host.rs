...
pub struct GetBastionHostResult {
    ...
    pub ip_configurations: Option<Vec<network::v20210301::BastionHostIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub sku: Option<network::v20210301::SkuResponse>,
    /// Resource tags.
...
pub async fn get_bastion_host(
    ...
    let result = ctx.invoke("azure-native:network/v20210301:getBastionHost", invoke_args, &opts).await?;
