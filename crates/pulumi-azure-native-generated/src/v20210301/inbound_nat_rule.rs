...
pub struct InboundNatRuleArgs {
    ...
    pub backend_address_pool: Option<Input<network::v20210301::SubResourceArgs>>,
    ...
    pub frontend_ip_configuration: Option<Input<network::v20210301::SubResourceArgs>>,
...
impl InboundNatRule {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20210301:InboundNatRule";
