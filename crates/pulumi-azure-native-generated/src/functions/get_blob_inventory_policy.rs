...
pub struct GetBlobInventoryPolicyResult {
    ...
    pub policy: storage::BlobInventoryPolicySchemaResponse,
    /// Metadata pertaining to creation and last modification of the resource.
    pub system_data: storage::SystemDataResponse,
...
pub async fn get_blob_inventory_policy(
    ...
    let result = ctx.invoke("azure-native:storage:getBlobInventoryPolicy", invoke_args, &opts).await?;
