...
pub struct GetEncryptionScopeResult {
    ...
    pub key_vault_properties: Option<storage::EncryptionScopeKeyVaultPropertiesResponse>,
...
pub async fn get_encryption_scope(
    ...
    let result = ctx.invoke("azure-native:storage:getEncryptionScope", invoke_args, &opts).await?;
