...
pub struct GetStorageTaskAssignmentResult {
    ...
    pub properties: storage::StorageTaskAssignmentPropertiesResponse,
...
pub async fn get_storage_task_assignment(
    ...
    let result = ctx.invoke("azure-native:storage:getStorageTaskAssignment", invoke_args, &opts).await?;
