...
pub struct GetResourceResult {
    ...
    pub extended_location: Option<resources::ExtendedLocationResponse>,
    /// Resource ID
    pub id: String,
    /// The identity of the resource.
    pub identity: Option<resources::IdentityResponse>,
    ...
    pub plan: Option<resources::PlanResponse>,
    /// The resource properties.
    pub properties: serde_json::Value,
    /// The SKU of the resource.
    pub sku: Option<resources::SkuResponse>,
    /// Resource tags
...
pub async fn get_resource(
    ...
    let result = ctx.invoke("azure-native:resources:getResource", invoke_args, &opts).await?;
