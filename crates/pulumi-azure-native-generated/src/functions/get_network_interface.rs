...
pub struct GetNetworkInterfaceResult {
    ...
    pub dns_settings: Option<network::NetworkInterfaceDnsSettingsResponse>,
    /// A reference to the dscp configuration to which the network interface is linked.
    pub dscp_configuration: network::SubResourceResponse,
    ...
    pub ip_configurations: Option<Vec<network::NetworkInterfaceIPConfigurationResponse>>,
    /// Resource location.
    ...
    pub private_endpoint: network::PrivateEndpointResponse,
    /// Privatelinkservice of the network interface resource.
    pub private_link_service: Option<network::PrivateLinkServiceResponse>,
    ...
    pub tap_configurations: Vec<network::NetworkInterfaceTapConfigurationResponse>,
    /// Resource type.
    pub type_: String,
    /// The reference to a virtual machine.
    pub virtual_machine: network::SubResourceResponse,
...
pub async fn get_network_interface(
    ...
    let result = ctx.invoke("azure-native:network:getNetworkInterface", invoke_args, &opts).await?;
