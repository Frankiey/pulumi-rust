...
pub struct GetPacketCaptureResult {
    ...
    pub capture_settings: Option<network::PacketCaptureSettingsResponse>,
    ...
    pub filters: Option<Vec<network::PacketCaptureFilterResponse>>,
    ...
    pub scope: Option<network::PacketCaptureMachineScopeResponse>,
    /// The storage location for a packet capture session.
    pub storage_location: network::PacketCaptureStorageLocationResponse,
...
pub async fn get_packet_capture(
    ...
    let result = ctx.invoke("azure-native:network:getPacketCapture", invoke_args, &opts).await?;
