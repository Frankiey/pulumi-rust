...
pub struct GetVirtualNetworkGatewayRoutesInformationResult {
    ...
    pub circuits_metadata_map: Option<HashMap<String, network::CircuitMetadataMapResponse>>,
    ...
    pub route_sets: Option<Vec<network::GatewayRouteSetResponse>>,
}
...
pub async fn get_virtual_network_gateway_routes_information(
    ...
    let result = ctx.invoke("azure-native:network:getVirtualNetworkGatewayRoutesInformation", invoke_args, &opts).await?;
