...
pub struct ListActiveConnectivityConfigurationResult {
    ...
    pub value: Option<Vec<network::ActiveConnectivityConfigurationResponse>>,
}
...
pub async fn list_active_connectivity_configuration(
    ...
    let result = ctx.invoke("azure-native:network:listActiveConnectivityConfiguration", invoke_args, &opts).await?;
