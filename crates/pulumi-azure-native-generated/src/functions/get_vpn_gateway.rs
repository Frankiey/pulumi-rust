...
pub struct GetVpnGatewayResult {
    ...
    pub connections: Option<Vec<network::VpnConnectionResponse>>,
    ...
    pub ip_configurations: Vec<network::VpnGatewayIpConfigurationResponse>,
    ...
    pub nat_rules: Option<Vec<network::VpnGatewayNatRuleResponse>>,
...
pub async fn get_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network:getVpnGateway", invoke_args, &opts).await?;
