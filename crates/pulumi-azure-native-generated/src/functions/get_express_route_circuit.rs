...
pub struct GetExpressRouteCircuitResult {
    ...
    pub authorizations: Option<Vec<network::ExpressRouteCircuitAuthorizationResponse>>,
    ...
    pub express_route_port: Option<network::SubResourceResponse>,
    ...
    pub peerings: Option<Vec<network::ExpressRouteCircuitPeeringResponse>>,
    ...
    pub service_provider_properties: Option<network::ExpressRouteCircuitServiceProviderPropertiesResponse>,
    /// The ServiceProviderProvisioningState state of the resource.
    pub service_provider_provisioning_state: Option<String>,
    /// The SKU.
    pub sku: Option<network::ExpressRouteCircuitSkuResponse>,
...
pub async fn get_express_route_circuit(
    ...
    let result = ctx.invoke("azure-native:network:getExpressRouteCircuit", invoke_args, &opts).await?;
