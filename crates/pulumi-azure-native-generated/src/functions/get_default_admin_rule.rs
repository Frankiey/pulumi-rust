...
pub struct GetDefaultAdminRuleResult {
    ...
    pub destinations: Vec<network::AddressPrefixItemResponse>,
    ...
    pub sources: Vec<network::AddressPrefixItemResponse>,
...
pub async fn get_default_admin_rule(
    ...
    let result = ctx.invoke("azure-native:network:getDefaultAdminRule", invoke_args, &opts).await?;
