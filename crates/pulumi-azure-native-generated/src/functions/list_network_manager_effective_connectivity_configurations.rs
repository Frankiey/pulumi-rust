...
pub struct ListNetworkManagerEffectiveConnectivityConfigurationsResult {
    ...
    pub value: Option<Vec<network::EffectiveConnectivityConfigurationResponseV1>>,
}
...
pub async fn list_network_manager_effective_connectivity_configurations(
    ...
    let result = ctx.invoke("azure-native:network:listNetworkManagerEffectiveConnectivityConfigurations", invoke_args, &opts).await?;
