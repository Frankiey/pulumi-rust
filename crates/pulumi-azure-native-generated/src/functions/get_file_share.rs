...
pub struct GetFileShareResult {
    ...
    pub file_share_paid_bursting: Option<storage::FileSharePropertiesResponseFileSharePaidBursting>,
    ...
    pub signed_identifiers: Option<Vec<storage::SignedIdentifierResponse>>,
...
pub async fn get_file_share(
    ...
    let result = ctx.invoke("azure-native:storage:getFileShare", invoke_args, &opts).await?;
