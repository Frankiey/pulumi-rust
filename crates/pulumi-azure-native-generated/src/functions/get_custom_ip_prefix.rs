...
pub struct GetCustomIPPrefixResult {
    ...
    pub child_custom_ip_prefixes: Vec<network::SubResourceResponse>,
    /// The prefix range in CIDR notation. Should include the start address and the prefix length.
    pub cidr: Option<String>,
    /// The commissioned state of the Custom IP Prefix.
    pub commissioned_state: Option<String>,
    /// The Parent CustomIpPrefix for IPv6 /64 CustomIpPrefix.
    pub custom_ip_prefix_parent: Option<network::SubResourceResponse>,
    ...
    pub public_ip_prefixes: Vec<network::SubResourceResponse>,
...
pub async fn get_custom_ip_prefix(
    ...
    let result = ctx.invoke("azure-native:network:getCustomIPPrefix", invoke_args, &opts).await?;
