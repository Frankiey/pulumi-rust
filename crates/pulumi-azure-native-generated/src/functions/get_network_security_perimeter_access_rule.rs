...
pub struct GetNetworkSecurityPerimeterAccessRuleResult {
    ...
    pub network_security_perimeters: Vec<network::PerimeterBasedAccessRuleResponse>,
    ...
    pub subscriptions: Option<Vec<network::SubscriptionIdResponse>>,
    /// Resource tags.
...
pub async fn get_network_security_perimeter_access_rule(
    ...
    let result = ctx.invoke("azure-native:network:getNetworkSecurityPerimeterAccessRule", invoke_args, &opts).await?;
