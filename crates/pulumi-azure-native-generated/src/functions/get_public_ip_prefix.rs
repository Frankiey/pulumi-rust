...
pub struct GetPublicIPPrefixResult {
    ...
    pub custom_ip_prefix: Option<network::SubResourceResponse>,
    ...
    pub load_balancer_frontend_ip_configuration: network::SubResourceResponse,
    /// Resource location.
    ...
    pub public_ip_addresses: Vec<network::ReferencedPublicIpAddressResponse>,
    /// The resource GUID property of the public IP prefix resource.
    pub resource_guid: String,
    /// The public IP prefix SKU.
    pub sku: Option<network::PublicIPPrefixSkuResponse>,
    /// Resource tags.
...
pub async fn get_public_ip_prefix(
    ...
    let result = ctx.invoke("azure-native:network:getPublicIPPrefix", invoke_args, &opts).await?;
