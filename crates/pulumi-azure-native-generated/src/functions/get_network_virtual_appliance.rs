...
pub struct GetNetworkVirtualApplianceResult {
    ...
    pub additional_nics: Option<Vec<network::VirtualApplianceAdditionalNicPropertiesResponse>>,
    /// Address Prefix.
    ...
    pub delegation: Option<network::DelegationPropertiesResponse>,
    ...
    pub inbound_security_rules: Vec<network::SubResourceResponse>,
    /// List of Resource Uri of Public IPs for Internet Ingress Scenario.
    pub internet_ingress_public_ips: Option<Vec<network::InternetIngressPublicIpsPropertiesResponse>>,
    /// Resource location.
    pub location: Option<String>,
    /// Resource name.
    pub name: String,
    /// Network Profile containing configurations for Public and Private NIC.
    pub network_profile: Option<network::NetworkVirtualAppliancePropertiesFormatResponseNetworkProfile>,
    /// Network Virtual Appliance SKU.
    pub nva_sku: Option<network::VirtualApplianceSkuPropertiesResponse>,
    /// The delegation for the Virtual Appliance
    pub partner_managed_resource: Option<network::PartnerManagedResourcePropertiesResponse>,
    ...
    pub virtual_appliance_connections: Vec<network::SubResourceResponse>,
    /// List of Virtual Appliance Network Interfaces.
    pub virtual_appliance_nics: Vec<network::VirtualApplianceNicPropertiesResponse>,
    /// List of references to VirtualApplianceSite.
    pub virtual_appliance_sites: Vec<network::SubResourceResponse>,
...
pub async fn get_network_virtual_appliance(
    ...
    let result = ctx.invoke("azure-native:network:getNetworkVirtualAppliance", invoke_args, &opts).await?;
