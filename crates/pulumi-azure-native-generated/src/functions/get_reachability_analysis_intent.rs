...
pub struct GetReachabilityAnalysisIntentResult {
    ...
    pub properties: network::ReachabilityAnalysisIntentPropertiesResponse,
...
pub async fn get_reachability_analysis_intent(
    ...
    let result = ctx.invoke("azure-native:network:getReachabilityAnalysisIntent", invoke_args, &opts).await?;
