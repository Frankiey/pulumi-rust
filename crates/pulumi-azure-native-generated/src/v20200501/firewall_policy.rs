...
pub struct FirewallPolicyArgs {
    ...
    pub base_policy: Option<Input<network::v20200501::SubResourceArgs>>,
    /// DNS Proxy Settings definition.
    pub dns_settings: Option<Input<network::v20200501::DnsSettingsArgs>>,
    ...
    pub threat_intel_whitelist: Option<Input<network::v20200501::FirewallPolicyThreatIntelWhitelistArgs>>,
}
...
impl FirewallPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200501:FirewallPolicy";
