...
pub struct GetVpnServerConfigurationResult {
    ...
    pub properties: network::v20200501::VpnServerConfigurationPropertiesResponse,
    /// Resource tags.
...
pub async fn get_vpn_server_configuration(
    ...
    let result = ctx.invoke("azure-native:network/v20200501:getVpnServerConfiguration", invoke_args, &opts).await?;
