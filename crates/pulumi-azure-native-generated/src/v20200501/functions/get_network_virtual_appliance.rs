...
pub struct GetNetworkVirtualApplianceResult {
    ...
    pub nva_sku: Option<network::v20200501::VirtualApplianceSkuPropertiesResponse>,
    ...
    pub virtual_appliance_nics: Vec<network::v20200501::VirtualApplianceNicPropertiesResponse>,
    /// List of references to VirtualApplianceSite.
    pub virtual_appliance_sites: Vec<network::v20200501::SubResourceResponse>,
...
pub async fn get_network_virtual_appliance(
    ...
    let result = ctx.invoke("azure-native:network/v20200501:getNetworkVirtualAppliance", invoke_args, &opts).await?;
