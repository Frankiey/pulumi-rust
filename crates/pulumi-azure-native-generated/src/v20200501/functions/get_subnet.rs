...
pub struct GetSubnetResult {
    ...
    pub delegations: Option<Vec<network::v20200501::DelegationResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// Resource ID.
    pub id: Option<String>,
    /// Array of IpAllocation which reference this subnet.
    pub ip_allocations: Option<Vec<network::v20200501::SubResourceResponse>>,
    /// Array of IP configuration profiles which reference this subnet.
    pub ip_configuration_profiles: Vec<network::v20200501::IPConfigurationProfileResponse>,
    /// An array of references to the network interface IP configurations using subnet.
    pub ip_configurations: Vec<network::v20200501::IPConfigurationResponse>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<String>,
    /// Nat gateway associated with this subnet.
    pub nat_gateway: Option<network::v20200501::SubResourceResponse>,
    /// The reference to the NetworkSecurityGroup resource.
    pub network_security_group: Option<network::v20200501::NetworkSecurityGroupResponse>,
    /// Enable or Disable apply network policies on private end point in the subnet.
    pub private_endpoint_network_policies: Option<String>,
    /// An array of references to private endpoints.
    pub private_endpoints: Vec<network::v20200501::PrivateEndpointResponse>,
    ...
    pub resource_navigation_links: Vec<network::v20200501::ResourceNavigationLinkResponse>,
    /// The reference to the RouteTable resource.
    pub route_table: Option<network::v20200501::RouteTableResponse>,
    /// An array of references to services injecting into this subnet.
    pub service_association_links: Vec<network::v20200501::ServiceAssociationLinkResponse>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<network::v20200501::ServiceEndpointPolicyResponse>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<network::v20200501::ServiceEndpointPropertiesFormatResponse>>,
}
...
pub async fn get_subnet(
    ...
    let result = ctx.invoke("azure-native:network/v20200501:getSubnet", invoke_args, &opts).await?;
