...
pub struct PublicIPAddressArgs {
    ...
    pub ddos_settings: Option<Input<network::v20200501::DdosSettingsArgs>>,
    /// The FQDN of the DNS record associated with the public IP address.
    pub dns_settings: Option<Input<network::v20200501::PublicIPAddressDnsSettingsArgs>>,
    /// Resource ID.
    ...
    pub ip_tags: Option<Vec<Input<network::v20200501::IpTagArgs>>>,
    /// Resource location.
    ...
    pub public_ip_prefix: Option<Input<network::v20200501::SubResourceArgs>>,
    /// The name of the public IP address.
    pub public_ip_address_name: Option<Input<String>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The public IP address SKU.
    pub sku: Option<Input<network::v20200501::PublicIPAddressSkuArgs>>,
    /// Resource tags.
...
impl PublicIPAddress {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200501:PublicIPAddress";
