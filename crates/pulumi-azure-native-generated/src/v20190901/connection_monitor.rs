...
pub struct ConnectionMonitorArgs {
    ...
    pub destination: Input<network::v20190901::ConnectionMonitorDestinationArgs>,
    ...
    pub source: Input<network::v20190901::ConnectionMonitorSourceArgs>,
...
impl ConnectionMonitor {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190901:ConnectionMonitor";
    ...
    pub async fn new(
        ...
        pulumi_sdk::resolve_input("source", args.source, &mut inputs, &mut deps, &mut prop_deps).await;
