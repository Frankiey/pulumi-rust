...
pub struct VirtualHubArgs {
    ...
    pub azure_firewall: Option<Input<network::v20190901::SubResourceArgs>>,
    /// The expressRouteGateway associated with this VirtualHub.
    pub express_route_gateway: Option<Input<network::v20190901::SubResourceArgs>>,
    /// Resource ID.
    pub id: Option<Input<String>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The P2SVpnGateway associated with this VirtualHub.
    pub p2s_vpn_gateway: Option<Input<network::v20190901::SubResourceArgs>>,
    /// The resource group name of the VirtualHub.
    pub resource_group_name: Input<String>,
    /// The routeTable associated with this virtual hub.
    pub route_table: Option<Input<network::v20190901::VirtualHubRouteTableArgs>>,
    ...
    pub virtual_hub_route_table_v2s: Option<Vec<Input<network::v20190901::VirtualHubRouteTableV2Args>>>,
    /// List of all vnet connections with this VirtualHub.
    pub virtual_network_connections: Option<Vec<Input<network::v20190901::HubVirtualNetworkConnectionArgs>>>,
    /// The VirtualWAN to which the VirtualHub belongs.
    pub virtual_wan: Option<Input<network::v20190901::SubResourceArgs>>,
    /// The VpnGateway associated with this VirtualHub.
    pub vpn_gateway: Option<Input<network::v20190901::SubResourceArgs>>,
}
...
impl VirtualHub {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20190901:VirtualHub";
