...
pub struct GetBastionShareableLinkArgs {
    ...
    pub vms: Option<Vec<network::v20190901::BastionShareableLink>>,
}
...
pub struct GetBastionShareableLinkResult {
    ...
    pub value: Option<Vec<network::v20190901::BastionShareableLinkResponse>>,
}
...
pub async fn get_bastion_shareable_link(
    ...
    let result = ctx.invoke("azure-native:network/v20190901:getBastionShareableLink", invoke_args, &opts).await?;
