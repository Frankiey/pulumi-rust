...
pub struct GetVpnGatewayResult {
    ...
    pub connections: Option<Vec<network::v20190901::VpnConnectionResponse>>,
...
pub async fn get_vpn_gateway(
    ...
    let result = ctx.invoke("azure-native:network/v20190901:getVpnGateway", invoke_args, &opts).await?;
