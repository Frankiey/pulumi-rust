...
pub struct GetSubnetResult {
    ...
    pub delegations: Option<Vec<network::v20190901::DelegationResponse>>,
    /// A unique read-only string that changes whenever the resource is updated.
    pub etag: String,
    /// Resource ID.
    pub id: Option<String>,
    /// Array of IP configuration profiles which reference this subnet.
    pub ip_configuration_profiles: Vec<network::v20190901::IPConfigurationProfileResponse>,
    /// An array of references to the network interface IP configurations using subnet.
    pub ip_configurations: Vec<network::v20190901::IPConfigurationResponse>,
    /// The name of the resource that is unique within a resource group. This name can be used to access the resource.
    pub name: Option<String>,
    /// Nat gateway associated with this subnet.
    pub nat_gateway: Option<network::v20190901::SubResourceResponse>,
    /// The reference of the NetworkSecurityGroup resource.
    pub network_security_group: Option<network::v20190901::NetworkSecurityGroupResponse>,
    /// Enable or Disable apply network policies on private end point in the subnet.
    pub private_endpoint_network_policies: Option<String>,
    /// An array of references to private endpoints.
    pub private_endpoints: Vec<network::v20190901::PrivateEndpointResponse>,
    ...
    pub resource_navigation_links: Vec<network::v20190901::ResourceNavigationLinkResponse>,
    /// The reference of the RouteTable resource.
    pub route_table: Option<network::v20190901::RouteTableResponse>,
    /// An array of references to services injecting into this subnet.
    pub service_association_links: Vec<network::v20190901::ServiceAssociationLinkResponse>,
    /// An array of service endpoint policies.
    pub service_endpoint_policies: Option<Vec<network::v20190901::ServiceEndpointPolicyResponse>>,
    /// An array of service endpoints.
    pub service_endpoints: Option<Vec<network::v20190901::ServiceEndpointPropertiesFormatResponse>>,
}
...
pub async fn get_subnet(
    ...
    let result = ctx.invoke("azure-native:network/v20190901:getSubnet", invoke_args, &opts).await?;
