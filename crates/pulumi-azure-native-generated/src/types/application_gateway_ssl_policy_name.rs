...
impl ApplicationGatewaySslPolicyName {
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::AppGwSslPolicy20220101 => "AppGwSslPolicy20220101",
            Self::AppGwSslPolicy20220101S => "AppGwSslPolicy20220101S",
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for ApplicationGatewaySslPolicyName {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> std::result::Result<Self, D::Error> {
        ...
        match s.as_str() {
            ...
            "AppGwSslPolicy20220101" => Ok(Self::AppGwSslPolicy20220101),
            "AppGwSslPolicy20220101S" => Ok(Self::AppGwSslPolicy20220101S),
            _ => Err(serde::de::Error::unknown_variant(&s, &["AppGwSslPolicy20150501", "AppGwSslPolicy20170401", "AppGwSslPolicy20170401S", "AppGwSslPolicy20220101", "AppGwSslPolicy20220101S"])),
        }
    }
}
