...
impl EndpointType {
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::AzureArcNetwork => "AzureArcNetwork",
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for EndpointType {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> std::result::Result<Self, D::Error> {
        ...
        match s.as_str() {
            ...
            "AzureArcNetwork" => Ok(Self::AzureArcNetwork),
            _ => Err(serde::de::Error::unknown_variant(&s, &["AzureVM", "AzureVNet", "AzureSubnet", "ExternalAddress", "MMAWorkspaceMachine", "MMAWorkspaceNetwork", "AzureArcVM", "AzureVMSS", "AzureArcNetwork"])),
        }
    }
}
