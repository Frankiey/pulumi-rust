...
impl<'de> serde::Deserialize<'de> for WebApplicationFirewallOperator {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> std::result::Result<Self, D::Error> {
        ...
        match s.as_str() {
            ...
            "Any" => Ok(Self::Any),
            _ => Err(serde::de::Error::unknown_variant(&s, &["IPMatch", "Equal", "Contains", "LessThan", "GreaterThan", "LessThanOrEqual", "GreaterThanOrEqual", "BeginsWith", "EndsWith", "Regex", "GeoMatch", "Any"])),
        }
    }
}
