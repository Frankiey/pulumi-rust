...
pub struct VpnServerConfigurationArgs {
    ...
    pub properties: Option<Input<network::v20200801::VpnServerConfigurationPropertiesArgs>>,
...
impl VpnServerConfiguration {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200801:VpnServerConfiguration";
