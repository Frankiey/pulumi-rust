...
pub struct FirewallPolicyArgs {
    ...
    pub base_policy: Option<Input<network::v20200801::SubResourceArgs>>,
    /// DNS Proxy Settings definition.
    pub dns_settings: Option<Input<network::v20200801::DnsSettingsArgs>>,
    ...
    pub intrusion_detection: Option<Input<network::v20200801::FirewallPolicyIntrusionDetectionArgs>>,
    /// Resource location.
    pub location: Option<Input<String>>,
    /// The name of the resource group.
    pub resource_group_name: Input<String>,
    /// The Firewall Policy SKU.
    pub sku: Option<Input<network::v20200801::FirewallPolicySkuArgs>>,
    /// Resource tags.
    pub tags: Option<HashMap<String, Input<String>>>,
    /// The operation mode for Threat Intelligence.
    pub threat_intel_mode: Option<Input<serde_json::Value>>,
    /// ThreatIntel Whitelist for Firewall Policy.
    pub threat_intel_whitelist: Option<Input<network::v20200801::FirewallPolicyThreatIntelWhitelistArgs>>,
    /// TLS Configuration definition.
    pub transport_security: Option<Input<network::v20200801::FirewallPolicyTransportSecurityArgs>>,
}
...
impl FirewallPolicy {
    const TYPE_TOKEN: &'static str = "azure-native:network/v20200801:FirewallPolicy";
